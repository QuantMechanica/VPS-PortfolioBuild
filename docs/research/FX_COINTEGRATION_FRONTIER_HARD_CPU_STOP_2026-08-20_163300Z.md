...
At `16:33Z`, five one-second whole-host CPU samples were `99.418492%`,
`98.446226%`, `100.0%`, `99.322927%`, and `99.716579%`. Their `99.380845%`
average and `100.0%` maximum exceeded the explicit `97%` hard ceiling.

Eight canonical work items were active across `T1` through `T8`: three Q04
runs and five Q07 runs. This is a fresh capacity snapshot 44.3 minutes after
the preceding FX-frontier observation, with the active set increasing from six
to eight. Per the mission stop condition, no Q02 or Q04 dispatch, queue
mutation, tester launch, terminal reservation, terminal reconciliation, or
terminal control followed.

Machine-readable evidence is
`artifacts/fx_cointegration_frontier_hard_cpu_stop_20260820T163300Z_board_advisor.json`.
