...
The read-only `farmctl.py mt5-slots` sample at `2026-08-13T09:02:41Z` found
three factory terminals running: `T1`, `T5`, and `T7`. The paced launch
maximum in `D:/QM/strategy_farm/state/launch_gate_max.txt` is `1`; three
active factory jobs exceed the binding ceiling. The FTMO and `T_Live`
...
`artifacts/fx_cointegration_frontier_cpu_stop_20260813T090241Z_board_advisor.json`.
