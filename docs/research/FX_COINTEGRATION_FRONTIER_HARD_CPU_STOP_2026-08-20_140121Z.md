...
At `14:01Z`, five one-second whole-host CPU samples were all `100.00%`. The
average and maximum were both `100.00%`, above the mission's explicit `97%`
hard ceiling.
...
followed. This is a fresh capacity observation 58.81 minutes after the prior
FX-frontier observation. Machine-readable evidence is
`artifacts/fx_cointegration_frontier_hard_cpu_stop_20260820T140121Z_board_advisor.json`.
