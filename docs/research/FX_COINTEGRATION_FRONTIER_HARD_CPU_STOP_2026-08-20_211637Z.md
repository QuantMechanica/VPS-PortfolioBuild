...
manifest, logical backtest setfile, and Card snapshot retain the hashes from
the preceding handoff. The setfile remains `RISK_FIXED=1000`,
...
disturb the existing governed successor.

## Binding capacity stop

The five one-second whole-host CPU samples ending at `21:16:37Z` were
`99.805879%`, `99.907978%`, `98.753106%`, `99.038495%`, and `99.807783%`.
Their `99.462648%` average and `99.907978%` maximum both exceeded the explicit
`97%` ceiling.

Eight canonical work items were active on T1, T2, T3, T5, T6, T7, T8, and
T10. This is a fresh observation 120.85 minutes after the preceding
FX-frontier evidence: the active set increased from seven to eight, pending
work decreased from 2223 to 2221, and the hard ceiling remained binding. A
path-anchored terminal-process snapshot matched those eight factory terminals.
...
`artifacts/fx_cointegration_frontier_hard_cpu_stop_20260820T211637Z_board_advisor.json`.
