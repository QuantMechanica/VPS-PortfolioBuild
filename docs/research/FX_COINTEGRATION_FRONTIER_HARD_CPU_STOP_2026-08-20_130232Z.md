...
At `13:02Z`, five one-second whole-host CPU samples were all `100.00%`. The
...
followed. This is a fresh capacity observation 45.89 minutes after the prior
FX-frontier observation. Machine-readable evidence is
`artifacts/fx_cointegration_frontier_hard_cpu_stop_20260820T130232Z_board_advisor.json`.
