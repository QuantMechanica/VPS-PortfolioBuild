...
**Intake status (2026-09-21 ~11:4xZ, Fable):** critic receipt sealed, QM-RESEARCH-2026-0012 sealed `reviewed` (verify ok, source_hash 2120bd97…); card `QM5_41485_ny-preopen-range-breakout-jpy.md` approved G0 on D: and C: (card_sha256 76df573e…, candidate_role VELOCITY_SLEEVE); magic rows USDJPY slot 0 = 414850000, EURUSD slot 1 = 414850001 (governed allocator, one slot per symbol — the USDJPY C3 second arm still needs a second-slot decision). Card-intake prescreen: only `TIMEFRAME_OUTSIDE_BOX:M30` remains (the Edge-Lab box allows M5–M15 / H1–H24 / D1; the sealed spec freezes an M30 chart) — parent decision pending; NEAR_DUPLICATE vs QM5_10001 demoted to a warning. Build (Codex) and the USDJPY Q02 canary follow.
