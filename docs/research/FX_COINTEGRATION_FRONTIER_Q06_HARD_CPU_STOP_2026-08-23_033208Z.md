# FX cointegration frontier: rotated Q09 roster / hard CPU stop

**Date:** 2026-08-23 UTC (`2026-08-23T03:32:08Z`), Europe/Berlin
...
The whole-host preflight returned 99.91%, 100%, and 99.48%. The average was
99.80% and the maximum 100%, above the explicit 97% hard ceiling. `D:` retained
121.97 GiB free.

The supported work-item view showed ten active rows, all Q09_NEWS and claimed
across T1-T10. The path-aware process snapshot observed six governed factory
terminals on T1, T5, T6, T7, T8, and T9. T2, T3, T4, and T10 had claimed rows
...
`2026-08-23T02:33:06Z` evidence: the visible governed roster rotated from
T2/T3/T5/T6/T7/T9 to T1/T5/T6/T7/T8/T9. The singular selected Q06 row and the
ten active Q09_NEWS claims remain unchanged.
...
`artifacts/fx_cointegration_frontier_q06_cpu_stop_20260823T033208Z_board_advisor.json`.
