...
Date: 2026-09-01 UTC (`2026-09-01T00:15:14Z`); 2026-09-01 02:15
Europe/Berlin

Branch: `agents/board-advisor`

Observation base: `48d4d0613a`
...
was `98%`, `96%`, `87%`, `84%`, and `60%`. Average utilization was `85%`;
maximum utilization was `98%`. The paced-fleet stop rule binds when either
measure is at least `97%`, so the maximum triggered the stop.
...
`artifacts/diversity_funnel_hard_cpu_stop_20260901T001514Z_board_advisor.json`.
