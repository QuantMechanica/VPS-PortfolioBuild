# QM5_20200 AUDJPY/EURAUD Cointegration — Q02 Handoff
...
`QM5_20200_audjpy-euraud` is a new, non-duplicate, low-frequency D1 FX
...
- Logical symbol: `QM5_20200_AUDJPY_EURAUD_COINTEGRATION_D1`
- Work item: `47fc8c32-fe57-4f98-828e-d8cb8d0f4a25`
...
AUDJPY/EURAUD seventeenth by OOS net Sharpe. Rank 16 EURJPY/EURAUD is already
built as `QM5_20199` and has an active logical Q02 row. Exact-pair searches
found no dedicated fixed-beta AUDJPY/EURAUD D1 card, EA, registry allocation,
...
performance claim for AUDJPY/EURAUD.

## Mechanization

- Host/traded leg: `AUDJPY.DWX`, magic `202000000`
- Companion/traded leg: `EURAUD.DWX`, magic `202000001`
- Conversion-history only: `USDJPY.DWX`, `AUDUSD.DWX`, `EURUSD.DWX`
- Fixed spread: `ln(AUDJPY) - (-2.073289367) * ln(EURAUD)`
...
"Market-neutral" is limited to the fitted two-series residual. The shared AUD
exposure appears in opposite quotation positions and retains EUR, JPY, carry,
and risk-sentiment risk.
...
- Targeted rank-16/rank-17 basket regression: PASS
- Magic resolver: 15,387 rows kept, zero dropped with `--keep-obsolete`
- EX5 SHA-256:
  `eecc397d999a4d56cce10e51f7e04d808ec9669fdf39c9496cf3a712c3038743`
- Build report:
  `D:\QM\reports\framework\21\build_check_20260801_201048.json`
- Compile summary:
  `D:\QM\reports\compile\20260801_201132\summary.csv`

No manual smoke, tester, or backtest run was launched.

## Q02 Queue Contract

The final precheck at `2026-08-01T20:14Z` found three factory terminals
running (`T4`, `T9`, `T10`) against the seven-terminal ceiling.
`T_Live` was observed separately and excluded; it was not controlled.
