# FX cointegration frontier: seven-terminal Q09 roster / hard CPU stop

**Date:** 2026-08-23 UTC (`2026-08-23T04:34:14Z`), Europe/Berlin
...
The whole-host preflight returned five consecutive 100% samples. Both average
and maximum were 100%, above the explicit 97% hard ceiling. `D:` retained
121.64 GiB free.

The supported work-item view showed ten active rows, all Q09_NEWS and claimed
across T1-T10. The path-aware process snapshot observed seven governed factory
terminals on T1, T2, T4, T6, T7, T8, and T10. T3, T5, and T9 had claimed rows
but no visible terminal process at that instant; this is recorded as an
observation, not an inferred verdict or repair diagnosis. `T_Live` and the
...
`2026-08-23T03:32:08Z` evidence: the visible governed roster rotated from
T1/T5/T6/T7/T8/T9 to T1/T2/T4/T6/T7/T8/T10 and increased from six to seven
terminals. The singular selected Q06 row and ten active Q09_NEWS claims remain
unchanged.
...
`artifacts/fx_cointegration_frontier_q06_cpu_stop_20260823T043414Z_board_advisor.json`.
