# FX cointegration frontier: factory + hard CPU ceiling stop

Date: 2026-08-27 UTC (`2026-08-27T03:01:34Z`); 2026-08-27 Europe/Berlin

Branch: `agents/board-advisor`

Observation base: `ed330e2a3c39a5ce8034c491f6e52349bcdd5368`

Status: the frozen 66-pair frontier remains fully mechanized; neither anchor
has a Q02 infrastructure blocker; stopped at both the factory-terminal and
hard CPU ceilings before any queue or test mutation
...
The immediately preceding FX receipt reconciled
...
a fresh work-item query or selection of another fallback could be used to
justify a non-duplicate enqueue. No duplicate Q02, Q03, or Q04 row was added.

## Binding capacity stop

The supported `farmctl mt5-slots` snapshot at `2026-08-27T03:01:14Z` observed
seven governed factory terminals actively testing: T1, T2, T5, T6, T7, T9,
and T10. All ten terminal-worker daemons were alive, seven terminal
reservations were active, and no orphaned factory terminal process was
reported. The fleet was exactly at the seven-terminal ceiling. `T_Live` and
the unrelated FTMO terminal were observed only to exclude them; neither was
controlled.

Five fresh whole-host CPU readings ending at `2026-08-27T03:01:34Z` were
100%, 100%, 100%, 99.95%, and 100%. Their average was 99.99% and their maximum
...
evidence is in
`artifacts/fx_cointegration_frontier_hard_cpu_stop_20260827T030134Z_board_advisor.json`.

## Non-duplicate delta and safety

The preceding FX receipt at `2026-08-27T02:02:13Z` observed T1, T6, and T10,
three active reservations, 97.96% average CPU, and a 99.61% maximum. This
receipt records the changed seven-terminal roster, seven reservations, 99.99%
average CPU, and a 100% maximum. It is changed governed capacity evidence, not
a repeated queue insert.
