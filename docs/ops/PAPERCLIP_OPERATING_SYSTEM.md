...
The process roadmap is a living public and internal artifact. It should show which processes exist, which are draft, which are active, and which are under review.
...
| Website Snapshot Export | active | yes | DevOps + Controlling | hourly cron |
...
Milestones should be small enough to finish and review quickly:
...
The public process roadmap on quantmechanica.com should be generated from the internal process registry with redactions. It should show:
