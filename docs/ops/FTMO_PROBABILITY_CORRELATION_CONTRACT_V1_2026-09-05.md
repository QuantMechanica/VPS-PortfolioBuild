...
Status: **PENDING (OWNER ratification of this contract).** Mirror: the bound acceptance test R5 (`docs/ops/OWNER_VORLAGE_2026-09-05_ftmo_positive_evidence_test.md`) was **RATIFIED** by receipt `a2057610-baf2-4c8f-b493-84ec80421ada` (2026-09-05 12:41Z); the C-6 estimator method was adopted by receipt `871cf325-3961-41b3-9543-e9b1477448e2` (12:42Z, INERT until a separate activation card). No gate, threshold or number in this contract changed. Klasse: **ROT** (Gate-Kriterien / Buchregeln / Zahlen). **Kein Auffangregel.**
