# STR-103 — Build record (QM5_20097)

- ea_id **20097** reserved via farmctl reserve_ea_ids (atomic; strategy_id
  WEB-SOURCES-HARVEST-2026-07), row in `framework/registry/ea_id_registry.csv`.
- Magic rows: 200970000-200970007 for AUDUSD(0) EURGBP(1) EURJPY(2) EURUSD(3) GBPUSD(4) USDCAD(5) USDCHF(6) USDJPY(7) .DWX in `framework/registry/magic_numbers.csv`
...
- Card: `D:\QM\strategy_farmrtifacts\cards_approved\QM5_20097_three-little-pigs-mtf-sma_card.md`
...
- Set files: 8 sets H4 backtest, gen_setfile.ps1 (-Env backtest; RISK_FIXED=1000,
