...
```text
Infra audit completed: status=critical, checks=28, issues=2
Report: C:\QM\repo\infra\reports\infra_audit_latest.json
```
...
```text
Infra audit completed: status=critical, checks=29, issues=2
Report: C:\QM\repo\infra\reports\infra_audit_latest.json
```
...
```text
Infra audit completed: status=critical, checks=30, issues=2
Report: C:\QM\repo\infra\reports\infra_audit_latest.json
```
...
```text
Infra audit completed: status=critical, checks=32, issues=2
Report: C:\QM\repo\infra\reports\infra_audit_latest.json
```
...
```json
{
  "name": "qua95_unblock_owner_consistency",
  "status": "ok",
  "meta": {
    "exit_code": 0
  }
...
```json
{
  "name": "qua95_custom_visibility_proof",
  "status": "ok",
  "meta": {
    "exit_code": 0
  }
...
```json
{
  "name": "qua95_heartbeat_custom_visibility",
  "status": "ok",
  "meta": {
    "exit_code": 0
  }
...
```json
{
  "name": "qua95_canonical_snapshot_freshness",
  "status": "ok",
  "meta": {
    "exit_code": 0
  }
