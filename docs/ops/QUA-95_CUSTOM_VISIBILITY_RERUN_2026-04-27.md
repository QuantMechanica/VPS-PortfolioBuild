...
```powershell
python C:\QM\repo\infra\scripts\probe_custom_symbol_visibility.py --target AUDUSD.DWX --json-out C:\QM\repo\lessons-learned\evidence\2026-04-27_qua95_xtiusd_custom_visibility_probe_rerun.json
```
...
- captured at: 2026-04-28T20:03:32+02:00
