...
|---|---|---|---|
| P0-01 | Order Hetzner AX42-U dedicated server | Fabian | DONE 2026-04-22: order B20260421-3420195-2995101, server #2982904 online in Rescue System, HEL1, IPv4 `37.27.225.167`, 1 TB extra NVMe, expense log updated; root/rescue password not stored |
| P0-02 | Install Windows Server 2022 Evaluation | Fabian + DevOps | Windows Server 2022 Eval boots, `slmgr /xpr` documented, Month-5 license reminder created |
| P0-03 | Harden Windows Server | Fabian + DevOps | RDP on non-default port, IPBan installed, firewall verified |
| P0-04 | Install MT5 T1-T5 factory terminals | DevOps + Pipeline-Operator | 5 terminals boot, separate portable data paths |
| P0-05 | Install MT5 T6 Live/Demo terminal | LiveOps + Fabian approval | T6 boots, no Strategy Tester use, AutoTrading initially OFF |
| P0-06 | Confirm DarwinexZero/Darwinex MT5 access and data path | Fabian + DevOps | DarwinexZero reset/new account decision documented, MT5 Demo/Live login verified, MT5-native data path or alternative backtest-data approach approved |
| P0-07 | Populate public repo skeleton | Fabian + Documentation-KM | `https://github.com/QuantMechanica/VPS-PortfolioBuild` contains `README.md`, `docs/`, `paperclip-prompts/`, `episodes/`, `expenses/` |
...
| P0-10 | Install fresh Paperclip company | Fabian + CEO | Company `QuantMechanica V5`, project `Portfolio Factory V5` |
| P0-11 | Hire first four agents | Fabian | CEO, CTO, Research, Documentation-KM online |
...
| P0-14 | Record EP01 | Fabian | Script, recording, thumbnail, show notes archived |
...
- Is Fabian still only approving, steering, and observing?
