...
> **RESULT 2026-09-22 06:3xZ — Demo Gen1 vom Broker beendet; KS-Wiedereintritt 4/6 identisch; Venue-Messung; Fan-out-Integration (Fable):**
> - **Demo Gen1 ENDED_BY_BROKER 21.09. 23:02Z** (Codex 6fa7831a, ACCOUNT_WIDE: FTMO stornierte XAU-Stops, zwangsschloss USDCAD `CLOSED_BY_FTMO`, Konto trade-disabled; vermutlich 14-Tage-Free-Trial-Ende). Trial-Fenster 18.-21.09.; EAs bleiben als KS-Rehearsal-Host; Sonntag = frisches Konto. Sonntag-Status/War Room/Book-JSON aktualisiert.
> - **KS-Rebuild Q02-Wiedereintritt (38385b96, STOP korrekt):** 13213/10700/11422/41219 EQUIVALENT_EXACT (Evidenz erbt); 10706 NOT_EQUIVALENT (1 Deal +3 s, PnL exakt) + Ablation-02-Vorgaenger ohne ex5-Binding; 10403 Parameter-Provenienz nicht authentifiziert (qm_ea_id + 11 Legacy-Filter-Inputs). Review-only Deploy-Paket validiert; demo_install Dry-Run verweigert korrekt (AutoTrading an). Folge-Ticket Codex 85 (10403-Binding, 10706-Timing-Mechanismus + Vertragsvorschlag).
> - **Abgenommen:** 92b2e527 (Bind-at-Claim fuer ungebundene Zeilen), bc00c556 (Simulator-Hygiene; 11910 gestutzt -> raus), 629043f6 (Venue PARTIAL: LCB 0,8619, P80 1397 cd), 0ad35f22 (Falsifikation blockiert: 41485 eingefroren -> Bau eines anker-konfigurierbaren Research-EA beauftragt, Codex 74), 6fa7831a.
> - **Integration:** vier Codex-Worktree-Commits per Cherry-pick auf den Arbeitszweig (292d3a1efc, 53308099be, dda05bd871, a8a6ba3da8). OWNER-interaktive Codex-Recovery (cd3b761c/df1cae9b, Claude-Lane 52728403/6c5219a9) laeuft parallel; nicht angefasst.
> - **Offen/naechste Schritte:** News-Korrektur-Publish + Requal (f50a0bba laeuft); KS-Rehearsal-Deploy auf dem toten Gen1-Terminal nach Loesung 10403/10706 (AutoTrading dafuer aus/an = Fable-Schritt mit Receipt); Familie B5 XNGUSD-Donnerstag Vorregistrierung.

> **RESULT 2026-09-22 04:4xZ — Nachtschicht: KS-Rebuilds, Q08-Fix, News-Korrektur, Scanner/ML, Shadow-Downgrade (Fable):**
> - **Abgenommen:** d6189118 KS/Prague-Initializer (51 Tests; sechs Sleeves governed neu kompiliert: 13213/10700/11422/41219/10403/10706 COMPILE_OK, receipted committed) -> Q02-Wiedereintritt + Identitaetsbeweise + Deploy-Manifest beauftragt (Codex 38385b96, 85); a36a5983 News-Archiv-Audit (82 USD-Zeilen -60 min; 128 Q09/Q10-Verdicts exponiert, alle D2g6-Sleeves) -> Korrektur-Receipt FABLE-DEC-NEWS-ARCHIVE-DST-CORRECTION-20260922, Publish + Requalifizierung roster-first (Codex f50a0bba, 84); 5de65240 Q08-Befoerderungsfenster-Fix (dd631220ee); 35bbe0bc Scanner (75.660 Zellen, 0 FDR-Ueberlebende); 08d62fa7 ML-Discovery (161.420 Tests, 0 robust); 01806354 Preflight-Zeilen; 7088da77 Harness v2 = MECHANIK OK, Oekonomie UNKNOWN (§L-Goldtest nicht bestanden: C2 PF 1,16 vs Q04 1,00) -> MT5-Falsifikation der drei WORTH_MT5_TEST-Zellen beauftragt (Codex, 76); 0d64aba8 Codex-Fan-out aktiviert (3 parallele Sessions bestaetigt, Dedupe-Key pro Task 4d69cf643b, Prompt-Haertung 3baa1437d6).
> - **Shadow-Downgrade:** Oel-Rebuilds auf eigener Q08 (2017-2025): 41488 FAIL_SOFT, 41489 FAIL_HARD (DSR, Verlustmonate, Chopping-Block PF 0,80) -> D2g6+12710+20266 zurueckgezogen, SHADOW = D2g6, offener Kandidat nur 11708. Naechste Quelle: Familie B5 XNGUSD-Donnerstag (zwei unabhaengige Scanner-Leads), Vorregistrierung folgt.
> - **Demo-ALARM:** 13213 USDJPY 05:00 Server 'Trade disabled' (10017), andere Sleeves handelten normal -> read-only Diagnose Symbol-Sessions beauftragt (Codex 6fa7831a, 72); Sonntag = frisches Konto.
> - **Systemdefekte gefunden/beauftragt:** befoerderte Q08-Zeilen ohne Build-Binding (92b2e527, laeuft); Codex-Session editierte farmctl.py direkt in C:/QM/repo (transienter SyntaxError) -> Prompt-Regel; Worker-Modul-Staleness verweigerte zwei Compiles (CANDIDATE_RECHECK_REFUSED) -> Nachfolger OK.

> **RESULT 2026-09-21 23:3xZ — Codex-Fan-out aktiviert, Oel-Rebuilds, BR-Linien geschlossen (Fable):**
> - **0d64aba8 APPROVED + Rollout Schritt 2 ausgefuehrt:** pinned Codex-Fan-out (f0b94aa4a5; 26+293 Tests; Dry-Run 3 Slots) — Scheduled Task `QM_StrategyFarm_CodexOrchestration_15min` auf `--max-sessions 3` gesetzt (Vorher/Nachher-XML in `docs/ops/evidence/2026-09-22_codex_pinned_fanout/`); greift nach Ende des laufenden Einzel-Controllers (PID 8456 seit 20:45Z, IgnoreNew). Beobachtung zweier Zyklen ueber den Stundenwatch; Rollback = `--max-sessions 1`.
> - **273f2de8 APPROVED (PARTIAL):** QM5_41488 (aus 12710) und QM5_41489 (aus 20266) unter der Symbol-Input-Regel gebaut, Compile PASS, Q02 PASS, Identitaetsbeweis EQUIVALENT_EXACT; eigene Kette laeuft (Q04 PASS, Q05 aktiv auf T8/T10). Q08-Fenster-Replay ohne governed Pfad -> entfaellt, eigene Q08-Streams ersetzen es. Shadow-Roster mappt 12710->41488, 20266->41489 sobald Q08 vorliegt (FTMO_BOOK_CURRENT.md 2, ftmo_book_current.json shadow.rebuilt_identities).
> - **BR-Linien:** a42aa6f7 (BR1-Rerun 0/6) APPROVED = REJECT; 2eba7ef7/ff6826f5 (BR2/BR3) BLOCKED = REJECT, keine weiteren Codex-Sessions; Codex arbeitet jetzt am Cross-Symbol-Scanner 35bbe0bc.

> **RESULT 2026-09-21 21:3xZ — PAYOUT80 + Venue-Kosten (Fable-Abnahme):**
> - **e5cc5e95 PAYOUT80 APPROVED:** Evaluator in first_passage 2.1.0 / book_sim (19 Tests gruen, Diagnose-JSON sha fb25ec50). Inkumbent D2g6 finanziert: P_PAYOUT_30/45/60/90D = 0; **P80 = 1300 Kalendertage** (bd 929, LCB 0,8013); P_PAYOUT_EVER 0,8913 / LCB 0,8762; bedingt p10/p50/p90 = 352/682/1253 cd; Stress 1,5x+2 USD/Lot: P80 1839 cd, LCB 0,8143. Kein Bank-Receipt-t80 (Admin-Lags ungebunden). BR/NNFX-Intake: 24 Zellen, 0 Ueberlebende (bestaetigt). Veroeffentlicht in FTMO_BOOK_CURRENT.md 0a, ftmo_book_current.json (payout_frontier, kpi), Sonntag-Status, War Room.
> - **73434cab Venue-Kosten APPROVED als fail-closed ABSTAIN:** FTMO-Spreads gemessen (USDJPY p90 0,44 bp, XAU 1,2 bp, 21Z-Rollover-Aufweitung), aber 0 exakt gematchte Darwinex-Minuten und Slippage UNMEASURED (Collector zeichnet keine Request-vs-Fill-Preise auf) -> kein additiver Aufschlag; book_sim kann jetzt Per-Symbol-Aufschlaege. Folge-Ticket: Demo-Collector um Request-vs-Fill und parallele DXZ-Spread-Snapshots erweitern (Codex, exempt).
...
> - **Familien-Ergebnisse heute (konservatives Fill-Modell, 0 Fabrikstunden):** B1 0/22, B2 0/14 (+1 unknown), B3 Break-&-Retest 0/16, C1 NNFX-H1 (N2) 0/8 — 5 Familien, 89 Zellen, 0 Ueberlebende; konsistente Lehre: enge M5/M15-Stops auf Indizes/XAU sind kostendominiert, Reversal-/Fade-Regeln falsch-signiert oder neutral, NNFX-H1-Kern negativ nach Kosten. Naechste Kandidaten kommen aus den systematischen Scannern (Codex/Kimi/Antigravity), nicht aus weiteren handgeschriebenen Einzelsymbol-Regeln.
> - **Abgenommen:** Sleeve-Attribution 74c41987 (Rekonziliation 0,00; Mission-Control-Block), NNFX-Gaps 9ace7476, Second-Chance-Revisionen b0ef5d66/f05399de, Genesis-Tooling 94a15624, Kritiken 3960afee/cb0eb674/2caa90f8, Simulator-Konfidenz 3fae43b2.
> - **Buch (finanziert):** Inkumbent D2g6 LCB 0,8668, erster Payout p10/p50/p90 = 254/489/909 bd; P(Payout <= 90 Kalendertage) ~ 0; P80 (exakt) liefert PAYOUT80 e5cc5e95 (Codex, laeuft). Shadow D2g6+12710+20266: LCB 0,8805, p50 460 bd.

> **RESULT 2026-09-21 — OWNER Break-&-Retest/NNFX-Auftrag eingeplant (Codex):** 28 NNFX- und 26 Retest-Identitäten im aktuellen Ledger abgeglichen. Sieben NNFX-Identitäten ohne ökonomisches Verdikt (sechs ohne Work Item, eine Q02 pending), drei aktive Retest-Identitäten ohne Work Item. Sieben neue, per Readback bestätigte Router-Pakete: N-RECOVERY `cd3b761c`, R-RECOVERY `df1cae9b`, BR1 US-Index-ORB/Peer `a42aa6f7`, BR2 London/Asia `2eba7ef7`, BR3 Gold/Silber-Session-Retest `ff6826f5`, N-GAPS `9ace7476` (Antigravity), PAYOUT80 `e5cc5e95`; übrige Lane-Pins Codex. Bestehende Build-/Review-/Q02-Aufträge referenziert, nicht dupliziert. Plan und Receipt: `docs/research/ftmo_intake/2026-09-21_br_nnfx/`. Ergebnis dieses Auftrags ist Inventur + Einplanung; neue Backtests und 80%-Auszahlungsnachweis sind offen. Umsetzung nutzt vorhandenes Harness/Book-Sim/Venue-Kosten-Programm und unveränderte Q-Gates. Keine G0-/Erfolgsbehauptung oder Live-Risikoänderung.

> **RESULT 2026-09-21 20:3xZ — OWNER Dual-Track-Korrektur aufgenommen, Spur B gestartet (Fable):**
> - Record `decisions/2026-09-21_owner_ftmo_dual_track_shadow_book_acceleration.md` (verbatim Evidence, CLAUDE.md-Abschnitt). Spur A unverändert (KS d6189118, Harness v2 7088da77, News-Audit a36a5983, Genesis 94a15624, Attribution 74c41987, Venue-Kosten 73434cab in der Codex-Lane).
> - **Spur B Programm B1 `docs/research/ftmo_shadow/TRACK_B_EDGE_DISCOVERY_PROGRAMME_2026-09-21.md`:** 8 vorregistrierte Hypothesen (Cash-Open-MR, Post-Open-Continuation, OR-Failure, Pullback, Vol-Compression, Time-of-Day-Reversal, XAU-Transition, FX-NY-Session) über NDX/SP500/WS30/GDAXI/XAUUSD/EURUSD/GBPUSD, konservatives Closed-Bar-Fill-Modell (Prescreen-Tool `velocity_family_f2_cash_session_0921.py`, 755a6b92ae); Sweep läuft (25 Zellen, 0 Fabrikstunden). Antigravity 2caa90f8 = alternative Hypothesen + Fill-Fragilität. Funnel `D:/QM/reports/state/ftmo_edge_funnel.json`.
> - **Pool-Sweep** (14 validierte Sleeves, finanziert, 5×40k; `docs/ops/evidence/2026-09-21_ftmo_pool_marginal_sweep/`): 7 aufgelöst positiv, aber 12855/21505 = Rare-Winner-Artefakte (Top-3-Trades 134 %/362 % des Netto → HOLD; TAIL_CONCENTRATION-Metrik → bc00c556), 11660 REJECT (DD +3,1k). **Shadow-Buch = D2g6 + 12710 + 20266 XTIUSD (2,34 %): LCB 0,8805 vs 0,8648, erster Payout 460 vs 492 bd, Max-Loss 0,017, Stress 0,679 vs 0,629** → Codex 273f2de8 (Symbol-Input-Rebuild + Identity-Proof + Q10-Seal); Sonntag nur bei fertigem Beweis, sonst nächste Generation. Der Pool kauft ~+0,02 LCB und einen Monat Tempo — die NY-Session-Rolle bleibt Forschungsaufgabe.
> - OWNER-Entscheid Konto = A (Free-Trial-Konto, am Sonntag angelegt, Zugangsdaten bis 12:00Z in `.private/secrets/ftmo_demo_gen2_20260927.md`).

> **RESULT 2026-09-21 19:5xZ — Kritikpfad-Abend (Fable):**
> - **Antigravity wieder aktiv** (OWNER-Login 18:45Z; Governor 93 %). agy-Headless-Falle behoben (Session starb bei Hintergrund-`farmctl health`; Prompt pinnt jetzt Vordergrund, 7429124cb4; Verifikationslauf 8 min, beide Kritiken geliefert). 3960afee (11708-Reconciliation) und cb0eb674 (Sunday Go/No-Go + KS-Spec) APPROVED; Befunde in d6189118 (Req 8–10: Wochenend-No-Tick-Rollover, Puls-Schwellen 200/500 + Burst, Proof-Chain), 94a15624 (Req 7–8: sechs Preflight-Zeilen, Tages-Klassifikation v2) und die Sunday-Checkliste übernommen.
> - **Codex 3fae43b2 (Simulator-Konfidenz) APPROVED:** financed fail-closed CLI, 5 gepaarte Seeds × 40k Pfade, SE/RESOLVED-Felder; D2g6 LCB 0,8668 reproduziert. **11708 = +0,0058 aufgelöst, aber −0,0056 unter Kostenstress → SHADOW_BOOK bleibt**; 11421 −0,008, 11910 −0,076. Folgeticket bc00c556 (kotermine Streams, profit-Assertion).
> - **Neuer Befund Kostenempfindlichkeit:** +1 bps/+2 USD/lot Stress: LCB 0,87 → 0,61, Max-Loss-Bruch 0,02 → 0,10 — Venue-Spread für 4 von 6 Symbolen ungemessen → Ticket 73434cab (VENUE_ADJUSTED-Headline) = stärkste offene ökonomische Unsicherheit fürs Kaufpaket.
> - **Retro-Audit 4505b206 APPROVED** (2 valide Tage, PRE_SUNDAY_LIVE_TRIAL; Wochenend-Anker-Defekt). Review-Backlog: 23af2b16/f1ff8fce/7ab3e9d3/160843a0/feb6e536 APPROVED, 8b09ed22 BLOCKED (Guardrail). Runbook `docs/ftmo/genesis/SUNDAY_LAUNCH_RUNBOOK_2026-09-27.md` v0; **OWNER-Karte OWNER-DEC-FTMO-DEMO-ACCOUNT-GEN2-20260927 (Konto A/B bis Fr 25.09. 12Z)**.

> **RESULT 2026-09-21 18:5xZ — OWNER FINAL FTMO MEGA Prompt aufgenommen und umgesetzt (`decisions/2026-09-21_owner_ftmo_final_mega_prompt_sunday_demo.md`):**
> - Codex-Plan zur Laufzeit verifiziert: **pro**, Wochenfenster 0 % (Reset 2026-09-28T17:57Z); Governor neu gelaufen, Budgetlinie bei 0 % verankert, Karten-Build-Pacer `QM_StrategyFarm_CodexFleetPacer` bis Sonntag DISABLED (Receipt `docs/ops/evidence/2026-09-21_ftmo_final_mega_prompt/README.md`).
> - Kritischer Pfad in der Codex-Lane (exempt, Reihenfolge §O): d6189118 Kill-Switch/Prague (86) → 7088da77 Harness v2 + §L Golden Test (84) → a36a5983 News-Archiv-Audit (82); neu: 3fae43b2 Simulator-Konfidenz (81), 4505b206 Demo-Tage-Retro-Audit (80), 74c41987 Sleeve-P&L-Attribution + Mission-Control-Block (74), 94a15624 Genesis-Manifest + Sunday-Preflight (72), 4d655789 Compile-Fail-Taxonomie (60).
> - **§V 11708-Vorzeichen erklärt** (`docs/ops/evidence/2026-09-21_ftmo_11708_sign_change_reconciliation/`): EXPECTED_MODEL_IMPROVEMENT; alt = Joint-Add mit 11910 auf kürzerem Schnittfenster, neu = unfinanziert + 1k-Pfad-Rauschen (Seed-SD der LCB 0,007–0,020). 11708 → SHADOW_BOOK, 11421 → HOLD, 11910 → REJECT.
> - **Buch-Headline jetzt finanziert:** LCB **0,8668** (P_Challenge 0,9516, Median 289 bd Phase 1 / 489 bd E2E, Max-Loss 0,020, 27,5 USD/Tag) — `docs/ftmo/FTMO_BOOK_CURRENT.md` v2 mit INCUMBENT/SHADOW/DELTA, State-JSON-Overlay, `docs/ftmo/FTMO_SUNDAY_LAUNCH_STATUS.md` (§Y-Felder). SUNDAY_DEMO_READY = NEIN (KS, Retro-Audit, Genesis, Attribution offen). QM5_41485 getaggt `PRESCREEN_EXECUTION_MODEL_FALSE_POSITIVE`.
> - Offen / wartend: Kimi EXHAUSTED (seit 18.09.), Antigravity Token abgelaufen (optionale menschliche Anmeldung), Review-Backlog Codex-Lane (25 REVIEW-Zeilen, Prio 30, hinter dem Kritikpfad).

> **RESULT 2026-09-19 — P0-Evidence-Loss (`f8432ebf`) vollständig attribuiert, Regenerationsplan versiegelt:** Die 172 fehlenden Watcher-Pfade sind vollständig belegt: 129 Dateien wurden durch den OWNER-autorisierten Backup-Retention-Phase-2-Lauf `4c0a5ae7` (`DELETE_NONRETAINED`, exakte Receipt-Zeilen) gelöscht, darunter alle 95 PASS-Artefakte; 27 nicht-PASS-Dateien überlebten nach DL-090-Quarantäne/C:-Relocation und liegen bereits receipt-/hash-gebunden wiederhergestellt vor; 16 weitere nicht-PASS-Dateien liegen weiterhin in der D:-Quarantäne. Damit ist die ältere Aussage „Mechanismus unbekannt“ korrigiert. Pro Pfad sind letzte Mtime/Größe, Prozessklasse und Receipt in `lost_directory_forensics.csv` gebunden. Die 81 Regenerationszellen sind reproduziert: ein PASS-Sibling ersetzt nur bei gleicher EA/Symbol/Q-Phase **und** bekannten identischen Datenfenstergrenzen; 14/95 haben einen solchen Sibling, unbekannte Fenster bleiben fail-closed. Append-only-Plan 81 Zeilen, Q03=52/Q05=17/Q06=9/Q07=3, geschätzt 7,97 Tester-Stunden; nichts enqueued. Guard-Vorschlag: der Phase-2-Writer muss jeden PASS unabhängig von Contract-Version schützen und unmittelbar vor Unlink gegen die DB revalidieren. Evidence: `docs/ops/evidence/2026-09-19_f8432ebf_evidence_loss_closeout/`. Status REVIEW.

> **RESULT 2026-09-19 — Kimi-Code-Quota-Bucket-Mapping (`1b891ee2`, Cross-Ref `d797e68f`) repariert:** Derselbe Read-only-Endpunkt `/coding/v1/usages` liefert zwei Bucket-Familien. Die für `kimi-code/kimi-for-coding` erzwungenen Fenster liegen in Top-Level `usage` (7 Tage: `used/limit`) und im 300-Minuten-Eintrag von `limits[].detail` (5 Stunden: `(limit-remaining)/limit`); `usages.limit_5h/limit_7d` beschreiben einen anderen Dashboard-Bucket. Live-Vergleich: Code 7d `100/100 = 100 %` und Code 5h `100/100 remaining = 0 %`, während die alte 7d-Quelle `0,000011` meldete; Reset-Zeitpunkte identisch. Fetcher/Config/Regression in Commit `67209e5e7a`; 92 Tests grün; frischer `--no-write`-Probe ergibt 5h `0,0`, 7d `1,0`. Governor-/Threshold-/Flag-/Retry-Logik unverändert (Governor-Blob `0e837f4b…`), insbesondere bleibt der Single-`quota_exhausted`-Fail-Closed-Pfad aus `d797e68f` aktiv. Evidence: `docs/ops/evidence/2026-09-19_kimi_code_quota_bucket_mapping.md`. Status REVIEW.

> **RESULT 2026-09-19 — 8-EA-Rework-Battery (`c162c123`) unverändert verifiziert:** Alle 16 MQ5/EX5-Hashes entsprechen weiterhin exakt Repair-Commit `c99b67c8b` und Codex-Re-Review `224c77f8`; Guardrails 8/8 PASS, mechanische Suite 24 passed, alle Sets Fixed-Risk/News-Maximum 336. No-change-Dedupe `d545c548…` erlaubte genau ein kanonisches State-Artefakt (`docs/ops/evidence/c162c123_eight_ea_recheck_state.json`). Der vorgeschriebene REVIEW-Übergang wurde von D6 korrekt verweigert (`strict_build_pass_evidence_missing`): der heutige Gate-Vertrag verlangt eine einzelne hash-gebundene Build-Identität und kann den historischen 8-EA-Batch nicht wahrheitsgemäß darstellen. Keine Binär-/Source-/Set-Änderung, kein Recompile, kein Pipeline-Enqueue. Status BLOCKED bis OWNER/Claude den Batch in acht Identitäten aufteilt oder einen batch-fähigen Review-Vertrag bereitstellt.

> **RESULT 2026-09-19 — QM5_21514 Symbol-Scope-Rework (`b8c2e67c`):** Hardcoded `_Symbol != "XAGUSD.DWX"` durch input-getriebene, suffix-sichere Canonical-Name-Prüfung ersetzt; beide Sets bleiben `RISK_FIXED=1000`, `RISK_PERCENT=0`, News-Maximum 336 und sind für COMPILE_EA auf `build_hash: pending` zurückgesetzt. Regression 2 passed, Symbol-Lint/Guardrails/Input-Pin/SPEC PASS; Source-Commit `ba7181fa1c`. Governed `enqueue-compile` blieb fail-closed (`BUILD_TASK_BINDING_NOT_FOUND`, `EX5_ALREADY_PRESENT`, `WORK_ITEMS_EXIST`); der vorgeschriebene REVIEW-Übergang wurde danach von D6 wegen fehlender frischer `build_identity.json` korrekt verweigert. Keine Ad-hoc-Kompilierung und kein Pipeline-Verdikt. Evidence: `docs/ops/evidence/2026-09-19_qm5_21514_symbol_scope_rework.md`. Status BLOCKED — exakte Compile-only-Autorität plus frische Build-Identität erforderlich.

> **RESULT 2026-09-18 ~10:00Z — Edge Lab v2 Kandidaten-Hypothesen Batch 2 (EDGE-6..EDGE-9) vorgelegt (Router-Task `0808f955`):**
> Viersätziger Entwurf orthogonaler Return-Source-Hypothesen als Anhang §9 in `docs/research/EDGE_DISCOVERY_PROGRAM_V1_2026-09-04.md` (DRAFT, unsealed — Fable/OWNER Siegel-Prärogative gewahrt) und Evidenz `docs/ops/evidence/2026-09-18_edge_lab_v2_candidate_hypotheses.md` hinterlegt. EDGE-6: US Equity Index Overnight Drift (Night vs Day Asymmetrie, SP500/NDX, Lou/Polk/Skouras 2019); EDGE-7: Month-End Currency Hedging Rebalancing Flows (EURUSD/GBPUSD/USDJPY, Curcuru et al. 2011, Krohn/Sushko 2022); EDGE-8: Pre-FOMC Announcement Drift in US Equities (SP500/NDX, Lucca/Moench 2015); EDGE-9: Post-EIA Petroleum Status Report Drift in Crude Oil (XTIUSD, Halova/Wang/Lien 2014). Alle 4 mit R1-verifizierten Zitaten, inventoriierten Datenquellen, expliziter Ökonomie und falsifizierbaren Refutation-Kriterien nach EDGE-1..5 Standard. Keine Strategy Cards, kein EA-Code, keine Gate-Änderungen. Task in REVIEW übergeben.

> **RESULT 2026-09-18 04:47Z — FTMO-Demo-Buch v3 (Roster D2g6) LIVE:** Cutover unter OWNER-DEC-FABLE-FULL-EXECUTIVE-AUTHORITY-20260917 ausgeführt (`docs/ops/evidence/2026-09-18_ftmo_demo_book_v3_D2g6/CUTOVER_RECEIPT.md`): 6 Sleeves (13213 USDJPY @0,156 %, 10706 GBPUSD, 10700/10403/41219 XAUUSD, 11422 USDCAD @0,3125 %; Buch 1,72 %), Alias-Builds gegen das kanonische Framework (versiegelte Binaries scheitern auf Venue-Namen), Verifier neu gepinnt, Start über `FTMO_ON.ps1`, alle 6 INIT_OK, neuer 14-Tage-Zyklus (roster_hash 5432d3db…), Waisenposition 1537 geschlossen. Evidenz-Basis der Entscheidung: Holdout + Financing + Deployability (`docs/ftmo/FTMO_ALT_ROSTER_*_2026-09-18.md`): finanzierte LCB 0.88 vs 0.53 (demo_8), OOS 0.98 vs 0.32.
