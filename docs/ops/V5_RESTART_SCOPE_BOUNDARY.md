...
- The V4 EA framework code (Include libraries, magic-number schema implementation, set-file format conventions, risk-input definitions, EA template) — V5 builds its own. Tracked as `P0-26 Establish V5 EA framework` under OWNER authorization and deterministic build checks.
...
```
V5 Research (G0)
  → V5 Strategy Card (technical review + OWNER G0)
...
- The V5 boundary rejects any task framed as "import V4 SM_X into V5".
...
2. What does the V5 EA framework look like? (P0-26 — assigned development work under OWNER authority.)
