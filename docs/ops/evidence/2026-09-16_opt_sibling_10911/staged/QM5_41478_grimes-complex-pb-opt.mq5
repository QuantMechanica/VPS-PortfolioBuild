...
#property description "QM5_41478 Grimes Complex Pullback Second-Leg Continuation - DL-089 opt sibling"
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"ea\":\"QM5_41478_grimes-complex-pb-opt\"}");
