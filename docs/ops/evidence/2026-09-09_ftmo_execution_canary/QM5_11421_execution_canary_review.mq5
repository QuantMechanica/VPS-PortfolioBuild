...
int OnInit()
  {
   ...
   QM_RuntimeExecutionContract contract;long generation=0;
   ...
   if(!EventSetMillisecondTimer(200)) return INIT_FAILED;
   g_qm_fw_timer_active=true;
