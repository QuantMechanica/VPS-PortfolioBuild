...
#property description "QM5_41482 Williams VIX-Fix on FX/Indices — Volatility-Spike Bottom (H4) - DL-089 opt sibling"
...
int OnInit()
{
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"ea\":\"QM5_41482\",\"slug\":\"williams-vix-fix-fx-h4-opt\"}");
