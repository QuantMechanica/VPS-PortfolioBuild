...
#property description "QM5_41190 XTI/XNG Thirteen-Month Theil-Sen Ratio Reversion"
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_MTHEILSEN_RV_ATTEMPT_MONTH_%I64d",
                       qm_ea_id,
                       Strategy_HostMagic());
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41190_XTIXNG_MTHEILSEN_RV";
...
bool Strategy_LoadMonthlyTheilSen(
      ...
      int &direction)
  {
   ...
   // direction > 0 means BUY XTI / SELL XNG. Fade only the strict robust
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41190_XTIXNG_MTHEILSEN_RV_HOST";
   ...
   if(valid && direction > 0)
      state = "negative_theilsen_fade_long_xti";
   else if(valid && direction < 0)
      state = "positive_theilsen_fade_short_xti";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XTI/XNG thirteen-month Theil-Sen ratio reversion package holds through Fridays until next broker month"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41190\",\"ea\":\"xtixng-mtheilsen-rv\"}");
