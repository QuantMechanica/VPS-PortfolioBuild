...
const string EA_INPUT_TIMEFRAME_MISMATCH            = "EA_INPUT_TIMEFRAME_MISMATCH";
const string EA_EXECUTION_CONTRACT_UNDECLARED       = "EA_EXECUTION_CONTRACT_UNDECLARED";
const string EA_EXECUTION_CONTRACT_MISMATCH         = "EA_EXECUTION_CONTRACT_MISMATCH";
...
const string EA_MAGIC_RESOLUTION_FAILED             = "EA_MAGIC_RESOLUTION_FAILED";
...
const string ACCOUNT_RISK_CONFIG_INVALID            = "ACCOUNT_RISK_CONFIG_INVALID";
const string ACCOUNT_RISK_RESERVATION_BUSY          = "ACCOUNT_RISK_RESERVATION_BUSY";
const string ACCOUNT_RISK_INVENTORY_UNKNOWN         = "ACCOUNT_RISK_INVENTORY_UNKNOWN";
const string ACCOUNT_RISK_REQUEST_UNPRICED           = "ACCOUNT_RISK_REQUEST_UNPRICED";
const string ACCOUNT_RISK_OVER_BUDGET                = "ACCOUNT_RISK_OVER_BUDGET";
