...
ea_id: QM5_40005
slug: tradingview-multitimeframe-supertrend-atr
type: strategy
strategy_id: QM5-40005-TRADINGVIEW-MULTITIMEFRAME-SUPERTREND-ATR-2026
variant_id: QM5-40005-TRADINGVIEW-MULTITIMEFRAME-SUPERTREND-ATR-2026_H1
source_id: tradingview-multitimeframe-supertrend-atr-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "KivancOzbilgic (TradingView #1)"
strategy_mechanic: tradingview-multitimeframe-supertrend-atr-quantitative-production-blueprint
source_citation: "KivancOzbilgic & LuxAlgo (2020). Multi-Timeframe Supertrend Strategy. TradingView Public Library."
source_citations:
  - type: verified_quantitative_model
    citation: "KivancOzbilgic & LuxAlgo (2020). Multi-Timeframe Supertrend Strategy. TradingView Public Library."
    quality_tier: A
    role: primary
sources:
  - "[[sources/tradingview-multitimeframe-supertrend-atr]]"
concepts:
...
# QM5_40005: TradingView Multi-Timeframe Supertrend ATR Trend Rider

## 1. Economic & Quantitative Strategy Thesis

The #1 most favorited trend strategy on TradingView (>100k boosts). Combines H4 Macro Supertrend orientation with H1 Supertrend (Lookback 10, Multiplier 3.0) direction flips for clean trend-riding.
...
$$\text{Supertrend}_{H1} = \frac{\text{High} + \text{Low}}{2} \pm 3.0 \times \text{ATR}(10, \text{H1})[1]$$
...
$$\text{Supertrend}_{H4}[1] == \text{BULL} \quad \text{AND} \quad \text{Supertrend}_{H1}[1] == \text{BULL} \quad \text{AND} \quad \text{Supertrend}_{H1}[2] == \text{BEAR}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Supertrend}_{H4}[1] == \text{BEAR} \quad \text{AND} \quad \text{Supertrend}_{H1}[1] == \text{BEAR} \quad \text{AND} \quad \text{Supertrend}_{H1}[2] == \text{BULL}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Set to $2.0 \times \text{SL\_Distance}$ ($1:2.0\text{ R:R}$).
* **Stop Loss (SL)**: Set at the Supertrend line value $\mp 2.0\text{ pips}$.
* **Trailing Stop**: Trailed bar-by-bar with the active Supertrend line.
...
|---|---|---|---|---|
| `InpATRPeriod` | `int` | `10` | `7 - 14` | Supertrend ATR lookback |
| `InpATRMultiplier`| `double` | `3.00` | `2.0 - 4.0` | Supertrend ATR distance multiplier |
