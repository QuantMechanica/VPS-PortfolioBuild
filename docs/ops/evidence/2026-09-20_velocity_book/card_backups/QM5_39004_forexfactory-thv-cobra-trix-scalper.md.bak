...
type: strategy
strategy_id: QM5-39004-FOREXFACTORY-THV-COBRA-TRIX-SCALPER-2026
variant_id: QM5-39004-FOREXFACTORY-THV-COBRA-TRIX-SCALPER-2026_M5
source_id: forexfactory-thv-cobra-trix-scalper-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Cobraforex & TAH"
strategy_mechanic: forexfactory-thv-cobra-trix-scalper-quantitative-production-blueprint
source_citation: "Cobraforex (2009-2024). THV System V3/V4. Forex Factory (>8M Views)."
source_citations:
  - type: verified_quantitative_model
    citation: "Cobraforex (2009-2024). THV System V3/V4. Forex Factory (>8M Views)."
    quality_tier: A
    role: primary
sources:
  - "[[sources/forexfactory-thv-cobra-trix-scalper]]"
concepts:
...
target_symbols: [EURUSD.DWX, USDJPY.DWX, GBPUSD.DWX]
...
# QM5_39004: THV Cobra Trix Scalping Engine (Cobraforex)

## 1. Economic & Quantitative Strategy Thesis

Integrated scalping system using Fast Trix (Triple EMA 9) and Slow Trix (Triple EMA 18) crossover triggers confirmed by THV Coral (SMMA 20) trend direction and zero-line alignment.
...
$$\text{Coral} = \text{SMMA}(20, \text{M5})[1], \quad \text{Trix\_Fast} = \text{TRIX}(9)[1], \quad \text{Trix\_Slow} = \text{TRIX}(18)[1]$$
...
$$\text{Close}[1] > \text{Coral}[1] \quad \text{AND} \quad \text{Trix\_Fast}[1] > \text{Trix\_Slow}[1] \quad \text{AND} \quad \text{Trix\_Fast}[1] > 0$$
...
* **Stop Loss (SL)**: Placed beyond the Coral band $\mp 2.0\text{ pips}$.
* **Fast Trix Exit**: Close position when Fast Trix changes direction.
...
|---|---|---|---|---|
| `InpCoralPeriod` | `int` | `20` | `14 - 30` | THV Coral SMMA period |
| `InpFastTrix` | `int` | `9` | `5 - 12` | Fast Trix derivative period |
| `InpSlowTrix` | `int` | `18` | `12 - 24` | Slow Trix derivative period |
...
* **Target symbols**: EURUSD.DWX, USDJPY.DWX, GBPUSD.DWX
