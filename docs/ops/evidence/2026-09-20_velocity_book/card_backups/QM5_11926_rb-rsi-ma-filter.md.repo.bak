...
g0_approval_reasoning: "Card review 2026-09-13 (Claude): H1 RSI(14) 30/70 trigger with D1 SMA50 trend filter and deterministic anti-spam RSI-50 reset latch, single resolved exit regime (SL fixed 5.0pct / TP fixed 1.0pct, trailing alternative dropped), sizing rule closed; charter-compliant FTMO block, single symbol EURUSD.D"
expected_pf: 1.2
