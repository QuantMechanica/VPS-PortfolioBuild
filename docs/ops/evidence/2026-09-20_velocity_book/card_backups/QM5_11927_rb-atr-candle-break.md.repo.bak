...
g0_approval_reasoning: "Card review 2026-09-13 (Claude): H1 Gold outlier-candle momentum, closed-bar[1] trigger (range>=1.5*ATR100, body>=60pct range, close in extreme quartile), direction from candle sign, D1 EMA200 trend filter, time filter 08:00-20:00 server, entry at next-bar open; SL 1.5pct / TP 2.0pct of price (appro"
expected_pf: 1.2
