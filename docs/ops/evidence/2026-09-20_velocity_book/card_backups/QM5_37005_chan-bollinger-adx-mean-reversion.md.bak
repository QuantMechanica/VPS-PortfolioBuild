...
type: strategy
strategy_id: QM5-37005-CHAN-BOLLINGER-ADX-MEAN-REVERSION-2026
variant_id: QM5-37005-CHAN-BOLLINGER-ADX-MEAN-REVERSION-2026_H1
source_id: chan-bollinger-adx-mean-reversion-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
...
strategy_mechanic: chan-bollinger-adx-mean-reversion-quantitative-production-blueprint
source_citation: "Chan, E. P. (2009). Quantitative Trading: How to Build Your Own Algorithmic Trading Business."
source_citations:
  - type: verified_quantitative_model
    citation: "Chan, E. P. (2009). Quantitative Trading: How to Build Your Own Algorithmic Trading Business."
    quality_tier: A
    role: primary
sources:
  - "[[sources/chan-bollinger-adx-mean-reversion]]"
concepts:
...
target_symbols: [EURUSD.DWX, USDCAD.DWX, AUDCAD.DWX]
...
# QM5_37005: Dr. Ernest P. Chan Bollinger & ADX Mean Reversion

## 1. Economic & Quantitative Strategy Thesis

Classic Ernest Chan Bollinger Band mean-reversion algorithm conditioned on an ADX regime filter. Only executes when $\text{ADX} < 20$, mathematically guaranteeing a stationary non-trending market.
...
$$\text{UpperBB} = \text{SMA}(20) + 2.0 \sigma, \quad \text{LowerBB} = \text{SMA}(20) - 2.0 \sigma, \quad \text{ADX}(14, \text{H1}) < 20.0$$
...
$$\text{ADX}(14)[1] < 20.0 \quad \text{AND} \quad \text{Low}[1] \le \text{LowerBB}[1] \quad \text{AND} \quad \text{Close}[1] > \text{Open}[1]$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{ADX}(14)[1] < 20.0 \quad \text{AND} \quad \text{High}[1] \ge \text{UpperBB}[1] \quad \text{AND} \quad \text{Close}[1] < \text{Open}[1]$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Target set at the 20-period SMA midline.
...
| `InpMaxADX` | `double` | `20.0` | `15.0 - 25.0` | Maximum ADX ranging filter |
...
* **Target symbols**: EURUSD.DWX, USDCAD.DWX, AUDCAD.DWX
