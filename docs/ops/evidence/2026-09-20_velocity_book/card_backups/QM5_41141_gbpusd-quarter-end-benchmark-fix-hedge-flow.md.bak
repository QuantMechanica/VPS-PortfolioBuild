...
pipeline_phase: G0
g0_approval_reasoning: "G0 cross-approval Claude 2026-08-24: orthogonal wave 2 (Opus G0 review APPROVE_G0)"
last_updated: 2026-08-24
expected_trades_per_year_per_symbol: 100
---

# GBPUSD.DWX Quarter-End Benchmark-Fix Hedge Flow

## Hypothesis

International equity managers adjust currency hedges at the London 16:00 benchmark fix. The paper finds that equity appreciation predicts associated currency depreciation before the end-of-month fix. This card uses completed UK100.DWX month-to-date return as the observable direction proxy for GBPUSD.DWX on quarter-end dates. The economic mechanism is a mandatory benchmark hedge flow. The single-index proxy is a QM translation, not a paper result.
