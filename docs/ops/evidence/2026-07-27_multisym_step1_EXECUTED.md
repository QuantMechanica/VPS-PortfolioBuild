...
Both were submitted with a 150-minute inner budget, `RISK_FIXED=1000`, and
`RISK_PERCENT=0`. No terminal was manually launched. The generated tester INIs
used the available 2018.07.02–2025.12.31 custom-symbol window.
