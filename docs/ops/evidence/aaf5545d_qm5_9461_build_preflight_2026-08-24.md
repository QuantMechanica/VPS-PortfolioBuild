# QM5_9461 build preflight — deterministic refusal

- Router task: `aaf5545d-ea51-4dab-9332-8f0784d9c663`
- Task type / priority: `build_ea` / `10`
- Assigned agent: `codex`
- EA / expected slug: `9461` / `gh-rsi-breakin`
...
| Gate | Result |
|---|---|
| Approved Strategy Card | `D:/QM/strategy_farm/artifacts/cards_approved/QM5_9461_gh-rsi-breakin.md` declares `ea_id: QM5_9461`, `slug: gh-rsi-breakin`, and `g0_status: APPROVED` |
| `ea_id_registry.csv` | exactly `1` row — active, slug `gh-rsi-breakin` |
| `magic_numbers.csv` | exactly `0` rows for `ea_id=9461` — **FAIL** |
| Required symbol slots | card targets `EURUSD.DWX`, `GBPUSD.DWX`, `XAUUSD.DWX`, and `GER40.DWX`; none is allocated |
| Canonical EA directory | `framework/EAs/QM5_9461_gh-rsi-breakin/` exists and contains only `QM5_9461_gh-rsi-breakin.mq5`; no `.ex5`, `SPEC.md`, or setfiles |
