# QM5_9519 build preflight — deterministic refusal

- Router task: `add54a46-19bc-415c-810d-0f117f5cf2ae`
- Task type / priority: `build_ea` / `10`
- Assigned agent: `codex`
- EA / expected slug: `9519` / `mql5-l1-ema`
...
| Gate | Result |
|---|---|
| Approved Strategy Card | `D:/QM/strategy_farm/artifacts/cards_approved/QM5_9519_mql5-l1-ema.md` declares `ea_id: QM5_9519`, `slug: mql5-l1-ema`, and `g0_status: APPROVED` |
| `ea_id_registry.csv` | exactly `1` row — active, slug `mql5-l1-ema` |
| `magic_numbers.csv` | exactly `0` rows for `ea_id=9519` — **FAIL** |
| Required symbol slots | card targets `EURUSD.DWX`, `GBPUSD.DWX`, `USDJPY.DWX`, and `XAUUSD.DWX`; none is allocated |
| Canonical EA directory | `framework/EAs/QM5_9519_mql5-l1-ema/` exists and contains only `QM5_9519_mql5-l1-ema.mq5`; no `.ex5`, `SPEC.md`, or setfiles |
