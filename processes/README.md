...
| 5 | Dashboard Refresh Cadence | [05-dashboard-refresh.md](05-dashboard-refresh.md) | [DevOps](/QUA/agents/devops) (export job + Netlify deploy); [Documentation-KM](/QUA/agents/documentation-km) (public copy + redaction); Controlling Wave 3 deferred (interim: CEO); Obs-SRE Wave 3 deferred (interim: DevOps) | **V5-authored 2026-04-29 (DRAFT pending CEO ack)** (QUA-230 — hourly Hetzner VPS export → public-data JSON → Netlify rebuild; V4 anchors retired: Strategy-Analyst routine `5d3aed1c`, `project_dashboard.html`, `processes.html`, `QM_ProcessesHtml_Build`) |
...
| 8 | Daily Operating Rhythm | [08-daily-operating-rhythm.md](08-daily-operating-rhythm.md) | [Documentation-KM](/QUA/agents/documentation-km) | **V5-authored 2026-04-29 (DRAFT pending CEO ack)** (QUA-231 — 9-agent rhythm table, event-driven default + timer-cadence exception, Wave 3/4/5 deferred placeholders, anti-loop rule per DL-042 / 17-agent-runtime-health.md) |
