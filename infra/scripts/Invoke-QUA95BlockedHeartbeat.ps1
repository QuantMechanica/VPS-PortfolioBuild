...
foreach ($p in @($refreshScript, $auditScript, $gateScript, $assertionScript, $blockedInvariantScript, $unblockReadinessScript, $unblockReadinessSummaryScript, $opsSuiteSnapshotScript, $opsBundleManifestScript)) {
