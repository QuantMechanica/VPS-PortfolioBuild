param(
    ...
    [string]$IssueId = $(if ($env:PAPERCLIP_TASK_ID) { $env:PAPERCLIP_TASK_ID } else { "QUA-413" }),
    [string]$StatusPayloadPath = "docs/ops/QUA-413_ISSUE_STATUS_UPDATE_2026-04-28.json",
    [string]$CommentPath = "docs/ops/QUA-413_ISSUE_COMMENT_2026-04-28.md",
