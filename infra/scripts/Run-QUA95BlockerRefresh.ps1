...
foreach ($f in @($invoke, $sync, $summary, $gate, $assertion, $transition, $transitionCheck, $blockedInvariant, $unblockReadiness, $integrity, $opsSuiteWriter, $opsBundleManifest, $manifest)) {
