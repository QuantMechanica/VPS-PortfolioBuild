...
preceding directional expansion. The QM implementation ports that idea to a
Darwinex-native WTI CFD rule: rank Bollinger BandWidth on completed D1 bars,
...
agrees with the breakout direction.
...
- R2 mechanical: PASS. Fixed D1 BandWidth rank, fixed Bollinger breakout,
  fixed SMA slope confirmation, fixed ATR stop/target, and fixed time exit.
