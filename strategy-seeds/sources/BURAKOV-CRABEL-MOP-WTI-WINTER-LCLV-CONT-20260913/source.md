...
title: WTI winter lower-tercile weekly-close continuation
status: approved_source_complete
source_type: governed_peer_reviewed_and_reputable_cross_source_mechanization
approval_basis: decisions/2026-09-13_wti_winter_lower_clv_continuation_source_approval.md
primary_instrument: XTIUSD.DWX
decision_timeframe: D1
strategy_ids:
  - BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913_S01
parent_sources:
  - source_id: BURAKOV-WTI-HALLOWEEN-2018
    role: peer_reviewed_wti_november_may_regime
...
# WTI Winter Lower-Tercile Weekly-Close Continuation
...
WTI regime. The governed Crabel composite provides reproducible
...
not establish a lower-tercile completed-week settlement, a one-week WTI CFD
short, fixed-dollar ATR risk, or Darwinex execution. Selling inside the
source's positive winter regime is explicitly counter-seasonal: seasonality
defines the structural state while continuation lineage supplies the downside
shock-persistence hypothesis. This is a transparent pre-result QM hypothesis.
No source return, significance, causality, portfolio correlation, or
...
5. Sell only when `CLV < 1/3`. Equality, zero range, malformed history, or an
   ineligible month is flat. There is no long side, weekly return sign, range
...
The seven-month interval contains roughly thirty weekly decisions. A lower-
...
- R1 `PASS_WITH_CROSS_SOURCE_HORIZON_AND_COUNTER_SEASONAL_TRANSLATION_RISK`:
  peer-reviewed WTI winter evidence, governed reputable close-location
  lineage, and peer-reviewed commodity continuation; the exact conjunction
  and counter-seasonal short direction are explicitly untested.
- R2 `PASS`: calendar, completed-week construction, strict close-location
  comparison, short-only orientation, attempt, stop, spread, and lifecycle
...
The canonical pre-allocation checker found no exact identity across 4,949
registry rows and 1,558 repository cards. It reported two fuzzy family
matches and the unavailable external Strategy Wiki mount. `QM5_41461` carries
the lower-tercile short continuation only during the disjoint June-October
summer interval. `QM5_41463` trades the winter interval but buys an upper-
tercile close. `QM5_41464` buys this winter lower-tercile state under reversal
lineage. Carrier, November-May clock, one-week package, strict lower-tercile
settlement, short-only continuation, and one-week lifecycle are jointly
load-bearing.
