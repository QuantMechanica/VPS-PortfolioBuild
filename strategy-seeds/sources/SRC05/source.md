...
status: closeout_pass_v2_complete             # 14 cards drafted; S13/S14 lifted from PENDING to DRAFT under [QUA-783](/QUA/issues/QUA-783) OWNER directive 2026-05-08
authored-by: Research Agent
last-updated: 2026-05-08
budget_tracking:
  heartbeats_used: 6                          # h1 scaffold + 4-card extraction batch (S01, S02, S05, S06); h2 single-symbol-futures batch (S07, S08, S09); h3 intraday-gap batch (S12 single-symbol opening-gap + S03 cross-sectional buy-on-gap); h4 multi-stock-universe / cross-sectional-momentum batch (S04 SPY-arb + S10 XS futures momentum + S11 XS stock momentum); h5 v1 completion_report drafted; h6 closeout v2 — S13 chan-at-pead + S14 chan-at-lev-etf-rebal drafted under [QUA-783](/QUA/issues/QUA-783) DL-057 OWNER directive
  cards_drafted: 14                           # S01-S12 (h1-h4) + S13 chan-at-pead + S14 chan-at-lev-etf-rebal (h6 [QUA-783](/QUA/issues/QUA-783))
  cards_passed_g0: 0
  cards_killed_pre_p1: 0
  cards_pending_ceo_decision: 0               # S13 + S14 lifted to DRAFT under [QUA-783](/QUA/issues/QUA-783); QB G0 is now the verdict gate on the darwinex_native_data_only / dwx_suffix_discipline exception (per OWNER directive "Hand to QB for G0 review")
extraction_pass_status: closeout_pass_v2_complete  # 14/14 cards drafted; SRC05 extraction is exhaustive under BASIS rule. Remaining work is sub-issue queue creation per DL-029 + QB G0 batched verdict.
completion_report: drafted_v2                 # strategy-seeds/sources/SRC05/completion_report.md v2 authored 2026-05-08 with S13 + S14 appended
...
| S13 | `chan-at-pead` | `strategy-seeds/cards/chan-at-pead_card.md` | TBD (h6 [QUA-783](/QUA/issues/QUA-783) extraction) | **DRAFT (h6 [QUA-783](/QUA/issues/QUA-783) commit)** | PDF p. 161 (Ex 7.2) + BOX 7.1 pp. 159-160 | Post-Earnings Announcement Drift: earnings announced after prev_close + before today_open → measure overnight return relative to 90d_stdev; long if return > 0.5·stdev, short if < -0.5·stdev; exit at close. APR 6.7%, Sharpe 1.5 (S&P 500 universe, Jan 2011 - Apr 2012). **Hard-rule-at-risk: `darwinex_native_data_only` (PRIMARY — requires earnings-calendar data feed) + `dwx_suffix_discipline` (PRIMARY — multi-stock S&P 500 universe not in Darwinex).** Card lifted from prior "DRAFT-PENDING-or-SKIP" to DRAFT under [QUA-783](/QUA/issues/QUA-783) OWNER directive 2026-05-08; QB G0 is the verdict gate on data + universe substitution path. **Vocab gap candidate: `event-driven-momentum`.** Forward-looking flag per [QUA-740](/QUA/issues/QUA-740) audit comment 312aef75: 90-bar D1 lookback is tight-but-not-blocking on default V5 P2 6-month window; QM-00086 Path X1 dependency NOT critical (vs. 252-bar audit cluster). |
| S14 | `chan-at-lev-etf-rebal` | `strategy-seeds/cards/chan-at-lev-etf-rebal_card.md` | TBD (h6 [QUA-783](/QUA/issues/QUA-783) extraction) | **DRAFT (h6 [QUA-783](/QUA/issues/QUA-783) commit)** | PDF pp. 163-164 (inline) | Leveraged-ETF MOC rebalancing momentum: buy DRN (3× REIT ETF) if return prev_close → T-15min > 2%, sell if < -2%, exit at close. APR 15%, Sharpe 1.8 (DRN, Oct 2011 - Oct 2012). **Hard-rule-at-risk: `darwinex_native_data_only` (PRIMARY — intraday DRN data) + `dwx_suffix_discipline` (PRIMARY — Darwinex spot/CFD lacks 3× leveraged sector ETFs) + `scalping_p5b_latency` (PRIMARY OPERATIONAL — 15-min hold).** Card lifted from prior "DRAFT-PENDING-or-SKIP" to DRAFT under [QUA-783](/QUA/issues/QUA-783) OWNER directive 2026-05-08; QB G0 is the verdict gate on data + symbol substitution path. **Vocab gap candidate: `leveraged-etf-rebalance-momentum`.** Forward-looking flag per [QUA-740](/QUA/issues/QUA-740) audit comment 312aef75: NO D1 training_lookback (single-bar dependency) → QM-00086 Path X1 dependency NOT binding. |

Slot count finalized: **14 cards (S01-S14)** as of closeout-pass v2 (2026-05-08), vs QUA-352's 5-8 prediction. S13 + S14 lifted from "conditional on CEO ratification" to DRAFT under [QUA-783](/QUA/issues/QUA-783) OWNER directive (Board Advisor 3d7e598e 2026-05-08T04:33Z) — the directive's "Hand to QB for G0 review" is interpreted as authorizing the draft with explicit Hard-Rule-at-risk flagging in § 11 / § 12, with QB G0 as the verdict gate on the data + universe substitution path. The discrepancy vs CEO's 5-8 prediction is driven by:
