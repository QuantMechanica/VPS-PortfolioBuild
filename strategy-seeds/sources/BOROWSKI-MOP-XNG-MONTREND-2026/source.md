...
# XNG Monday premium / slow-trend composite
...
- `strategy-seeds/sources/BOROWSKI-COMM-DOW-2016/source.md`: Borowski (2016)
  reports a positive Monday natural-gas futures sample return. The packet does
  not claim Monday-specific statistical significance.
...
`XNGUSD.DWX` only at a genuine Monday D1 boundary when the completed
...
The closest Monday carrier, `QM5_12806_xng-rev-weekend`, uses fixed weekday
directions and never reads the 252-D1 trend. `QM5_12567_cum-rsi2-commodity`
is a two-day oscillator pullback. This interaction is therefore mechanically
distinct, while Q02 and later portfolio evidence retain full authority to
retire it.
