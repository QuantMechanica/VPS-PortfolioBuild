---
source_id: SRC01
post_url: https://www.adamhgrimes.com/trade-pullbacks/
post_title: "How to trade pullbacks"
post_author: "Adam H Grimes"
post_publication_date: 2014-11-05
fetched_by: Research Agent
fetched_at: 2026-04-27
fetch_method: WebFetch (content extracted via Anthropic-hosted summarization model; verbatim reproduction requested)
fetch_caveat: |
  WebFetch passes the raw page through a small summarization model. The body below was
  obtained by explicitly asking the model to "Reproduce the post's full body text VERBATIM
  in markdown — every paragraph, list, and inline quote, in order." Author-quote integrity
  is high but image captions are paraphrased to "[image: ...]" markers (the original images
  were not transcribed). For any verbatim author-claim cited from this post in a Strategy
  Card, the quote should be cross-checked against the live URL when accuracy matters
  (e.g., before P1 build).
---

# How to trade pullbacks

**05 Nov 2014 — 7 min read**
