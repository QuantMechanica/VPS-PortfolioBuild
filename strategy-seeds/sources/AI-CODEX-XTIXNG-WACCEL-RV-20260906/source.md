...
title: XTI/XNG completed-week acceleration-overshoot reversion
...
approval_basis: decisions/2026-09-06_xtixng_weekly_acceleration_overshoot_source_approval.md
parent_source_ids:
  - VILLAR-RAMBERG-OILGAS-2026
  - SCHWEIKERT-CME-XAUXAG-WACCEL-RV-2026
parent_sha256:
  VILLAR-RAMBERG-OILGAS-2026: 4A03377F4CE8BCA9816DC2D9DBC34131ADC5E50B5ABB9D02AC29CB64E9CC4604
  SCHWEIKERT-CME-XAUXAG-WACCEL-RV-2026: 6A077F318CB3DDF71369B53EBB311C2D925BA1FCC22806C570E575C34E3EE650
created: 2026-09-06
...
# XTI/XNG Completed-Week Acceleration-Overshoot Reversion Source Packet
...
2. `strategy-seeds/sources/SCHWEIKERT-CME-XAUXAG-WACCEL-RV-2026/source.md`,
   used only for the already governed exact two-return acceleration-overshoot
...
oil/gas relative-price state. They do not establish that two same-sign weekly
moves overshoot, that the inverse package converges, or that a Darwinex CFD
package is neutral, profitable, or uncorrelated.
...
`abs(r_new)>abs(r_old)`. Two positive, accelerating relative moves open SELL
XTI / BUY XNG. Two negative, accelerating relative moves open BUY XTI / SELL
XNG. Close at the first later Monday anchor or after ten calendar days.

The weekly horizon, endpoint reconstruction, return count, strict same-sign
and acceleration conditions, inverse sides, CFD carrier, equal-notional
...
The canonical pre-allocation receipt scanned 4,839 registry rows and 1,452
repository cards. It found no exact identity and five expected fuzzy family
matches; the unavailable optional Wiki root is explicit in the receipt.

- `QM5_41076_xauxag-waccel-rv` shares the arithmetic but owns a precious-
  metals carrier. This candidate owns the weak, time-varying oil/gas carrier,
  energy contract metadata, and energy spread costs.
- `QM5_41358_xtixng-wovershoot-rv` shares the carrier but requires strict
  opposite signs. The states are mutually exclusive.
...
Verdict:
`FUZZY_FAMILY_MATCHES_RESOLVED_DISTINCT_XTIXNG_TWO_ADJACENT_COMPLETED_WEEK_RELATIVE_RETURNS_STRICT_SAME_SIGN_NEWEST_ACCELERATION_CONTRARIAN_BASKET`.
