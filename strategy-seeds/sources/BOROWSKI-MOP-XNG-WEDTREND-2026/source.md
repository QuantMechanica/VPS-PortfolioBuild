...
# XNG Wednesday weakness / slow-trend composite
...
- `strategy-seeds/sources/BOROWSKI-COMM-DOW-2016/source.md`: Borowski (2016)
  reports a negative Wednesday natural-gas futures return and a weekday
...
`XNGUSD.DWX` only at a genuine Wednesday D1 boundary when the completed
252-D1 log return is negative, then flatten at the next D1 boundary. The
...
The closest build, `QM5_20018_xng-wed-short`, is unconditional and never reads
