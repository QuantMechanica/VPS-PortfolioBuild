...
title: WTI monthly linear-trend quality extraction from Time Series Momentum
...
approval_basis: decisions/2026-08-07_qm5_20261_wti_lr_trend_g0.md
...
# WTI Linear-Trend Quality Source Packet
...
- Appendix A includes NYMEX WTI crude among the paper's commodity futures.
...
consecutive completed `XTIUSD.DWX` month-end closes. Order them oldest to
...
The deterministic pre-allocation check on 2026-08-07 scanned 4,318 EA-registry
rows and 435 intake cards. It found no exact slug or strategy-ID collision and
returned five expected lexical/source-family fuzzy neighbors. Manual review
separates the candidate from cumulative-return TSMOM, dual-horizon agreement,
multi-horizon majority vote, binary return-sign momentum, and day-of-month
trend builds. A content scan found no WTI card using both an OLS log-price
slope and fixed regression-fit gate.
...
the existing WTI momentum family.
