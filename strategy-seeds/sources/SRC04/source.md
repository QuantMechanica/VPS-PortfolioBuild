...
budget_tracking:
  heartbeats_used: 4                          # h1 scaffold + PDF text extract + per-chapter validation read; h2 first-pass extraction (S02a + S02b + S03 — 3 cards); h3 first-pass technical-block continuation (S05 + S07 — 2 cards); h4 technical-block continuation (S04 + S06 + S08 — 3 cards). SRC03 ceiling 5 heartbeats / 14 cards.
  cards_drafted: 8                            # SRC04_S02a (lien-dbb-pick-tops), SRC04_S02b (lien-dbb-trend-join), SRC04_S03 (lien-fade-double-zeros), SRC04_S04 (lien-waiting-deal), SRC04_S05 (lien-inside-day-breakout), SRC04_S06 (lien-fader), SRC04_S07 (lien-20day-breakout), SRC04_S08 (lien-channels)
  cards_passed_g0: 0
  cards_killed_pre_p1: 0
extraction_pass_status: first_pass_partial    # h2 closed first three high-prediction technical cards (Ch 9 split + Ch 10); h3 closed S05 (Ch 12 Inside Days) + S07 (Ch 14 20-Day Breakout); h4 closed S04 (Ch 11 Waiting for Deal) + S06 (Ch 13 Fader, distinct from SRC03_S10 spec-trap) + S08 (Ch 15 Channels). Technical block remaining: S01 (Ch 8 multi-TF, likely SKIP methodology) + S09 (Ch 16 Perfect Order, vocab-gap candidate). Fundamental block (S10/S11/S12-19) scheduled for h5-h6.
