...
title: WTI exact eight-completed-month trend with a fixed two-month holding clock
...
approval_basis: decisions/2026-09-08_wti_eight_month_momentum_two_month_hold_source_approval.md
...
# WTI Eight-Month Trend / Two-Month Hold
...
and volatility scaling. It does not publish a standalone WTI `k=8, h=2`
...
nine consecutive completed month-end closes `C[0]..C[8]`, oldest to newest.
Compute `r8 = ln(C[8] / C[0])`. Buy if `r8 > 0`, sell if `r8 < 0`, and consume
...
completed months on that lifecycle. `QM5_41379` through `QM5_41386` observe
three, one, nine, six, four, two, five, and seven completed months. The new
identity requires the exact combination of nine consecutive endpoints,
eight-month orientation, fixed odd-month epoch, no even-month action, one
