# Strategy Card (mechanized) — H1: Intraday session-bounded mean-reversion beats swing on FTMO first-passage
...
Refuted if intraday session-flat variants do not reduce worst-day loss or wdd_p90 relative to med60 versus the swing sleeves.
