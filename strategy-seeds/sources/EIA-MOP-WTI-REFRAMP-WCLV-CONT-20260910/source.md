...
title: WTI refinery-ramp weekly upper-tercile continuation
...
approval_basis: decisions/2026-09-10_wti_refinery_ramp_weekly_close_location_continuation_source_approval.md
...
cards_extracted: [wti-reframp-wclv-cont]
---

# WTI Refinery-Ramp Weekly Upper-Tercile Continuation

## Complete-Read Record

Both governed parents named above were read end to end before the durable
approval at
`decisions/2026-09-10_wti_refinery_ramp_weekly_close_location_continuation_source_approval.md`.
The official EIA packet records refinery maintenance/outage structure and the
transition toward higher utilization heading into summer. The momentum packet
preserves the complete-paper receipt for Moskowitz, Ooi, and Pedersen (2012),
*Time Series Momentum*, *Journal of Financial Economics* 104(2), 228-250, DOI
...
EIA supplies only refinery-maintenance and utilization-ramp context. The MOP
lineage supplies broad own-return continuation evidence at materially longer
horizons. Neither source tests April-July, two completed broker weeks,
parent-close return, an upper-tercile close, long-only direction, a one-week
hold, or a Darwinex continuous WTI CFD. The exact rule is a transparent
...
6. When `r > 0` and `clv > 2/3`, buy. Equality, a nonpositive return, a lower
...
family members. `QM5_41080` is year-round and symmetric, uses outer-fifth
thresholds, and trades both upper and lower states. `QM5_41081` trades XNG.
`QM5_41422` uses only the newest week's open-to-close sign in April-May; this
rule uses two completed weeks, parent-close to newest-close return, upper-
tercile range confirmation, and April-July. Because the newest week's opening
gap is excluded by this return endpoint but included by `QM5_41422`, their
signals can disagree. Daily May-July squeeze/pullback cards use current D1
patterns rather than completed-week endpoint/range state.
...
nonadjacent weekly packages, wrong endpoints, a nonqualifying entry, any short,
