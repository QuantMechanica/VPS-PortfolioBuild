...
title: Brent, CAD, and NZD commodity-FX relative-value source packet
status: cards_ready
created: 2026-07-09
created_by: Codex
...
# Brent/NZDCAD Oil-FX Relative-Value Source
...
- `xbr-nzdcad-rspr`: D1 two-leg `XBRUSD.DWX` / `NZDCAD.DWX` return-spread
  z-score reversion. The basket treats Brent as the energy leg and `NZDCAD` as
...
- R3 data available: PASS. `XBRUSD.DWX` and `NZDCAD.DWX` exist in the DWX
