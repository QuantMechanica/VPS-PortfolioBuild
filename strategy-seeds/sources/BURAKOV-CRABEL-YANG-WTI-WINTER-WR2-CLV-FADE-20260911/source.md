...
title: WTI winter weekly range-expansion close-location reversion
status: approved_source_complete
source_type: governed_peer_reviewed_reputable_and_academic_cross_source_mechanization
approval_basis: decisions/2026-09-11_wti_winter_wr2_clv_reversion_source_approval.md
primary_instrument: XTIUSD.DWX
decision_timeframe: D1
strategy_ids:
  - BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-CLV-FADE-20260911_S01
parent_sources:
...
# WTI Winter Weekly Range-Expansion Close-Location Reversion

## Complete-Read Record

The three bounded parent records named above were read end to end before the durable approval at
`decisions/2026-09-11_wti_winter_wr2_clv_reversion_source_approval.md`. Burakov, Freidin, and
...
futures and do not establish a two-week range comparison, close-location threshold, fixed-dollar
ATR risk, or one-week holding period on the Darwinex continuous CFD. This is a transparent
pre-result QM cross-source hypothesis. No source return, significance, causality, correlation, or
...
completed positions in a full scored year, nonpositive governed economics, or any contract defect.
No threshold may be relaxed after Q02.
...
The canonical pre-allocation scan found no exact identity. `QM5_41403` and `QM5_41408` fade two
same-sign weekly returns without range or close-location predicates. `QM5_41440` uses the same WTI
winter range-expansion/upper-quartile state but buys continuation, while this rule sells it and
also buys the strict lower-quartile state. `QM5_41435` is a short-only fade confined to the
disjoint August-October hurricane window. `QM5_41438` follows outer-quartile continuation on XNG
in November-March. Certified `QM5_12567` is an XNG cumulative-RSI pullback. Carrier, November-May
clock, strict range expansion, two outer-quartile predicates, contrarian orientation, and
