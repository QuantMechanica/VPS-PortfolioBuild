...
title: XNG winter-demand two-week exhaustion fade
...
approval_basis: decisions/2026-09-10_xng_winter_two_week_fade_source_approval.md
parent_source_ids: [EIA-XNG-SHOULDER-2026, YANG-COMM-REVERSAL-2017]
created: 2026-09-10
created_by: Research+Development
cards_extracted: [xng-winter-w2fade]
---

# XNG Winter-Demand Two-Week Exhaustion Fade
...
Administration record establishes recurring winter natural-gas heating demand.
Yang, Goncu, and Pantelous (2017) supply academic commodity fixed-horizon
reversal lineage.

Neither source tests this exact XNG-only winter-conditioned two-week state.
...
the expected family matches. `QM5_41402` follows the same-sign winter state;
this card trades its inverse. `QM5_41403` uses the same inverse map on WTI and
also includes April and May. `QM5_41401` uses XNG only in the disjoint shoulder
months. `QM5_41395` follows only one completed winter week.
`QM5_12567_cum-rsi2-commodity` is a long-only two-day cumulative-RSI pullback
above a slow trend. This identity jointly fixes the XNG carrier, November-March
