...
title: WTI exact ten-completed-month trend with a fixed two-month holding clock
...
approval_basis: decisions/2026-09-09_wti_ten_month_momentum_two_month_hold_source_approval.md
...
# WTI Ten-Month Trend / Two-Month Hold
...
and volatility scaling. It does not publish a standalone WTI `k=10, h=2`
...
completed months on that lifecycle. `QM5_41379` through `QM5_41387` observe
three, one, nine, six, four, two, five, seven, and eight completed months. The
new identity requires the exact combination of eleven consecutive endpoints,
ten-month orientation, fixed odd-month epoch, no even-month action, one
