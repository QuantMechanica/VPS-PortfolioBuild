...
title: WTI exact seven-completed-month trend with a fixed two-month holding clock
...
approval_basis: decisions/2026-09-08_wti_seven_month_momentum_two_month_hold_source_approval.md
...
# WTI Seven-Month Trend / Two-Month Hold
...
and volatility scaling. It does not publish a standalone WTI `k=7, h=2`
...
eight consecutive completed month-end closes `C[0]..C[7]`, oldest to newest.
Compute `r7 = ln(C[7] / C[0])`. Buy if `r7 > 0`, sell if `r7 < 0`, and consume
...
completed months on that lifecycle. `QM5_41379` through `QM5_41385` observe
three, one, nine, six, four, two, and five completed months. The new identity
requires the exact combination of eight consecutive endpoints, seven-month
orientation, fixed odd-month epoch, no even-month action, one consumed
bimonthly attempt, and two-month renewal.
