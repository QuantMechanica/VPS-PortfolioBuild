...
| S03 | `williams-hidden-oops` | `strategy-seeds/cards/williams-hidden-oops_card.md` | TBD | DRAFT (2026-04-28) | PDF pp. 36, 40 | Hidden OOPS!: projected H/L formula `(H+L+C)/3 × 2` minus high/low; entry at projected level on stop. Multi-sub-rule structure (S&P sub-rules A-D, Bonds sub-rules A-C). Reuses S02 `gap-fade-stop-entry` family flag. Fold-vs-distinct: DISTINCT (different reference price than S02 — projected vs actual). |
