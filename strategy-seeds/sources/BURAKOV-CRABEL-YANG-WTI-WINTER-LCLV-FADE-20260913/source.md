...
title: WTI winter lower-tercile weekly-close reversion
status: approved_source_complete
source_type: governed_peer_reviewed_reputable_and_academic_cross_source_mechanization
approval_basis: decisions/2026-09-13_wti_winter_lower_clv_reversion_source_approval.md
...
# WTI Winter Lower-Tercile Weekly-Close Reversion
...
- R1 `PASS_WITH_CROSS_SOURCE_AND_HORIZON_TRANSLATION_RISK`: peer-reviewed WTI
  ...
  reviewed commodity reversal; the exact conjunction is explicitly
  untested.
...
The canonical pre-allocation checker found no exact identity across 4,945
registry rows and 1,554 repository cards. It returned four expected fuzzy
family matches and also failed closed on the unavailable external Strategy
Wiki mount; both findings received the manual review below.
...
rank range, ignores body direction, and keys only on a strict lower-tercile
...
`QM5_41442` and `QM5_41456` add a two-week range-rank gate and symmetric
sides; this candidate has neither.
Certified `QM5_12567` is an XNG cumulative-RSI pullback. Carrier,
November-May clock, one-week package, strict lower-tercile settlement,
