...
# XNG summer demand plus price-trend source packet
...
EIA supports recurring summer electric-power-demand seasonality in natural gas.
...
two structural states: take long XNG exposure only in May-September and only
when completed D1 prices show a positive, rising fast/slow trend stack.
