...
budget_tracking:
  heartbeats_used: 5                          # h1 scaffold; h2 Ch 3+7 + S01 + Ex 7.1 SKIP; h3 S02; h4 S07+S08 + HFT/Leverage SKIPs; h5 S05+S06 multi-stock equity seasonals
  cards_drafted: 6                            # S01 S02 S05 S06 S07 S08
  cards_passed_g0: 0
  cards_killed_pre_p1: 0
extraction_pass_status: in_progress           # 6/9 cards drafted; S03 (Khandani-Lo Ex 3.7+3.8) + S04 (PCA Ex 7.4) + S09 (PEAD Ch 7 narrative) pending; final candidate set 9 + 3 SKIPs
