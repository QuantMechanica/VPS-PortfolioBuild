...
title: XTI/XNG two-week common-shock relative-leader-persistence continuation
...
approval_basis: decisions/2026-09-06_xtixng_common_shock_leader_persistence_continuation_source_approval.md
parent_source_ids:
  - FMR-MOMTS-2010
...
cards_extracted:
  - xtixng-cs-leadpersist-cont
---

# XTI/XNG Two-Week Common-Shock Leader-Persistence Continuation Source Packet
...
The sources support a falsifiable relative-return research question, but they
do not test a two-week same-leader rule, a weekly CFD package, or this exact
continuation direction. No source alpha, hedge ratio, frequency, cost,
...
same-leader persistence, newest-winner continuation, continuous-CFD carrier,
...
The canonical receipt covered 4,849 registry rows and 1,462 repository cards,
...
- `QM5_41367_xtixng-commonshock-cont` follows a winner after one common-sign
  week; this rule requires two consecutive common-sign weeks and identical
  strict leadership across both.
- `QM5_41368_xtixng-cs-leadswitch-rv` requires leadership to switch and fades
  the newest winner; this rule requires leadership to persist and follows it.
- `QM5_41361_xtixng-commonshock-rv` is a one-week winner fade.
- `QM5_41365_xtixng-decouple-rv` and `QM5_41366_xtixng-decouple-cont` require
  opposite individual-leg signs inside one completed week.
- `QM5_41362_xtixng-wdecel-cont` uses the sign and relative magnitude of two
  ratio returns; this rule ignores magnitude and requires same-sign individual
  returns inside both weeks plus an unchanged leader.
...
- R2 `PASS`: synchronized endpoints, consecutive-week membership, two strict
  common-sign states, strict same-leader persistence, newest-winner
  continuation, durable attempt, aggregate risk, hard stops, and lifecycle
  are deterministic.
