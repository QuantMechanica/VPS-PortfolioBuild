...
title: WTI summer weekly range-contraction negative-week continuation
status: approved_source_complete
source_type: governed_peer_reviewed_reputable_and_academic_cross_source_mechanization
approval_basis: decisions/2026-09-12_wti_summer_nr2_negative_week_continuation_source_approval.md
primary_instrument: XTIUSD.DWX
decision_timeframe: D1
strategy_ids:
  - BURAKOV-CRABEL-MOP-WTI-SUMMER-NR2-DOWNWEEK-CONT-20260912_S01
parent_sources:
...
# WTI Summer Weekly Range-Contraction Negative-Week Continuation

## Complete-Read Record

The three bounded parent records named above were read end to end before the durable approval at
`decisions/2026-09-12_wti_summer_nr2_negative_week_continuation_source_approval.md`. Burakov,
...
futures and do not establish a two-week range contraction, negative weekly body, fixed-dollar
...
contraction followed by a negative weekly body is expected to produce approximately five to
...
The canonical pre-allocation checker found no exact identity across 4,941 registry rows and 1,550
repository cards, reported seven fuzzy family matches, and could not inspect the unavailable
external Strategy Wiki. That fail-closed limitation is preserved in
`artifacts/qm5_candidate_wti_summer_nr2_downweek_cont_dedup_preallocation_20260912.json`.
...
symmetric November-May NR2 body-continuation rule. Closest sibling `QM5_41459` requires strict range expansion, while this candidate requires strict
contraction; the volatility states cannot signal on the same non-tied observation. `QM5_41457`
shares contraction but requires a strictly positive newest-week body and fades it; this candidate
requires a strictly negative body and continues it. Carrier, June-October clock, strict contraction, negative newest-
week body, short-only orientation, and one-week lifecycle are jointly load-bearing.

Manual verdict:
`DISTINCT_WTI_JUNE_OCTOBER_NR2_NEGATIVE_WEEK_SHORT_CONTINUATION_AFTER_FUZZY_FAMILY_REVIEW`.
