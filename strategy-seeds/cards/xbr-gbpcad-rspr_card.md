...
g0_approval_reasoning: "Mission-directed G0 approval 2026-07-08: R1 PASS EIA and Bank of Canada source packet; R2 PASS deterministic D1 XBR/GBPCAD inverse-CAD return-spread basket; R3 PASS XBRUSD.DWX and GBPCAD.DWX exist in the DWX matrix; R4 PASS no ML/grid/martingale/external runtime data."
---
...
- `QM5_12607_brent-cad-confirm`: USDCAD confirmation filter for an outright Brent
  position.
- `QM5_12609_brent-cad-spread-mr` and `QM5_12722_brent-cad-brk`: USDCAD-specific
  spread/breakout definitions.
- `QM5_13010_xbr-cadjpy-rspr`, `QM5_13011_xbr-cadchf-rspr`, and
  `QM5_13034_xbr-audcad-rspr`: different CAD crosses and different quotation
  mechanics.
- `QM5_13029_gbpcad-gbpnzd-coint`: FX-only GBPCAD/GBPNZD cointegration, not an
  energy/FX oil-CAD sleeve.
- XAU/XAG, XNG, index, Brent/Brent, XBR/XNG, oil/metals, and single-symbol Brent
...
- [x] Non-duplicate: paired Brent/GBPCAD inverse-CAD return-spread mean
  reversion, not Brent/USDCAD, Brent/CADJPY, Brent/CADCHF, Brent/AUDCAD,
  GBPCAD/GBPNZD cointegration, XBR/NZD, XBR/XNG, Brent/CAD, Brent/Brent,
  metal-ratio, XNG, index, or outright Brent logic.

## Risk

Backtests use `RISK_FIXED=1200`, `RISK_PERCENT=0`, and one logical basket
...
- Keep Q02 setfile on `RISK_FIXED=1200` and `RISK_PERCENT=0`.
...
|---|---|---|---|
| v1 | 2026-07-08 | initial XBR/GBPCAD return-spread basket build | Q02 | PENDING |
...
| Q01 Build Validation | 2026-07-08 | PENDING | `artifacts/qm5_13087_build_result.json` |
