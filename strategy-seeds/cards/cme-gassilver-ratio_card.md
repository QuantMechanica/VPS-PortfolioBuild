...
Natural gas is a weather, storage, production, and power-burn energy market,
while silver combines precious-metal and industrial demand exposure. This card
prices natural gas in silver terms and tests a market-neutral D1 mean-reversion
package when that relative price reaches an extreme.

This is deliberately different from:

- `QM5_12567_cum-rsi2-commodity`: no RSI, oscillator, or single-leg pullback.
- `QM5_12577_cme-xauxag-ratio` and `QM5_12724_cme-xauxag-brk`: not a
  gold/silver metals-ratio sleeve.
...
- `QM5_12604_cme-oilgold-ratio` and `QM5_12605_cme-oilgold-brk`: no oil or
  gold leg.
- `QM5_12606_oil-silver-ratio` and `QM5_12797_oil-silver-brk`: the energy leg
  is natural gas, not WTI crude.
- `QM5_12824_cme-gasgold-ratio`: silver is the hedge leg, so this tests an
  energy/industrial-metal relative value rather than gas versus monetary gold.
...
- Logical symbol: `QM5_12826_XNG_XAG_RATIO_D1`.
- Period: D1.
...
- [x] Non-duplicate: not existing XAU/XAG, XTI/XNG, XNG/XAU, oil/gold,
  oil/silver, WTI single-leg, XNG single-leg, or commodity-RSI logic.

## Framework Alignment

- no_trade: D1 host guard, `XNGUSD.DWX` slot-0 guard, parameter guard, spread
  caps, both-leg trade-session checks.
- trade_entry: two-leg natural-gas/silver log-ratio z-score extremes.
