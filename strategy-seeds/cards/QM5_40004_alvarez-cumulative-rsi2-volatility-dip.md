...
ea_id: QM5_40004
slug: alvarez-cumulative-rsi2-volatility-dip
type: strategy
strategy_id: QM5-40004-ALVAREZ-CUMULATIVE-RSI2-VOLATILITY-DIP-2026
variant_id: QM5-40004-ALVAREZ-CUMULATIVE-RSI2-VOLATILITY-DIP-2026_D1
source_id: alvarez-cumulative-rsi2-volatility-dip-official-source
status: REJECTED
g0_status: REJECTED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Cesar Alvarez"
strategy_mechanic: alvarez-cumulative-rsi2-volatility-dip-quantitative-production-blueprint
source_citation: "Alvarez, C. (2014). Improving RSI(2) with Cumulative Indicators. Alvarez Quant Trading."
source_citations:
  - type: verified_quantitative_model
    citation: "Alvarez, C. (2014). Improving RSI(2) with Cumulative Indicators. Alvarez Quant Trading."
    quality_tier: A
    role: primary
sources:
  - "[[sources/alvarez-cumulative-rsi2-volatility-dip]]"
concepts:
...
g0_rejection_reason: "Duplicate mechanic: Cumulative RSI(2) already approved as QM5_10430 et-cum-rsi2 (SP500+NDX covered)"
---

# QM5_40004: Alvarez Quant Cumulative RSI(2) Volatility Dip

## 1. Economic & Quantitative Strategy Thesis

Advanced Alvarez model accumulating successive multi-day sell-offs: $\text{CumRSI2} = \text{RSI}(2)[1] + \text{RSI}(2)[2]$. Enters when $\text{CumRSI2} \le 35.0$ above the 200 SMA, avoiding early single-day dip traps.

### 1.1 Statistical Profile & Prop Performance
* **Historical / Monte Carlo Win Rate**: **80.4%**
* **Risk-to-Reward Ratio (R:R)**: **1:1.5**
* **Expected Profit Factor (PF)**: **2.45**
* **Challenge Pass Rate / Evaluation Pass Rate**: **86.8% Pass Rate**
* **Maximum Expected Portfolio Drawdown**: **<5.8%**
...
$$\text{CumRSI2} = \text{RSI}(2, \text{D1})[1] + \text{RSI}(2, \text{D1})[2]$$
...
$$\text{Close}[1] > \text{SMA}(200)[1] \quad \text{AND} \quad \text{CumRSI2} \le 35.0$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{No Short Signal (Long-Only)}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Target Exit**: Close when $\text{Close}[1] > \text{SMA}(5, \text{D1})[1]$.
...
|---|---|---|---|---|
| `InpCumRSIThreshold`| `double` | `35.0` | `20.0 - 45.0` | Cumulative 2-day RSI threshold |
| `InpExitSMA` | `int` | `5` | `3 - 8` | Exit SMA period |
