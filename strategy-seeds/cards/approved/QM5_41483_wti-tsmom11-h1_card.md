...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K11H1_S42
variant_id: MOP-TSMOM-2012_XTI_K11H1_S42
source_id: MOP-WTI-TSMOM11-H1-2026
ea_id: QM5_41483
slug: wti-tsmom11-h1
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41483_wti-tsmom11-h1_card.md
execution_contract_status: APPROVED
created: 2026-09-19
created_by: Research+Development
last_updated: 2026-09-19
g0_status: APPROVED
g0_decision: decisions/2026-09-19_qm5_41483_wti_tsmom11_h1_g0.md
source_approval: decisions/2026-09-19_wti_eleven_month_momentum_one_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM11-H1-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: monthly-wti-sign-of-exact-eleven-completed-broker-month-log-return-one-month-hold
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, eleven-month-return, one-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
expected_trade_frequency: "Approximately eleven to twelve WTI packages per full post-warm-up year; Q02 must prove at least five/year or retire."
...
parameters_to_test: "Locked Q02 baseline only: D1; twelve consecutive completed month-end closes; exact eleven-month log-return sign; every-month decision; one-month hold; 300 D1 bars; 3.5*ATR(20,D1) frozen stop; 40-day stale repair; 1500-point spread ceiling."
...
force_build: true
review_focus: "Falsify the source-bounded WTI k=11,h=1 stream. Verify twelve exact completed-month endpoints, every-month attempts, fixed risk, frozen stop, and next-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal]
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_eleven_month_orientation, monthly_attempt_state, one_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed JFE source with WTI in universe and WTI-specific efficacy unproven; R2 exact monthly k=11,h=1 mechanical contract; R3 XTIUSD.DWX D1 native history; R4 deterministic non-ML; canonical and manual family review found no exact identity."
---

# QM5_41483 WTI Eleven-Month Momentum / One-Month Hold

## Hypothesis

An eleven-completed-month WTI own-return direction may persist over the next
month, providing an oil return driver absent from the current index/metal/XNG
book. This is a pre-result structural test. The peer-reviewed source defines
the time-series-momentum formation/holding family and includes WTI, but does
not publish a standalone WTI `k=11, h=1` or continuous-CFD result.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/MOP-WTI-TSMOM11-H1-2026/source.md`; its complete-read
...
only. `QM5_41390` uses the same exact eleven-month formation but a fixed
odd-month, two-month package. `QM5_41391` renews monthly but uses an exact
ten-month formation. `QM5_12603` uses a 252-D1 proxy and neutral band, while
`QM5_20284` excludes the newest completed month. This card requires both exact
`k=11` broker-month endpoints and the every-month `h=1` lifecycle.
...
- History: twelve consecutive completed broker-month-end closes `C[0]..C[11]`,
  oldest to newest; newest is the immediately prior completed month.
- Formula: `r11 = ln(C[11] / C[0])`; positive buys, negative sells, equality or invalid state stays flat.
...
2. Require configured symbol, D1, EA 41483, slot 0, and fixed-risk backtest mode.
...
4. Reconstruct exactly twelve positive finite consecutive completed month-end
   closes with strictly increasing timestamps and no current-month price.
5. Compute `ln(C[11]/C[0])`; buy strict positive and sell strict negative.
...
invalid quote/ATR/stop, or failed persistence. Framework RNG, news, and Friday
inputs remain configurable and are not equality-pinned by the strategy guard.
...
| host, identity, risk, locked strategy values; framework inputs unpinned | No Trade | `Strategy_NoTradeFilter` |
...
fixed-risk paced Q02 enqueue below the CPU ceiling. Forbidden: manual
backtests, optimization, portfolio-gate edits or admission, correlation
waivers, deploy/live manifests, `T_Live`, AutoTrading, terminal control, or live use.

## Pipeline Phase Status

| Phase | Date | Status | Evidence |
|---|---|---|---|
| G0 Source Approval | 2026-09-19 | APPROVED_SOURCE | source decision above |
| G0 Research Intake | 2026-09-19 | APPROVED | G0 decision above |
| Q01 Build Validation | 2026-09-19 | NOT_STARTED | pending deterministic build |
| Q02 Baseline Screening | 2026-09-19 | NOT_ENQUEUED | pending Q01 and capacity check |
