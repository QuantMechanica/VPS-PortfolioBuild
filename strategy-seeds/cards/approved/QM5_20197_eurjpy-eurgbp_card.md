---
strategy_id: AI-CLAUDE-FX-COINT66-20260609-EURJPY-EURGBP
ea_id: QM5_20197
slug: eurjpy-eurgbp
type: strategy
status: APPROVED
...
markets: [forex]
timeframes: [D1]
primary_target_symbols: [EURJPY.DWX, EURGBP.DWX]
target_symbols: [EURJPY.DWX, EURGBP.DWX]
logical_symbol: QM5_20197_EURJPY_EURGBP_COINTEGRATION_D1
period: D1
...
# QM5_20197 EURJPY/EURGBP D1 Cointegration Basket
...
low-frequency daily implementation. Chan makes no claim for EURJPY/EURGBP.
...
EURJPY/EURGBP ranks fifteenth of 66 by OOS net Sharpe. Rank 14 NZDUSD/EURJPY
is already built as `QM5_12723` and has terminal Q02 PASS evidence. Exact-pair
searches found no dedicated fixed-beta EURJPY/EURGBP D1 card, EA, or logical
basket manifest.
...
The sub-0.8 OOS Sharpe and slow half-life are adverse evidence. This card
...
`ln(EURJPY) - (-0.679904414) * ln(EURGBP)`. The negative fitted coefficient
...
Both pairs share EUR as the base and retain GBP, JPY, carry, and European-risk
...
The fixed scan suggests large deviations in the EURJPY/EURGBP residual may
...
`EURJPY.DWX` is the tester host and first traded leg. `EURGBP.DWX` is the
companion traded leg. The three conversion-only histories are selected and
warmed for JPY/GBP P/L and EUR margin under the USD tester account; they
...
- Compute `spread = ln(EURJPY) - strategy_beta * ln(EURGBP)`, with frozen
  `strategy_beta = -0.679904414`.
...
Chan supplies the pair-trading method but reports no EURJPY/EURGBP result.
...
data_requirements: "EURJPY.DWX, EURGBP.DWX, USDJPY.DWX, GBPUSD.DWX, and EURUSD.DWX D1 histories"
```
...
| Q01 Build Validation | 2026-08-01 | PASS | `D:\QM\reports\framework\21\build_check_20260801_164231.json` |
| Q02 Baseline Screening | 2026-08-01 | NOT_QUEUED_CPU_CEILING | seven factory terminals active at `2026-08-01T16:43:30Z` |

## 16. Lessons Captured

- 2026-08-01: Rank 15 is below the original survivor bar; it is admitted only
