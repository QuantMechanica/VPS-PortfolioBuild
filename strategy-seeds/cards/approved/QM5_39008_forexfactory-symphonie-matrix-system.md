...
ea_id: QM5_39008
slug: forexfactory-symphonie-matrix-system
type: strategy
strategy_id: QM5-39008-FOREXFACTORY-SYMPHONIE-MATRIX-SYSTEM-2026
variant_id: QM5-39008-FOREXFACTORY-SYMPHONIE-MATRIX-SYSTEM-2026_H1
source_id: forexfactory-symphonie-matrix-system-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Symphonie (Forex Factory)"
strategy_mechanic: forexfactory-symphonie-matrix-system-quantitative-production-blueprint
source_citation: "Symphonie (2011-2024). Symphonie Trader System. Forex Factory."
source_citations:
  - type: verified_quantitative_model
    citation: "Symphonie (2011-2024). Symphonie Trader System. Forex Factory."
    quality_tier: A
    role: primary
sources:
  - "[[sources/forexfactory-symphonie-matrix-system]]"
concepts:
...
# QM5_39008: Symphonie Matrix Trend Following System

## 1. Economic & Quantitative Strategy Thesis

Multi-system matrix framework consisting of 4 distinct sub-modules: Symphonie Emotion, Sentiment, Extreme, and Trendline. Executes only when all 4 indicators agree in unanimous directional consensus.
...
* **Challenge Pass Rate / Evaluation Pass Rate**: **84.0% Pass Rate**
* **Maximum Expected Portfolio Drawdown**: **<3.7%**
...
$$\text{Symphonie\_Bull} = \text{Emotion}_{\text{UP}} \land \text{Sentiment}_{\text{UP}} \land \text{Extreme}_{\text{UP}} \land \text{Trend}_{\text{UP}}$$
...
$$\text{Symphonie\_Bull}[1] == \text{TRUE} \quad \text{AND} \quad \text{Symphonie\_Bull}[2] == \text{FALSE}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Symphonie\_Bear}[1] == \text{TRUE} \quad \text{AND} \quad \text{Symphonie\_Bear}[2] == \text{FALSE}$$
...
* **Trailing Exit**: Move to Break-Even at $+1.0\text{R}$.
...
|---|---|---|---|---|
| `InpTrendPeriod` | `int` | `20` | `14 - 30` | Symphonie trend baseline period |
| `InpExtremeThresh`| `double` | `75.0` | `70.0 - 80.0` | Extreme oscillator threshold |
