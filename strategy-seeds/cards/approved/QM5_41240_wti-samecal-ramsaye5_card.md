...
type: strategy
strategy_id: KELOHARJU-STATSMODELS-WTI-SAMECAL-RAMSAYE5-2026_S01
variant_id: KELOHARJU-STATSMODELS-WTI-SAMECAL-RAMSAYE5-2026_S01
source_id: KELOHARJU-STATSMODELS-WTI-SAMECAL-RAMSAYE5-2026
ea_id: QM5_41240
slug: wti-samecal-ramsaye5
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41240_wti-samecal-ramsaye5_card.md
execution_contract_status: APPROVED
created: 2026-08-31
created_by: Research+Development
last_updated: 2026-08-31
g0_status: APPROVED
g0_decision: decisions/2026-08-31_qm5_41240_wti_same_calendar_ramsay_e_5_g0.md
source_approval: decisions/2026-08-31_wti_same_calendar_ramsay_e_5_source_approval.md
source_author: "Matti Keloharju; Juhani T. Linnainmaa; Peter Nyberg; Tobias J. Moskowitz; Yao Hua Ooi; Lasse Heje Pedersen; statsmodels developers"
source_authors: "Matti Keloharju; Juhani T. Linnainmaa; Peter Nyberg; Tobias J. Moskowitz; Yao Hua Ooi; Lasse Heje Pedersen; statsmodels developers"
source_citation: "Keloharju, Linnainmaa, and Nyberg (2016), Return Seasonalities, Journal of Finance 71(4), DOI 10.1111/jofi.12398; Moskowitz, Ooi, and Pedersen (2012), Time Series Momentum, Journal of Financial Economics 104(2), DOI 10.1016/j.jfineco.2011.11.003; statsmodels developers, robust.norms.RamsayE official source, version 0.15.0."
source_citations:
  ...
  - type: official_statistical_source
    citation: "statsmodels developers. statsmodels.robust.norms.RamsayE and estimate_location source, version 0.15.0."
    location: "Official complete module rendering reviewed 2026-08-31; retrieval SHA-256 52994832B273BCC5F1F4F890F62E513B815CC46A1E4436367A64547DACBA819D"
    quality_tier: A_method
    role: ramsay_e_default_constant_psi_exponential_weight_median_start_and_location_update
  - type: governed_composite_source
    citation: "QuantMechanica bounded WTI exact-five-year same-calendar fixed-scale Ramsay-E extraction."
    location: "strategy-seeds/sources/KELOHARJU-STATSMODELS-WTI-SAMECAL-RAMSAYE5-2026/source.md"
    quality_tier: internal_governed_complete
    role: exact_calendar_endpoints_median_mad_weight_update_risk_claim_and_lifecycle
strategy_mechanic: exact-prior-five-year-same-calendar-month-wti-log-returns-odd-median-mad-frozen-scale-ramsay-e-exponential-weight-thirty-two-update-location-sign-monthly-renewal
sources:
  - "[[sources/KELOHARJU-STATSMODELS-WTI-SAMECAL-RAMSAYE5-2026]]"
concepts:
...
indicators:
  ...
  - "[[indicators/ramsay-e-weighted-location]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, crude-oil, calendar-seasonality, same-calendar-month, robust-location, ramsay-e-weighting, monthly-renewal, atr-hard-stop, low-frequency, symmetric-long-short]
...
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_RAMSAY_E_CONJUNCTION_AND_SINGLE_CFD_TRANSLATION_RISK
r1_reasoning: "Two complete peer-reviewed trading-paper records support recurring same-calendar commodity information, explicit WTI membership, own-return direction, and monthly renewal. Official statsmodels source fixes the Ramsay-E norm, default constant, exponential weight, median start, and location update. The exact five-return WTI conjunction is an untested QM translation."
r2_mechanical: PASS
r2_reasoning: "Month clock, uniform D1-label normalization, exact Y-5..Y-1 endpoints, five-return requirement, median, MAD, frozen scale, a=0.3, exponential weight, exactly 32 updates, epsilon side map, consumed attempt, fixed risk, hard stop, spread, and lifecycle are deterministic and locked."
...
r4_reasoning: "Only timestamps, completed prices, logarithms, deterministic sorting, absolute deviations, exponentials, finite arithmetic, ATR risk controls, quotes, and execution state; no trained signal, banned signal indicator, or external runtime feed."
parameters_to_test: "Locked Q02 baseline only: exact prior five matching-calendar years; all five mandatory; odd median; raw MAD; frozen 1.4826*MAD scale; median initialization; Ramsay-E a=0.3; exactly 32 exponential-weight updates; strict final sign outside 1e-12; 3000 D1 history bars; ATR(20)*3.5 frozen stop; 40-day stale repair; 1500-point spread ceiling."
...
force_build: true
review_focus: "Falsify a direct-WTI recurring-calendar sleeve outside the certified XAU/SP500/NDX/XNG book. Verify normalized completed endpoints, exact five-year membership, median, MAD, frozen scale, a=0.3, exponential weights, 32 updates, consumed month, fixed risk, frozen stop, and next-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, first_tradable_month_bar, uniform_energy_label_normalization, exact_prior_five_year_same_calendar_months, completed_month_endpoints, no_current_month_price, five_of_five_sample, chronological_return_orientation, odd_median, raw_mad, frozen_rescaled_mad, ramsay_e_a_0_3, exponential_weight, positive_weight, exact_32_updates, strict_sign_epsilon, monthly_attempt_state, risk_mode_dual, hard_stop_present, friday_close_disabled, next_month_exit, cfd_futures_basis, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER mission 2026-08-31 and decisions/2026-08-31_qm5_41240_wti_same_calendar_ramsay_e_5_g0.md: R1 passes with two complete peer-reviewed WTI/commodity lineages and official statsmodels Ramsay-E source, with explicit conjunction/CFD translation risk; R2 locks calendar, endpoints, exact sample, median, MAD, scale, constant, weight, update count, epsilon, side, attempt, risk, stop, spread, and lifecycle; R3 binds the five-year rule to registered WTI D1 history; R4 uses deterministic native arithmetic only. Corrected-root canonical dedup found expected same-calendar robust-location neighbors, and fixed fixtures prove opposite sides from soft-L1, Cauchy, arctangent, median, and raw-mean siblings."
---

# QM5_41240 WTI Same-Calendar Ramsay-E Location
...
strict sign of a five-observation Ramsay-E location for one month.
...
own-return direction, and monthly renewal. Official statsmodels source fixes
Ramsay-E default `a=0.3`, `psi(u)=u*exp(-a*abs(u))`, weight
`exp(-a*abs(u))`, median initialization, and the weighted-location update.

No source tests this single-WTI, five-return, fixed-scale exponential-weight
conjunction or a continuous Darwinex CFD. Raw MAD, 32 fixed updates, epsilon,
ATR stop, spread cap, fixed-dollar risk, attempt state, and lifecycle are
disclosed QM choices. No source performance or correlation result transfers.

The candidate-specific source approval is
`decisions/2026-08-31_wti_same_calendar_ramsay_e_5_source_approval.md`. The
bounded packet is
...
`mu[32] < -1e-12`, and consume the month flat in the inclusive band or on
any invalid arithmetic.
...
found no exact identity across 4,739 registry rows, 1,377 cards, and 45
Strategy Wiki nodes. Expected same-calendar and robust-location fuzzy matches
were manually resolved.

On sorted `[-0.135,-0.010,-0.005,+0.005,+0.050]`, Ramsay-E finishes near
`+0.000567268656` and buys. Otherwise matched soft-L1, Cauchy, and arctangent
paths plus raw mean and median all sell. On a second fixture Ramsay-E sells
while soft-L1, arctangent, raw mean, and median buy. Its exponential
`exp(-0.3*abs(u))` weight changes actual participation rather than renaming a
...
1. Run only on exact `XTIUSD.DWX`, D1, EA `41240`, slot 0, registered magic.
...
6. Compute the formula above with odd median, raw MAD, frozen
   `1.4826*MAD`, median start, `a=0.3`, and exactly 32 updates. Any
   nonpositive scale or zero/nonfinite weight, sum, or location consumes the
   month flat.
...
| `strategy_ramsay_a` | 0.3 | official Ramsay-E default attenuation |
...
No lookback, scale, constant, update, threshold, side, stop, hold, spread, or
...
| median, MAD, frozen scale and 32 Ramsay-E updates | trade_entry | deterministic native arithmetic |
...
- R1: `PASS_WITH_RAMSAY_E_CONJUNCTION_AND_SINGLE_CFD_TRANSLATION_RISK`.
...
exact years, incorrect return orientation, median, MAD, scale, constant,
exponential weight, update count, epsilon, wrong sign, fewer than five
positions in any full post-warm-up scored year, nonpositive governed
economics, repeated attempts, missing stop, wrong lifecycle, invalid fixed
risk, or nondeterminism. No post-result change to the sample, estimator,
...
|---|---|---|---|---|
| v1 | 2026-08-31 | initial WTI same-calendar Ramsay-E location card | G0 | APPROVED; build pending |

## Approvals

| Gate | Date | Verdict | Evidence |
|---|---|---|---|
| Source Approval | 2026-08-31 | APPROVED_SOURCE | `decisions/2026-08-31_wti_same_calendar_ramsay_e_5_source_approval.md` |
| G0 Research Intake | 2026-08-31 | APPROVED | `decisions/2026-08-31_qm5_41240_wti_same_calendar_ramsay_e_5_g0.md` |
