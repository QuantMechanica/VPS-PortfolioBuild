...
type: strategy
strategy_id: HOLLSTEIN-VOV-2021_XNG_TS_S04
variant_id: HOLLSTEIN-VOV-2021_XNG_TS_S04
source_id: HOLLSTEIN-XNG-VOV-REGIME-2026
ea_id: QM5_20299
slug: xng-vov-regime
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_20299_xng-vov-regime_card.md
...
source_citations:
  - type: peer_reviewed_trading_paper
    ...
    location: "DOI https://doi.org/10.1142/S2010139221500178; complete-paper evidence strategy-seeds/sources/HOLLSTEIN-VOV-2021/source.md; bounded extraction strategy-seeds/sources/HOLLSTEIN-XNG-VOV-REGIME-2026/source.md"
    quality_tier: A
    role: primary_vov_formula_low_minus_high_direction_and_monthly_cadence
strategy_mechanic: monthly-xng-two-disjoint-252-by-20d-realized-volatility-of-volatility-blocks-self-relative-low-minus-high-regime
sources:
  - "[[sources/HOLLSTEIN-XNG-VOV-REGIME-2026]]"
concepts:
...
indicators:
  ...
  - "[[indicators/atr]]"
strategy_type_flags: [commodity, energy, natural-gas, structural-uncertainty-premium, realized-volatility-of-volatility, self-relative-regime, monthly-rebalance, atr-hard-stop, time-stop, symmetric-long-short, low-frequency]
...
period: D1
timeframe: D1
expected_trade_frequency: "Approximately eleven to twelve completed monthly XNG positions/year after 543 completed D1 closes; Q02 must prove at least five/year or retire."
...
g0_approval_reasoning: "APPROVED under decisions/2026-08-13_qm5_20299_xng_vov_regime_g0.md: R1 tier-A peer-reviewed complete-read source with exact VoV transform, robust negative direction, and natural-gas membership; R2 locked 20-return/252-sample nested estimator over offsets 0 and 271, self-relative low-minus-high direction, consumed month, stop, rollover, and stale guard; R3 registered XNG D1 route; R4 deterministic native arithmetic. No exact identity across 4,364 registry rows and 475 cards; ten expected source-family fuzzy neighbors were manually resolved. Implied-to-realized and cross-sectional-to-time-series transfers plus the parent energy carrier's Q08 failure are explicit kill risks."
---
...
Uncertainty about XNG risk can itself vary in slow regimes as production,
inventory, transport, refining, hedging, policy, and demand conditions change.
If the source's low-VoV premium has a price-native time-series analogue, XNG
...
The certified XAU/SP500/NDX/XNG book already contains natural gas, but its XNG
sleeve is a short-horizon, long-only cumulative-RSI pullback. This candidate's
symmetric monthly uncertainty state is mechanically different; that does not
prove decorrelation, profitability, or portfolio suitability. Q02 owns density
and economics, while unchanged later gates, especially Q09, own robustness and
realized book overlap.

## Source Traceability And Claim Boundary

The source of record is the bounded packet
`strategy-seeds/sources/HOLLSTEIN-XNG-VOV-REGIME-2026/source.md`. Its governed
...
in a two-portfolio robustness split, renews monthly, and includes natural gas.

The source does not test realized VoV, two own-history blocks, an outright XNG
...
material translations. No source return, alpha, significance, XNG-only
...
The canonical pre-allocation checker scanned 4,364 registry rows and 475 root
cards. It found no exact identity and returned ten expected lexical/source-
family fuzzy matches. Manual review separates them:

- `QM5_13146_energy-vov` ranks concurrent XTI against XNG VoV and manages a
  two-leg package; this candidate compares two disjoint XNG history blocks and
  manages one outright leg.
- `QM5_20236_xauxag-vov-rank` is a paired precious-metal carrier.
- `QM5_20298_wti-vov-regime` preserves the exact estimator, disjoint offsets,
  direction, and lifecycle on WTI. This card is a separately authorized XNG
  carrier with its own history, contract economics, spread guard, magic, and
  Q02 verdict; it inherits no WTI result.
...
- `QM5_20297_xng-kurt-prem` uses a centered fourth return moment around three,
...
- `QM5_20296_xng-skew-prem` uses a centered third standardized moment around
  zero and has neither rolling realized-volatility estimates nor VoV.
- XNG trend, location, calendar, event, variance-ratio, breakout, and reversal
...
self-relative low-minus-high direction, outright XNG topology, and consumed
...
- Exact host/traded symbol: `XNGUSD.DWX`, D1, slot 0, intended magic
  `202990000`.
...
1. Require EA ID 20299, exact `XNGUSD.DWX` D1 host, slot 0, and every locked
   input.
...
8. Require spread in `[0,2500]` points, executable quote, completed
...
high-minus-low commodity relation, use monthly renewal, and include natural gas. They
do not claim that realized VoV, this two-block XNG rule, a continuous CFD, or
...
states, XNG gaps and rolls, CFD basis and financing, two-year warm-up, hard-
stop slippage, and correlation with the incumbent XNG sleeve or risk assets can dominate the
...
|---|---|---|
| R1 | PASS | Tier-A peer-reviewed source with DOI, institutional complete-read record, exact transform, robustness caveats, and natural-gas membership. |
| R2 | PASS | Fixed nested estimator, disjoint blocks, direction, attempt, stop, rollover, and stale guard. |
| R3 | PASS | Registered `XNGUSD.DWX` D1 and native V5 execution state suffice for the disclosed proxy. |
