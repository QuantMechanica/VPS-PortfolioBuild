...
type: strategy
strategy_id: QM5-37008-GARCH-VOLATILITY-FORECAST-BREAKOUT-2026
variant_id: QM5-37008-GARCH-VOLATILITY-FORECAST-BREAKOUT-2026_D1
source_id: garch-volatility-forecast-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Robert Engle / Python Econometrics Desk"
strategy_mechanic: garch-volatility-forecast-breakout-quantitative-production-blueprint
source_citation: "Engle, R. (1982). Autoregressive Conditional Heteroskedasticity. Python Arch Library."
source_citations:
  - type: verified_quantitative_model
    citation: "Engle, R. (1982). Autoregressive Conditional Heteroskedasticity. Python Arch Library."
    quality_tier: A
    role: primary
sources:
  - "[[sources/garch-volatility-forecast-breakout]]"
concepts:
...
# QM5_37008: GARCH(1,1) Volatility Forecast Breakout Engine

## 1. Economic & Quantitative Strategy Thesis

Uses a rolling Generalized Autoregressive Conditional Heteroskedasticity (GARCH 1,1) econometric model to forecast next-day volatility $\sigma_{t+1}^2$. Breakouts exceeding the dynamic GARCH cone trigger high-momentum trend entries.
...
$$\sigma_{t+1}^2 = \omega + \alpha \epsilon_t^2 + \beta \sigma_t^2, \quad \text{Cone} = \text{Open}_t \pm 1.50 \times \sigma_{t+1}$$
...
$$\text{Close}[1] > \text{Open}[1] + 1.50 \times \sigma_{t+1} \quad \text{AND} \quad \text{Close}[1] > \text{SMA}(50, \text{D1})[1]$$
...
* **Stop Loss (SL)**: Set at entry $\mp 1.0 \times \sigma_{t+1}$.
* **Trailing Stop**: Ratchet with 1-sigma GARCH cone.
...
|---|---|---|---|---|
| `InpOmega` | `double` | `0.00001`| `0.000001 - 0.0001` | GARCH constant variance parameter |
| `InpAlpha` | `double` | `0.08` | `0.04 - 0.15` | ARCH shock persistence parameter |
| `InpBeta` | `double` | `0.90` | `0.80 - 0.95` | GARCH lagged variance persistence parameter |
