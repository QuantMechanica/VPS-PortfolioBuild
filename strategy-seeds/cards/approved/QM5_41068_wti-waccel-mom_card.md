...
type: strategy
strategy_id: MOP-WTI-WACCEL-MOM-2026_S01
variant_id: MOP-WTI-WACCEL-MOM-2026_S01
source_id: MOP-WTI-WACCEL-MOM-2026
ea_id: QM5_41068
slug: wti-waccel-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41068_wti-waccel-mom_card.md
execution_contract_status: APPROVED
created: 2026-08-20
created_by: Research+Development
last_updated: 2026-08-20
g0_status: APPROVED
g0_decision: decisions/2026-08-20_qm5_41068_wti_weekly_acceleration_momentum_g0.md
source_approval: decisions/2026-08-20_wti_weekly_acceleration_momentum_source_approval.md
...
source_citations:
  - type: academic_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; Sections 3.1-3.2; Appendix A; complete-read packet strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded translation strategy-seeds/sources/MOP-WTI-WACCEL-MOM-2026/source.md"
    quality_tier: A
    role: own_return_sign_continuation_and_wti_carrier_lineage
strategy_mechanic: normalized-week-boundary-wti-two-adjacent-nonoverlapping-week-returns-same-strict-sign-newest-absolute-return-strictly-larger-newest-sign-continuation-one-week-hold
sources:
  - "[[sources/MOP-WTI-WACCEL-MOM-2026]]"
concepts:
  - "[[concepts/time-series-momentum]]"
  - "[[concepts/weekly-trend-acceleration]]"
  - "[[concepts/wti-structural-trend]]"
indicators:
  - "[[indicators/adjacent-completed-week-log-returns]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, wti-crude, time-series-momentum, weekly-return-acceleration, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
period: D1
timeframe: D1
expected_trade_frequency: "Approximately 8-18 completed WTI positions per full post-warm-up year after strict same-sign weekly acceleration and execution gates; Q02 must prove at least five/year or retire."
...
q01_build_report: D:/QM/reports/framework/21/build_check_20260820_124830.json
q01_p1_evidence: D:/QM/reports/pipeline/QM5_41068/P1/P1_QM5_41068_result.json
review_focus: "Falsify a direct-WTI weekly acceleration sleeve outside the certified XAU/SP500/NDX/XNG book. Verify uniform energy labels, exact Monday anchors, three completed week-end closes, two disjoint weekly returns, strict common sign, strict newest-magnitude acceleration, newest-sign direction, one attempt, and next-week exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_symbol_period, normalized_energy_label, first_tradable_week_bar, consecutive_monday_anchors, completed_week_endpoints, strict_same_sign, strict_newest_magnitude_acceleration, newest_sign_direction, no_current_week_leakage, weekly_attempt_state, risk_mode_dual, hard_stop_present, next_week_exit, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER-authorized build; R1 named-author peer-reviewed source with complete-read evidence and weekly acceleration translation risk disclosed; R2 exact clock, anchors, endpoints, sign and magnitude state, side, attempt, risk, and lifecycle; R3 registered native WTI D1 only; R4 deterministic arithmetic without banned signal or trained logic; canonical dedup CLEAN and manual family review separated all neighboring weekly identities."
---

# QM5_41068 WTI Completed-Week Acceleration Momentum

## Hypothesis

Two consecutive completed WTI weekly returns with the same sign and a
strictly larger newest absolute move may identify a strengthening
short-horizon trend state. On the first tradable bar of a broker week, the
...
this weekly horizon, acceleration state, standalone CFD result, or portfolio
...
`strategy-seeds/sources/MOP-WTI-WACCEL-MOM-2026/source.md`, approved before
card extraction in
`decisions/2026-08-20_wti_weekly_acceleration_momentum_source_approval.md` at
commit `b6c50e85f`.
...
test weekly WTI, two adjacent same-sign weeks, an absolute-return acceleration
...
- `QM5_41065_wti-wflip-mom` requires opposite signs and follows a fresh sign
  handoff; this card rejects every opposed-sign pair and requires same-sign
  acceleration.
- `QM5_13049_xti-1w-mom-vol` thresholds one five-D1 return under a realized-
  volatility-rank cap; this card uses two full broker weeks and no threshold,
  volatility estimate, or rank.
- `QM5_21503_xti-weekly-tsmom-lowvol` follows one completed week under a
  lower-tercile volatility state; this card consumes no volatility field and
  requires two same-sign weekly returns with a strict magnitude relation.
- `QM5_41022_wti-wdual-mom` requires agreement between opening and closing
  segments inside one week; this card uses only full close-to-close weeks.
- `QM5_41061_wti-week-nr7-brk` follows a breakout after seven-week range
  contraction; this card uses no high, low, range, rank, or breakout.
...
- Timeframe: exact D1; magic slot 0; magic `410680000`.
...
- Signal: both returns share a strict sign and the newest absolute return is
  strictly larger; direction equals that sign.
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41068 and
   magic slot zero.
...
8. Compute the two log returns. BUY only when both are strictly positive and
   the newest absolute return is strictly larger. SELL only when both are
   strictly negative and the newest absolute return is strictly larger.
   Opposed signs, zero, equality, or non-acceleration stay flat.
...
- Exact host, D1, EA 41068, slot zero, and registered magic.
...
- Own at most one `XTIUSD.DWX` position under magic `410680000`.
...
membership. They do not supply the weekly horizon, same-sign acceleration
condition, or CFD execution choices.

## QM Interpretations

`MOP-WTI-WACCEL-MOM-2026_S01` fixes the weekly horizon, strict same-sign
acceleration gate, continuous-CFD Monday anchors and week-end closes, label
...
- Major risks are exhaustion after accelerating WTI weeks, weekend gaps,
...
opposed-sign or non-accelerating entry, wrong side, current-week leakage, late
...
signs, equality, or deceleration, reversing the side, adding a return
...
acceleration directions; opposed-sign, equality, zero, and non-acceleration
...
|---|---|---|---|---|
| v1 | 2026-08-20 | initial WTI completed-week acceleration-momentum card | G0 | APPROVED |
...
|---|---|---|---|
| G0 Research Intake | 2026-08-20 | APPROVED | `decisions/2026-08-20_qm5_41068_wti_weekly_acceleration_momentum_g0.md` |
| Q01 Build Validation | 2026-08-20 | PASS | `D:/QM/reports/framework/21/build_check_20260820_124830.json`; `D:/QM/reports/pipeline/QM5_41068/P1/P1_QM5_41068_result.json` |
| Q02 Baseline Screening | 2026-08-20 | ENQUEUED_PENDING_CPU_CEILING | pending work item `747954ed-a571-47a7-a56e-b222c949c483`; `docs/ops/evidence/2026-08-20_qm5_41068_wti_week_acceleration_q01_q02_cpu_ceiling_stop.md` |
