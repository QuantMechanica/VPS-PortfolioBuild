...
type: strategy
strategy_id: QM5-35007-INSIDE-BAR-MOMENTUM-BREAKOUT-SYSTEM-2026
variant_id: QM5-35007-INSIDE-BAR-MOMENTUM-BREAKOUT-SYSTEM-2026_H4
source_id: inside-bar-momentum-breakout-system-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
...
source_citations:
  - type: verified_quantitative_model
    ...
    role: primary
sources:
  - "[[sources/inside-bar-momentum-breakout-system]]"
concepts:
...
# QM5_35007: Inside Bar Momentum Breakout System (Robopip)

## 1. Economic & Quantitative Strategy Thesis

Inside bars represent extreme price compression. Placing pending stop orders beyond the Mother Bar's high and low captures the subsequent momentum explosion with tight risk.
...
$$\text{Inside\_Bar}: \text{High}[1] < \text{High}[2] \quad \text{AND} \quad \text{Low}[1] > \text{Low}[2]$$
$$\text{Mother\_Range} = \text{High}[2] - \text{Low}[2]$$
...
|---|---|---|---|---|
| `InpBufferPips` | `double` | `2.0` | `1.0 - 5.0` | Entry buffer beyond mother bar high/low |
| `InpSLRatio` | `double` | `0.20` | `0.15 - 0.35` | Stop loss distance as ratio of mother range |
