...
type: strategy
strategy_id: BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913_S01
variant_id: BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913_S01
source_id: BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913
ea_id: QM5_41463
slug: wti-winter-hclv-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41463_wti-winter-hclv-cont.md
execution_contract_status: APPROVED
created: 2026-09-13
created_by: Research+Development
last_updated: 2026-09-13
g0_status: APPROVED
g0_decision: decisions/2026-09-13_qm5_41463_wti_winter_upper_clv_continuation_g0.md
source_approval: decisions/2026-09-13_wti_winter_upper_clv_continuation_source_approval.md
...
source_citations:
  - type: peer_reviewed_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913/source.md
    quality_tier: A_and_B_and_governed_reputable_lineages_with_translation_risk
    role: november_may_calendar_upper_tercile_weekly_close_continuation_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-one-completed-week-upper-tercile-close-location-long-only-continuation-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913]]"]
...
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, upper-tercile-close-location, long-only, weekly-continuation, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 11,12,1,2,3,4,5; exactly the immediately completed week with 3-5 sessions; CLV strictly above two thirds; long only; 20 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
pipeline_phase: Q02
q01_status: PASS
q01_compile_work_item: cb0cdcec-952d-458e-8ecc-02b3376538ad
q01_build_report: D:/QM/reports/work_items/cb0cdcec-952d-458e-8ecc-02b3376538ad/QM5_41463/COMPILE_EA/compile_evidence.json
q02_status: ENQUEUED
q02_work_item: 808bf133-94f2-4aaf-8edf-f0cbbae9840f
q02_receipt: D:/QM/strategy_farm/artifacts/receipts/first_q02_intake/cb0cdcec-952d-458e-8ecc-02b3376538ad_808bf133-94f2-4aaf-8edf-f0cbbae9840f.json
force_build: true
review_focus: "Falsify a WTI November-May upper-tercile weekly-close continuation distinct from the certified XNG oscillator, monthly WTI winter sign rules, and two-week range-state variants. Verify exact completed week, strict CLV inequality, no range/body predicates, long-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, immediately_completed_week, bounded_week_sessions, strict_upper_tercile_close_location, no_range_rank, no_body_sign_gate, long_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineage with explicit translation risk; R2 exact mechanical WTI winter upper-tercile weekly-close long continuation; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact repository duplicate after canonical and manual family review."
---

# QM5_41463 WTI Winter Upper-Tercile Weekly-Close Continuation

## Hypothesis

During the documented November-through-May positive WTI return leg, a
completed week settling in the upper third of its full range may identify
price discovery that persists over the next normalized broker week. Buy at
...
packet supplies completed-week and close-location lineage; Moskowitz et al.
supply commodity-continuation lineage. None establishes this conjunction.

The canonical scan found no exact identity or fuzzy repository match; its
external Wiki root was unavailable and is recorded rather than treated as a
pass. `QM5_41440` and `QM5_41447` require two completed weeks and opposite
strict range comparisons. This card requires one completed week, no range
ranking, no body direction, and only a strict upper-tercile settlement.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41463, slot zero,
...
6. Buy only when `CLV > strategy_clv_cutoff`, locked to two thirds. Equality
   or a lower close is flat. There is no short side, range-rank test, or
...
Burakov et al. supply the November-May positive WTI leg. Moskowitz et al.
supply broad commodity continuation. The governed Crabel record supplies
...
| Q01 Build Validation | 2026-09-13 | PASS | compile `cb0cdcec-952d-458e-8ecc-02b3376538ad`; `COMPILE_OK`; 0 compiler errors/warnings; strict build check PASS; 10 reference tests; PACER audit zero hits |
| Q02 Baseline Screening | 2026-09-13 | ENQUEUED | exactly one fixed-risk `XTIUSD.DWX` D1 canary `808bf133-94f2-4aaf-8edf-f0cbbae9840f`; CPU maximum 82.0% immediately before successful intake; result not awaited |
