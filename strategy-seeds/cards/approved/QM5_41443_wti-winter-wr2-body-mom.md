...
type: strategy
strategy_id: BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911_S01
variant_id: BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911_S01
source_id: BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911
ea_id: QM5_41443
slug: wti-winter-wr2-body-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41443_wti-winter-wr2-body-mom.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41443_wti_winter_wr2_body_momentum_g0.md
source_approval: decisions/2026-09-11_wti_winter_wr2_body_momentum_source_approval.md
...
source_citations:
  - type: peer_reviewed_and_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911/source.md
    quality_tier: B_and_A_and_governed_reputable_lineages_with_translation_risk
    role: november_may_calendar_range_expansion_and_body_continuation_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-two-completed-weeks-newest-strict-wider-range-than-prior-own-body-sign-symmetric-continuation-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911]]"]
...
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, weekly-range-expansion, body-sign, symmetric-long-short, weekly-continuation, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 11,12,1,2,3,4,5; two immediately completed consecutive weeks with 3-5 sessions each; newest range strictly greater than prior; newest body close strictly above open buys and strictly below open sells; body equality is flat; 30 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
q02_status: ENQUEUED
q02_work_item: 5b5fb49e-94a7-45b9-a49e-34610df50261
force_build: true
...
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_expansion, strict_own_body_sign, continuation_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineages with explicit translation risk; R2 exact mechanical WTI winter WR2/body symmetric continuation; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
During the documented November-through-May WTI winter regime, an expanding completed week may
carry information about continuing repricing. Follow the newest completed week's own open-to-close
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911/source.md`.
...
The canonical scan found no exact match. `QM5_41440` buys only an upper-quartile close and ignores
body sign. `QM5_41441` requires contraction and a later completed-current-week close breakout.
`QM5_41442` fades outer-quartile settlement. `QM5_41087` requires the widest of four weeks and a
matching outer-quartile close all year. Certified `QM5_12567` is a two-day cumulative-RSI XNG
pullback. The new identity requires WTI, the full November-May clock, two-week range expansion,
the newest week's own body sign, symmetric continuation, and a one-week hold.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41443, slot zero, registered magic, and
...
late restart, consumed week, ineligible month, malformed packages, nonexpanding range, zero body,
...
Changing the calendar, formation, strict range rank, body-sign orientation, carrier, stop,
...
Monday anchors, two completed weeks, strict range expansion, weekly body mapping, boundary entry,
...
range expansion, range tie, positive, negative, and zero body states, both continuation sides,
...
| Q02 Baseline Screening | 5b5fb49e-94a7-45b9-a49e-34610df50261 | ENQUEUED | Fixed-risk XTIUSD.DWX D1 canary; fresh CPU window admitted below 97% |
