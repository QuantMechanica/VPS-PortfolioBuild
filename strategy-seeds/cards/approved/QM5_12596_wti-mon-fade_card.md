...
g0_approval_reasoning: "R1 PASS peer-reviewed crude-oil seasonality source; R2 PASS deterministic Monday D1 short/next-bar flat rule with ATR stop; R3 PASS XTIUSD.DWX available; R4 PASS no ML/grid/martingale/external data."
expected_pf: 1.1
