...
type: strategy
strategy_id: BURAKOV-CRABEL-WTI-WINTER-NR2-BREAKOUT-20260911_S01
variant_id: BURAKOV-CRABEL-WTI-WINTER-NR2-BREAKOUT-20260911_S01
...
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41441_wti_winter_nr2_breakout_g0.md
source_approval: decisions/2026-09-11_wti_winter_nr2_breakout_source_approval.md
source_author: "Dmitry Burakov; Max Freidin; Yuriy Solovyev; Toby Crabel; OpenAI Codex"
source_authors: "Dmitry Burakov; Max Freidin; Yuriy Solovyev; Toby Crabel; OpenAI Codex"
source_citation: "Burakov, Freidin and Solovyev (2018), The Halloween Effect on Energy Markets; Crabel systematic range-state lineage."
source_citations:
  - type: peer_reviewed_and_reputable_bounded_mechanization
    citation: "Peer-reviewed WTI November-May seasonality plus governed Crabel range-state lineage."
    location: strategy-seeds/sources/BURAKOV-CRABEL-WTI-WINTER-NR2-BREAKOUT-20260911/source.md
    quality_tier: B_and_governed_reputable_lineages_with_cross_source_and_horizon_translation_risk
    role: winter_calendar_contraction_and_completed_close_breakout_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-two-completed-weeks-newest-strict-narrower-range-than-prior-next-week-completed-d1-close-breakout-symmetric-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-WTI-WINTER-NR2-BREAKOUT-20260911]]"]
concepts: ["[[concepts/wti-winter-seasonality]]", "[[concepts/completed-week-volatility-contraction]]", "[[concepts/completed-close-breakout]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-d1-close]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, weekly-contraction, completed-close-breakout, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_contraction, frozen_breakout_box, completed_current_week_close_only, strict_breakout_inequality, weekly_attempt_after_signal, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed/governed reputable lineage with explicit cross-source and horizon translation risk; R2 exact mechanical seasonal NR2/completed-close breakout; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
During November through May, a completed WTI week whose full range contracts relative
to the preceding week may form a structural reference box before renewed seasonal repricing.
...
`strategy-seeds/sources/BURAKOV-CRABEL-WTI-WINTER-NR2-BREAKOUT-20260911/source.md`. Burakov,
Freidin, and Solovyev support the November-May WTI calendar; governed Crabel work supplies range-
contraction/expansion lineage. Neither establishes this Darwinex CFD conjunction.

The canonical scan found no exact match. `QM5_41439` uses the same chronology on XNG and only in
November-March. `QM5_41437` is the WTI August-October hurricane carrier. `QM5_41440` uses WTI in
November-May but requires range expansion and an immediate upper-quartile long signal. Certified
`QM5_12567` is a long-only two-day cumulative-RSI XNG pullback. This card requires WTI, two-week
relative contraction, no containment, the full November-May interval, and a strict later
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41441, slot zero, registered magic, and
   fixed-risk backtest mode.
2. Evaluate only on a new D1 bar and only inside a normalized Monday-anchored week whose anchor
   month is November, December, January, February, March, April, or May. Require entry within 180 elapsed
   minutes of that bar.
...
Burakov, Freidin, and Solovyev supply the WTI November-May interval. Governed Crabel records
supply range-contraction and expansion lineage. They do not supply this exact conjunction or its
thresholds.

## QM Interpretations

November-May Monday anchors, two completed weeks, strict two-week range comparison, no
...
history, ATR, and terminal-global attempt state only. No weather, inventory, curve, volume, open-
interest, file, API, optimizer, trained output, or portfolio state.

## Risk

Backtest only: `RISK_FIXED=1000`, `RISK_PERCENT=0`, `PORTFOLIO_WEIGHT=1`. WTI gaps,
roll/basis, financing, label sensitivity, sparse seasonal samples, delayed confirmation, false
breakout, stop slippage, source translation, and overlap with other WTI candidates can dominate.
