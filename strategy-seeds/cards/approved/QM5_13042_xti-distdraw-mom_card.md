...
This is not `QM5_13039_xti-gasdraw-mom`: that sleeve is May-August gasoline
stock pressure. This card is October-March distillate/heating-season pressure.
It is not `QM5_12583_eia-distillate-winter` or `QM5_12748_eia-distill-pb`,
which are broad seasonal channel-breakout/pullback builds without a weekly WPSR
reaction-window gate. It is not crude inventory momentum, product-supplied
breakout, refinery, Cushing, DPR, SPR, import/export, COT, rig-count, OPEC,
IEA/STEO, expiry/roll, XAU/XAG, XNG RSI, or index logic.
...
- R1 PASS: single official EIA source family for WPSR distillate stocks and
  heating-oil/distillate context.
