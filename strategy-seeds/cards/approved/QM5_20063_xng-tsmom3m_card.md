---
strategy_id: MOP-TSMOM-2012_XNG_S07
...
pipeline_phase: Q02
review_focus: "Adds medium-horizon natural-gas trend exposure to the XAU/SP500/NDX/XNG book; unlike QM5_12567 it does not buy short-horizon RSI pullbacks. Q09 must still falsify realized correlation."
g0_approval_reasoning: "APPROVED under the 2026-07-23 OWNER commodity-sleeve mission: peer-reviewed JFE commodity-futures lineage; deterministic monthly three-month return sign; registered XNG D1 carrier and twelve packages/year; no ML, banned indicator, external feed, grid, or martingale."
---

# Natural Gas Three-Month Time-Series Momentum
...
tests the sign of natural gas's completed three-month return as a monthly
...
`QM5_12804` and the MOP source's earlier gas card use 12-month momentum plus an
ATR/price volatility corridor. This card uses a pure 63-D1-bar return sign with
no volatility-regime filter. Weekly momentum, reversal, storage, seasonality,
calendar, and cross-market gas EAs have different clocks and triggers.

## Markets And Timeframe

- `XNGUSD.DWX`, D1, magic slot 0 only.
...
- [x] R3: registered `XNGUSD.DWX` D1 carrier.
...
- trade_entry: monthly sign of completed 63-D1-bar log return.
...
|---|---|---|---|---|
| v1 | 2026-07-23 | initial source-backed three-month XNG trend build | Q02 | ENQUEUED |
...
| Q01 Build Validation | 2026-07-23 | PASS: strict compile and build check, 0 errors/0 warnings | `docs/ops/evidence/2026-07-23_qm5_20063_xng_tsmom3m_q02_enqueue.md` |
| Q02 Baseline Screening | 2026-07-23 | pending, unclaimed | work item `97aa3634-e22c-458e-8c75-e96e45383445` |
