...
type: strategy
strategy_id: AI-CODEX-XAUXAG-MWINSOR2-RV-20260905_S01
variant_id: AI-CODEX-XAUXAG-MWINSOR2-RV-20260905_S01
source_id: AI-CODEX-XAUXAG-MWINSOR2-RV-20260905
ea_id: QM5_41356
slug: xauxag-mwinsor2-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41356_xauxag-mwinsor2-rv_card.md
execution_contract_status: APPROVED
created: 2026-09-05
created_by: Research+Development
last_updated: 2026-09-05
g0_status: APPROVED
g0_decision: decisions/2026-09-05_qm5_41356_xauxag_monthly_winsor2_reversion_g0.md
source_approval: decisions/2026-09-05_xauxag_monthly_winsor2_reversion_source_approval.md
...
source_citations:
  - type: governed_composite_source
    citation: "OpenAI Codex (2026). XAU/XAG monthly fixed-tail Winsor ratio-return reversion."
    location: strategy-seeds/sources/AI-CODEX-XAUXAG-MWINSOR2-RV-20260905/source.md
...
strategy_mechanic: monthly-xauxag-thirteen-synchronized-completed-month-log-ratio-endpoints-twelve-adjacent-returns-fixed-two-per-tail-winsorized-mean-sign-contrarian-equal-notional-basket
sources:
  - "[[sources/AI-CODEX-XAUXAG-MWINSOR2-RV-20260905]]"
concepts:
...
strategy_type_flags: [commodity, precious-metals, market-neutral-style, relative-value, structural-reversion, fixed-tail-winsorized-mean, monthly-renewal, equal-notional-basket, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41356_XAU_XAG_MWINSOR2_RV_D1
symbol: QM5_41356_XAU_XAG_MWINSOR2_RV_D1
...
r1_reasoning: "Peer-reviewed state-dependent gold/silver relationship, exchange-defined spread, and governed fixed-tail Winsor arithmetic; no source efficacy transfers to this conjunction or CFDs."
r2_mechanical: PASS
...
g0_approval_reasoning: "OWNER mission 2026-09-05 and decisions/2026-09-05_qm5_41356_xauxag_monthly_winsor2_reversion_g0.md: R1-R4 pass within disclosed synthesis and continuous-CFD risks. Corrected-root dedup found no exact identity across 4,836 registry rows, 1,449 cards, and 45 Wiki nodes; eight fuzzy family matches were manually resolved. A fixed twelve-return fixture makes the Winsorized mean buy while the trimmed-mean sibling sells. This identity decision is not a correlation claim."
---
...
that the two-per-tail Winsorized location of twelve synchronized monthly
...
`strategy-seeds/sources/AI-CODEX-XAUXAG-MWINSOR2-RV-20260905/source.md`.
Schweikert supplies relationship evidence, CME supplies spread construction,
and the governed fixed-tail Winsor packet supplies arithmetic. No source tests this
conjunction, direction, constants, CFDs, costs, or portfolio correlation.

## Non-Duplicate Decision

The corrected-root receipt found no exact identity. The exact fixed-tail
Winsorization is not a z-score, regression residual, distribution-shift test,
tail deletion, or iterative robust M-estimator. The declared fixture makes
this estimator negative while the nearest trimmed estimator is positive,
causing opposed pair sides. This is a distinct mechanic, not a parameter
rename.

## Markets, Timeframe, And Cadence

- Logical symbol: `QM5_41356_XAU_XAG_MWINSOR2_RV_D1`.
...
If `w > +1e-12`, sell XAU and buy XAG. If `w < -1e-12`, buy XAU and
...
|---|---|---|---|---|
| v1 | 2026-09-05 | initial fixed-tail Winsor XAU/XAG reversion card | G0 | APPROVED; build pending |
