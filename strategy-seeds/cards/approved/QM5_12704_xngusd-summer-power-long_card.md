...
U.S. Energy Information Administration, "Natural gas consumption, production respond to seasonal changes", Today in Energy, 2015-09-24, URL https://www.eia.gov/todayinenergy/detail.php?id=22892.
...
This is deliberately different from `QM5_12567_cum-rsi2-commodity` because it uses no RSI, oscillator, or short-horizon pullback logic. It is summer-only and long-only, not the broader `QM5_12575` winter/summer/shoulder calendar map, not `QM5_12588` compression-breakout summer squeeze, and not an XNG storage/event/fade/weekend-gap or energy-ratio basket.
