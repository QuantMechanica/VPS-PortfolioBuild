...
type: strategy
strategy_id: EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911_S01
variant_id: EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911_S01
source_id: EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911
ea_id: QM5_41435
slug: wti-hurr-wr2-clv-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41435_wti-hurr-wr2-clv-fade_card.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41435_wti_hurricane_wr2_clv_reversion_g0.md
source_approval: decisions/2026-09-11_wti_hurricane_wr2_clv_reversion_source_approval.md
source_author: "U.S. Energy Information Administration; Toby Crabel; Cheng Yang; Aydin Goncu; Athanasios A. Pantelous; OpenAI Codex"
source_authors: "U.S. Energy Information Administration; Toby Crabel; Cheng Yang; Aydin Goncu; Athanasios A. Pantelous; OpenAI Codex"
source_citation: "EIA hurricane-season petroleum-supply context; governed Crabel range-state lineage; Yang, Goncu and Pantelous (2017), Momentum and Reversal in Commodity Futures, SSRN 3069253."
source_citations:
  - type: official_government_reputable_and_academic_bounded_mechanization
    citation: "EIA hurricane-season context plus governed Crabel range-state and Yang-Goncu-Pantelous commodity-reversal lineage."
    location: strategy-seeds/sources/EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911/source.md
    quality_tier: A_lineages_with_cross_source_and_horizon_translation_risk
    role: hurricane_calendar_range_expansion_and_directional_reversal_lineage
strategy_mechanic: normalized-weekly-wti-august-september-october-hurricane-season-two-completed-weeks-newest-strict-wider-range-than-prior-upper-quartile-close-short-reversion-one-week-hold
sources: ["[[sources/EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911]]"]
concepts: ["[[concepts/hurricane-season-supply-risk]]", "[[concepts/completed-week-range-expansion]]", "[[concepts/commodity-reversal]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-week-close-location]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, hurricane-season, weekly-range-expansion, close-location, short-only, weekly-reversion, atr-hard-stop, time-stop, low-frequency]
...
force_build: true
review_focus: "Falsify a WTI hurricane-season weekly range-expansion/upper-quartile reversion distinct from the opposite-side WR2 continuation, positive-return hurricane fade, and D1 failed-spike fade. Verify two exact weeks, strict range and CLV inequalities, short-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, hurricane_season_month_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_expansion, strict_upper_quartile_close, short_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete official/governed/academic lineage with explicit translation risk; R2 exact mechanical seasonal WR2/CLV short reversion; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after fuzzy-family review."
---
...
During August through October, a WTI week that expands beyond the preceding week's range and
settles in its own upper quartile may represent an overextended hurricane supply-risk premium.
Sell at the next normalized week boundary and hold for one week. The exact rule is unproven and
belongs to Q02 onward.

## Source Traceability And Non-Duplicate Decision

The source packet is
`strategy-seeds/sources/EIA-CRABEL-YANG-WTI-HURR-WR2-CLV-FADE-20260911/source.md`. EIA supports
the hurricane-risk calendar; governed Crabel work supplies range-state lineage; Yang-Goncu-
Pantelous supplies commodity-reversal lineage. None establishes this Darwinex CFD conjunction.

The canonical scan found no exact match. `QM5_41434` buys the exact WR2/upper-quartile state;
this card sells it, so the hypotheses have opposite payoffs. `QM5_41433` shorts any positive
completed-week return without comparing ranges or close location. `QM5_12754` is a single-D1-bar
rejection/SMA rule with different entry and exit mechanics. `QM5_12861` trades XNG. Calendar,
two-week formation, strict range rank, close-location, short side, and lifecycle are jointly
load-bearing.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41435, slot zero, registered magic, and
...
6. Compute newest-week `CLV=(final_close-low)/(high-low)`. Sell only when `CLV>0.75`; equality or
   lower values are flat. Weekly body sign is irrelevant. There is no long branch.
...
Immediately flatten duplicate, wrong-symbol, wrong-magic, non-short, missing-stop,
...
EIA supplies hurricane-season physical-risk context. Governed Crabel and Yang-Goncu-Pantelous
records supply range-state and broad reversal lineage. They do not supply this exact conjunction.

## QM Interpretations

August-October Monday anchors, two completed weeks, strict range expansion, `CLV>0.75`, the
short-only side, one-week hold, retry semantics, and every numeric threshold are QM choices.
...
range expansion, range tie, strict CLV threshold, short-only entry, body-sign irrelevance,
...
three completed positions in a full scored year, nonpositive governed economics, or contract
