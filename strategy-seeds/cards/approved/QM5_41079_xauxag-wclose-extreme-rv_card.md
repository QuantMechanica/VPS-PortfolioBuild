...
- Own exactly one `XAUUSD.DWX` position under intended magic `410790000` and
  one opposite-side `XAGUSD.DWX` position under intended magic `410790001`.
...
| Q01 Build Validation | TBD | NOT_RUN | active slot-0/1 magic allocation and build required |
