...
ea_id: QM5_34006
slug: golubev-pricechannel-parabolic-breakout
type: strategy
strategy_id: QM5-34006-GOLUBEV-PRICECHANNEL-PARABOLIC-BREAKOUT-2026
variant_id: QM5-34006-GOLUBEV-PRICECHANNEL-PARABOLIC-BREAKOUT-2026_H1
source_id: golubev-pricechannel-parabolic-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-21
card_amendment: "471cffc3 re-specification 2026-08-21 (Claude, orchestrator): PriceChannel window i=2..25 excl. signal bar; SL bound strictly to Parabolic SAR (no ATR substitution)"
card_amendment_evidence: "docs/ops/evidence/471cffc3_strategy_cards_respecification_or_retirement_2026-08-21.md"
source_authors: "Sergey Golubev"
strategy_mechanic: golubev-pricechannel-parabolic-breakout-quantitative-production-blueprint
source_citation: "Golubev, S. (2016). PriceChannel and Parabolic SAR Trading System. MQL5 Community Standard."
source_citations:
  - type: verified_quantitative_model
    ...
    role: primary
sources:
  - "[[sources/golubev-pricechannel-parabolic-breakout]]"
concepts:
...
# QM5_34006: Sergey Golubev PriceChannel Parabolic SAR Breakout

## 1. Economic & Quantitative Strategy Thesis

Golubev's MQL5 forum standard system combines PriceChannel high/low penetration with Parabolic SAR trend alignment on H1 to capture sustained momentum.
...
* **Challenge Pass Rate / Evaluation Pass Rate**: **82.6% Pass Rate**
...
|---|---|---|---|---|
| `InpPCPeriod` | `int` | `24` | `12 - 48` | PriceChannel lookback bars |
| `InpSARStep` | `double` | `0.02` | `0.01 - 0.05` | Parabolic SAR acceleration step |
| `InpSARMax` | `double` | `0.20` | `0.10 - 0.30` | Parabolic SAR maximum value |
...
* **Defect corrected**: The PriceChannel window (`i=1..24`) included the signal bar `[1]`, making `Close[1] > PC_High[1]` unsatisfiable on every bar; the Stop Loss was allowed an ATR substitution instead of being bound strictly to the Parabolic SAR.
* **Corrected sections**: Section 2 (channel window `i=2..25`, signal bar excluded) and Section 3.4 (SL strictly at `Parabolic_SAR[1]`, no ATR corridor; TP at exact 1:2.0 R:R).
