...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K1H2_S31
variant_id: MOP-TSMOM-2012_XTI_K1H2_S31
source_id: MOP-WTI-TSMOM1-H2-2026
ea_id: QM5_41380
slug: wti-tsmom1-h2
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41380_wti-tsmom1-h2_card.md
execution_contract_status: APPROVED
created: 2026-09-07
created_by: Research+Development
last_updated: 2026-09-07
g0_status: APPROVED
g0_decision: decisions/2026-09-07_qm5_41380_wti_tsmom1_h2_g0.md
source_approval: decisions/2026-09-07_wti_one_month_momentum_two_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM1-H2-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: bimonthly-wti-sign-of-exact-one-completed-broker-month-log-return-two-month-hold-odd-month-epoch
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, one-month-return, two-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
q01_status: PASS
q02_status: ENQUEUED
parameters_to_test: "Locked Q02 baseline only: D1; two consecutive completed month-end closes; exact one-month log-return sign; odd-month decisions; two-month hold; 300 D1 bars; 3.5*ATR(20,D1) frozen stop; 70-day stale repair; 1500-point spread ceiling."
review_focus: "Falsify the source-bounded WTI k=1,h=2 stream. Verify two exact completed-month endpoints, odd-month-only attempts, no even-month rollover, fixed risk, frozen stop, and next-odd-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal]
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_one_month_orientation, odd_month_epoch, bimonthly_attempt_state, two_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
---

# QM5_41380 WTI One-Month Momentum / Two-Month Hold

## Hypothesis

A one-completed-month WTI own-return direction may persist when held as a
...
`strategy-seeds/sources/MOP-WTI-TSMOM1-H2-2026/source.md`; its complete-read
...
`QM5_20187` uses the same one-month return with monthly renewal;
`QM5_20281` uses the same two-month clock with a twelve-month return, and
`QM5_41379` uses a three-month return. This card requires both exact `k=1`
endpoints and the fixed odd-month `h=2` lifecycle.
...
- Decision: first processed D1 bar of January, March, May, July, September, or
  November.
- History: two consecutive completed broker-month-end closes `C[0]..C[1]`,
  oldest to newest; newest is the immediately prior completed month.
- Formula: `r1 = ln(C[1] / C[0])`; positive buys, negative sells, equality or
...
2. Require configured symbol, D1, EA 41380, slot 0, and fixed-risk backtest
   mode.
...
4. Reconstruct exactly two positive finite consecutive completed month-end
   closes with strictly increasing timestamps and no current-month price.
5. Compute `ln(C[1]/C[0])`; buy strict positive and sell strict negative.
...
Q01 must prove month adjacency and year boundaries, exact two endpoints,
...
|---|---|---|---|
| G0 Research Intake | 2026-09-07 | APPROVED | `decisions/2026-09-07_qm5_41380_wti_tsmom1_h2_g0.md` |
| Q01 Build Validation | 2026-09-07 | PASS | PACER audit zero hits; reference vectors 13/13; governed `COMPILE_OK`, zero errors/warnings; build check PASS. |
| Q02 Baseline Screening | 2026-09-07 | ENQUEUED | Work item `39f66ffd-dc0b-44cb-ac21-60f574055cf0`; fixed-risk XTIUSD.DWX D1; admission CPU max 85.7% below 97% ceiling. |
