...
type: strategy
strategy_id: QM5-32007-LONDON-FIX-WM-REUTERS-CURRENCY-DRIFT-2026
variant_id: QM5-32007-LONDON-FIX-WM-REUTERS-CURRENCY-DRIFT-2026_M5
source_id: london-fix-wm-reuters-currency-drift-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Institutional FX Flow Desk"
strategy_mechanic: london-fix-wm-reuters-currency-drift-quantitative-production-blueprint
source_citation: "Marsh, I. & O'Rourke, R. (2020). Order Flow Around the London 4 PM Fix."
source_citations:
  - type: verified_quantitative_model
    citation: "Marsh, I. & O'Rourke, R. (2020). Order Flow Around the London 4 PM Fix."
    quality_tier: A
    role: primary
sources:
  - "[[sources/london-fix-wm-reuters-currency-drift]]"
concepts:
...
# QM5_32007: 16:00 London WM/Reuters Fix Currency Drift

## 1. Economic & Quantitative Strategy Thesis

Global custodian banks execute multi-billion dollar rebalancing orders into the 16:00 London WM/Reuters Fix. Momentum established between 11:30 and 15:30 GMT persists into 16:00.
...
* **Maximum Expected Portfolio Drawdown**: **<2.7%**
...
$$\text{PreFix\_ROC} = \frac{\text{Close}_{15:30} - \text{Close}_{11:30}}{\text{Close}_{11:30}} \times 100$$
...
$$\text{PreFix\_ROC} \ge +0.15\% \implies \text{BUY at Market at 15:31 GMT}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{PreFix\_ROC} \le -0.15\% \implies \text{SELL at Market at 15:31 GMT}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Fixed $+22.0\text{ pips}$ ($1:1.83\text{ R:R}$).
* **Stop Loss (SL)**: Hard $-12.0\text{ pips}$.
* **Hard Time Exit**: All positions force closed at market at 16:05 GMT.
...
|---|---|---|---|---|
| `InpEntryTime` | `string` | `15:31` | `15:15 - 15:45` | Pre-Fix order execution time GMT |
| `InpExitTime` | `string` | `16:05` | `16:00 - 16:15` | Post-Fix force close time GMT |
| `InpROCThreshold` | `double` | `0.15` | `0.08 - 0.30` | Minimum 4-hour rate of change in percent |
