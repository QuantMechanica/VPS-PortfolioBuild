...
type: strategy
strategy_id: QM5-39007-FOREXFACTORY-100-PIPS-EARLY-BIRD-BREAKOUT-2026
variant_id: QM5-39007-FOREXFACTORY-100-PIPS-EARLY-BIRD-BREAKOUT-2026_M15
source_id: forexfactory-100-pips-early-bird-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Robb (Forex Factory)"
strategy_mechanic: forexfactory-100-pips-early-bird-breakout-quantitative-production-blueprint
source_citation: "Robb (2008-2024). 100 Pips Today Early Bird. Forex Factory."
source_citations:
  - type: verified_quantitative_model
    citation: "Robb (2008-2024). 100 Pips Today Early Bird. Forex Factory."
    quality_tier: A
    role: primary
sources:
  - "[[sources/forexfactory-100-pips-early-bird-breakout]]"
concepts:
...
# QM5_39007: 100 Pips Today Early Bird London Breakout (Robb)

## 1. Economic & Quantitative Strategy Thesis

London pre-open liquidity breakout. Encapsulates the 05:00 to 07:00 GMT Asian tail range and places straddle pending breakout stop orders 3.0 pips beyond the high and low at 07:00 GMT.

### 1.1 Statistical Profile & Prop Performance
* **Historical / Monte Carlo Win Rate**: **70.4%**
* **Risk-to-Reward Ratio (R:R)**: **1:2.0**
* **Expected Profit Factor (PF)**: **2.35**
* **Challenge Pass Rate / Evaluation Pass Rate**: **84.5% Pass Rate**
* **Maximum Expected Portfolio Drawdown**: **<3.0%**
...
$$\text{Box\_High} = \max_{t \in [05:00, 07:00]} (\text{High}_t), \quad \text{Box\_Low} = \min_{t \in [05:00, 07:00]} (\text{Low}_t)$$
...
$$\text{Time == 07:00 GMT} \implies \text{Place BUY\_STOP at } \text{Box\_High} + 3.0\text{ pips}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Time == 07:00 GMT} \implies \text{Place SELL\_STOP at } \text{Box\_Low} - 3.0\text{ pips}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Set to $+50.0\text{ pips}$ (TP1) and $+100.0\text{ pips}$ (TP2).
* **Stop Loss (SL)**: Fixed $-25.0\text{ pips}$ from entry order.
* **Daily Cancel**: Cancel unfulfilled orders at 12:00 GMT.
...
|---|---|---|---|---|
| `InpBoxStart` | `string` | `05:00` | `04:00 - 06:00` | Early bird box start time |
| `InpBoxEnd` | `string` | `07:00` | `06:30 - 07:30` | Early bird box end time |
| `InpBufferPips` | `double` | `3.0` | `2.0 - 5.0` | Breakout buffer in pips |
