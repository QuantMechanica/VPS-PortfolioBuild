...
type: strategy
strategy_id: QM5-32003-CL-PIT-OPEN-VOLATILITY-BREAKOUT-2026
variant_id: QM5-32003-CL-PIT-OPEN-VOLATILITY-BREAKOUT-2026_M5
source_id: cl-pit-open-volatility-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Futures Energy Trading Desk"
strategy_mechanic: cl-pit-open-volatility-breakout-quantitative-production-blueprint
source_citation: "Crude Oil Pit Open Mechanics & Apex/Topstep Energy Studies."
source_citations:
  - type: verified_quantitative_model
    citation: "Crude Oil Pit Open Mechanics & Apex/Topstep Energy Studies."
    quality_tier: A
    role: primary
sources:
  - "[[sources/cl-pit-open-volatility-breakout]]"
concepts:
...
# QM5_32003: Crude Oil (CL) Pit Open Volatility Breakout

## 1. Economic & Quantitative Strategy Thesis

Captures the New York energy floor open (09:00 EST / 14:00 GMT). Places opening range breakout stops across the 10-minute pre-open box (08:50 to 09:00 EST).
...
$$\text{CL\_High} = \max_{t \in [08:50, 09:00]} (\text{High}_t), \quad \text{CL\_Low} = \min_{t \in [08:50, 09:00]} (\text{Low}_t)$$
...
$$\text{Order: Place BUY\_STOP at } \text{CL\_High} + 0.03\$ \text{ at 09:01 EST}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Order: Place SELL\_STOP at } \text{CL\_Low} - 0.03\$ \text{ at 09:01 EST}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Fixed $+0.50\$ = 50\text{ ticks} = \$500/\text{contract}$.
* **Stop Loss (SL)**: Hard $-0.25\$ = 25\text{ ticks} = \$250/\text{contract}$ ($1:2.0\text{ R:R}$).
* **Time Stop**: Close position at 14:30 EST.
...
|---|---|---|---|---|
| `InpBoxStart` | `string` | `08:50` | `08:30 - 08:55` | Energy box start time EST |
| `InpBoxEnd` | `string` | `09:00` | `08:55 - 09:10` | Energy box end time EST |
| `InpTPDollars` | `double` | `0.50` | `0.30 - 1.00` | Take profit in CL dollars per barrel |
| `InpSLDollars` | `double` | `0.25` | `0.15 - 0.40` | Stop loss in CL dollars per barrel |
