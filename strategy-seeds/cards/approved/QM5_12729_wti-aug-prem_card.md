...
period: D1
expected_trade_frequency: "August-only D1 WTI month-of-year positive-return sleeve; estimate 18-22 entries/year after weekends, broker holidays, and framework filters."
...
g0_approval_reasoning: "R1 PASS academic oil-seasonality paper; R2 PASS deterministic August D1 long/time-flat rule with ATR stop; R3 PASS XTIUSD.DWX available; R4 PASS no ML/grid/martingale/external data."
expected_pf: 1.08
expected_dd_pct: 16.0
---

# WTI August Calendar Premium
...
This card isolates the unused August positive month as a clean QM book sleeve:
long-only exposure to `XTIUSD.DWX` during broker-calendar August D1 bars, with
each position flattened on the next D1 bar unless the ATR hard stop or framework
Friday close acts first.

This is deliberately different from:

- `QM5_12727_wti-apr-prem`: April spring premium; this card isolates August.
...
- `QM5_12596_wti-mon-fade`, `QM5_12610_wti-tue-fade`, and
  `QM5_12597_wti-fri-prem`: weekday effects, not month-of-year August.
- `QM5_12576_eia-wti-season`: broad EIA refined-product demand seasonality
  with monthly rebalance plus SMA/ROC confirmation, not a pure August one-bar
  calendar premium.
...
crude-oil returns, including August in the reported positive-return months. No
...
- [x] Non-duplicate: August month-of-year long is not the existing April or
...
|---|---|---|---|
| v1 | 2026-06-28 | initial structural WTI August calendar-premium build | G0 | APPROVED |
