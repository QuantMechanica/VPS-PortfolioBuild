...
Canonical card mirrors `strategy-seeds/cards/xng-52w-anchor_card.md`.
...
- Only `XNGUSD.DWX` on D1 and magic slot 0.
...
R1-R4: PASS/PASS/PASS/PASS. Q02 target: `XNGUSD.DWX`, D1, RISK_FIXED.
