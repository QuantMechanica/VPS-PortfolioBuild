...
type: strategy
strategy_id: KELOHARJU-MOP-WTI-SEASRESMOM-2026_S01
variant_id: KELOHARJU-MOP-WTI-SEASRESMOM-2026_S01
source_id: KELOHARJU-MOP-WTI-SEASRESMOM-2026
ea_id: QM5_41209
slug: wti-seas-resid-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41209_wti-seas-resid-mom_card.md
execution_contract_status: APPROVED
created: 2026-08-30
created_by: Research+Development
last_updated: 2026-08-30
g0_status: APPROVED
g0_decision: decisions/2026-08-30_qm5_41209_wti_seasonal_residual_momentum_g0.md
source_approval: decisions/2026-08-30_wti_seasonal_residual_momentum_source_approval.md
...
source_citation: "Keloharju, Linnainmaa, and Nyberg (2016), Return Seasonalities, Journal of Finance 71(4), 1557-1590, DOI 10.1111/jofi.12398; Moskowitz, Ooi, and Pedersen (2012), Time Series Momentum, Journal of Financial Economics 104(2), 228-250, DOI 10.1016/j.jfineco.2011.11.003."
source_citations:
  - type: peer_reviewed_trading_paper
    ...
    quality_tier: A
    role: same_calendar_month_commodity_expectation_and_explicit_crude_oil_membership
  - type: peer_reviewed_trading_paper
    citation: "Moskowitz, T. J., Ooi, Y. H., and Pedersen, L. H. (2012). Time Series Momentum. Journal of Financial Economics 104(2), 228-250."
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete 23-page governed review strategy-seeds/sources/MOP-TSMOM-2012/source.md"
    quality_tier: A
    role: own_return_continuation_explicit_wti_membership_and_one_month_formation_hold_evidence
  - type: governed_composite_source
    citation: "QuantMechanica bounded WTI standardized seasonal-residual momentum extraction."
    location: "strategy-seeds/sources/KELOHARJU-MOP-WTI-SEASRESMOM-2026/source.md"
    quality_tier: internal_governed
    role: exact_conjunction_calendar_sample_score_risk_and_lifecycle
strategy_mechanic: monthly-wti-just-completed-log-return-minus-up-to-ten-prior-year-same-calendar-mean-divided-by-sample-standard-deviation-strict-half-sigma-continuation-next-month
sources:
  - "[[sources/KELOHARJU-MOP-WTI-SEASRESMOM-2026]]"
concepts:
  - "[[concepts/return-seasonality]]"
  - "[[concepts/seasonally-adjusted-momentum]]"
  - "[[concepts/calendar-month-renewal]]"
indicators:
  - "[[indicators/completed-month-log-return]]"
  - "[[indicators/sample-standard-deviation]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, crude-oil, calendar-seasonality, standardized-residual, momentum, monthly-renewal, atr-hard-stop, low-frequency, symmetric-long-short]
...
r1_reasoning: "Complete peer-reviewed Journal of Finance same-calendar commodity evidence with explicit crude-oil membership plus complete peer-reviewed Journal of Financial Economics own-return continuation evidence with explicit WTI membership and a pooled one-month formation/hold test; the exact standardized conjunction remains untested."
r2_mechanical: PASS
...
force_build: true
review_focus: "Falsify a monthly WTI stream that follows only the just-completed return unexplained by recurring same-calendar history. Verify the information clock, uniform label convention, endpoint chronology, realized-sample exclusion, exact n-1 scale, strict continuation band, durable attempt, fixed risk, frozen stop, and next-month close. Q09 alone may establish realized decorrelation from the current book."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, first_month_bar_clock, uniform_energy_label_normalization, just_completed_month_mapping, completed_month_endpoints, no_current_month_price, realized_sample_exclusion, ten_year_search_cap, five_sample_floor, arithmetic_mean, sample_variance_n_minus_one, strict_residual_band, continuation_direction, monthly_attempt_state, monthly_renewal, risk_mode_dual, hard_stop_present, nonnegative_modeled_spread, friday_close_disabled, cfd_futures_basis, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER mission 2026-08-30 and decisions/2026-08-30_qm5_41209_wti_seasonal_residual_momentum_g0.md: R1 passes with two complete peer-reviewed lineages and explicit untested-conjunction risk; R2 locks calendar, endpoints, exclusion, sample, mean, n-1 scale, score, continuation side, attempt, risk, stop, spread, and lifecycle; R3 uses registered native WTI D1 with session/CFD risk; R4 is deterministic native arithmetic only. Corrected-root canonical dedup is CLEAN across 4,708 registry rows, 1,354 cards, and 45 Wiki nodes; manual review separates raw one-month WTI momentum, upcoming-month seasonal sign and agreement rules, fixed physical-season reversal, XNG residual reversion, and paired-metals residual reversion."
---

# QM5_41209 WTI Monthly Seasonal-Residual Momentum

## Hypothesis

Crude-oil production, refinery, transport, consumption, hedging, and capital-
allocation pressures can recur by calendar month, while WTI own returns also
show continuation in the source family. When the just-completed WTI monthly
return is unusually large after subtracting its own historical return for that
same calendar month, the unexpected component may continue during the
following broker month.

This is direct WTI exposure outside the stated XAU/SP500/NDX/XNG directional
book. Its monthly, seasonally adjusted residual state is neither a raw return
sign nor an upcoming-month seasonal forecast. That mechanical distinction
does not prove low realized correlation. Q02 owns density and baseline
economics; unchanged Q09 alone owns portfolio overlap.

## Source Traceability And Claim Boundary

The approved bounded packet is
`strategy-seeds/sources/KELOHARJU-MOP-WTI-SEASRESMOM-2026/source.md`,
SHA-256
`A8D8FACC8E80381E7E0288C366CABF68432C8A1B9B2F6F053ECD1ED108FCD62F`,
committed as `d5a6cc40c` after source approval `a19955cc0` and before card
approval.

Keloharju, Linnainmaa, and Nyberg supply the same-calendar commodity
information object, explicit crude-oil membership, and a five-year history
floor. Moskowitz, Ooi, and Pedersen supply own-return continuation, explicit
WTI membership, and a pooled commodity one-month formation / one-month hold
test. They do not report a standalone WTI one-month result.

Neither source tests the exact standardized residual, Darwinex continuous
...
- Crude oil and WTI are explicitly inside the respective source universes,
  while peer-reviewed evidence supports fixed-frequency own-return
  continuation at the pooled commodity level.
...
- Arithmetic mean, n-1 sample deviation, strict 0.50 plus 1e-10 band, and
  continuation side are the locked conjunction; no candidate result fitted
  them.
...
found no exact or fuzzy identity across 4,708 registry rows, 1,354 cards, and
...
- `QM5_20187_wti-tsmom1m` follows every nonzero completed-month WTI return.
  This card first removes recurring calendar expectation, scales the
  residual, and remains flat inside a strict band.
- `QM5_20099_wti-samecal` follows the historical mean for the upcoming
  calendar month. This card never predicts the upcoming seasonal sign.
- `QM5_20205_wti-calmom1` requires the upcoming same-calendar sign and raw
  prior-month sign to agree. This card forms one prior-month standardized
  realized-minus-expected residual instead.
- `QM5_20229_wti-seas-rev1` uses a fixed physical-season direction after an
  opposing raw month. This card has no fixed winter/summer map and follows
  rather than reverses the residual.
- `QM5_41208_xng-seas-surprise-rv` uses analogous arithmetic on XNG and fades
  the residual. This card owns WTI and follows the residual under WTI-specific
  peer-reviewed momentum lineage.
- `QM5_21517_xauxag-seas-rv` owns a contrarian two-leg precious-metals
  package. This card owns one directional crude-oil position.
...
sample_y      = the same WTI calendar-month return in earlier year y
...
BUY  iff residual_z > +0.50 + 1e-10
SELL iff residual_z < -0.50 - 1e-10
FLAT otherwise
```
...
1. Require exact EA ID `41209`, `XTIUSD.DWX` D1 host, slot 0, magic
   `412090000`, fixed-risk inputs, both news axes OFF, and Friday close OFF.
...
8. Buy beyond `+0.50+1e-10`; sell below `-0.50-1e-10`; equality and the
...
- The entry hard stop is never moved. No residual sign change alters an open
...
| `strategy_entry_z` | 0.50 | strict standardized-residual band |
...
warm-up, unstable sample dispersion, crude-oil gaps, roll/financing, label
mapping, threshold sparsity, and stop slippage can erase the premise. Q09
alone may measure correlation with the incumbent WTI sleeve or wider book.
...
No curve, inventory, storage data, weather, volume, open interest, event
...
No weak result may be rescued by adopting unconditional one-month momentum or
reversal, forecasting the upcoming calendar month, selecting months, moving
the band, changing estimator, adding another trend, storage, weather, volume,
event, curve, or price-action filter, changing the carrier, or extending the
hold.
...
3. five through ten observations produce the exact arithmetic mean, `n-1`
   sample standard deviation, strict score boundaries, and continuation side;
4. fixtures distinguish unconditional one-month WTI momentum, upcoming-month
   raw-mean and agreement rules, XNG residual reversion, and paired-metals
   residual-reversion logic;
...
|---|---|---|---|
| G0 Research Intake | 2026-08-30 | APPROVED; R1-R4 PASS | `decisions/2026-08-30_qm5_41209_wti_seasonal_residual_momentum_g0.md`; approved source packet |
...
|---|---|---|---|---|
| v1 | 2026-08-30 | initial WTI standardized seasonal-residual momentum card | G0 | APPROVED; build pending |
