...
type: strategy
strategy_id: QM5-33005-ANDREA-UNGER-DAX-INTRADAY-BIAS-BREAKOUT-2026
variant_id: QM5-33005-ANDREA-UNGER-DAX-INTRADAY-BIAS-BREAKOUT-2026_M15
source_id: andrea-unger-dax-intraday-bias-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Andrea Unger"
strategy_mechanic: andrea-unger-dax-intraday-bias-breakout-quantitative-production-blueprint
source_citation: "Unger, A. (2018). The Unger Method: 4-Time World Cup Trading Champion."
source_citations:
  - type: verified_quantitative_model
    citation: "Unger, A. (2018). The Unger Method: 4-Time World Cup Trading Champion."
    quality_tier: A
    role: primary
sources:
  - "[[sources/andrea-unger-dax-intraday-bias-breakout]]"
concepts:
...
# QM5_33005: Andrea Unger DAX Intraday Bias Breakout

## 1. Economic & Quantitative Strategy Thesis

The Frankfurt 09:00 CET cash equity open creates persistent institutional trend legs. The 30-minute opening range breakout captures the expansion with a strict 17:30 CET close.
...
$$\text{High}_{30} = \max_{t \in [09:00, 09:30]} (\text{High}_t), \quad \text{Low}_{30} = \min_{t \in [09:00, 09:30]} (\text{Low}_t)$$
$$\text{Range}_{30} = \text{High}_{30} - \text{Low}_{30}$$
...
$$\text{Order: Place BUY\_STOP at } \text{High}_{30} + 3.0 \text{ pts at 09:31 CET}$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Order: Place SELL\_STOP at } \text{Low}_{30} - 3.0 \text{ pts at 09:31 CET}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Set to $1.8 \times \text{Range}_{30}$ ($1:3.0\text{ R:R}$).
* **Stop Loss (SL)**: Placed at entry $\mp 0.60 \times \text{Range}_{30}$.
* **Time Exit**: Force close all positions at 17:30 CET.
...
|---|---|---|---|---|
| `InpRangeStart` | `string` | `09:00` | `08:00 - 10:00` | Frankfurt range evaluation start time |
| `InpRangeEnd` | `string` | `09:30` | `08:30 - 10:30` | Frankfurt range evaluation end time |
| `InpBreakoutOffset` | `double` | `3.0` | `1.0 - 10.0` | Index point buffer beyond range extreme |
