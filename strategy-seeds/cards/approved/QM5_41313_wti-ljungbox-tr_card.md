...
type: strategy
strategy_id: LJUNGBOX-MOP-WTI-PORTMANTEAU-20260902_S01
variant_id: LJUNGBOX-MOP-WTI-PORTMANTEAU-20260902_S01
source_id: LJUNGBOX-MAHDI-MOP-WTI-PORTMANTEAU-20260902
ea_id: QM5_41313
slug: wti-ljungbox-tr
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41313_wti-ljungbox-tr_card.md
execution_contract_status: APPROVED
created: 2026-09-02
created_by: Research+Development
last_updated: 2026-09-02
g0_status: APPROVED
g0_decision: decisions/2026-09-02_qm5_41313_wti_monthly_ljung_box_trend_g0.md
source_approval: decisions/2026-09-02_wti_monthly_ljung_box_trend_source_approval.md
source_author: QuantMechanica governed synthesis
source_authors: G. M. Ljung; George E. P. Box; Esam Mahdi; Tobias J. Moskowitz; Yao Hua Ooi; Lasse Heje Pedersen
source_citation: "QuantMechanica governed WTI portmanteau synthesis; Ljung and Box (1978), Biometrika 65(2), DOI 10.1093/biomet/65.2.297; Mahdi (2016), SpringerPlus 5, DOI 10.1186/s40064-016-3167-4; Moskowitz, Ooi, and Pedersen (2012), Journal of Financial Economics 104(2), DOI 10.1016/j.jfineco.2011.11.003."
source_citations:
  - type: original_peer_reviewed_statistical_method
    ...
    location: "DOI 10.1093/biomet/65.2.297; Oxford University Press metadata and abstract only"
    quality_tier: A_bibliographic
    role: original_ljung_box_attribution
  - type: peer_reviewed_open_access_statistical_method
    citation: "Mahdi, E. (2016). Portmanteau test statistics for seasonal serial correlation in time series models. SpringerPlus 5, 1485."
    location: "DOI 10.1186/s40064-016-3167-4; complete open-access article read via PubMed Central PMC5011475"
    quality_tier: A
    role: residual_autocorrelation_ljung_box_formula_and_finite_sample_limitations
  ...
  - type: governed_composite_source
    citation: "QuantMechanica (2026). WTI monthly Ljung-Box-portmanteau-gated trend."
...
strategy_mechanic: monthly-wti-forty-eight-completed-log-returns-demeaned-six-lag-finite-sample-ljung-box-squared-autocorrelation-portmanteau-inclusive-535-gated-newest-twelve-month-continuation
sources:
  - "[[sources/LJUNGBOX-MAHDI-MOP-WTI-PORTMANTEAU-20260902]]"
concepts:
  - "[[concepts/time-series-momentum]]"
  - "[[concepts/serial-dependence]]"
  - "[[concepts/crude-oil-structural-trend]]"
indicators:
  - "[[indicators/completed-month-log-return]]"
  - "[[indicators/ljung-box-portmanteau]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, crude-oil, structural-trend, serial-dependence, portmanteau, autocorrelation, monthly-rebalance, atr-hard-stop, time-stop, symmetric-long-short, low-frequency]
...
expected_trade_frequency: "Approximately six completed WTI positions per full post-warm-up year; one consumed attempt per broker month. A fixed-seed market-free null prior qualified 50.1025%. Q02 must prove at least five trades in every full scored year or retire."
...
r1_reasoning: "Peer-reviewed original attribution, complete peer-reviewed open-access portmanteau-method read, complete governed peer-reviewed WTI trading-paper read, and explicit disclosure that applying the diagnostic to raw WTI returns as a trend gate is untested QM synthesis."
r2_mechanical: PASS
r2_reasoning: "Month clock, 49 endpoints, 48 returns, demeaning, common denominator, ordinary lags 1-6, exact finite-sample Ljung-Box weights, inclusive 5.35 gate, newest-12m direction, consumed attempt, fixed risk, stop, spread, and lifecycle are deterministic and locked."
...
r4_reasoning: "Only completed prices, timestamps, logarithms, sums, products, bounded autocorrelation loops, ATR risk, quotes, positions, deals, and persistent state; no trained output or external runtime feed."
parameters_to_test: "Locked Q02 baseline only: 49 consecutive completed month-end closes; 48 adjacent log returns; subtract arithmetic mean; ordinary autocorrelations lags 1-6 with common centered-squares denominator; Q6=48*50*sum(rho_k^2/(48-k)); denominator floor 1e-18; inclusive Q6 floor 5.35; newest 12m direction epsilon 1e-12; 1500 D1 history bars; 180-minute month-entry grace; 10-day endpoint staleness; ATR(20)*3.5 frozen stop; 40-day stale exit; 1500-point spread ceiling."
...
force_build: true
review_focus: "Falsify a direct-WTI monthly portmanteau-state continuation sleeve outside the certified XAU/SP500/NDX/XNG book. Verify endpoints, demeaning, autocorrelation orientation/denominator, all six finite-sample weights, inclusive boundary, newest-12m side, consumed month, fixed risk, frozen stop, and next-month lifecycle. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, first_tradable_month_bar, forty_nine_consecutive_completed_months, no_current_month_price, forty_eight_adjacent_log_returns, chronological_return_orientation, exact_demeaning, common_autocorrelation_denominator, exact_lags_one_through_six, squared_lag_terms, finite_sample_ljung_box_weights, inclusive_q6_535, newest_twelve_month_continuation_side, monthly_attempt_state, fixed_risk, hard_stop_present, nonnegative_spread, next_month_exit, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER mission 2026-09-02 and decisions/2026-09-02_qm5_41313_wti_monthly_ljung_box_trend_g0.md: R1-R4 pass within disclosed raw-return synthesis and continuous-CFD risks. Corrected-root dedup returned CLEAN across 4,798 registry rows, 1,427 cards, and 45 Wiki nodes; manual review separates the six-lag squared-autocorrelation portmanteau state from signed variance ratio, raw von Neumann ratio, Bartels ranks, entropy, pure momentum, calendar, event, channel, and certified XNG RSI families."
---

# QM5_41313 WTI Monthly Ljung-Box-Portmanteau-Gated Trend
...
carrier set. When forty-eight completed monthly WTI returns show sufficiently
large aggregate serial dependence across lags one through six, the newest
...
of profitability, statistical significance, independence, or decorrelation.
Q02 owns cadence and baseline economics; unchanged Q09 alone owns portfolio
overlap.
...
approved at commit `9fe9c6ec63` before card extraction.

Ljung and Box supply original attribution. Mahdi's complete open-access paper
fixes the autocorrelation and finite-sample statistic arithmetic while also
making clear that it is a model diagnostic with sample-size limitations.
Moskowitz, Ooi, and Pedersen supply only the WTI carrier and monthly own-return
continuation lineage. None tests this conjunction, raw-return use, window,
boundary, CFD, fixed risk, costs, lifecycle, activity, or portfolio fit.
...
returned `CLEAN` across 4,798 registry rows, 1,427 cards, and all 45 Strategy
Wiki nodes.

- `QM5_20256` linearly combines signed autocorrelations in a variance ratio;
  opposite lag signs can cancel. This gate sums six squared, finite-sample-
  weighted autocorrelations.
- `QM5_41310` uses one successive-difference ratio, dominated by lag-one path
  variation, with no six-lag portmanteau sum.
- `QM5_41170` ranks observations before applying a Bartels statistic; this
  gate preserves raw return magnitudes.
- Entropy, LZ76, recurrence, pure trend, distribution, calendar, event,
...
- Exact host and slot zero: `XTIUSD.DWX`, D1, governed magic `413130000`.
...
`den>1e-18`. The gate is sign-agnostic by construction; only `mom12` assigns
side. Statistic and momentum magnitude never alter risk. The inclusive `5.35`
boundary approximates the chi-square-six median only as a pre-data state
divider, not a significance threshold or p-value.
...
- Reject current-month input, missing/duplicate/nonconsecutive month keys,
  ...
  invalid arithmetic, low centered variance, low `Q6`, or neutral momentum.
...
1. Require EA ID 41313, exact `XTIUSD.DWX` D1, slot zero, magic 413130000,
...
6. Apply exact demeaning, common denominator, lag orientation, squared terms,
   finite-sample weights, inclusive `5.35` gate, and newest twelve-month side.
...
- Fail closed on stale/nonconsecutive history, invalid closes/returns,
  demeaning, denominator, correlation, statistic, low gate, neutral momentum,
  prior attempt/deal, spread, quote, ATR, sizing, or margin.
...
| autocorrelation lags | ordinary `k=1..6` |
| autocorrelation denominator | common `sum((x-mean)^2)` |
| portmanteau statistic | `48*50*sum(rho[k]^2/(48-k))` |
| centered-squares floor | `>1e-18` |
| qualification boundary | inclusive `Q6>=5.35` |
...
qualifies 50.1025% of 200,000 independent standard-normal paths, or `6.0123`
...
raw-return diagnostic is noisy and roll discontinuities can inflate multiple
autocorrelations. Squaring deliberately admits both persistent and
anti-persistent lag structures; the continuation conjunction is untested.
Live risk is not authorized.
...
- R1: PASS with disclosed synthesis boundary and complete reputable records.
...
wrong lag orientation, denominator or finite-sample weight error, boundary or
direction error, zero positions, fewer than five positions in any full post-
warm-up year, nonpositive governed economics, missing stop, invalid fixed-risk
mode, nondeterminism, lifecycle deviation, or any downstream gate failure. No
...
carrier. The six-lag portmanteau state is also mechanically distinct from
existing WTI gates. This is a diversification hypothesis only. Q09 must
measure realized correlation and may reject it without a waiver.

## Validation Plan

1. Reference-test endpoint/return orientation, demeaning, each lag numerator,
   common denominator, weighted squared terms, `Q6`, boundary, and direction
   against independent fixtures, including distinction from signed VR and raw
...
| card rule | module |
|---|---|
| identity, risk/news/Friday contract, month attempt, endpoints and portmanteau state | `Strategy_NoTradeFilter` and bounded helpers |
...
|---|---|---|---|---|
| v1 | 2026-09-02 | initial WTI Ljung-Box trend card | G0 | APPROVED; build pending |

## Pipeline Phase Status

| Phase | Date | Verdict | Evidence path |
|---|---|---|---|
| G0 Source Approval | 2026-09-02 | APPROVED_SOURCE | `decisions/2026-09-02_wti_monthly_ljung_box_trend_source_approval.md` |
| G0 Research Intake | 2026-09-02 | APPROVED | `decisions/2026-09-02_qm5_41313_wti_monthly_ljung_box_trend_g0.md` |
