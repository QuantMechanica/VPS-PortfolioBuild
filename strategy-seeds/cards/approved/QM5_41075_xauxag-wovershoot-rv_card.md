...
type: strategy
strategy_id: SCHWEIKERT-CME-XAUXAG-WOVERSHOOT-RV-2026_S01
variant_id: SCHWEIKERT-CME-XAUXAG-WOVERSHOOT-RV-2026_S01
source_id: SCHWEIKERT-CME-XAUXAG-WOVERSHOOT-RV-2026
ea_id: QM5_41075
slug: xauxag-wovershoot-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41075_xauxag-wovershoot-rv_card.md
execution_contract_status: APPROVED
created: 2026-08-20
created_by: Research+Development
last_updated: 2026-08-20
g0_status: APPROVED
g0_decision: decisions/2026-08-20_qm5_41075_xauxag_weekly_reversal_overshoot_reversion_g0.md
source_approval: decisions/2026-08-20_xauxag_weekly_reversal_overshoot_reversion_source_approval.md
...
strategy_mechanic: synchronized-completed-two-adjacent-week-xau-minus-xag-relative-returns-opposite-sign-newest-strictly-larger-fade-newest-direction-one-week-equal-notional-basket
sources:
  - "[[sources/SCHWEIKERT-CME-XAUXAG-WOVERSHOOT-RV-2026]]"
concepts:
...
strategy_type_flags: [commodity, precious-metals, gold-silver-ratio, market-neutral-basket, weekly-reversal-overshoot, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41075_XAU_XAG_WOVERSHOOT_RV_D1
symbol: QM5_41075_XAU_XAG_WOVERSHOOT_RV_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [410750000, 410750001]
period: D1
timeframe: D1
...
convergence without taking an outright single-metal signal.
...
source tests adjacent opposite-sign weekly returns, strict newest-magnitude
dominance, this contrarian direction, a continuous-CFD package, equal-notional
sizing, fixed cash risk, ATR stops, or a one-week hold.
...
- `QM5_41066_xauxag-wdecay-rv` uses two strict same-sign weekly relative
  ...
  opposite signs with a strictly larger newest move, so the states are
  mutually exclusive.
...
- Exact host: `XAUUSD.DWX`, D1, slot 0, magic `410750000`.
- Exact companion: `XAGUSD.DWX`, D1, slot 1, magic `410750001`.
...
1. Evaluate only once on a new exact `XAUUSD.DWX` D1 bar under EA 41075 and
...
7. SELL XAU/BUY XAG only when `r_old<0`, `r_new>0`, and the newest move
   dominates. BUY XAU/SELL XAG only when `r_old>0`, `r_new<0`, and the newest
...
- Exact host, D1, EA 41075, slot zero, and both registered magics.
...
- Own exactly one `XAUUSD.DWX` position under magic `410750000` and one
  opposite-side `XAGUSD.DWX` position under magic `410750001`.
...
source supplies the weekly horizon or reversal-overshoot fade.

## QM Interpretations

`SCHWEIKERT-CME-XAUXAG-WOVERSHOOT-RV-2026_S01` fixes the exact weekly endpoint
