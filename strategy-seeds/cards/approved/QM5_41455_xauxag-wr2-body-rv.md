...
type: strategy
strategy_id: SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912_S01
variant_id: SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912_S01
source_id: SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912
ea_id: QM5_41455
slug: xauxag-wr2-body-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41455_xauxag-wr2-body-rv.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41455_xauxag_wr2_body_reversion_g0.md
source_approval: decisions/2026-09-12_xauxag_wr2_body_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_exchange_and_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912/source.md
    quality_tier: A_and_B_lineages_with_cross_source_and_weekly_translation_risk
    role: gold_silver_relative_carrier_weekly_range_expansion_and_body_reversion_lineage
strategy_mechanic: normalized-week-boundary-xau-xag-two-synchronized-completed-weeks-newest-strict-wider-log-ratio-close-range-strict-ratio-week-body-contrarian-equal-notional-one-week-basket
sources: ["[[sources/SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912]]"]
...
strategy_type_flags: [commodity, precious-metals, gold-silver-relative-value, market-neutral-basket, weekly-range-expansion, body-reversion, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41455_XAU_XAG_WR2_BODY_RV_D1
symbol: QM5_41455_XAU_XAG_WR2_BODY_RV_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [414550000, 414550001]
period: D1
timeframe: D1
...
parameters_to_test: "Locked Q02 baseline only: D1; input-bound synchronized XAU/XAG labels; two immediately completed consecutive weeks with 3-5 sessions each; log-ratio close range; newest range strictly wider than prior; newest ratio-week body strict beyond 1e-10; contrarian equal-notional package; 45 D1 bars; 180-minute grace; aggregate fixed risk; 3.5*ATR(20,D1) frozen stops; 20% notional mismatch cap; 10-day stale repair; XAU/XAG spread ceilings 1500/500."
...
g0_approval_reasoning: "R1 complete peer-reviewed, exchange, and governed reputable lineage with explicit translation risk; R2 exact mechanical two-week ratio WR2/body reversion basket; R3 registered XAU/XAG D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---

# QM5_41455 XAU/XAG Weekly WR2 Body Reversion
...
`strategy-seeds/sources/SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912/source.md`. Schweikert
...
expansion and body reversion.

The canonical scan found no exact identity and raised five expected fuzzy relatives. `QM5_41448`
uses expansion with outer-quartile CLV reversion; `QM5_41449` uses expansion with body
continuation; `QM5_41450` uses contraction with body reversion; `QM5_41453` uses contraction with
CLV reversion; and `QM5_41454` uses contraction with body continuation. The strict expansion state
and contrarian body side are jointly load-bearing and distinct from every reviewed identity.
...
1. Run only from the setfile-bound `XAUUSD.DWX` D1 host with input-bound `XAGUSD.DWX` companion,
   EA 41455, slots zero/one, registered magics, and fixed-risk backtest mode.
...
4. For every session compute `s=ln(XAU_close)-ln(XAG_close)`. For each week compute
   `R=max(s)-min(s)`. Require positive finite ranges and newest `R` strictly greater than prior `R`;
   equality or contraction is flat. Do not require containment.
...
positive ranges, strict expansion and tie, non-containment allowance, strict positive/negative/
