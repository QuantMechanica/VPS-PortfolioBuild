...
type: strategy
strategy_id: VILLAR-KOENKER-BASSETT-XTIXNG-MLAD-RV-2026_S01
variant_id: VILLAR-KOENKER-BASSETT-XTIXNG-MLAD-RV-2026_S01
source_id: VILLAR-KOENKER-BASSETT-XTIXNG-MLAD-RV-2026
ea_id: QM5_41189
slug: xtixng-mlad-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41189_xtixng-mlad-rv_card.md
execution_contract_status: APPROVED
created: 2026-08-28
created_by: Research+Development
last_updated: 2026-08-28
g0_status: APPROVED
g0_decision: decisions/2026-08-28_qm5_41189_xtixng_monthly_lad_reversion_g0.md
source_approval: decisions/2026-08-28_xtixng_monthly_lad_reversion_source_approval.md
source_author: "Jose A. Villar; Frederick L. Joutz; David J. Ramberg; John E. Parsons; Roger Koenker; Gilbert Bassett Jr.; Karsten Schweikert"
source_authors: "Jose A. Villar; Frederick L. Joutz; David J. Ramberg; John E. Parsons; Roger Koenker; Gilbert Bassett Jr.; Karsten Schweikert"
source_citation: "Villar and Joutz (2006), U.S. EIA, The Relationship Between Crude Oil and Natural Gas Prices; Ramberg and Parsons (2012), The Energy Journal 33(2), 13-35, DOI 10.5547/01956574.33.2.2; Schweikert (2018), Journal of Banking & Finance 88, 44-51, DOI 10.1016/j.jbankfin.2017.11.010; governed exact Koenker-Bassett median-regression reduction."
source_citations:
  ...
  - type: peer_reviewed_statistical_method_record
    ...
    location: "DOI 10.1016/j.jbankfin.2017.11.010; complete author-preprint read preserved in the governed LAD parent packet"
    quality_tier: A
    role: koenker_bassett_median_regression_objective_lineage
  - type: governed_composite_source
    citation: "QuantMechanica bounded XTI/XNG monthly exact LAD ratio-slope reversion extraction."
    location: "strategy-seeds/sources/VILLAR-KOENKER-BASSETT-XTIXNG-MLAD-RV-2026/source.md"
    quality_tier: internal_governed
    role: exact_sample_solver_direction_risk_atomicity_and_lifecycle
strategy_mechanic: synchronized-thirteen-completed-month-end-oil-minus-gas-log-ratio-exact-least-absolute-deviation-residual-median-profiled-slope-sign-contrarian-equal-notional-basket
sources:
  - "[[sources/VILLAR-KOENKER-BASSETT-XTIXNG-MLAD-RV-2026]]"
concepts:
  - "[[concepts/oil-gas-relative-value]]"
  - "[[concepts/least-absolute-deviation-ratio-reversion]]"
  - "[[concepts/market-neutral-basket]]"
indicators:
  - "[[indicators/completed-month-end-ratio-lad-slope]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, relative-value, market-neutral-style, structural-reversion, least-absolute-deviation, median-regression, robust-slope, monthly-rebalance, equal-notional-basket, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy, oil_gas_relative_value]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41189_XTI_XNG_MLAD_RV_D1
symbol: QM5_41189_XTI_XNG_MLAD_RV_D1
...
r1_reasoning: "Complete government and peer-reviewed oil/gas relationship evidence with adverse regime findings plus a complete governed peer-reviewed LAD-method reduction; the exact contrarian ratio basket is an untested QM hypothesis."
r2_mechanical: PASS
r2_reasoning: "Month clock, synchronized endpoints, ratio orientation, 78 candidates, residual medians, absolute objectives, equality guard, final median, contrarian sides, consumed attempt, aggregate fixed risk, atomicity, and lifecycle are deterministic and locked."
...
r4_reasoning: "Only timestamps, completed prices, logarithms, sorting, absolute loss, finite arithmetic, ATR risk controls, and execution state; no trained signal, prohibited indicator, or external runtime feed."
parameters_to_test: "Locked Q02 baseline only: 13 synchronized endpoints; exact 78-candidate LAD arithmetic; 900 D1 history bars; 1e-12 objective equality guard; 180-minute month-entry grace; 10-day endpoint staleness; ATR(20)*3.5 stops; equal target notionals; 20% notional mismatch ceiling; 40-day stale exit; 1500/3000-point spread ceilings."
...
force_build: true
review_focus: "Falsify a thirteen-completed-month oil/gas ratio exact LAD reversion basket outside the directional XAU/SP500/NDX/XNG book. Verify synchronization, consecutive months, oil-minus-gas orientation, all 78 forward slopes, residual median index 6, chronological absolute loss, 1e-12 minimizer guard, final ordinary median, contrarian sides, one attempt, aggregate fixed risk, equal-notional tolerance, atomicity, and next-month exit. Q09 alone may establish realized decorrelation."
...
synchronized oil-minus-gas log ratio, summarized by an exact least-absolute-
deviation slope, subsequently reverts. It imports no equilibrium coefficient,
...
authorized by
`decisions/2026-08-28_xtixng_monthly_lad_reversion_source_approval.md` at
commit `f96fc89ed` and extracted at commit `3eda3860a` before card review.

Villar/Joutz and Ramberg/Parsons supply a related but state-dependent oil/gas
hypothesis plus binding adverse evidence. The governed Koenker–Bassett packet
supplies exact thirteen-observation median-regression arithmetic. None tests
...
Before allocation, the fail-closed checker scanned 4,688 registry identities,
1,339 card files, and 45 current Strategy Wiki nodes and returned `CLEAN`.
Evidence is
...
- `QM5_41160_xauxag-mlad-rv` applies the same estimator to a gold/silver path
  and owns only precious-metal legs. This card owns an economically distinct
  oil/gas path and only energy legs.
- `QM5_41159_wti-lad-tr` applies the estimator to outright WTI, follows its
  sign, and owns one leg. This card applies it to a synchronized ratio, fades
  the sign, and owns an atomic equal-notional basket.
- `QM5_41188_xtixng-mrepmedian-rv` takes thirteen pivot-specific slope medians
  and one outer median. This card profiles a median intercept for every global
  candidate and selects slopes by minimum total absolute vertical loss.
- On valid ratio levels
  `[0,.02,0,0,-.06,-.09,-.05,-.05,.03,.06,-.02,-.03,.05]`, LAD is
  `-0.002` while Theil–Sen and repeated median are positive. The locked fade
  rules therefore request opposite packages on the same valid state.
- Pettitt, Mann–Whitney, Cox–Stuart, Spearman, and median-runs XTI/XNG cards
  ...
  state functions rather than absolute-loss median regression.
- `QM5_20237_xtixng-ecm-rv` fits a daily trend-augmented OLS residual with a
  ...
  residual scale, coefficient bound, or convergence exit.
- `QM5_12578_eia-oilgas-ratio` standardizes a fixed log-price ratio. This
  card uses only the strict sign of an exact LAD ratio slope.
...
- Logical tester symbol: `QM5_41189_XTI_XNG_MLAD_RV_D1` on XTI host.
- Timeframe: D1; intended magics `411890000` and `411890001`.
...
for each candidate b:
  ...
  loss(b) = sum(i=0..12) abs(s[i] - intercept - b*x[i])

minimum = min(loss(candidate[0..77]))
retain every b where abs(loss(b) - minimum) <= 1e-12
lad_slope = ordinary median of ascending retained slopes
```

Positive LAD slope means SELL XTI / BUY XNG. Negative means BUY XTI / SELL
XNG. Exact zero or invalid state consumes the month flat. Magnitude never
scales risk.

## Rules

These are the complete authorized baseline. There is no parameter sweep,
candidate pruning, iterative solver, slope bound, Theil–Sen or repeated-
median fallback, OLS, endpoint agreement, z-score, volatility signal,
seasonal filter, external series, or prior-result gate.

## 4. Entry Rules

1. Require exact EA ID `41189`, host `XTIUSD.DWX`, companion `XNGUSD.DWX`, D1,
...
7. Enumerate all 78 candidates lexicographically for `0<=i<j<=12`. Orient
   each slope from earlier to later and divide by the positive integer month-
   index distance. Reject any count other than 78 or nonfinite candidate.
8. For each candidate, compute thirteen residuals, sort a copy, select index
   six as the intercept, then recompute and sum thirteen absolute residuals in
   chronological order. Require finite residuals/intercept/objective and a
   nonnegative objective.
9. Find the minimum across all 78 objectives. Retain exactly those candidates
   within `1e-12`, require at least one, sort the retained slopes, and use the
   ordinary median. Fade the strict sign; exact zero consumes the month flat.
...
- Reject consumed attempt, owned exposure, same-month entry history, malformed
  ...
  pair, nonpositive/nonfinite close, invalid ratio/candidate/residual/
  intercept/objective/minimizer, wrong count, exact-zero statistic, excessive
...
candidate set, loss, equality convention, direction, clock, risk, stop,
balance, hold, spread, order sequence, or retry policy requires a new card and
full pipeline run.
...
governed method source documents median-regression and exact LAD arithmetic.
...
- Fail on wrong synchronization, month order, current-month leakage, stale
  endpoint, ratio orientation, candidate omission/duplication, wrong residual
  median, loss, tie set, final median, sides, retry, non-atomic package, risk-
...
|---|---|---|
| R1 | PASS | Complete government and peer-reviewed oil/gas evidence with adverse regime findings plus a complete governed peer-reviewed LAD-method reduction; estimator/carrier translation risk remains explicit. |
| R2 | PASS | Fixed endpoints, synchronization, 78 candidates, residual median, loss, equality guard, final median, direction, attempt, aggregate risk, atomicity, and exits. |
...
| R4 | PASS | Deterministic logarithms, sorting, absolute loss, calendar, and ATR risk arithmetic; no trained model, banned signal indicator, external feed, grid, or martingale. |
...
- trade_entry: durable month attempt, synchronized endpoint reconstruction,
  exact LAD minimization, spread/quote/ATR/stop checks, equal-notional sizing,
...
omission/duplication, wrong residual median, loss, equality guard, minimizer,
...
enumeration, residual median, loss order, equality convention, direction,
stop, spread caps, atomic sequence, attempt lifecycle, symbol, timeframe,
news/Friday mode, or risk mode requires a new binary and full pipeline
requalification. Realized diversification may only be assessed at unchanged
Q09; correlation failure receives no waiver here.
...
|---|---|---|---|---|
| v1 | 2026-08-28 | initial XTI/XNG exact LAD ratio-reversion card | G0 | APPROVED; build pending |

## Pipeline Phase Status

| phase | date | verdict | evidence |
|---|---|---|---|
| G0 Research Intake | 2026-08-28 | APPROVED; R1-R4 PASS | `decisions/2026-08-28_qm5_41189_xtixng_monthly_lad_reversion_g0.md`; approved source packet |
