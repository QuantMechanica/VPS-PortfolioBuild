...
type: strategy
strategy_id: EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911_S01
variant_id: EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911_S01
source_id: EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911
ea_id: QM5_41437
slug: wti-hurr-nr2-breakout
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41437_wti-hurr-nr2-breakout_card.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41437_wti_hurricane_nr2_breakout_g0.md
source_approval: decisions/2026-09-11_wti_hurricane_nr2_breakout_source_approval.md
...
source_citation: "EIA hurricane-season petroleum-supply context; Crabel systematic range-contraction and expansion lineage."
source_citations:
  - type: official_government_and_reputable_bounded_mechanization
    citation: "EIA hurricane-season context plus governed Crabel range-state lineage."
    location: strategy-seeds/sources/EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911/source.md
    quality_tier: A_lineages_with_cross_source_translation_risk
    role: hurricane_calendar_contraction_and_completed_close_breakout_lineage
strategy_mechanic: normalized-weekly-wti-august-september-october-hurricane-season-two-completed-weeks-newest-strict-narrower-range-than-prior-next-week-completed-d1-close-breakout-symmetric-one-week-hold
sources: ["[[sources/EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911]]"]
concepts: ["[[concepts/hurricane-season-supply-risk]]", "[[concepts/completed-week-volatility-contraction]]", "[[concepts/completed-close-breakout]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-d1-close]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, hurricane-season, weekly-contraction, completed-close-breakout, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
expected_trade_frequency: "Approximately 3-8 completed positions per full post-warm-up year; Q02 must prove at least three in every full scored year or retire."
...
pipeline_phase: Q02
q01_status: PASS
q01_compile_work_item: 27ca36d0-4048-42b9-8322-cce59d692de4
q01_build_report: D:/QM/reports/framework/21/build_check_20260911_094336.json
q02_status: ENQUEUED_ACTIVE
q02_work_item: e29b85e8-c31d-42a5-a3d2-3abb5ed8ecae
q02_receipt: D:/QM/strategy_farm/artifacts/receipts/first_q02_intake/27ca36d0-4048-42b9-8322-cce59d692de4_e29b85e8-c31d-42a5-a3d2-3abb5ed8ecae.json
force_build: true
review_focus: "Falsify a WTI hurricane-season weekly contraction/completed-close breakout distinct from immediate NR2 sign continuation, all-year NR7 breakout, inside-week filtered breakout, and incumbent XNG oscillator. Verify two exact completed weeks, strict range contraction without containment, current-week close chronology, both sides, durable first-breakout attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, hurricane_season_month_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_contraction, frozen_breakout_box, completed_current_week_close_only, strict_breakout_inequality, weekly_attempt_after_signal, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete official/governed reputable lineage with explicit translation risk; R2 exact mechanical seasonal NR2/completed-close breakout; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
During August through October, a completed WTI week whose full range contracts relative to the
preceding week may form a structural reference box before renewed hurricane-risk repricing. Trade
only the direction of the first completed D1 close beyond that box during the next week. The exact
rule is unproven and belongs to Q02 onward.

## Source Traceability And Non-Duplicate Decision

The source packet is
`strategy-seeds/sources/EIA-CRABEL-WTI-HURR-NR2-BREAKOUT-20260911/source.md`. EIA supports the
hurricane-risk calendar; governed Crabel work supplies range-contraction/expansion lineage. Neither
establishes this Darwinex CFD conjunction.

The canonical scan found no exact match. `QM5_41436` enters immediately in the completed week's
body direction; this rule waits for a later current-week completed-close breakout and ignores that
body. `QM5_41434/41435` require range expansion and upper-quartile close location. `QM5_41061`
requires the strict narrowest of seven weeks all year. `QM5_13075` requires literal inside-week
containment and SMA/ATR/CLV filters. This card requires only two-week relative contraction, no
containment, a hurricane calendar, and a strict later completed-close breakout.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41437, slot zero, registered magic, and
   fixed-risk backtest mode.
2. Evaluate only on a new D1 bar and only inside a normalized Monday-anchored week whose anchor
   month is August, September, or October. Require entry within 180 elapsed minutes of that bar.
...
take-profit-bearing, future-dated, or invalid-volume owned exposure. No trail, break-even, partial
close, scale-in, pyramid, grid, martingale, hedge, reversal, or re-entry is allowed.
...
EIA supplies hurricane-season physical-risk context. Governed Crabel records supply range-
contraction and expansion lineage. They do not supply this exact conjunction or its thresholds.

## QM Interpretations

August-October Monday anchors, two completed weeks, strict two-week range comparison, no
...
financing, label sensitivity, sparse seasonal samples, delayed confirmation, false breakout, stop
slippage, source translation, and overlap with other WTI candidates can dominate. Q02 owns
economics; unchanged Q09 alone owns realized portfolio correlation.
...
trades, fewer than three completed positions in a full scored year, nonpositive governed economics,
...
| Q01 Build Validation | 2026-09-11 | PASS | governed compile `27ca36d0-4048-42b9-8322-cce59d692de4`; strict build check PASS |
| Q02 Baseline Screening | 2026-09-11 | ENQUEUED_ACTIVE | work item `e29b85e8-c31d-42a5-a3d2-3abb5ed8ecae` |
