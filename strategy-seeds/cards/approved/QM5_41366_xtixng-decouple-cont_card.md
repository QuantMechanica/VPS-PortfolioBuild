...
type: strategy
strategy_id: AI-CODEX-XTIXNG-DECOUPLE-CONT-20260906_S01
variant_id: AI-CODEX-XTIXNG-DECOUPLE-CONT-20260906_S01
source_id: AI-CODEX-XTIXNG-DECOUPLE-CONT-20260906
ea_id: QM5_41366
slug: xtixng-decouple-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41366_xtixng-decouple-cont_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41366_xtixng_weekly_decoupling_continuation_g0.md
source_approval: decisions/2026-09-06_xtixng_weekly_decoupling_continuation_source_approval.md
...
source_citation: "Moskowitz, Ooi, and Pedersen (2012), Journal of Financial Economics 104(2), DOI 10.1016/j.jfineco.2011.11.003; Villar and Joutz (2006), U.S. EIA; Ramberg and Parsons (2012), The Energy Journal 33(2), DOI 10.5547/01956574.33.2.2."
source_citations:
  - type: peer_reviewed_trading_paper
    ...
    quality_tier: A
    role: futures_return_sign_continuation_and_one_period_hold_lineage
...
strategy_mechanic: normalized-week-boundary-xti-xng-synchronized-completed-week-individual-log-returns-strict-opposite-sign-decoupling-buy-winner-sell-loser-equal-notional-one-week-hold
sources:
  - "[[sources/AI-CODEX-XTIXNG-DECOUPLE-CONT-20260906]]"
concepts:
...
strategy_type_flags: [commodity, energy, oil-gas-relative-value, market-neutral-basket, opposite-direction-decoupling, cross-sectional-momentum, continuation, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41366_XTI_XNG_DECOUPLE_CONT_D1
symbol: QM5_41366_XTI_XNG_DECOUPLE_CONT_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413660000, 413660001]
period: D1
timeframe: D1
...
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_WEEKLY_CROSS_SECTIONAL_TRANSLATION_RISK
r2_mechanical: PASS
...
force_build: true
review_focus: "Falsify a completed-week WTI/natural-gas opposite-direction decoupling continuation outside the certified XAU/SP500/NDX/XNG book. Verify exact prior-two-week membership, synchronized three-to-five-session close pairs, week-end endpoint selection, strict opposite individual-return signs, winner-long/loser-short sides, durable weekly attempt, aggregate fixed risk, atomic basket repair, and next-week lifecycle. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_xti_xng_carrier, immediately_preceding_two_monday_anchors, synchronized_completed_d1_closes, three_to_five_week_sessions, exact_week_end_endpoints, strict_individual_leg_opposite_signs, winner_long_loser_short_direction, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 uses complete peer-reviewed momentum evidence plus complete U.S. government and peer-reviewed oil/gas evidence, retains adverse instability, and discloses the weekly cross-sectional continuation as an untested QM translation; R2 locks synchronized consecutive weeks, endpoint selection, individual log-return orientation, strict opposite signs, winner-long/loser-short sides, durable attempt, aggregate fixed risk, hard stops, spreads, and next-week lifecycle; R3 uses registered native XTI/XNG D1 histories with synchronization and CFD-basis risks explicit; R4 is deterministic native arithmetic without a banned signal, trained output, or external feed; repository dedup scopes and manual family review resolve the expected fuzzy siblings while the unavailable external Wiki remains explicit."
---

# QM5_41366 XTI/XNG Weekly Decoupling-Shock Continuation
...
that divergence as a decoupling shock. Buy the completed-week winner and sell
the loser as one equal-notional continuation package for the following week.
...
Moskowitz, Ooi, and Pedersen supply peer-reviewed futures-continuation
lineage. Villar/Joutz and Ramberg/Parsons supply government and peer-reviewed
evidence for a weak, time-varying oil/gas relationship, including binding
adverse instability. No source supplies the exact completed-week opposite-
direction conjunction. No source tests this energy CFD
implementation, and no return, frequency, cost, hedge-ratio, neutrality, or
correlation statistic transfers.

## Non-Duplicate Decision

The canonical checker scanned 4,846 registry rows and 1,459 cards and found no
exact identity. It returned the expected fuzzy `QM5_41365` and `QM5_41362`
siblings for manual resolution. The
...
- `QM5_41365_xtixng-decouple-rv` uses the identical one-week state but buys
  the loser and sells the winner. This card has exactly opposite package sides.
- `QM5_41362_xtixng-wdecel-cont` requires two adjacent same-sign ratio returns
  and a smaller newest magnitude, not strict cross-leg sign disagreement.
...
- `QM5_12733_xti-xng-xmom` uses a 126-D1 monthly rank and configurable band,
  not an exact one-week strict-sign state and next-week exit.
...
opposite-sign individual returns, two-sided winner-long/loser-short direction,
...
- Logical basket: `QM5_41366_XTI_XNG_DECOUPLE_CONT_D1`.
- Timeframe: exact D1; slots 0 and 1; magics `413660000` and `413660001`.
...
- Signal: individual weekly WTI and natural gas returns must have strict
  opposite signs; buy the winner and sell the loser.
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41366 and
...
9. Buy the positive-return winner and sell the negative-return loser. Same
...
- Exact host/companion, D1, EA 41366, slots zero/one, and registered magics.
...
- Own exactly zero or two positions: one `XTIUSD.DWX` leg under magic
  `413660000` and one `XNGUSD.DWX` leg under magic `413660001`.
...
Moskowitz, Ooi, and Pedersen supply futures-continuation lineage;
...
not supply this exact opposite-direction weekly decoupling conjunction.

## QM Interpretations

`AI-CODEX-XTIXNG-DECOUPLE-CONT-20260906_S01` fixes the synchronized
...
winner-long/loser-short sides, continuous-CFD mapping, durable attempt,
...
|---|---|---|---|---|
| v1 | 2026-09-06 | initial XTI/XNG weekly decoupling-shock continuation card | G0 | APPROVED; build pending |
| v2 | 2026-09-06 | governed source-fresh compile and strict build validation | Q01 | COMPILE_OK; 9/9 reference tests PASS |
| v3 | 2026-09-06 | paced first-Q02 admission check | Q02 | NOT_ENQUEUED_CPU_CEILING; average 97.695676%, maximum 99.034667% |

## Pipeline Phase Status

| Phase | Date | Status | Evidence |
|---|---|---|---|
| G0 Research Intake | 2026-09-06 | APPROVED | `decisions/2026-09-06_qm5_41366_xtixng_weekly_decoupling_continuation_g0.md` |
| Q01 Build Validation | 2026-09-06 | COMPILE_OK | work item `469c6d49-4bd3-4c4f-af33-a68739e7877c`; EX5 `1b10812d1df947a00365aba98fd5988756e255d1c77b90ac61cbe0944e5c0563`; `artifacts/qm5_41366_q01_compile_20260906.json` |
| Q02 Baseline Screening | 2026-09-06 | NOT_ENQUEUED_CPU_CEILING | `artifacts/qm5_41366_q02_cpu_admission_20260906.json` |
