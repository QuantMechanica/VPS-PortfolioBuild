...
type: strategy
strategy_id: MOP-WTI-WRESUME-DOM-2026_S01
variant_id: MOP-WTI-WRESUME-DOM-2026_S01
source_id: MOP-WTI-WRESUME-DOM-2026
ea_id: QM5_41071
slug: wti-wresume-dom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41071_wti-wresume-dom_card.md
execution_contract_status: APPROVED
created: 2026-08-20
created_by: Research+Development
last_updated: 2026-08-20
g0_status: APPROVED
g0_decision: decisions/2026-08-20_qm5_41071_wti_weekly_resumption_dominance_g0.md
source_approval: decisions/2026-08-20_wti_weekly_resumption_dominance_source_approval.md
...
source_citations:
  - type: academic_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; Sections 3.1-3.2; Appendix A; complete-read packet strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded translation strategy-seeds/sources/MOP-WTI-WRESUME-DOM-2026/source.md"
    quality_tier: A
    role: own_return_sign_continuation_and_wti_carrier_lineage
strategy_mechanic: normalized-week-boundary-wti-three-adjacent-nonoverlapping-week-returns-outer-same-sign-middle-opposed-newest-absolute-return-strictly-dominates-counterweek-resumed-sign-continuation-one-week-hold
sources:
  - "[[sources/MOP-WTI-WRESUME-DOM-2026]]"
concepts:
  - "[[concepts/time-series-momentum]]"
  - "[[concepts/weekly-trend-resumption]]"
  - "[[concepts/wti-structural-trend]]"
indicators:
  - "[[indicators/adjacent-completed-week-log-returns]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, wti-crude, time-series-momentum, weekly-resumption-dominance, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
period: D1
timeframe: D1
expected_trade_frequency: "Approximately 5-10 completed WTI positions per full post-warm-up year after the strict three-week resumption and execution gates; Q02 must prove at least five/year or retire."
expected_trades_per_year_per_symbol: 7
expected_pf: 1.01
expected_dd_pct: 30.0
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_WEEKLY_RESUMPTION_TRANSLATION_RISK
r2_mechanical: PASS
...
q01_build_report: D:/QM/reports/framework/21/build_check_20260820_153631.json
q01_p1_evidence: D:/QM/reports/pipeline/QM5_41071/P1/P1_QM5_41071_result.json
review_focus: "Falsify a direct-WTI weekly resumption sleeve outside the certified XAU/SP500/NDX/XNG book. Verify uniform energy labels, exact Monday anchors, four completed week-end closes, three disjoint weekly returns, outer-sign equality, opposed middle, strict resumed-move dominance, resumed-sign direction, one attempt, and next-week exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_symbol_period, normalized_energy_label, first_tradable_week_bar, consecutive_monday_anchors, completed_week_endpoints, strict_outer_sign_equality, strict_opposed_middle, strict_resumed_magnitude_dominance, resumed_sign_direction, no_current_week_leakage, weekly_attempt_state, risk_mode_dual, hard_stop_present, next_week_exit, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER-authorized build; R1 named-author peer-reviewed source with complete-read evidence and weekly resumption translation risk disclosed; R2 exact clock, anchors, endpoints, chronological sign and magnitude state, side, attempt, risk, and lifecycle; R3 registered native WTI D1 only; R4 deterministic arithmetic without banned signal or trained logic; canonical dedup CLEAN and manual family review separated generic handoff, immediate pullback, same-sign acceleration/deceleration, monthly, relative-basket, range, and volatility-ranked identities."
---
...
A completed WTI trend week, one completed counterweek, and a third completed
week that restores the original sign with a larger absolute move than the
counterweek may identify a resumed trend rather than an unresolved reversal.
On the first tradable bar of the next broker week, the strategy follows the
resumed sign for one week.

The source establishes broad own-return continuation and WTI membership, not
this weekly path, magnitude condition, standalone CFD result, or portfolio
...
`strategy-seeds/sources/MOP-WTI-WRESUME-DOM-2026/source.md`, approved before
card extraction in
`decisions/2026-08-20_wti_weekly_resumption_dominance_source_approval.md` at
commit `b3f0cbd8e`.
...
test weekly WTI, a three-return resume/counter/resume path, a strict
newest-versus-counter magnitude condition, continuous-CFD week-end closes,
...
- `QM5_41065_wti-wflip-mom` trades every two-week sign handoff without an
  older trend anchor or magnitude dominance; this card requires a third older
  week whose sign is restored by a separate, dominant newest week.
- `QM5_41069_wti-wpull-trend` enters immediately after a smaller counterweek
  in the older sign; this card waits for a further completed resumption week.
...
- `QM5_41064_wti-mflip-mom` uses two completed calendar months and follows the
  newest month sign without this four-week-end path.
- `QM5_20273_wti-signrun-tr` scores a multi-month sign run, not a strict
  three-week resume/counter/resume state.
- `QM5_13049_xti-1w-mom-vol` and `QM5_21503_xti-weekly-tsmom-lowvol` use one
  return plus a volatility state; this card uses three returns and no
  volatility estimate or rank.
...
- Timeframe: exact D1; magic slot 0; magic `410710000`.
...
- Signal: outer returns share a strict sign, the middle return opposes, and
  the newest absolute return strictly exceeds the middle countermove;
  direction equals the resumed newest sign.
- Normal exit: first tick whose broker Monday anchor is later than the open
  position's anchor.
- Expected cadence: approximately 5-10 completed positions/year.
...
and abs(r_resume) > abs(r_counter)                         => BUY

r_oldest < 0 and r_counter > 0 and r_resume < 0
and abs(r_resume) > abs(r_counter)                         => SELL
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41071 and
   magic slot zero.
...
8. Compute the three chronological log returns. BUY only for strict
   positive/negative/positive signs and SELL only for strict
   negative/positive/negative signs. In either case require the newest
   absolute return to be strictly larger than the middle countermove. Zero,
   equality, any other sign path, or failed dominance stays flat.
...
- Exact host, D1, EA 41071, slot zero, and registered magic.
...
- Uniform label normalization, first-week-bar clock, 180-minute grace,
  endpoint chronology, strict path and magnitude state, durable attempt,
...
- Own at most one `XTIUSD.DWX` position under magic `410710000`.
...
membership. They do not supply the weekly horizon, resume/counter/resume path,
dominance condition, or CFD execution choices.

## QM Interpretations

`MOP-WTI-WRESUME-DOM-2026_S01` fixes the weekly horizon, strict three-return
path and dominance gate, continuous-CFD Monday anchors and week-end closes,
...
- Major risks are false trend resumption, weekend gaps, continuous-CFD
...
wrong sign path, absent strict dominance, wrong side, current-week leakage,
late or repeated attempt, missing hard stop, wrong next-week close,
nondeterminism, or invalid fixed-risk mode.

Changing the WTI carrier, endpoint count, weekly horizon, sign path,
magnitude condition, direction, attempt clock, risk, stop, or lifecycle
...
removing the outer anchor or counterweek, relaxing dominance, reversing the
side, adding a return threshold, changing the hold, or adding a calendar,
...
|---|---|---|
| exact host/period, label, week anchors, endpoints, returns, strict path/dominance state, attempt, spread, ATR | Trade Entry | `Strategy_EntrySignal` plus deterministic helpers |
...
completed week ends; three adjacent non-overlapping returns; positive and
negative resumption directions; outer-sign mismatch, non-opposed middle,
equality, zero, and failed-dominance flat states; no current-bar leakage;
...
|---|---|---|---|---|
| v1 | 2026-08-20 | initial WTI completed-week resumption-dominance card | G0 | APPROVED |
...
| v1-q02-capacity | 2026-08-20 | target-only dry run selected one fresh row; apply withheld at 97.36% average host CPU | Q02 | NOT_ENQUEUED_CPU_CEILING |

## Pipeline Phase Status

| Phase | Date | Status | Evidence |
|---|---|---|---|
| G0 Research Intake | 2026-08-20 | APPROVED | `decisions/2026-08-20_qm5_41071_wti_weekly_resumption_dominance_g0.md` |
| Q01 Build Validation | 2026-08-20 | PASS | `D:/QM/reports/framework/21/build_check_20260820_153631.json`; `D:/QM/reports/pipeline/QM5_41071/P1/P1_QM5_41071_result.json` |
| Q02 Baseline Screening | 2026-08-20 | NOT_ENQUEUED_CPU_CEILING | `docs/ops/evidence/2026-08-20_qm5_41071_wti_weekly_resumption_q01_q02_cpu_ceiling_stop.md` |
