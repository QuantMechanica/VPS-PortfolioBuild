...
slug: wti-wed-trend
type: strategy
strategy_id: LI-MOP-WTI-WEDTREND-2026_S01
variant_id: LI-MOP-WTI-WEDTREND-2026_S01
source_id: LI-MOP-WTI-WEDTREND-2026
status: DRAFT
g0_status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_20154_wti-wed-trend_card.md
execution_contract_status: DRAFT
created: 2026-07-25
created_by: Research+Development
strategy_mechanic: wednesday-wti-long-only-when-completed-252d-return-is-positive
...
timeframe: D1
timeframes: [D1]
expected_trade_frequency: "Approximately 12-30 Wednesday packages/year; Q02 must prove >=5/year."
...
q01_status: PASS
q02_status: ENQUEUED
q02_work_item_id: 2d67d318-509a-4e5d-9fc2-1aff90be0b76
modules_used: [no_trade, trade_entry, trade_management, trade_close]
g0_approval_reasoning: "OWNER commodity/energy sleeve mission: R1 PASS governed peer-reviewed composite packet; R2 PASS genuine Wednesday boundary, positive completed 252-D1 return, one BUY, ATR stop, next-D1 exit, and persistent weekly attempt; R3 PASS registered XTIUSD.DWX D1; R4 PASS deterministic native MT5 data only, no ML/grid/martingale. Deterministic dedup CLEAN and manual semantic neighbor review complete."
---

# QM5_20154 WTI Wednesday Positive-Trend Long

## Hypothesis

WTI's source-documented positive Wednesday return may be more coherent when its
...
1. Run only on exact `XTIUSD.DWX`, D1, EA 20154, magic slot 0.
2. Evaluate only the first executable tick within five minutes of a Wednesday
   D1 bar whose immediately prior completed D1 bar is Tuesday. Do not shift
...
Li et al. supply the positive WTI Wednesday direction. Moskowitz et al.
...
The exact Wednesday-after-Tuesday boundary, five-minute grace, 252 D1 bars,
...
- no_trade: exact host/D1/EA/slot, locked inputs, news OFF, Friday close, and
  identity guards.
- trade_entry: genuine Wednesday-after-Tuesday, positive completed 252-D1
...
2. First non-Wednesday D1 boundary or wrong-side cleanup.
