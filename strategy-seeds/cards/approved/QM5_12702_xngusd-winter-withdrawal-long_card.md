...
This is deliberately different from `QM5_12567_cum-rsi2-commodity` because it uses no RSI, oscillator, or short-horizon pullback logic. It is winter-only and long-only, not the broader `QM5_12575` winter/summer/shoulder calendar map, not `QM5_12586` Donchian winter breakout, and not an XNG storage/event/fade/weekend-gap or energy-ratio basket.
