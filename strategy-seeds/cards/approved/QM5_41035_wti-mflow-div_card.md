...
type: strategy
strategy_id: WILLIAMS-MOP-WTI-MFLOWDIV-2026_S01
variant_id: WILLIAMS-MOP-WTI-MFLOWDIV-2026_S01
source_id: WILLIAMS-MOP-WTI-MFLOWDIV-2026
ea_id: QM5_41035
slug: wti-mflow-div
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41035_wti-mflow-div_card.md
execution_contract_status: APPROVED
created: 2026-08-17
created_by: Research+Development
last_updated: 2026-08-17
g0_status: APPROVED
g0_decision: decisions/2026-08-17_wti_monthly_flow_divergence_g0.md
source_approval: decisions/2026-08-17_wti_monthly_flow_divergence_source_approval.md
...
strategy_mechanic: exact-immediately-completed-broker-month-wti-close-open-and-open-close-log-flow-strict-sign-opposition-follow-session-entry-first-new-month-hold-to-next-month
sources:
  - "[[sources/WILLIAMS-MOP-WTI-MFLOWDIV-2026]]"
concepts:
...
strategy_type_flags: [commodity, energy, crude-oil, price-flow-decomposition, flow-divergence, monthly-entry, monthly-hold, atr-hard-stop, low-frequency, symmetric-long-short]
...
`strategy-seeds/sources/WILLIAMS-MOP-WTI-MFLOWDIV-2026/source.md`, approved
before card extraction in
`decisions/2026-08-17_wti_monthly_flow_divergence_source_approval.md` at commit
`56fe6878e`.
...
The deterministic pre-allocation checker scanned 4,522 EA-registry rows and
618 root cards. It found no exact match and raised three expected fuzzy family
...
- `QM5_41033_wti-flow-dom` follows the reconciled total/dominant component of
  an opposed-flow week. This card always follows monthly session flow and can
  oppose its completed-month total when overnight magnitude dominates.
- `QM5_20187_wti-tsmom1m` trades every nonzero completed-month total. This card
  rejects agreement months and follows session flow rather than total flow.
...
- Timeframe: D1; magic slot 0; planned magic `410350000`.
...
- Exact host `XTIUSD.DWX`, D1, `qm_ea_id=41035`, and slot 0 only.
...
| v1-q02 | 2026-08-17 | one paced WTI baseline row created | Q02 | ENQUEUED |
...
- Q02: `ENQUEUED` — pending work item
  `6c8f3dd6-7d8c-4400-8c74-7f6cc754db29`.
