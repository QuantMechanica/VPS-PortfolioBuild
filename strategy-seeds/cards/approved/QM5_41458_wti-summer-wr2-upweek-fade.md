...
type: strategy
strategy_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912_S01
variant_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912_S01
source_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912
ea_id: QM5_41458
slug: wti-summer-wr2-upweek-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41458_wti-summer-wr2-upweek-fade.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41458_wti_summer_wr2_positive_week_reversion_g0.md
source_approval: decisions/2026-09-12_wti_summer_wr2_positive_week_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_reputable_and_academic_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912/source.md
    quality_tier: B_and_governed_reputable_and_academic_lineages_with_translation_risk
    role: june_october_calendar_range_expansion_and_positive_week_reversion_lineage
strategy_mechanic: normalized-weekly-wti-june-through-october-two-completed-weeks-newest-strict-wider-range-than-prior-positive-final-week-body-short-only-reversion-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912]]"]
concepts: ["[[concepts/wti-summer-seasonality]]", "[[concepts/completed-week-range-expansion]]", "[[concepts/commodity-reversal]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-week-body]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, summer-negative-leg, weekly-range-expansion, positive-week-body, short-only, weekly-reversion, atr-hard-stop, time-stop, low-frequency]
...
q02_status: PENDING
force_build: true
review_focus: "Falsify a WTI June-October range-expansion positive-week short fade distinct from the certified XNG oscillator, unconditional summer short, generic summer momentum/reversal, winter expansion body fade, and winter expansion CLV fade. Verify exact weeks, strict inequalities, short-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, june_october_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_expansion, strict_positive_week_body, short_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed, academic, and governed reputable lineage with explicit translation risk; R2 exact mechanical WTI summer WR2/positive-week short reversion; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact repository duplicate after canonical and manual fuzzy-family review."
---
...
after range expansion may be a temporary counter-seasonal bounce. Short at the next normalized
...
The canonical scan found no exact repository identity and six fuzzy family matches; its external
...
`QM5_41457` requires strict range contraction; this card requires the opposite, strict expansion.
`QM5_41444` is symmetric and November-May. Carrier, June-October clock, expansion state, positive
weekly body, short-only side, and one-week hold are jointly load-bearing.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41458, slot zero, registered magic, and
...
Monday anchors, two completed weeks, strict range expansion, positive-body predicate, boundary
...
range expansion, range tie, strict positive body, zero/negative-body flat states, short-only
