...
type: strategy
strategy_id: FMR-CME-XAUXAG-WRELVOTE-FLIP-CONT-20260910_S01
variant_id: FMR-CME-XAUXAG-WRELVOTE-FLIP-CONT-20260910_S01
source_id: FMR-CME-XAUXAG-WRELVOTE-FLIP-CONT-20260910
ea_id: QM5_41414
slug: xauxag-wrelvote-flip-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41414_xauxag-wrelvote-flip-cont_card.md
execution_contract_status: APPROVED
created: 2026-09-10
created_by: Research+Development
last_updated: 2026-09-10
g0_status: APPROVED
g0_decision: decisions/2026-09-10_qm5_41414_xauxag_weekly_relative_vote_flip_continuation_g0.md
source_approval: decisions/2026-09-10_xauxag_weekly_relative_vote_flip_continuation_source_approval.md
...
source_citations:
  - type: peer_reviewed_plus_exchange_bounded_mechanization
    citation: "Fuertes-Miffre-Rallis commodity momentum evidence plus CME gold/silver ratio and intermarket-spread lineage; QuantMechanica governed overlapping weekly relative-vote translation."
    location: strategy-seeds/sources/FMR-CME-XAUXAG-WRELVOTE-FLIP-CONT-20260910/source.md
...
strategy_mechanic: normalized-week-boundary-xau-xag-five-synchronized-completed-week-endpoints-four-adjacent-relative-log-returns-overlapping-older-and-newer-three-week-strict-sign-majorities-strict-majority-flip-newest-majority-winner-continuation-equal-notional-one-week-basket
strategy_type_flags: [commodity, precious-metals, gold-silver-relative-value, market-neutral-basket, overlapping-three-week-relative-vote, majority-flip, newest-majority-continuation, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41414_XAU_XAG_WRELVOTE_FLIP_CONT_D1
symbol: QM5_41414_XAU_XAG_WRELVOTE_FLIP_CONT_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [414140000, 414140001]
period: D1
timeframe: D1
...
force_build: true
review_focus: "Falsify a fresh overlapping-three-week XAU/XAG relative-majority flip continuation outside the certified directional XAU/SP500/NDX/XNG book. Verify five consecutive synchronized completed-week endpoints, exact four strict signs, overlapping majority windows, strict majority flip, newest-majority continuation, durable weekly attempt, aggregate fixed risk, atomic package repair, and next-week lifecycle. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_xau_xag_carrier, immediately_preceding_five_monday_anchors, synchronized_completed_d1_closes, three_to_five_week_sessions, four_adjacent_relative_returns, strict_nonzero_return_differences, overlapping_three_return_majorities, strict_majority_flip, newest_majority_continuation, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 preserves one governed source packet with peer-reviewed commodity-momentum and official exchange carrier lineage while disclosing the untested weekly overlapping-vote translation; R2 locks endpoints, signs, vote windows, flip, continuation direction, lifecycle, and risk; R3 uses registered native XAU/XAG D1 data; R4 uses deterministic non-trained arithmetic. No exact duplicate exists; the energy-carrier analogue is economically different, the XAU/XAG strict-alternation siblings use four rather than five endpoints, and monthly votes use different clocks and return objects."
---

# QM5_41414 XAU/XAG Weekly Relative-Vote Flip Continuation

## Hypothesis

A fresh reversal in the overlapping three-week majority of XAU-minus-XAG
relative returns may identify a new relative-information regime. The EA follows
...
Neither defines this weekly vote-flip signal or two-metal CFD port.

The canonical checker found no exact identity. `QM5_41372` uses the same state
on the XTI/XNG energy carrier. `QM5_41413` requires exact alternation across
...
three-return majorities, a strict majority flip, newest-majority continuation,
...
- Newer majority positive: buy XAU and sell XAG.
- Newer majority negative: sell XAU and buy XAG.
...
- Exact host, D1, EA 41414, slot zero, both registered magics, and the locked
