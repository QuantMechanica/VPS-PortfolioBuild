...
type: strategy
strategy_id: AI-CODEX-XTIXNG-WACCEL-RV-20260906_S01
variant_id: AI-CODEX-XTIXNG-WACCEL-RV-20260906_S01
source_id: AI-CODEX-XTIXNG-WACCEL-RV-20260906
ea_id: QM5_41359
slug: xtixng-waccel-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41359_xtixng-waccel-rv_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41359_xtixng_weekly_acceleration_overshoot_g0.md
source_approval: decisions/2026-09-06_xtixng_weekly_acceleration_overshoot_source_approval.md
...
strategy_mechanic: synchronized-completed-two-adjacent-week-xti-minus-xng-relative-returns-same-sign-newest-strictly-larger-fade-newest-direction-one-week-equal-notional-basket
strategy_type_flags: [commodity, energy, oil-gas-ratio, market-neutral-basket, weekly-acceleration-overshoot, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41359_XTI_XNG_WACCEL_RV_D1
symbol: QM5_41359_XTI_XNG_WACCEL_RV_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413590000, 413590001]
period: D1
timeframe: D1
...
may capture convergence without taking an outright single-energy signal.
...
`decisions/2026-09-06_xtixng_weekly_acceleration_overshoot_source_approval.md`.
...
the exact two-return acceleration-overshoot arithmetic only. No source tests
...
The canonical checker scanned 4,839 registry rows and 1,452 cards, found no
exact identity, and surfaced five fuzzy family matches. Manual review fixes
the boundaries:

- `QM5_41076_xauxag-waccel-rv` shares the arithmetic but uses precious metals.
- `QM5_41358_xtixng-wovershoot-rv` requires opposite-sign relative returns;
  this card requires strict same-sign moves, so the states are disjoint.
...
returns, strict same-sign agreement, strict newest acceleration, inverse side,
weekly attempt, equal-target-notional aggregate-risk package, and next-week
exit are jointly load-bearing.

## Markets, Timeframe, And Cadence

- Exact host: `XTIUSD.DWX`, D1, slot 0, magic `413590000`.
- Exact companion: `XNGUSD.DWX`, D1, slot 1, magic `413590001`.
...
- Signal: two strict same-sign weekly relative returns with a strictly larger
  newest magnitude; fade the shared direction.
...
1. Evaluate only once on a new exact host D1 bar under EA 41359 and slot zero.
...
6. Require both relative returns finite and non-zero, strict same sign, and
   `abs(r_new)>abs(r_old)`. Opposed signs, equality, or non-acceleration is flat.
7. Fade the shared sign through opposed legs exactly as the formula specifies.
...
- Exact host, D1, EA 41359, slot zero, and both registered magics.
...
arithmetic lineage. They do not supply the energy-carrier acceleration fade.
...
endpoints, nonconsecutive anchors, current-week leakage, opposed signs, zero,
equality, non-accelerating entry, wrong side, duplicate attempt, one-leg
survivor, aggregate-risk breach, excessive mismatch, missing stop, wrong exit,
nondeterminism, or invalid fixed-risk mode.

Changing the carrier, endpoint count, horizon, sign or acceleration condition,
...
strict same-sign acceleration directions; opposed-sign, zero, equality, and
non-acceleration flat states; no current-bar leakage; durable weekly attempts;
...
|---|---|---|---|---|
| v1 | 2026-09-06 | initial completed-week XTI/XNG acceleration-overshoot card | G0 | APPROVED |
...
|---|---|---|---|
| G0 Research Intake | 2026-09-06 | APPROVED | `decisions/2026-09-06_qm5_41359_xtixng_weekly_acceleration_overshoot_g0.md` |
| Q01 Build Validation | 2026-09-06 | COMPILE_OK; BUILD_CHECK_PASS | `D:/QM/reports/work_items/72fb26b3-2612-40a0-86a7-cdc3e7b38a63/QM5_41359/COMPILE_EA/compile_evidence.json` |
| Q02 Baseline Screening | 2026-09-06 | ENQUEUED_PENDING | work item `00cf2ac1-4083-4c6b-9de5-d14e841b411e`; CPU admission `artifacts/qm5_41359_q02_cpu_admission_20260906.json` |
