...
type: strategy
strategy_id: BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911_S01
variant_id: BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911_S01
source_id: BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911
ea_id: QM5_41444
slug: wti-winter-wr2-body-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41444_wti-winter-wr2-body-fade.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41444_wti_winter_wr2_body_reversion_g0.md
source_approval: decisions/2026-09-11_wti_winter_wr2_body_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_reputable_and_academic_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911/source.md
    quality_tier: B_and_governed_reputable_and_academic_lineages_with_translation_risk
    role: november_may_calendar_range_expansion_and_body_reversion_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-two-completed-weeks-newest-strict-wider-range-than-prior-own-body-sign-symmetric-reversion-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911]]"]
...
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, weekly-range-expansion, body-sign, symmetric-long-short, weekly-reversion, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 11,12,1,2,3,4,5; two immediately completed consecutive weeks with 3-5 sessions each; newest range strictly greater than prior; newest body close strictly above open sells and strictly below open buys; body equality is flat; 30 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
pipeline_phase: Q01_PASS_Q02_RESOURCE_BLOCKED
q01_status: PASS
...
q02_status: NOT_ENQUEUED_D_FREE_FLOOR
force_build: true
...
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_expansion, strict_own_body_sign, contrarian_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed, governed reputable, and academic lineages with explicit translation risk; R2 exact mechanical WTI winter WR2/body symmetric reversion; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
represent short-horizon overreaction rather than persistent repricing. Fade the newest completed
week's open-to-close direction at the next normalized week boundary and hold one week. This exact
Darwinex-CFD rule is unproven and belongs to Q02.

## Source Traceability And Non-Duplicate Decision

The source packet is
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911/source.md`.
...
The canonical scan found no exact match. `QM5_41442` trades only strict outer-quartile close
locations and ignores body sign. This rule trades every nonzero body after expansion, so it also
covers middle-range closes and body/CLV disagreements. `QM5_41443` follows the same body state
instead of fading it. `QM5_41403` and `QM5_41408` require two same-sign weeks without the range or
winter predicates; `QM5_41096` uses intraweek excursion rejection. Certified `QM5_12567` is an
XNG cumulative-RSI pullback. The new identity requires WTI, the full November-May clock, two-week
range expansion, the newest week's own body sign, symmetric reversion, and a one-week hold.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41444, slot zero, registered magic, and
...
range expansion, range tie, positive, negative, and zero body states, both contrarian sides,
...
| Q02 Baseline Screening | - | NOT_ENQUEUED_D_FREE_FLOOR | CPU passed; D: 57.97 GiB remained below the governed 100 GiB intake floor |
