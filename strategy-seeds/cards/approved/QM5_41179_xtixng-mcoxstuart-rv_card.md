...
parameters_to_test: "Locked Q02 baseline only: 14 synchronized endpoints; exactly 7 lag-seven pairs; strict 5-of-7 sign threshold; 900 D1 history bars; 180-minute month-entry grace; 10-day endpoint staleness; ATR(20)*3.5 stops; equal target notionals; 20% mismatch ceiling; 40-day stale exit; 1500/3000-point spread ceilings."
...
| `strategy_pair_count` | 7 | fixed half-sample pair count and lag |
| `strategy_signs_required` | 5 | strict directional sign threshold |
