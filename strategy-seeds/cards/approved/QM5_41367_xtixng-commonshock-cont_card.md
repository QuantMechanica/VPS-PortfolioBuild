...
type: strategy
strategy_id: AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906_S01
variant_id: AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906_S01
source_id: AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906
ea_id: QM5_41367
slug: xtixng-commonshock-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41367_xtixng-commonshock-cont_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41367_xtixng_weekly_common_shock_continuation_g0.md
source_approval: decisions/2026-09-06_xtixng_weekly_common_shock_continuation_source_approval.md
...
source_citations:
  - type: peer_reviewed_trading_paper
    ...
    quality_tier: A
    role: commodity_cross_sectional_winner_minus_loser_continuation
...
strategy_mechanic: normalized-week-boundary-xti-xng-synchronized-completed-week-individual-log-returns-strict-same-sign-common-shock-relative-winner-continuation-equal-notional-one-week-hold
sources:
  - "[[sources/AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906]]"
concepts:
...
strategy_type_flags: [commodity, energy, oil-gas-relative-value, market-neutral-basket, common-direction-dispersion, cross-sectional-momentum, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41367_XTI_XNG_COMMONSHOCK_CONT_D1
symbol: QM5_41367_XTI_XNG_COMMONSHOCK_CONT_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413670000, 413670001]
period: D1
timeframe: D1
...
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_WEEKLY_TWO_ASSET_TRANSLATION_RISK
r2_mechanical: PASS
...
hard_rules_at_risk: [exact_xti_xng_carrier, immediately_preceding_two_monday_anchors, synchronized_completed_d1_closes, three_to_five_week_sessions, exact_week_end_endpoints, strict_individual_leg_same_sign, strict_relative_return_inequality, winner_long_loser_short_direction, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 uses complete peer-reviewed commodity cross-sectional-momentum evidence plus complete U.S. government and peer-reviewed oil/gas evidence, retains adverse instability, and discloses the weekly two-asset common-shock continuation as an untested QM translation; R2 locks synchronized consecutive weeks, endpoint selection, individual log-return orientation, strict shared sign, strict relative inequality, winner-long/loser-short sides, durable attempt, aggregate fixed risk, hard stops, spreads, and next-week lifecycle; R3 uses registered native XTI/XNG D1 histories with synchronization and CFD-basis risks explicit; R4 is deterministic native arithmetic without a banned signal, trained output, or external feed; canonical dedup and manual carrier-family review resolve the expected fuzzy siblings while the unavailable external Wiki remains explicit."
---

# QM5_41367 XTI/XNG Weekly Common-Shock Relative Continuation
...
sign as a common-shock admission state. Continue the relative displacement by
buying the energy contract with the larger completed return and selling the
one with the smaller return as one equal-notional package for the following
week.

The peer-reviewed momentum source supports commodity winner-minus-loser
continuation, while the government and peer-reviewed energy sources support
testing a weak, time-varying oil/gas relationship. They do not establish this
weekly two-asset signal, efficacy, or neutrality. No ex-ante profitability,
neutrality, or decorrelation claim is made.

## Source Traceability And Claim Boundary

The approved source of record is
`strategy-seeds/sources/AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906/source.md`,
authorized before extraction in
`decisions/2026-09-06_xtixng_weekly_common_shock_continuation_source_approval.md`.

Fuertes, Miffre, and Rallis supply peer-reviewed broad-universe commodity
cross-sectional-momentum lineage. Villar/Joutz and Ramberg/Parsons supply
government and peer-reviewed evidence for a weak, time-varying oil/gas
relationship, including binding adverse instability. No source tests a
weekly, two-asset, common-sign energy CFD package, and no return, frequency,
cost, hedge-ratio, neutrality, or correlation statistic transfers.

## Non-Duplicate Decision

The canonical checker scanned 4,847 registry rows and 1,460 cards, found no
exact identity, and surfaced six expected fuzzy family matches. The optional
external Wiki root was unavailable and this coverage limit remains explicit.

- `QM5_41361_xtixng-commonshock-rv` uses the identical one-week common-sign
  state but sells the relative winner and buys the loser. This card reverses
  both package sides by following the relative winner.
- `QM5_41086` owns common-shock reversion on XAU/XAG; this card owns the
  economically distinct WTI/natural-gas carrier and continuation direction.
...
- `QM5_41366_xtixng-decouple-cont` follows the relative winner only when the
  individual returns have opposite signs. This card's strict same-sign state
  is disjoint.
- `QM5_12733_xti-xng-xmom` ranks a monthly 126-D1 formation return with a
  configurable band, not one exact completed week with a zero deadband.
...
same-sign individual returns, symmetric relative-winner continuation, persistent
...
- Logical basket: `QM5_41367_XTI_XNG_COMMONSHOCK_CONT_D1`.
- Timeframe: exact D1; slots 0 and 1; magics `413670000` and `413670001`.
...
- Signal: individual weekly WTI and natural gas returns must share a strict sign;
  follow the strict relative winner.
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41367 and
...
9. If `g>s`, buy XTI and sell XNG. If `g<s`, sell XTI and buy XNG. Mixed signs,
...
- Exact host/companion, D1, EA 41367, slots zero/one, and registered magics.
...
- Own exactly zero or two positions: one `XTIUSD.DWX` leg under magic
  `413670000` and one `XNGUSD.DWX` leg under magic `413670001`.
...
Fuertes, Miffre, and Rallis supply broad-universe commodity cross-sectional-
momentum lineage. Villar/Joutz and Ramberg/Parsons supply evidence for testing
a weak, time-varying oil/gas relationship and preserve adverse instability.
They do not supply this weekly two-asset common-sign conjunction.

## QM Interpretations

`AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906_S01` fixes the synchronized
...
relative-winner continuation, continuous-CFD mapping, durable attempt,
...
negative same-sign directions; winner-long/loser-short WTI and natural gas leadership; mixed-
