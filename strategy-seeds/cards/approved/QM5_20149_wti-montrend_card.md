...
slug: wti-montrend
type: strategy
strategy_id: QUAY-MOP-WTI-MONTREND-2026_S01
variant_id: QUAY-MOP-WTI-MONTREND-2026_S01
source_id: QUAY-MOP-WTI-MONTREND-2026
status: DRAFT
g0_status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_20149_wti-montrend_card.md
execution_contract_status: DRAFT
created: 2026-07-25
created_by: Research+Development
last_updated: 2026-07-25
source_authors: "H. A. Quayyum, M. A. M. Khan, S. M. Ali; Tobias J. Moskowitz, Yao Hua Ooi, Lasse Heje Pedersen"
strategy_mechanic: monday-wti-short-only-when-completed-252d-return-is-negative
...
sources:
  - "[[sources/QUAY-MOP-WTI-MONTREND-2026]]"
concepts:
...
timeframe: D1
timeframes: [D1]
expected_trade_frequency: "Approximately 12-30 completed Monday-session WTI packages/year when the completed 252-D1 return is strictly negative; Q02 must prove or retire the density."
...
directional state. Taking the WTI Monday short only when the completed
...
`strategy-seeds/sources/QUAY-MOP-WTI-MONTREND-2026/source.md` preserves the
...
research cards and returned `CLEAN` for slug `wti-montrend`, strategy ID
`QUAY-MOP-WTI-MONTREND-2026_S01`, and mechanic
`Monday WTI short only when completed 252-D1 return is negative`.
...
- `QM5_20145_wti-fri-trend` buys positive-trend Fridays; this card shorts
  negative-trend Mondays.
- `QM5_12567_cum-rsi2-commodity` is a two-day oscillator pullback.

The genuine Monday boundary and negative completed 252-D1 sign are jointly
...
- Timeframe: D1.
- Magic slot: 0; allocated magic `201490000`.
...
10. Open at most one position for magic `201490000`; no pending order,
...
- One position for magic `201490000` and one consumed decision per broker
  week.
...
There is no baseline parameter sweep. The Monday gate and negative 252-D1 sign
...
- trade_entry: genuine Monday boundary, negative completed 252-D1 state, one
