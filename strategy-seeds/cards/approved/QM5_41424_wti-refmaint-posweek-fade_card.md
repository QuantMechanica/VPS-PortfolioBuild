...
type: strategy
strategy_id: EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910_S01
variant_id: EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910_S01
source_id: EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910
ea_id: QM5_41424
slug: wti-refmaint-posweek-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41424_wti-refmaint-posweek-fade_card.md
execution_contract_status: APPROVED
created: 2026-09-10
created_by: Research+Development
last_updated: 2026-09-10
g0_status: APPROVED
g0_decision: decisions/2026-09-10_qm5_41424_wti_refinery_maintenance_positive_week_reversion_g0.md
source_approval: decisions/2026-09-10_wti_refinery_maintenance_positive_week_reversion_source_approval.md
source_author: "U.S. Energy Information Administration; Chao Yang; A. Goncu; Athanasios A. Pantelous; OpenAI Codex"
source_authors: "U.S. Energy Information Administration; Chao Yang; A. Goncu; Athanasios A. Pantelous; OpenAI Codex"
source_citation: "EIA refinery-outage and maintenance-season context; Yang, Goncu and Pantelous (2017), Momentum and Reversal in Commodity Futures, SSRN 3069253."
source_citations:
  - type: official_government_and_academic_bounded_mechanization
    citation: "EIA refinery-maintenance seasonality plus Yang-Goncu-Pantelous commodity-reversal lineage; QuantMechanica governed positive-week WTI translation."
    location: strategy-seeds/sources/EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910/source.md
    quality_tier: A_lineages_with_cross_source_and_short_horizon_translation_risk
    role: maintenance_regime_context_and_commodity_reversal_lineage
strategy_mechanic: normalized-weekly-wti-one-immediately-completed-week-open-to-close-strict-positive-log-return-short-reversion-only-february-march-september-october-one-week-hold
sources: ["[[sources/EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910]]"]
concepts: ["[[concepts/commodity-reversal]]", "[[concepts/refinery-maintenance-season]]", "[[concepts/positive-week-reversion]]"]
indicators: ["[[indicators/completed-week-open-close]]", "[[indicators/log-return-sign]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, refinery-maintenance, positive-week, weekly-reversal, short-only, atr-hard-stop, time-stop, low-frequency]
...
expected_trade_frequency: "Approximately 7-10 completed positions per full post-warm-up year after the positive-week gate; Q02 must prove at least five in every full scored year or retire."
...
q01_build_report: D:/QM/reports/work_items/ec65f795-ad77-465a-9620-93c35c7e2905/QM5_41424/COMPILE_EA/compile_evidence.json
force_build: true
review_focus: "Falsify a short-only WTI refinery-maintenance positive-week reversion distinct from the mutually exclusive negative-week continuation, shoulder stretch fade, May-July refinery entries, and XNG shoulder reversion. Verify exact week membership, positive-only signal and short-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, refinery_maintenance_month_gate, normalized_week_clock, immediately_completed_week_membership, strict_positive_sign, short_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 official EIA plus complete-read academic Yang-Goncu-Pantelous context with disclosed translation risk; R2 exact mechanical short-only positive-week maintenance reversion; R3 registered XTIUSD.DWX D1; R4 deterministic non-ML; no exact dedup identity and two fuzzy family neighbors manually resolved."
---

# QM5_41424 WTI Refinery-Maintenance Positive-Week Reversion
...
completed positive WTI week may be a short-lived counter-move that reverses
over the following week. This exact short-only price translation is unproven
and belongs to Q02 onward.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910/source.md`.
EIA supports only the refinery-maintenance calendar context; Yang, Goncu, and
Pantelous support broad commodity-reversal lineage. Neither establishes this
weekly WTI CFD result.

The canonical checker found no exact identity and two fuzzy neighbors.
`QM5_41421` shorts only after a negative maintenance-season week as
continuation; this card shorts only after a positive week as reversion, so the
admitted sign states are mutually exclusive. `QM5_41392` trades XNG rather
than WTI, uses April-May/September-October, and is two-sided. Calendar,
one-week formation, positive-only signal, short side, and one-week lifecycle
...
1. Run only on the setfile-bound `XTIUSD.DWX` D1 host with EA 41424, slot zero,
...
nonpositive return, spread, quote, ATR, stop, sizing, or order state. Framework
...
| week clock, maintenance gate, package, positive sign, attempt, spread, ATR | Trade Entry | `Strategy_EntrySignal` and helpers |
...
Q01 must verify all four eligible months, ineligible boundaries, positive short
...
| Q01 Build Validation | 2026-09-10 | PASS | governed compile `ec65f795-ad77-465a-9620-93c35c7e2905`; 12 reference tests; PACER audit clean |
| Q02 Baseline Screening | 2026-09-10 | NOT_ENQUEUED_CPU_CEILING | five-sample CPU maximum 97.27% exceeded exclusive 97% ceiling |
