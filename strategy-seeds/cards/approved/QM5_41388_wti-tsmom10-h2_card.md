...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K10H2_S39
variant_id: MOP-TSMOM-2012_XTI_K10H2_S39
source_id: MOP-WTI-TSMOM10-H2-2026
ea_id: QM5_41388
slug: wti-tsmom10-h2
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41388_wti-tsmom10-h2_card.md
execution_contract_status: APPROVED
created: 2026-09-09
created_by: Research+Development
last_updated: 2026-09-09
g0_status: APPROVED
g0_decision: decisions/2026-09-09_qm5_41388_wti_tsmom10_h2_g0.md
source_approval: decisions/2026-09-09_wti_ten_month_momentum_two_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM10-H2-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: bimonthly-wti-sign-of-exact-ten-completed-broker-month-log-return-two-month-hold-odd-month-epoch
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, ten-month-return, two-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; eleven consecutive completed month-end closes; exact ten-month log-return sign; odd-month decisions; two-month hold; 300 D1 bars; 3.5*ATR(20,D1) frozen stop; 70-day stale repair; 1500-point spread ceiling."
review_focus: "Falsify the source-bounded WTI k=10,h=2 stream. Verify eleven exact completed-month endpoints, odd-month-only attempts, no even-month rollover, fixed risk, frozen stop, and next-odd-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal]
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_ten_month_orientation, odd_month_epoch, bimonthly_attempt_state, two_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
---

# QM5_41388 WTI Ten-Month Momentum / Two-Month Hold

## Hypothesis

A ten-completed-month WTI own-return direction may persist when held as a
fixed non-overlapping two-month package, sampling a horizon between the
existing nine- and twelve-month siblings. This is a pre-result structural
test. The peer-reviewed source defines the time-series-momentum
formation/holding family and includes WTI, but does not publish a standalone
WTI `k=10, h=2` result or continuous-CFD evidence.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/MOP-WTI-TSMOM10-H2-2026/source.md`; its complete-read
...
`QM5_41379` through `QM5_41387` use three-, one-, nine-, six-, four-, two-,
five-, seven-, and eight-month returns. This card requires both exact `k=10`
...
2. Require configured symbol, D1, EA 41388, slot 0, and fixed-risk backtest mode.
...
Q01 must prove month adjacency and year boundaries, exact eleven endpoints,
...
|---|---|---|---|
| G0 Research Intake | 2026-09-09 | APPROVED | `decisions/2026-09-09_qm5_41388_wti_tsmom10_h2_g0.md` |
