...
type: strategy
strategy_id: QM5-39001-FOREXFACTORY-TRADING-MADE-SIMPLE-TMS-2026
variant_id: QM5-39001-FOREXFACTORY-TRADING-MADE-SIMPLE-TMS-2026_H1
source_id: forexfactory-trading-made-simple-tms-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Big E (Eric) / eelfranz"
strategy_mechanic: forexfactory-trading-made-simple-tms-quantitative-production-blueprint
source_citation: "Big E (2011-2024). Trading Made Simple. Forex Factory (>15M Views)."
source_citations:
  - type: verified_quantitative_model
    citation: "Big E (2011-2024). Trading Made Simple. Forex Factory (>15M Views)."
    quality_tier: A
    role: primary
sources:
  - "[[sources/forexfactory-trading-made-simple-tms]]"
concepts:
...
# QM5_39001: Trading Made Simple (TMS) with TDI Engine

## 1. Economic & Quantitative Strategy Thesis

Trading Made Simple (TMS) is Forex Factory's most viewed mechanical system. Combines the Traders Dynamic Index (TDI) with 5 EMA and Heikin-Ashi price momentum to capture high-probability multi-bar trend swings.
...
$$\text{TDI\_RSI} = \text{RSI}(13)[1], \quad \text{TDI\_Fast} = \text{SMA}(\text{TDI\_RSI}, 2)[1], \quad \text{TDI\_Slow} = \text{SMA}(\text{TDI\_RSI}, 7)[1]$$
$$\text{TDI\_MarketBase} = \text{SMA}(\text{TDI\_RSI}, 34)[1]$$
...
$$\text{TDI\_Fast}[1] > \text{TDI\_Slow}[1] \quad \text{AND} \quad \text{TDI\_Fast}[1] > \text{TDI\_MarketBase}[1] \quad \text{AND} \quad \text{Close}[1] > \text{EMA}(5, \text{Typical})[1]$$
...
* **Stop Loss (SL)**: Placed below the recent H1 swing low $\mp 3.0\text{ pips}$.
* **TDI Exit**: Close position when TDI Fast crosses back over TDI Slow.
...
|---|---|---|---|---|
| `InpTDIRSIPeriod` | `int` | `13` | `8 - 21` | TDI RSI baseline lookback |
| `InpTDIBandPeriod`| `int` | `34` | `20 - 50` | TDI volatility band period |
| `InpEMA5Period` | `int` | `5` | `3 - 8` | Typical price trigger EMA period |
