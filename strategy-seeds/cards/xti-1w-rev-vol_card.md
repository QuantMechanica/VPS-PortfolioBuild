...
realized volatility is elevated. WTI gives the portfolio an energy sleeve
distinct from the existing index, metal, and natural-gas RSI book exposure.

This is not a duplicate of `QM5_13049_xti-1w-mom-vol`, which follows the
five-day move only when volatility is low. This card fades the five-day move
only when volatility is high. It is also distinct from WTI 6-month reversal,
63-D1 Yang reversal, COT release fades, inventory/event sleeves, month/weekday
calendar effects, XTI/XNG baskets, oil-metal ratios, and `QM5_12567`
cum-RSI2 commodity logic.
