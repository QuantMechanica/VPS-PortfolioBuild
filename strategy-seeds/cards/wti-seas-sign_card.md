...
- Carrier: `XTIUSD.DWX`, D1, slot 0, prospective magic `202220000`.
...
|---|---|---|---|---|
| v1 | 2026-08-05 | initial WTI seasonal/sign concordance candidate | G0 | APPROVED; build pending |
...
| Q01 Compile / Static Validation | - | PENDING | - |
