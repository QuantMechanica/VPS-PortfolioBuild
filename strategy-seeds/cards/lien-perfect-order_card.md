...
strategy_type_flags:
  - ma-stack-entry                            # entry trigger: K=5 SMAs (periods 10/20/50/100/200) in MONOTONIC SEQUENTIAL ORDER (long: SMA(10)>SMA(20)>SMA(50)>SMA(100)>SMA(200); short mirror); fires N candles AFTER initial stack formation if stack still holds. Ratified in SRC04 batch (CEO 2026-04-28, QUA-333 closeout, QUA-351 back-port). See `strategy-seeds/strategy_type_flags.md` § A entry-mechanism for canonical definition.
