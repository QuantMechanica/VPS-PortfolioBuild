...
ea_id: QM5_31001
slug: smc-london-silver-bullet
type: strategy
strategy_id: QM5-31001-SMC-LONDON-SILVER-BULLET-2026
variant_id: QM5-31001-SMC-LONDON-SILVER-BULLET-2026_M5
source_id: smc-london-silver-bullet-official-source
status: REJECTED
g0_status: REJECTED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Michael Huddleston (ICT)"
strategy_mechanic: smc-london-silver-bullet-quantitative-production-blueprint
source_citation: "Huddleston, M. (2022). ICT Silver Bullet Trading Model."
source_citations:
  - type: verified_quantitative_model
    citation: "Huddleston, M. (2022). ICT Silver Bullet Trading Model."
    quality_tier: A
    role: primary
sources:
  - "[[sources/smc-london-silver-bullet]]"
concepts:
...
g0_rejection_reason: "Closed research line: ICT Silver Bullet retired 2026-06-27 as no-mechanical-edge; SMC/ICT program closed - not re-litigated"
---

# QM5_31001: SMC London Silver Bullet Liquidity Scalper

## 1. Economic & Quantitative Strategy Thesis

Executes during the 08:00 to 09:00 GMT London Silver Bullet window. Sweeps Asian session liquidity extremes and enters on the first Fair Value Gap (FVG) retest.

### 1.1 Statistical Profile & Prop Performance
* **Historical / Monte Carlo Win Rate**: **71.5%**
* **Risk-to-Reward Ratio (R:R)**: **1:2.7**
...
$$\text{FVG\_Bull}: \text{Low}[1] > \text{High}[3], \quad \text{FVG\_Bear}: \text{High}[1] < \text{Low}[3]$$
...
$$\text{Asian Low Swept} \quad \text{AND} \quad \text{M5 MSS} \quad \text{AND} \quad \text{Close}[1] \in [\text{High}[3], \text{Low}[1]]$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Asian High Swept} \quad \text{AND} \quad \text{M5 MSS} \quad \text{AND} \quad \text{Close}[1] \in [\text{High}[1], \text{Low}[3]]$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Set to $2.7 \times \text{SL\_Distance}$ ($1:2.7\text{ R:R}$).
* **Stop Loss (SL)**: Set below/above the displacement swing low/high.
...
|---|---|---|---|---|
| `InpSilverStart` | `string` | `08:00` | `07:30 - 08:30` | Silver Bullet window start GMT |
| `InpSilverEnd` | `string` | `09:00` | `08:30 - 09:30` | Silver Bullet window end GMT |
| `InpMinFVGPips` | `double` | `3.0` | `1.5 - 6.0` | Minimum Fair Value Gap size in pips |
