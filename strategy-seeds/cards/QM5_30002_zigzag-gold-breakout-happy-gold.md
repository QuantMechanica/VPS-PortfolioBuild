...
type: strategy
strategy_id: QM5-30002-ZIGZAG-GOLD-BREAKOUT-HAPPY-GOLD-2026
variant_id: QM5-30002-ZIGZAG-GOLD-BREAKOUT-HAPPY-GOLD-2026_M15
source_id: zigzag-gold-breakout-happy-gold-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Happy Forex Official Developer"
strategy_mechanic: zigzag-gold-breakout-happy-gold-quantitative-production-blueprint
source_citation: "Happy Gold Official EA Specification. 5+ Years Live Track Record."
source_citations:
  - type: verified_quantitative_model
    citation: "Happy Gold Official EA Specification. 5+ Years Live Track Record."
    quality_tier: A
    role: primary
sources:
  - "[[sources/zigzag-gold-breakout-happy-gold]]"
concepts:
...
# QM5_30002: ZigZag Gold Reversal Breakout (Happy Gold)
...
* **Expected Profit Factor (PF)**: **1.85**
...
$$\text{ZZ\_High}[1] = \text{ZigZagPeak}(12, 5, 3), \quad \text{Trend} = \text{Close}[1] > \text{EMA}(50, \text{H4})[1]$$
...
$$\text{Close}[1] > \text{ZZ\_High}[1] \quad \text{AND} \quad \text{Close}[1] > \text{EMA}(50, \text{H4})[1]$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Close}[1] < \text{ZZ\_Low}[1] \quad \text{AND} \quad \text{Close}[1] < \text{EMA}(50, \text{H4})[1]$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Fixed $+36.0\text{ pips}$ ($+3.60\$$ on Gold).
* **Stop Loss (SL)**: Hard $-24.0\text{ pips}$ ($-2.40\$$ on Gold).
* **Trailing Stop**: When profit reaches $+15.0\text{ pips}$, trail at $10.0\text{ pips}$ behind price.
...
|---|---|---|---|---|
| `InpZZDepth` | `int` | `12` | `8 - 24` | ZigZag depth parameter |
| `InpH4EMAPeriod` | `int` | `50` | `20 - 100` | Higher timeframe trend filter EMA |
| `InpTPPoints` | `int` | `360` | `200 - 600` | Hard take profit in points |
| `InpSLPoints` | `int` | `240` | `150 - 400` | Hard stop loss in points |
