...
ea_id: QM5_31005
slug: japanstrike-tokyo-liquidity-breakout
type: strategy
strategy_id: QM5-31005-JAPANSTRIKE-TOKYO-LIQUIDITY-BREAKOUT-2026
variant_id: QM5-31005-JAPANSTRIKE-TOKYO-LIQUIDITY-BREAKOUT-2026_M15
source_id: japanstrike-tokyo-liquidity-breakout-official-source
status: APPROVED
g0_status: APPROVED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Asian Session Prop Desk"
strategy_mechanic: japanstrike-tokyo-liquidity-breakout-quantitative-production-blueprint
source_citation: "Tokyo Bank Open Fix (00:00-03:00 GMT) Liquidity Studies."
source_citations:
  - type: verified_quantitative_model
    citation: "Tokyo Bank Open Fix (00:00-03:00 GMT) Liquidity Studies."
    quality_tier: A
    role: primary
sources:
  - "[[sources/japanstrike-tokyo-liquidity-breakout]]"
concepts:
...
# QM5_31005: Tokyo Session JPY Liquidity Breakout (JapanStrike)

## 1. Economic & Quantitative Strategy Thesis

Captures the 00:00 GMT Tokyo bank open. Handled as a breakout of the 2-hour pre-Tokyo consolidation range (22:00 to 00:00 GMT).
...
$$\text{PreTokyo\_High} = \max_{t \in [22:00, 00:00]} (\text{High}_t), \quad \text{PreTokyo\_Low} = \min_{t \in [22:00, 00:00]} (\text{Low}_t)$$
...
$$\text{Close}[1] > \text{PreTokyo\_High} + 2.0\text{ pips} \quad (00:00 \text{ to } 03:00 \text{ GMT})$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Close}[1] < \text{PreTokyo\_Low} - 2.0\text{ pips} \quad (00:00 \text{ to } 03:00 \text{ GMT})$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Set to $2.0 \times \text{SL\_Distance}$ ($1:2.0\text{ R:R}$).
* **Stop Loss (SL)**: Placed at the pre-Tokyo range midpoint.
...
|---|---|---|---|---|
| `InpBoxStart` | `string` | `22:00` | `21:00 - 23:00` | Pre-Tokyo evaluation start GMT |
| `InpBoxEnd` | `string` | `00:00` | `23:30 - 00:30` | Pre-Tokyo evaluation end GMT |
...
* **Target symbols**: USDJPY.DWX, GBPJPY.DWX
* **Primary symbol**: USDJPY.DWX
* **Timeframe**: M15
