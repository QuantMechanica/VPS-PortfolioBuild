...
ea_id: QM5_41007
slug: vix-volatility-spike-equity-reversion
type: strategy
strategy_id: QM5-41007-VIX-VOLATILITY-SPIKE-EQUITY-REVERSION-2026
variant_id: QM5-41007-VIX-VOLATILITY-SPIKE-EQUITY-REVERSION-2026_H1
source_id: vix-volatility-spike-equity-reversion-official-source
status: REJECTED
g0_status: REJECTED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Quant Equity Research"
strategy_mechanic: vix-volatility-spike-equity-reversion-quantitative-production-blueprint
source_citation: "Whaley, R. E. (2000). The Investor Fear Gauge. Journal of Portfolio Management."
source_citations:
  - type: verified_quantitative_model
    citation: "Whaley, R. E. (2000). The Investor Fear Gauge. Journal of Portfolio Management."
    quality_tier: A
    role: primary
sources:
  - "[[sources/vix-volatility-spike-equity-reversion]]"
concepts:
...
g0_rejection_reason: "R3 FAIL: no VIX data feed in MT5/DWX universe; mechanic depends on VIX 2-sigma spike trigger. ATR-percentile re-mechanization would be a new card"
---

# QM5_41007: VIX Volatility Spike Equity Mean Reversion

## 1. Economic & Quantitative Strategy Thesis

Exploits mean-reverting equity market panics: When the VIX volatility index spikes $> 2.0\sigma$ above its 20-day moving average while S&P 500 RSI(14) is $< 30$, it buys the index for rapid mean-reversion snapbacks.
...
* **Maximum Expected Portfolio Drawdown**: **<4.8%**
...
$$Z_{\text{VIX}} = \frac{\text{VIX}_t - \text{SMA}(\text{VIX}, 20)}{\text{std}(\text{VIX}, 20)} \ge +2.00, \quad \text{RSI}(14, \text{US500}) \le 30.0$$
...
$$Z_{\text{VIX}}[1] \ge 2.00 \quad \text{AND} \quad \text{RSI}(14, \text{US500})[1] \le 30.0 \quad \text{AND} \quad \text{Close}[1] > \text{Open}[1]$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{No Short Signal (Long-Only Panic Reversal)}$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Take Profit (TP)**: Target when $Z_{\text{VIX}} \le 0.0$ (VIX mean-reverts to equilibrium).
...
|---|---|---|---|---|
| `InpVIXZScore` | `double` | `2.00` | `1.5 - 2.5` | Standard deviation spike threshold |
| `InpMaxRSI` | `double` | `30.0` | `25.0 - 35.0` | S&P 500 RSI oversold filter |
