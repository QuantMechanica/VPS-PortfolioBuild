...
ea_id: QM5_32006
slug: btcusd-weekend-range-monday-breakout
type: strategy
strategy_id: QM5-32006-BTCUSD-WEEKEND-RANGE-MONDAY-BREAKOUT-2026
variant_id: QM5-32006-BTCUSD-WEEKEND-RANGE-MONDAY-BREAKOUT-2026_H1
source_id: btcusd-weekend-range-monday-breakout-official-source
status: REJECTED
g0_status: REJECTED
created: 2026-08-15
created_by: Research+Development
last_updated: 2026-08-15
source_authors: "Crypto Quantitative Desk"
strategy_mechanic: btcusd-weekend-range-monday-breakout-quantitative-production-blueprint
source_citation: "Bitcoin Weekend Liquidity Compression & Monday Open Expansion Studies."
source_citations:
  - type: verified_quantitative_model
    citation: "Bitcoin Weekend Liquidity Compression & Monday Open Expansion Studies."
    quality_tier: A
    role: primary
sources:
  - "[[sources/btcusd-weekend-range-monday-breakout]]"
concepts:
...
target_symbols: [BTCUSD.DWX, BTCUSD, BTC.FUT]
...
g0_rejection_reason: "R3 FAIL: BTCUSD not in DWX tradeable universe (dwx_symbol_matrix.csv)"
---

# QM5_32006: Bitcoin (BTCUSD) Weekend Range Breakout (Crypto Prop)

## 1. Economic & Quantitative Strategy Thesis

In 24/7 crypto markets, weekend trading compresses into low volatility. On Monday 00:00 UTC, institutional liquidity injects directional momentum breaking out of the 48h range.
...
$$\text{W\_High} = \max_{\text{Sat-Sun}} (\text{High}), \quad \text{W\_Low} = \min_{\text{Sat-Sun}} (\text{Low}), \quad \text{W\_Mid} = \frac{\text{W\_High} + \text{W\_Low}}{2}$$
...
$$\text{Close}[1] > \text{W\_High} + 0.10 \times \text{ATR}(14, \text{H1})[1] \quad (\text{Mon 00:00 to 08:00 UTC})$$

### 3.3 Short Entry Conditions (`Strategy_EntrySignal` $\rightarrow$ `SELL`)
$$\text{Close}[1] < \text{W\_Low} - 0.10 \times \text{ATR}(14, \text{H1})[1] \quad (\text{Mon 00:00 to 08:00 UTC})$$

### 3.4 Position Exit Conditions (`Strategy_ExitSignal`)
* **Stop Loss (SL)**: Placed at Weekend Midpoint ($\text{W\_Mid}$).
...
|---|---|---|---|---|
| `InpATRPeriod` | `int` | `14` | `10 - 24` | ATR volatility buffer lookback |
| `InpATROffset` | `double` | `0.10` | `0.05 - 0.25` | ATR breakout confirmation buffer |
