---
ea_id: QM5_41489
slug: collins-66mom-symbolinput
parent_ea_id: QM5_20266
...
g0_approval_reasoning: "Fable 2026-09-22 symbol-input rebuild of QM5_20266 (OWNER symbols-are-inputs rule 2026-09-06; Codex 273f2de8 identity proof EQUIVALENT_EXACT 491/491 deals): mechanics, Collins 2006 source lineage and R1-R4 verdicts inherited unchanged from the parent card of record; only the identity and the strateg"
card_sha256: ba102aa6874f50ff887853c377e793be06416c897b256e2d7a09cf413ec6a0ab
---
...
This card is the card of record for `QM5_41489` (`collins-66mom-symbolinput`), the symbol-input rebuild of `QM5_20266` under the OWNER rule of
...
`D:/QM/reports/identity_equivalence/QM5_20266__QM5_41489/XTIUSD.DWX/proof.json`). The rebuilt identity runs its own Q-chain;
...
- This declaration locks the exact XTIUSD.DWX/D1 configuration used by Q08 (set file `QM5_41489_collins-66mom-symbolinput_XTIUSD.DWX_D1_backtest.set`). It changes no strategy mechanics, threshold, or stored verdict.
...
```qm-dsr-single-configuration
{
  ...
  "locked_parameters": {
    ...
    "strategy_entry_fraction": "0.66",
    "strategy_host_symbol": "XTIUSD",
    "strategy_lookback_d1": "9",
    "strategy_max_hold_bars": "20",
    "strategy_max_spread_points": "1000",
    "strategy_min_stop_points": "10",
    "strategy_pending_expiry_hours": "24",
    "strategy_stop_fraction": "1.32"
  },
  "no_optimization_search": true,
  "research_trial_count": 0,
  "schema": "qm.dsr-single-configuration-declaration/v1",
  "spec_sha256": "30f5e49af567c58f17b8a17e3cfd9eea50c23f2b135e19fa0a733b6254250891",
  "symbol": "XTIUSD.DWX",
  "timeframe": "D1"
}
```
