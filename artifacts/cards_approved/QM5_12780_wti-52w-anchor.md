...
logical_symbol: QM5_12780_XTI_52W_ANCHOR_D1
period: D1
...
`strategy-seeds/cards/approved/QM5_12780_wti-52w-anchor_card.md`.
...
Runtime status: `QM5_12780_wti-52w-anchor` compiled and passed framework
`build_check` on 2026-06-29, then was enqueued to Q02 as work item
`09f91beb-51a4-4eb8-8a5c-f6af09fe54ad`.
...
approved later, must be allocated by the portfolio process.
