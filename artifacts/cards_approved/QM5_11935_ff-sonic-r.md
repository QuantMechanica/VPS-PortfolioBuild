...
g0_approval_reasoning: "Card review 2026-09-13 (Claude): M15 Dragon-EMA(34 H/L/C) tunnel breakout+retest state machine filtered by EMA89 trend, closed-bar two-step entry, SL=89EMA far side, TP fixed 1.5R; charter-compliant FTMO block, single symbol EURUSD.DWX, 150 trades/yr >> 5 floor, source cited (FF Sonic R). Magic prec"
expected_pf: 1.2
