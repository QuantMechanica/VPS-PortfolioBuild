---
ea_id: QM5_41346
slug: cum-rsi2-commodity-requal8-opt
type: strategy
source_id: OWNER-DEC-Q09HOLD-REQUAL-8-20260829:QM5_12567
parent_ea_id: QM5_41219
parent_slug: cum-rsi2-commodity-requal8
parent_card: D:/QM/strategy_farm/artifacts/cards_approved/QM5_41219_cum-rsi2-commodity-requal8.md
g0_status: APPROVED
...
# QM5_41346 `cum-rsi2-commodity-requal8-opt`

Target symbol: `XAUUSD.DWX`.

OWNER-authorized DL-089 measurement sibling of `QM5_41219`. It preserves the
...
|---|---|---|
| R1 Source-Link | PASS | Inherited from the approved QM5_41219 parent and source `OWNER-DEC-Q09HOLD-REQUAL-8-20260829:QM5_12567`. |
| R2 Mechanical | PASS | Parent mechanics are unchanged; six deterministic inputs only veto entries. |
| R3 Data Available | PASS | Uses closed D1 OHLC predicates on `XAUUSD.DWX` with the parent's native inputs. |
