...
slug: wti-fri-bear
type: strategy
strategy_id: GORSKA-MOP-WTI-FRIBEAR-2026_S01
variant_id: GORSKA-MOP-WTI-FRIBEAR-2026_S01
...
strategy_mechanic: friday-wti-long-only-when-completed-252d-return-is-negative
...
timeframe: D1
timeframes: [D1]
expected_trade_frequency: "Approximately 8-25 Friday packages/year; Q02 must prove >=5/year."
...
# QM5_20172 WTI Friday Bear-Regime Bounce

## Hypothesis

WTI's documented positive Friday return may express as a short-horizon bounce
inside a negative slow regime. This tests a different return state from
`QM5_20145`, which trades only when the completed 252-D1 return is positive.
Diversification remains a later evidence gate, not a card claim.

## Rules

1. Run only on exact `XTIUSD.DWX`, D1, EA 20172, magic slot 0.
2. Evaluate only the first executable tick within five minutes of a Friday
   D1 bar whose immediately prior completed D1 bar is Thursday.
...
6. Close at the first new D1 bar that is not Friday, immediately on a
...
Gorska and Krawiec supply the positive WTI Friday direction. Moskowitz et al.
...
- trade_entry: genuine Friday-after-Thursday, negative completed 252-D1 return, consumed-week state, spread/quote/ATR validation, one BUY.
