...
g0_approval_reasoning: "Card review 2026-09-13 (Claude): M5 mean-reversion off running intraday H1-open extremes (00:00 reset), closed-bar two-condition trigger, SL=day extreme, TP fixed 15 pips (midpoint of source 10-20pip range); charter-compliant FTMO block, single symbol EURUSD.DWX, 200 trades/yr >> 5 floor, source cit"
expected_pf: 1.2
