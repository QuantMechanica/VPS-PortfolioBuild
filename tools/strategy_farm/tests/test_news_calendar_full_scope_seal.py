...
def _write_candidate(path: Path) -> None:
    ...
    footprints = [{"id": "a", "status": "MISSING_M5", "currency": "AUD"}]
    ...
    gates = {
        name: {"pass": name not in {"6.1_anchor_shares", "6.5_tick_footprints"}}
    ...
    manifest = {
        ...
        "declared_inadmissible_ranges": [{"id": "fixture"}], "scoped_review_only": True,
    }
