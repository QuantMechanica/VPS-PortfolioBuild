...
RULEPACK_HASHES = {
    ...
    "FTMO_2S_100K_SWING_V2": "93735045ca7a473107f1583c9aca011aa5a0fad23cab89a3068453973a707c74",
}
...
def _observations() -> dict:
    return {
        ...
        "ftmo": {
            "official_criteria": _criterion_rows(
                "FTMO_2S_100K_SWING_V2", "official", "ftmo.simulation.sealed"
            ),
            "internal_criteria": _criterion_rows(
                "FTMO_2S_100K_SWING_V2", "internal", "ftmo.prospective.shadow"
            ),
            "q08_verdict": "SUPPORTED",
            "evidence_debt_visible": False,
