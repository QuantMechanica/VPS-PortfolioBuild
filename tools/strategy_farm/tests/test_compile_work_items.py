...
def test_qm5_41186_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41186_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41186_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41186_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_INDICATOR_BUFFER_UNBOUNDED",
        "compile_result": {
            "compile_result": "PASS",
    ...
    arguments = {
        "ea_id": "41186",
        "source_sha": (
            compile_work_items.QM5_41186_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41186_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41187_unrelated",
    ...
    changed_inventory = json.loads(json.dumps(inventory))
    changed_inventory["work_rows"]["41186"][0]["status"] = "done"
    assert not compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41186_COMPILE_FAIL_REPAIR_AUTHORITY,
        **{**arguments, "inventory": changed_inventory},
...
def test_qm5_41251_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41251_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41251_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41251_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_INDICATOR_BUFFER_UNBOUNDED",
        "compile_result": {
            "compile_result": "PASS",
    ...
    arguments = {
        "ea_id": "41251",
        "source_sha": (
            compile_work_items.QM5_41251_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41251_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41250_unrelated",
    ...
    changed_inventory = json.loads(json.dumps(inventory))
    changed_inventory["work_rows"]["41251"][0]["payload_json"] = json.dumps(
        {**predecessor_payload, "verdict_reason": "OTHER"}
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_41253_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41253_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41253_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41253_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_INDICATOR_BUFFER_UNBOUNDED",
        "compile_result": {
            "compile_result": "PASS",
    ...
    arguments = {
        "ea_id": "41253",
        "source_sha": (
            compile_work_items.QM5_41253_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41253_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41252_unrelated",
    ...
    changed_inventory = json.loads(json.dumps(inventory))
    changed_inventory["work_rows"]["41253"][0]["payload_json"] = json.dumps(
        {**predecessor_payload, "verdict_reason": "OTHER"}
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_41264_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41264_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41264_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41264_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_INDICATOR_BUFFER_UNBOUNDED",
        "compile_result": {
            "compile_result": "PASS",
    ...
    arguments = {
        "ea_id": "41264",
        "source_sha": (
            compile_work_items.QM5_41264_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41264_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41263_unrelated",
...
def test_qm5_41274_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41274_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41274_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41274_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_INDICATOR_BUFFER_UNBOUNDED",
        "compile_result": {
            "compile_result": "PASS",
    ...
    arguments = {
        "ea_id": "41274",
        "source_sha": (
            compile_work_items.QM5_41274_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41274_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41273_unrelated",
    ...
    changed_inventory = json.loads(json.dumps(inventory))
    changed_inventory["work_rows"]["41274"][0]["payload_json"] = json.dumps(
        {**predecessor_payload, "verdict_reason": "OTHER"}
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_41185_compile_fail_repair_authority_is_failure_and_hash_bound() -> None:
    label = compile_work_items.QM5_41185_COMPILE_FAIL_REPAIR_EA_LABEL
    predecessor_id = (
        compile_work_items.QM5_41185_COMPILE_FAIL_REPAIR_PREDECESSOR_ID
    )
    predecessor_payload = {
        "ea_label": label,
        "mq5_sha256": (
            compile_work_items.QM5_41185_COMPILE_FAIL_REJECTED_SOURCE_SHA256
        ),
        "verdict_reason": "EA_ML_FORBIDDEN",
        "compile_result": {
            "compile_result": "PASS",
            "build_check_result": "FAIL",
            "failure_classes": ["EA_ML_FORBIDDEN"],
        },
    }
    inventory = {
        "work_rows": {
    ...
    arguments = {
        "ea_id": "41185",
        "source_sha": (
            compile_work_items.QM5_41185_COMPILE_FAIL_REPAIRED_SOURCE_SHA256
        ),
        "inventory": inventory,
    }
    ...
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_41185_COMPILE_FAIL_REPAIR_AUTHORITY,
        **arguments,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_41186_unrelated",
    ...
    changed_inventory = json.loads(json.dumps(inventory))
    changed_inventory["work_rows"]["41185"][0]["payload_json"] = json.dumps(
        {**predecessor_payload, "verdict_reason": "OTHER"}
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_10069_q02_stale_resolver_repair_authority_is_exact_label_bound() -> None:
    label = "QM5_10069_mql5-hs-rev"

    assert compile_work_items.QM5_10069_Q02_STALE_RESOLVER_REPAIR_EA_LABELS == {
        label
    }
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_10069_Q02_STALE_RESOLVER_REPAIR_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_10070_unrelated-h1",
        compile_work_items.QM5_10069_Q02_STALE_RESOLVER_REPAIR_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_10069_stale_resolver_with_q02_history_can_append_compile_recovery(
    tmp_path: Path,
    monkeypatch,
) -> None:
    label = "QM5_1001_mql5-hs-rev"
    repo, root = _fixture(tmp_path, [label])
    monkeypatch.setattr(
        compile_work_items,
        "QM5_10069_Q02_STALE_RESOLVER_REPAIR_EA_LABELS",
        frozenset({label}),
    )
    binary = repo / "framework" / "EAs" / label / f"{label}.ex5"
    binary.write_bytes(b"stale pre-expansion resolver fixture")
    setfile = (
        repo / "framework" / "EAs" / label / "sets"
        / f"{label}_AUDUSD.DWX_H1_backtest.set"
    )
    setfile.parent.mkdir()
    setfile.write_text("; build_hash: stale\n", encoding="utf-8")
    now = farmctl.utc_now()
    with farmctl.connect(root) as conn:
        conn.execute(
            ...
            "(id,kind,phase,ea_id,symbol,setfile_path,status,verdict,attempt_count,"
            "evidence_path,payload_json,created_at,updated_at) "
            "VALUES ('failed-q02','backtest','Q02','QM5_1001','AUDUSD.DWX',"
            "'audusd.set','done','INFRA_FAIL',0,"
...
def test_qm5_10116_q02_stale_resolver_repair_authority_is_exact_label_bound() -> None:
    label = "QM5_10116_tv-multi-ma-exit"

    assert compile_work_items.QM5_10116_Q02_STALE_RESOLVER_REPAIR_EA_LABELS == {
        label
    }
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_10116_Q02_STALE_RESOLVER_REPAIR_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_10117_unrelated-h1",
        compile_work_items.QM5_10116_Q02_STALE_RESOLVER_REPAIR_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_10116_stale_resolver_with_q02_history_can_append_compile_recovery(
    tmp_path: Path,
    monkeypatch,
) -> None:
    label = "QM5_1001_tv-multi-ma-exit"
    repo, root = _fixture(tmp_path, [label])
    monkeypatch.setattr(
        compile_work_items,
        "QM5_10116_Q02_STALE_RESOLVER_REPAIR_EA_LABELS",
        frozenset({label}),
    )
    binary = repo / "framework" / "EAs" / label / f"{label}.ex5"
    binary.write_bytes(b"stale pre-expansion resolver fixture")
    setfile = (
        repo / "framework" / "EAs" / label / "sets"
        / f"{label}_USDCAD.DWX_H1_backtest.set"
    )
    setfile.parent.mkdir()
    setfile.write_text("; build_hash: stale\n", encoding="utf-8")
    now = farmctl.utc_now()
    with farmctl.connect(root) as conn:
        conn.execute(
            ...
            "(id,kind,phase,ea_id,symbol,setfile_path,status,verdict,attempt_count,"
            "evidence_path,payload_json,created_at,updated_at) "
            "VALUES ('failed-q02','backtest','Q02','QM5_1001','USDCAD.DWX',"
            "'usdcad.set','done','INFRA_FAIL',0,"
            "'evidence/summary.json','{}',?,?)",
            (now, now),
        )
        conn.commit()
...
def test_qm5_39005_q02_worker_crash_recovery_authority_is_exact_label_bound() -> None:
    label = "QM5_39005_forexfactory-genesis-matrix-scalper"

    assert compile_work_items.QM5_39005_Q02_WORKER_CRASH_RECOVERY_EA_LABELS == {
        label
    }
    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_39005_Q02_WORKER_CRASH_RECOVERY_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        "QM5_39006_unrelated-scalper",
        compile_work_items.QM5_39005_Q02_WORKER_CRASH_RECOVERY_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
        label,
...
def test_qm5_39005_worker_crash_with_q02_history_can_append_compile_recovery(
    ...
    label = "QM5_1001_forexfactory-genesis-matrix-scalper"
    repo, root = _fixture(tmp_path, [label])
    monkeypatch.setattr(
        compile_work_items,
        "QM5_39005_Q02_WORKER_CRASH_RECOVERY_EA_LABELS",
        frozenset({label}),
    )
    binary = repo / "framework" / "EAs" / label / f"{label}.ex5"
    binary.write_bytes(b"current worker-crash recovery fixture")
    setfile = (
        repo / "framework" / "EAs" / label / "sets"
        / f"{label}_EURUSD.DWX_M5_backtest.set"
    )
    setfile.parent.mkdir()
    setfile.write_text("; build_hash: current\n", encoding="utf-8")
    now = farmctl.utc_now()
    with farmctl.connect(root) as conn:
        conn.execute(
            "INSERT INTO work_items "
            "(id,kind,phase,ea_id,symbol,setfile_path,status,verdict,attempt_count,"
            "evidence_path,payload_json,created_at,updated_at) "
            "VALUES ('failed-q02','backtest','Q02','QM5_1001','EURUSD.DWX',"
            "'eurusd.set','failed','INFRA_FAIL',0,"
            "'EVIDENCE_UNAVAILABLE:worker_crashed_handling_item','{}',?,?)",
            (now, now),
        )
        conn.commit()
...
def test_qm5_38005_blocked_build_recovery_authority_is_exact_label_bound() -> None:
    label = "QM5_38005_codetrading-ascending-triangle-breakout"

    assert compile_work_items._source_repair_authorized(
        label,
        compile_work_items.QM5_38005_BLOCKED_BUILD_RECOVERY_AUTHORITY,
    )
    assert not compile_work_items._source_repair_authorized(
...
def test_qm5_41355_framework_input_pin_authority_is_exactly_bound() -> None:
    authority = compile_work_items.QM5_41355_FRAMEWORK_INPUT_PIN_REPAIR_AUTHORITY
    binding = compile_work_items.BACKLOG_SOURCE_REPAIR_REGISTRATIONS[authority]
    repo = Path(__file__).resolve().parents[3]
    predecessors = []
    for predecessor_id, expected in binding["predecessors"].items():
    ...
    inventory = {"work_rows": {"41355": predecessors}}
    ...
    predecessors[0]["verdict"] = "COMPILE_OK"
    assert not compile_work_items._source_repair_authorized(
        binding["ea_label"],
        authority,
        repo_root=repo,
