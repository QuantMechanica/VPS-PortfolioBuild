...
def ensure_magic_precondition_task(
    ...
    payload = {
        ...
        "diagnosis": {
            "identity_registry_rows": precheck.get("identity_registry_rows"),
            "active_magic_rows": precheck.get("active_magic_rows"),
            "retired_magic_rows": precheck.get("retired_magic_rows"),
            "other_status_magic_rows": precheck.get("other_status_magic_rows"),
        ...
        "acceptance": [
            "Use the governed allocator sequence: EA directory/card, exact active EA identity, exact per-symbol magic CSV rows, resolver regeneration, verification.",
            "Never invent a magic outside ea_id*10000+slot and never revive a retired row.",
            "Leave the original build blocked until a fresh precheck proves the identity and every card symbol/slot/magic/resolver tuple.",
        ],
