...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 56 (2026-09-06 ~19:47Z): dsr_cohort window recovery b2b3d35d65 (claim-time attach reads the module).py (f9ce2102) + backup-reuse farmctl (70f55cbf) -> stale-worker-module class; idle-only, one at a time
