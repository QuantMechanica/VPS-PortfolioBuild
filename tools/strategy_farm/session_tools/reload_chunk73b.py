"""Chunk 73b = continuation of chunk 73 for T6, T9 (purge relaunches, flag-less) and T8, T10 (lane-aware flag), run detached via Start-Process because the Bash-tool background job was stopped after ~10 min.
...
TERMINALS = ["T9"]  # chunk 73b: only T9 left (chunk 73 process died ~13:37Z after T3,T2,T5,T4,T1,T7,T6,T10,T8)
