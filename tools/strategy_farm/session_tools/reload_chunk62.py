"""Staggered idle-worker reload chunk 62 (Orchestrator 2026-09-10 03:4xZ): OWNER 2026-09-10 03:3xZ "Winsweep ja" -> same-program parallelism L=2 for WINSWEEP_QM5_41398_USDJPY_DWX_2019_2025 (allowlist + lanes injected into the worker env; launcher only carries QM_* and DL089_PROGRAM_SLOTS from machine scope). Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 62 (2026-09-10 03:4xZ): WINSWEEP L=2 allowlist
