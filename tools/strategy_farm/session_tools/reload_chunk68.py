"""Staggered idle-worker reload chunk 68 (Orchestrator 2026-09-11 20:1xZ, post-reboot): single idle worker T8 to load the *_deferred claim diagnostics; NO census cap (rolled back with the reboot), L=2 + allowlist come from machine scope. Same discipline as chunk 58.
...
TERMINALS = ["T8"]  # chunk 68: single diagnostic reload
