...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 57 (2026-09-07 ~02:1xZ): farmctl a430c1aeda+e73af54859 (EA-id helper, replacement setfile), news_calendar_taint e2511daad8 (claim guard import), factory_mutation_lock 0a5edeef42 (dead-pid reap).py (f9ce2102) + backup-reuse farmctl (70f55cbf) -> stale-worker-module class; idle-only, one at a time
