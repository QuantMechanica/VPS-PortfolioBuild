"""Staggered idle-worker reload chunk 61 (Orchestrator 2026-09-10 02:3xZ): load the farmctl claim-order hotfix (window-owner subquery anchored on idx_work_items_ea_phase) after the 4ce11df5c1 full-scan regression stalled the fleet. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 61 (2026-09-10 02:3xZ): claim-order hotfix
