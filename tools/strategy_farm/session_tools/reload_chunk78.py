"""Staggered idle-worker reload chunk 78 (Orchestrator 2026-09-14 04:1xZ): T1 only - loads the claim_result skip_samples diagnostic in next_cell_prestage.py so the per-row refusal reason of the claim-idle fleet becomes visible.
...
TERMINALS = ["T1"]  # chunk 78: T1 only, claim diagnostic  # chunk 76: reloaded by chunk 75 before the flag
