...
TERMINALS = ["T3", "T5", "T6", "T2", "T9", "T10", "T1", "T4", "T7", "T8"]  # chunk 82: T3/T5 first (they also need the lever-3 code)  # chunk 77: all ten  # chunk 76: reloaded by chunk 75 before the flag
