...
TERMINALS = ["T2", "T3", "T5", "T10", "T1", "T4", "T6", "T7", "T8", "T9"]  # chunk 49 (2026-09-05 ~21:45Z): claim-lock cost fix 0844d70712 (claim order memo outside the lock, partial indexes, FIFO tickets) + M06 consumer exception inert 3720e3044e, Q08/Q09 RAM floor 30a7888dc6, D1 prescreen 97bebb43f5; idle-only, one at a time
