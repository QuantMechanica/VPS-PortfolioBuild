"""Staggered idle-worker reload chunk 63 (Orchestrator 2026-09-10 19:0xZ): OWNER 2026-09-10 ~19:00Z "Umsetzen!" -> census cap DL089_CELL_SLOTS=3 for 48 h so Q04 long runs (32 GB) and Q02 intake (CPU<97) get RAM/CPU windows; Clear-ETA was 61 d at 1.08 gate rows/h. Keeps L=2 + allowlist from chunk 62. Rollback due 2026-09-12T19:00Z: reload without DL089_CELL_SLOTS. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 63 (2026-09-10 19:0xZ): census cap G=3 for 48 h

import ctypes
os.environ["QM_DSR_V2"] = "1"  # decision-bound: new workers inherit the V2 flag
os.environ["DL089_CELL_SLOTS"] = "3"  # OWNER 2026-09-10 "Umsetzen!": fleet-wide census cap 3 for 48 h (rollback due 2026-09-12T19:00Z)
os.environ["DL089_LANES_PER_PROGRAM"] = "2"  # OWNER 2026-09-10 "Winsweep ja": L=2 for allow-listed programs
os.environ["DL089_SAME_PROGRAM_PARALLEL_ALLOWLIST"] = "DL089_QM5_21507_XAUUSD_DWX_2019_2025,DL089_QM5_12710_XTIUSD_DWX_2019_2025,DL089_QM5_11910_NZDUSD_DWX_2019_2025,WINSWEEP_QM5_41398_USDJPY_DWX_2019_2025"  # machine scope mirrors this value (set 03:4xZ)
