...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T9", "T10"]  # chunk 52 (2026-09-06 ~12:15Z): seven seed-pin compile authorities registered (65c5d9a1) after all workers started 09:36-10:46Z -> stale-worker-module class; idle-only, one at a time
