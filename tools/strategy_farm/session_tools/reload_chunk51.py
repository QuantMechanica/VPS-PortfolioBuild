...
TERMINALS = ["T1", "T2", "T7", "T3", "T4", "T8", "T5", "T6", "T10", "T9"]  # chunk 51 (2026-09-06 ~09:45Z): compile authority for QM5_41193 registered (690fc42a) after all workers started 07:30-08:34Z -> every resident worker lacks it (stale-worker-module class); idle-only, one at a time
