"""Staggered idle-worker reload chunk 66 (Orchestrator 2026-09-11 06:4xZ): load the config_sweep worker adapter 57574e26cc (sweep_engine dispatch) so the QM5_41405 control cells become claimable; keeps cap G=3, L=2 and allowlist. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 66 (2026-09-11 06:4xZ): config_sweep adapter
