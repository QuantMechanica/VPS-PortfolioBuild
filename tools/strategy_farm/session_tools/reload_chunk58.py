...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 58 (2026-09-07 ~06:5xZ): news_calendar_taint 312f37e679 (consumer B release semantics in the claim guard), farmctl c4a8687327 (scoped Q10 window seal), scoped_activation 4d8fd0820a (B-prime).py (f9ce2102) + backup-reuse farmctl (70f55cbf) -> stale-worker-module class; idle-only, one at a time
