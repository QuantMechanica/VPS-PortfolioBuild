...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 55 (2026-09-06 ~17:15Z): DSR single-config claim-time hook in terminal_worker.py (f9ce2102) + backup-reuse farmctl (70f55cbf) -> stale-worker-module class; idle-only, one at a time
