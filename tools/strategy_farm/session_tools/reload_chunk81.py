"""Staggered idle-worker reload chunk 81 (Orchestrator 2026-09-14 14:0xZ): CODE reload of T3 and T5 only, which chunk 80 restarted BEFORE the lever-3 patch landed on disk (evidence-class-aware DL-089 lane view for PRESCREEN promotions, commit 3283767561); the other eight workers already carry it. Same env as chunk 80.
...
TERMINALS = ["T3", "T5"]  # chunk 81: only the two workers reloaded before the lever-3 patch  # chunk 77: all ten  # chunk 76: reloaded by chunk 75 before the flag
