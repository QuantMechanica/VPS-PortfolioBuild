...
TERMINALS = ["T7", "T8", "T2", "T9", "T1", "T3", "T5", "T6", "T10", "T4"]  # chunk 82: T3/T5 first (they also need the lever-3 code)  # chunk 77: all ten  # chunk 76: reloaded by chunk 75 before the flag
