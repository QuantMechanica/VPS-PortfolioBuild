"""Staggered idle-worker reload chunk 59 (Orchestrator 2026-09-09 23:3xZ): load the WINSWEEP worker adapter 1b4644149e so window_sweep.py enqueue --apply passes its worker-freshness gate. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 59 (2026-09-09 23:3xZ): WINSWEEP adapter 1b4644149e
