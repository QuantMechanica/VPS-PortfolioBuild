"""Staggered idle-worker reload chunk 65 (Orchestrator 2026-09-11 03:0xZ): load the terminal_worker._dl089_declared_lane hotfix (window-program stage-B amendment cells) so stage B becomes claimable; keeps cap G=3, L=2 and allowlist. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 65 (2026-09-11 03:0xZ): lane resolver hotfix for stage B
