...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 53 (2026-09-06 ~13:15Z): 72 compile authorities registered by Codex (301c0948ee wave 1, 2c1236af61 pacer) after all workers started 12:07-12:5xZ -> stale-worker-module class; idle-only, one at a time
