"""Staggered idle-worker reload chunk 64 (Orchestrator 2026-09-11 01:1xZ): load the window_sweep.py ingestion repair (no pairing) so the enqueue worker-freshness gate passes for stage B; keeps cap G=3, L=2 and allowlist from chunk 63. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 64 (2026-09-11 01:1xZ): window_sweep ingestion repair, stage B
