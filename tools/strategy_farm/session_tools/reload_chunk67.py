"""Staggered idle-worker reload chunk 67 (Orchestrator 2026-09-11 17:5xZ): load the opt_census_index_cell commit class (annual NDX census cells 12 GB instead of 44 GB, fleet was parked behind commit_headroom_low); keeps cap G=3, L=2 and allowlist. Same discipline as chunk 58.
...
TERMINALS = ["T2", "T7", "T1", "T3", "T4", "T8", "T6", "T5", "T10", "T9"]  # chunk 67 (2026-09-11 17:5xZ): index census commit class
