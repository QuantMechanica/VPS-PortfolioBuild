...
- ⬜ **PC3-02c Queue #3: QM5_1017 chan-pairs-stat-arb** (`strategy_id: SRC02_S01`, `ea_id: 1017`) — `.ex5` scaffold exists at `framework/EAs/QM5_1017_chan_pairs_stat_arb/`. **P0 compile validate (2026-05-01):** `PASS`, `errors=0`, `warnings=0`, latest log `framework/build/compile/20260501_090243/QM5_1017_chan_pairs_stat_arb.compile.log`. **Next action:** governance header alignment then CTO DL-036 review gate before baseline dispatch. **Status:** blocked on card header mismatch (`strategy-seeds/cards/chan-pairs-stat-arb_card.md` still `status: DRAFT`, `ea_id: TBD`). **Unblock owner/action:** CEO+CTO set card header to `APPROVED` + `ea_id: 1017`. **Blocked signal:** `framework/EAs/QM5_1017_chan_pairs_stat_arb/QUA-663_GOVERNANCE_BLOCK_2026-05-01T0912Z.signal`.
- ⬜ **PC3-02d Queue state snapshot** — current machine-readable status in `docs/ops/QUA-663_QUEUE_STATE_CURRENT.json` (ready: `1004`, `SRC04_S03`; blocked: `1017`).
