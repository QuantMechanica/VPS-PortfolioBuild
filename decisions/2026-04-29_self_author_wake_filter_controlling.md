---
name: Self-author wake filter patch - controlling
status: proposed
date: 2026-04-29
owner: CTO
scope: paperclip-prompts/controlling.md
propagation_path: hot_reload
---

# Self-author wake filter patch - controlling

## Change
Inserted the binding wake filter block into paperclip-prompts/controlling.md:
...
## Evidence
- File patched: paperclip-prompts/controlling.md
