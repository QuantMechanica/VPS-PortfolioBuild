# WTI Summer NR2 Positive-Week Reversion - Source Approval
...
None of the parents tests this exact June-October, two-week contraction, positive-week,
...
narrower than its predecessor and its close to be strictly above its open. Sell only, consume the
...
- R2 `PASS`: calendar, completed-week construction, strict contraction and positive-body
...
The canonical checker scanned 4,938 registry rows and 1,547 repository cards, found no exact or
fuzzy repository identity, and failed closed only because the external Strategy Wiki root was
...
`QM5_20213` and `QM5_20214`, generic summer momentum/reversal variants; `QM5_41446`, a symmetric
November-May NR2 weekly-body fade; and `QM5_41456`, a November-May NR2 outer-quartile CLV fade.
The new candidate is flat unless a summer decision week follows both strict range contraction
and a positive completed-week body. Verdict:
