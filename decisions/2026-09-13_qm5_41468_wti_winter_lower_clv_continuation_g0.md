# QM5_41468 WTI Winter Lower-CLV Continuation — G0 Decision
...
- EA: `QM5_41468_wti-winter-lclv-cont`
- Strategy ID:
  `BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913_S01`
- Host/slot/magic: `XTIUSD.DWX`, D1, slot 0, `414680000`
...
- R1: PASS with disclosed cross-source/horizon, counter-seasonal-direction,
  and continuous-CFD translation risk.
...
The canonical scan found no exact collision and two fuzzy family matches.
Manual review separates the disjoint summer lower-tercile continuation, the
opposite-state winter upper-tercile continuation, and the opposite-direction
winter lower-tercile reversion. The unavailable external Wiki mount remains
an explicit limitation rather than an inferred pass; the OWNER-authorized
repository review is the durable approval basis.
...
The deterministic identity registry allocated `QM5_41468`; slot zero is the
