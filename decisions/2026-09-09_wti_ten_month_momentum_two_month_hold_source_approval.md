# WTI Ten-Month Momentum / Two-Month Hold — Source Approval
...
- Proposed slug: `wti-tsmom10-h2`
- Strategy ID: `MOP-TSMOM-2012_XTI_K10H2_S39`
- Parent source: `strategy-seeds/sources/MOP-TSMOM-2012/source.md`
- Dedup receipt: `artifacts/qm5_wti_tsmom10_h2_preallocation_dedup_20260909.json`
...
standalone WTI `k=10, h=2` result. No paper return, significance, alpha,
Sharpe ratio, CFD equivalence, trade count, or diversification result transfers.

## Locked Mechanic

1. Trade preset-bound `XTIUSD.DWX` on D1 only.
2. At the first D1 bar of each odd-numbered broker month, reconstruct eleven
...
The canonical checker scanned 4,868 registry rows, 1,481 cards, and 45
...
formation; `QM5_41379` through `QM5_41387` use three-, one-, nine-, six-,
four-, two-, five-, seven-, and eight-month formation. This identity requires
both exact ten-month endpoints and the non-overlapping two-month lifecycle.

Verdict: `DISTINCT_WTI_K10H2_NONOVERLAPPING_MONTHLY_TSMOM`.
