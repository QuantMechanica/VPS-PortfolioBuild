# WTI Summer Two-Week Agreement Momentum — Source Approval
...
- Proposed slug: `wti-summer-w2agree`
...
- Dedup receipt:
  `artifacts/qm5_wti_summer_w2agree_preallocation_dedup_20260910.json`
...
The canonical checker covered 4,886 registry rows and 1,496 repository cards.
...
separates the disjoint WTI winter agreement (`QM5_41404`), the XNG summer
agreement (`QM5_41396`), the XNG winter agreement (`QM5_41402`), and the XNG
