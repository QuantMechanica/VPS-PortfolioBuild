---
name: Self-author wake filter patch - development
status: proposed
date: 2026-04-29
owner: CTO
scope: paperclip-prompts/development.md
propagation_path: hot_reload
---

# Self-author wake filter patch - development

## Change
Inserted the binding wake filter block into paperclip-prompts/development.md:
...
## Evidence
- File patched: paperclip-prompts/development.md
