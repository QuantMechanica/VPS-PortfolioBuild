# WTI Seven-Month Momentum / Two-Month Hold — Source Approval
...
- Proposed slug: `wti-tsmom7-h2`
- Strategy ID: `MOP-TSMOM-2012_XTI_K7H2_S37`
- Parent source: `strategy-seeds/sources/MOP-TSMOM-2012/source.md`
- Dedup receipt: `artifacts/qm5_wti_tsmom7_h2_preallocation_dedup_20260908.json`
...
WTI `k=7, h=2` result. No paper return, significance, alpha, Sharpe ratio, CFD
equivalence, trade count, or diversification result transfers.

## Locked Mechanic

1. Trade preset-bound `XTIUSD.DWX` on D1 only.
2. At the first D1 bar of each odd-numbered broker month, reconstruct eight
   consecutive completed broker-month-end closes.
3. Compute `ln(C[7] / C[0])`; buy for a strict positive value, sell for a
...
The canonical checker scanned 4,866 registry rows, 1,479 cards, and 45
...
formation; `QM5_41379` through `QM5_41385` use three-, one-, nine-, six-,
four-, two-, and five-month formation. This identity requires both exact
seven-month endpoints and the non-overlapping two-month lifecycle.

Verdict: `DISTINCT_WTI_K7H2_NONOVERLAPPING_MONTHLY_TSMOM`.
