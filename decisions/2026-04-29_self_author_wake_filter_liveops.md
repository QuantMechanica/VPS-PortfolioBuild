---
name: Self-author wake filter patch - liveops
status: proposed
date: 2026-04-29
owner: CTO
scope: paperclip-prompts/liveops.md
propagation_path: hot_reload
---

# Self-author wake filter patch - liveops

## Change
Inserted the binding wake filter block into paperclip-prompts/liveops.md:
...
## Evidence
- File patched: paperclip-prompts/liveops.md
