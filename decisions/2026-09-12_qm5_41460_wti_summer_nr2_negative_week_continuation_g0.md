# QM5_41460 WTI Summer NR2 Negative-Week Continuation - G0 Decision

- Date: 2026-09-12
- Decision owner: OWNER
- Recorded by: Codex
- Card: `strategy-seeds/cards/approved/QM5_41460_wti-summer-nr2-downweek-cont.md`
- Source approval: `decisions/2026-09-12_wti_summer_nr2_negative_week_continuation_source_approval.md`
- Verdict: `APPROVED`
...
The canonical scan found no exact repository identity and reported seven fuzzy family matches.
Manual review separates the unconditional and two-sign summer cards, symmetric November-May
NR2 body continuation, and closest sibling `QM5_41459`, whose strict expansion gate is mutually
exclusive with this card's strict contraction gate. `QM5_41457` shares contraction but requires
a positive body and fades it. The external Strategy Wiki was unavailable and that
...
The atomic `farmctl reserve-ea-ids` command allocated `QM5_41460` to the approved strategy
