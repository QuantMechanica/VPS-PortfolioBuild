# WTI Summer WR2 Negative-Week Continuation - Source Approval
...
None of the parents tests this exact June-October, two-week expansion, negative-week,
...
- R2 `PASS`: calendar, completed-week construction, strict expansion and negative-body
...
The canonical checker scanned 4,940 registry rows and 1,549 repository cards, found no exact
identity, reported four fuzzy family matches, and failed closed because the external Strategy Wiki
...
`QM5_41443`, a symmetric November-May WR2 body-continuation rule. The closest match,
`QM5_41458`, requires a strictly positive newest-week body and fades it, whereas this candidate
requires a strictly negative body and continues it. Those body predicates are mutually exclusive.
`QM5_41457` separately requires range contraction and a positive body. Verdict:
