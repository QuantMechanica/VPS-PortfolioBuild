# G0 Decision — QM5_41045 WTI Wednesday Event / Slow-Trend Agreement
...
- EA ID: `QM5_41045`, atomically allocated in commit `4690bd83e`
- slug: `wti-wed-trend-agree`
- strategy ID: `EIA-MOP-WTI-WEDTRENDAGREE-2026_S01`
- source approval commit: `ebe884e63`
- carrier: exact `XTIUSD.DWX`, D1, slot 0, planned magic `410450000`
- mechanic: after an exact completed standard Wednesday, require strict sign
  ...
  trend ending Tuesday, follow that sign Thursday, and close next D1
...
- R2 `PASS`: exact weekdays, label normalization, separate completed endpoints,
  strict agreement, direction, attempt persistence, grace, fixed risk, hard
...
The canonical checker scanned 4,532 registry rows and 625 root cards and
returned `CLEAN`. Manual review separates this candidate from the Wednesday
component-agreement continuation in `QM5_41042`, the Wednesday opposed-flow
fade in `QM5_41041`, the pre-event Wednesday trend entry in `QM5_20154`, the
range-expansion aftershock in `QM5_12590`, the M30 WPSR sequences in
`QM5_20133/20134`, and the incumbent oscillator in `QM5_12567`.
...
- exact `XTIUSD.DWX` D1 slot 0 and planned magic `410450000`;
...
- first-Thursday decision within 180 minutes and one durable `yyyymmdd` attempt
...
- strict nonzero sign agreement and continuation in the common sign;
