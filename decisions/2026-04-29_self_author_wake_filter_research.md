---
name: Self-author wake filter patch - research
status: proposed
date: 2026-04-29
owner: CTO
scope: paperclip-prompts/research.md
propagation_path: hot_reload
---

# Self-author wake filter patch - research

## Change
Inserted the binding wake filter block into paperclip-prompts/research.md:
...
## Evidence
- File patched: paperclip-prompts/research.md
