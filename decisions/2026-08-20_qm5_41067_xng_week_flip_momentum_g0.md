# G0 Decision - QM5_41067 XNG Fresh Weekly Return-Sign Handoff
...
`decisions/2026-08-20_xng_week_flip_momentum_source_approval.md`.

Approved card:
`strategy-seeds/cards/approved/QM5_41067_xng-wflip-mom_card.md`.

## Identity

- EA ID: `QM5_41067`, allocated deterministically at commit `6558066f4`
- slug: `xng-wflip-mom`
- strategy ID: `MOP-XNG-WFLIP-MOM-2026_S01`
- source approval commit: `258db74a0`
- magic allocation commit: `5258258d0`
- host: exact `XNGUSD.DWX`, D1, slot 0, magic `410670000`
- mechanic: strict sign change between two adjacent completed XNG weekly
...
- R1 `PASS_WITH_WEEKLY_HORIZON_AND_TRANSITION_RISK`: a named-author,
  ...
  identity, and explicit natural-gas membership supplies own-return
  continuation
...
separates the incumbent cumulative-RSI2 pullback in `QM5_12567`, thresholded
low-realized-volatility continuation in `QM5_13101`, quiet-volume continuation
in `QM5_21520`, monthly XNG continuation and contrarian systems in
`QM5_20204` and `QM5_20054`, complete-week NR7 breakout in `QM5_41063`, and
...
- exact XNG D1 slot zero and registered magic;
