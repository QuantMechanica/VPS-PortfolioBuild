# QM5_41408 XNG Winter Two-Week Exhaustion Fade — G0 Decision

- Date: 2026-09-10
- Decision owner: OWNER
- Recorded by: Codex
- Card: `strategy-seeds/cards/approved/QM5_41408_xng-winter-w2fade_card.md`
- Source approval:
  `decisions/2026-09-10_xng_winter_two_week_fade_source_approval.md`
- Verdict: `APPROVED`
- Execution contract: `APPROVED` for branch build and non-live pipeline only

## Gate Decision

- R1 `PASS_WITH_HORIZON_AND_INTERACTION_TRANSLATION_RISK`: completely read
  official EIA natural-gas seasonality and academic commodity-reversal
  records; the exact weekly winter interaction remains untested.
- R2 `PASS`: November-March anchors, normalized weekly clock, two completed
  weekly packages, strict agreement, inverse direction, attempt, fixed risk,
  stop, spread, and rollover are fixed.
...
No exact identity was found. Manual review separates the same-carrier winter
continuation, the WTI winter fade, disjoint XNG shoulder fade, one-week XNG
winter momentum, and certified XNG RSI pullback. This candidate's joint state
is XNG, November-March, two adjacent complete same-sign weeks, symmetric
