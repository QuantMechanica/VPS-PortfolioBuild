---
name: Self-author wake filter patch - pipeline-operator
status: proposed
date: 2026-04-29
owner: CTO
scope: paperclip-prompts/pipeline-operator.md
propagation_path: hot_reload
---

# Self-author wake filter patch - pipeline-operator

## Change
Inserted the binding wake filter block into paperclip-prompts/pipeline-operator.md:
...
## Evidence
- File patched: paperclip-prompts/pipeline-operator.md
