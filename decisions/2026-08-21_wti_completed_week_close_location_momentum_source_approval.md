# WTI Completed-Week Close-Location Momentum - Source Approval
...
- proposed slug: `wti-wclose-location-mom`
- proposed strategy ID: `MOP-WTI-WCLOSE-LOCATION-MOM-2026_S01`
- proposed source ID: `MOP-WTI-WCLOSE-LOCATION-MOM-2026`
...
horizons are monthly. They do not test a WTI-only weekly horizon, a completed
...
- R1 `PASS_WITH_WEEKLY_CLOSE_LOCATION_TRANSLATION_RISK`: named authors,
  ...
  identity, explicit WTI membership, and the untested weekly close-location
...
The canonical checker, including author and mechanic fields, scanned 4,567
registry rows and 625 root cards and returned `CLEAN`, with no exact or fuzzy
match. Manual family review separates:

- `QM5_41020_wti-wclose-mom`, which forms on an exact Tuesday-to-Friday
  closing segment, enters Monday, exits Wednesday, and never aggregates a
  completed weekly high-low range;
- `QM5_41073_wti-woutside-settle`, which requires a strict outside week,
  settlement beyond the parent high or low, own-week open-to-close agreement,
  and outer-quartile location; this candidate requires no parent-range break
  and instead confirms the strict parent-close-to-new-close return sign with
  the new week's own close location;
- `QM5_41065`, `QM5_41068`, `QM5_41069`, `QM5_41070`, `QM5_41071`,
  `QM5_41072`, and `QM5_41074`, which classify multi-week sign or magnitude
  paths without using the newest completed week's own high-low close
  location;
- `QM5_12965_wti-week-orb` and `QM5_41061_wti-week-nr7-brk`, which wait for a
  current-week breakout after an opening-range or seven-week-compression
  state rather than entering at the boundary from completed-week settlement;
- `QM5_13049_xti-1w-mom-vol`, which uses a rolling five-D1 magnitude and
  volatility-rank gate with a different clock and lifecycle; and
...
The exact WTI carrier, two consecutive completed weekly packages, newest
week high-low aggregation, parent-close-to-new-close sign, strict own-range
`0.80` / `0.20` close location, consumed weekly attempt, and full-next-week
hold are jointly load-bearing. Verdict:
