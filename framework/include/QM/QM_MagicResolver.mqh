...
#define QM_MAGIC_REGISTRY_SHA256 "4624447B1087E411004D8508D444E1DBCF5BBD9F0E0A7F82C95AE6C5FCF06181"

#define QM_MAGIC_REGISTRY_ROWS 4
static const int    QM_MAGIC_REG_EA_ID[QM_MAGIC_REGISTRY_ROWS]   = {1001, 1044, 1044, 1045};
static const int    QM_MAGIC_REG_SLOT[QM_MAGIC_REGISTRY_ROWS]    = {0, 0, 1, 0};
static const string QM_MAGIC_REG_SYMBOL[QM_MAGIC_REGISTRY_ROWS]  = {"EURUSD.DWX", "NDX.DWX", "WS30.DWX", "SPX500.DWX"};
static const int    QM_MAGIC_REG_MAGIC[QM_MAGIC_REGISTRY_ROWS]   = {10010000, 10440000, 10440001, 10450000};
