"""Q05 — Gross full-history robustness runner (formerly "Stress MEDIUM").

Spec re-ratified 2026-07-05 (decisions/2026-07-05_q05_spec_reratification.md):
this runner applies NO cost stress — the pre-2026-07-05 vault spec described
slippage/spread/commission multipliers that were never implemented. What it
actually tests, and now officially tests:
