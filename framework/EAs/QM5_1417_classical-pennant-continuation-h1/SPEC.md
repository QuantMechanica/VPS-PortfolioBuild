# QM5_1417_classical-pennant-continuation-h1 — Strategy Spec

**EA ID:** QM5_1417
**Slug:** `classical-pennant-continuation-h1`
...
`artifacts/cards_approved/QM5_1417_classical-pennant-continuation-h1.md`. See that card's body for
...
`QM5_1417_classical-pennant-continuation-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_penn_min_bars` | 5 | (see source) | (see strategy logic) |
| `strategy_penn_max_bars` | 15 | (see source) | (see strategy logic) |
| `strategy_penn_slope_symmetry_max` | 0.40 | (see source) | (see strategy logic) |
| `strategy_penn_range_min_atr` | 1.50 | (see source) | (see strategy logic) |
| `strategy_penn_range_max_atr` | 4.00 | (see source) | (see strategy logic) |
| `strategy_penn_apex_dist_min` | 0.20 | (see source) | (see strategy logic) |
| `strategy_penn_apex_dist_max` | 0.80 | (see source) | (see strategy logic) |
| `strategy_penn_max_retrace_pct` | 0.50 | (see source) | (see strategy logic) |
| `strategy_penn_volume_mult` | 0.75 | (see source) | (see strategy logic) |
...
| `strategy_failure_exit_bars` | 5 | (see source) | (see strategy logic) |
| `strategy_time_stop_bars` | 18 | (see source) | (see strategy logic) |
| `strategy_sl_buffer_atr` | 0.30 | (see source) | (see strategy logic) |
| `strategy_sl_cap_atr` | 2.00 | (see source) | (see strategy logic) |
...
| `strategy_reuse_guard_bars` | 10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_1417_classical-pennant-continuation-h1.md`
