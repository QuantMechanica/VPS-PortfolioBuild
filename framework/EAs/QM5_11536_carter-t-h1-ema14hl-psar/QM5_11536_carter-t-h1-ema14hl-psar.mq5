...
#property description "QM5_11536 carter-t-h1-ema14hl-psar — EMA(14,High/Low) channel + PSAR flip (H1)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11536 carter-t-h1-ema14hl-psar
// -----------------------------------------------------------------------------
// Source: Thomas Carter, "20 Forex Trading Strategies (1 Hour Time Frame)",
//   System #10, self-published 2014.
// Card: artifacts/cards_approved/QM5_11536_carter-t-h1-ema14hl-psar.md (APPROVED).
//
...
//   zero-trade trap #4), so only the PSAR flip is an event here.
//
...
//
//   Stop  : fixed pips (55 default, card P2). Take: fixed pips (75 default).
...
input int    strategy_sl_pips            = 55;    // stop-loss distance in pips (card P2)
input int    strategy_tp_pips            = 75;    // take-profit distance in pips (card P2)
input double strategy_spread_pct_of_stop = 15.0;  // skip if spread > this % of stop distance
input bool   strategy_no_friday_entry    = true;  // suppress new entries on Friday (card filter)
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // Optional no-Friday-entry filter (card "No Friday entry").
