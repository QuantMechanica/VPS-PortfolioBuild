...
#property description "QM5_41402 XNG Winter Two-Week Agreement Momentum"
...
//   - decide only in November, December, January, February, and March
...
bool Strategy_LoadTwoWeekAgreementSignal(const int current_week_key,
                                         ...
                                         int &direction)
  {
   ...
   // Both adjacent completed weeks must agree strictly. Disagreement and
   // exact zero are valid flat states rather than data failures.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41402_XNG_WINTER_W2AGREE";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_WINTER_W2_AGREE_LONG"
      : "XNG_WINTER_W2_AGREE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41402 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41402_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41402\",\"ea\":\"xng-winter-w2agree\"}");
