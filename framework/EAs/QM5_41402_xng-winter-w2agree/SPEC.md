# QM5_41402_xng-winter-w2agree - Strategy Spec

**EA ID:** QM5_41402  
**Slug:** `xng-winter-w2agree`  
**Strategy ID:** `EIA-MOP-XNG-WINTER-W2AGREE-202609090909_S01`  
**Source:** `EIA-MOP-XNG-WINTER-W2AGREE-20260909`  
**Last revised:** 2026-09-09

## 1. Strategy Logic

At the first tradable `XNGUSD.DWX` D1 bar of a normalized broker week whose
Monday anchor lies in November through March, read only the two immediately
completed adjacent three-to-five-session weeks. Compute each
`ln(final_close / first_open)` and trade the shared strict sign only when both
...
`414020000`. The symbol is an input; no executable symbol literal is embedded
...
week. Only November-through-March anchors may continue. Validate the two
immediately prior adjacent weeks, compute both open-to-close log returns, and
follow their sign only on strict agreement. Require no owned position or
...
8-16 completed packages per full year. The expected regime is winter
electric-generation demand; expected hold is one normalized week.

## 6. Source Citation

The source-of-record packet is
`strategy-seeds/sources/EIA-MOP-XNG-WINTER-W2AGREE-20260909/source.md`. It joins
...
two-week winter conjunction, continuous-CFD efficacy, and portfolio decorrelation are
not source claims. R1 lineage and R2-R4 status are recorded in
`strategy-seeds/cards/approved/QM5_41402_xng-winter-w2agree_card.md`.
...
| entry | winter calendar, two completed-week packages, strict agreement, durable attempt, spread and frozen ATR stop |
