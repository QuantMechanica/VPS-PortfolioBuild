# QM5_9972_bandy-heikin-ashi-color-flip-trend — Strategy Spec
...
`artifacts/cards_approved/QM5_9972_bandy-heikin-ashi-color-flip-trend.md`. See that card's body for
...
`QM5_9972_bandy-heikin-ashi-color-flip-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
