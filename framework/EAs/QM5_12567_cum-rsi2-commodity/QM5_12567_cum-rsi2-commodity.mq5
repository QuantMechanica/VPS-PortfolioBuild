...
#property description "QM5_12567 Cumulative RSI2 Pullback — Commodity Port (cum-rsi2 survivor mechanic on energy/metals)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_12567 cum-rsi2-commodity
// -----------------------------------------------------------------------------
// Portfolio-diversification port of survivor QM5_11132_tm-cum-rsi2. IDENTICAL
// Connors two-day cumulative RSI(2) pullback mechanic; only the magic identity
// (qm_ea_id) and the traded universe (energy/metals via setfile) differ. The
// strategy hooks are symbol-agnostic (operate on _Symbol / PERIOD_D1), so the
// commodity port reuses the proven survivor logic verbatim.
//
// Mechanic (per card QM5_12567): D1, long-only, close > SMA(200) trend filter,
// enter when two-day cumulative RSI(2) < 35, exit when RSI(2) > 65 or after
// 5 D1 bars, 2.5×ATR(14) stop fixed at entry.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12567;
