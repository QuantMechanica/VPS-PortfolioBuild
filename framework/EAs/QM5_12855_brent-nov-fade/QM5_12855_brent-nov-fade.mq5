...
#property description "QM5_12855 Brent November Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12855 - Brent November Calendar Fade
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - short XBRUSD.DWX only during broker-calendar November D1 bars
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12855_BRENT_NOV_FADE";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12855\",\"ea\":\"brent-nov-fade\"}");
