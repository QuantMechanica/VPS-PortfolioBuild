# QM5_20158_xng-tue-trend — Strategy Spec

**EA ID:** QM5_20158
**Slug:** `xng-tue-trend`
**Source:** `BOROWSKI-MOP-XNG-TUETREND-2026`
...
- `XNGUSD.DWX` — registered Darwinex XNG CFD carrier for the cited Tuesday
...
first executable quote determines entry; the Friday-close to Tuesday-open gap
...
| Regime preference | Tuesday premium aligned with positive 252-D1 XNG trend |
...
- **Source ID:** `BOROWSKI-MOP-XNG-TUETREND-2026`
- **Source type:** governed composite of two peer-reviewed journal papers
- **Pointer:**
  `strategy-seeds/sources/BOROWSKI-MOP-XNG-TUETREND-2026/source.md`
- **R1-R4 verdict (G0):** all PASS; see
  `strategy-seeds/cards/approved/QM5_20158_xng-tue-trend_card.md`

Borowski supply the XNG Tuesday direction. Moskowitz, Ooi, and
