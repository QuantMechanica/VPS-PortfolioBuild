...
#property description "QM5_20158 XNG Tuesday Premium Positive-Trend Agreement"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20158 - XNG Tuesday Premium / Slow-Trend Agreement
// -----------------------------------------------------------------------------
// D1 structural crude-oil sleeve:
//   - first observed tick of a genuine broker-calendar Tuesday D1 bar
//   - BUY only when the completed 252-D1 XNG log return is positive
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "XNG_TUE_POS252_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20158_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20158\",\"ea\":\"xng-tue-trend\"}");
