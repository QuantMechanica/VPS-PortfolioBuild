# QM5_1345_chan-cot-spec-momo — Strategy Spec

**EA ID:** QM5_1345
**Slug:** `chan-cot-spec-momo`
...
`artifacts/cards_approved/QM5_1345_chan-cot-spec-momo.md`. See that card's body for
...
`QM5_1345_chan-cot-spec-momo.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_lookback_period` | 60 | (see source) | (see strategy logic) |
| `strategy_ratio_entry_long` | 3.0 | (see source) | (see strategy logic) |
| `strategy_ratio_entry_short` | 0.333 | (see source) | (see strategy logic) |
| `strategy_ratio_exit` | 1.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_max_hold_days` | 120 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_1345_chan-cot-spec-momo.md`
