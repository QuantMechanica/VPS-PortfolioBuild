...
#property description "QM5_12775 WTI Wednesday Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12775 - WTI Wednesday Calendar Premium
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - buy XTIUSD.DWX on the broker-calendar Wednesday D1 bar
//   - flatten on the next non-Wednesday D1 bar or one-day stale-position guard
// Runtime uses MT5 OHLC/broker calendar only; no external energy data.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12775;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12775_WTI_WED_PREM";
   ...
   req.reason = "WTI_WEDNESDAY_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12775\",\"ea\":\"wti-wed-prem\"}");
