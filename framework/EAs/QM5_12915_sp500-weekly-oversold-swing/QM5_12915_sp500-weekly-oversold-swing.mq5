...
#property description "QM5_12915 SP500 weekly oversold swing"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12915;
...
bool Strategy_IsTarget()
  {
   return (_Symbol == "SP500.DWX" && _Period == PERIOD_D1 && qm_magic_slot_offset == 0);
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "SP500_10D_LOW_SWING";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12915\",\"ea\":\"sp500-weekly-oversold-swing\"}");
