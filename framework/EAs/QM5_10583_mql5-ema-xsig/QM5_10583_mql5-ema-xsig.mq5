...
#property description "QM5_10583 mql5-ema-xsig"
...
input int    strategy_slow_ema_period   = 6;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const int signal = EmaCrossoverSignal();
   if(signal == 0)
      return false;
   ...
   req.reason = (signal > 0) ? "EMA_XSIG_BUY" : "EMA_XSIG_SELL";
   req.symbol_slot = qm_magic_slot_offset;
   req.expiration_seconds = 0;
   return true;
  }
