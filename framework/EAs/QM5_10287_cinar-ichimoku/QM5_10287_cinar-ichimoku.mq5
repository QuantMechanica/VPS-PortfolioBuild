...
#property description "QM5_10287 Cinar Ichimoku Cloud Trend"
...
bool Strategy_NoTradeFilter()
  {
   // Card specifies no time, spread, or extra regime filter beyond framework gates.
   return false;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double base = QM_Ichimoku_KijunSen(_Symbol,
                                            (ENUM_TIMEFRAMES)_Period,
                                            strategy_tenkan_period,
                                            strategy_kijun_period,
                                            strategy_senkou_b_period,
   ...
   req.reason = (signal > 0) ? "CINAR_ICHIMOKU_LONG" : "CINAR_ICHIMOKU_SHORT";
   return true;
  }
