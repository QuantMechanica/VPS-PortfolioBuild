...
#property description "QM5_11551 carter-t-m5-ema40-80-cci21 — 40/80 EMA trend + CCI(21) zero-cross (M5)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11551 carter-t-m5-ema40-80-cci21
// -----------------------------------------------------------------------------
// Source: Thomas Carter, "20 Forex Trading Strategies (5 Minute Time Frame)",
//         System #10 (2014). Card:
//         artifacts/cards_approved/QM5_11551_carter-t-m5-ema40-80-cci21.md
//         (g0_status APPROVED, source_id 42530cb3-0265-534a-89cc-150f80733ff5).
//
...
//                 card range 10-15, P3 sweep 8/12/15).
...
//                 modeled spread); card spread cap = 5 pips.
//
...
input int    strategy_sl_pips           = 12;     // fixed stop-loss in pips (P3 sweep 8/12/15)
input int    strategy_tp_pips           = 12;     // fixed take-profit in pips (P3 sweep 8/12/15)
input bool   strategy_no_friday_entry   = true;   // skip new entries on broker Friday
input double strategy_spread_cap_pips   = 5.0;    // skip if spread exceeds this many pips (card cap)
