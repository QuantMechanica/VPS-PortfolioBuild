...
#property description "QM5_20027 WTI Calendar-Day-26 One-Session Short"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20027 - WTI Calendar-Day-26 One-Session Short
// -----------------------------------------------------------------------------
// Borowski (2016) crude-oil day-of-month carrier:
//   - SELL only at the opening of a broker D1 bar dated exactly the 26th
//   - never shift an absent/non-trading 26th to a neighboring session
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20027_WTI_DOM26_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_PrimeLateDay26Attach()
  {
...
bool Strategy_ConsumeDay26Decision()
  {
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsWtiD1())
      return true;
   if(qm_ea_id != 20027 || qm_magic_slot_offset != 0)
      return true;
   if(!qm_friday_close_enabled ||
      qm_friday_close_hour_broker != 21)
      return true;
   if(strategy_entry_day != 26)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "WTI_DOM26_ONE_SESSION_SHORT";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved WTI DOM26 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;

   Strategy_LoadAttemptState(TimeCurrent());
   if(!Strategy_PrimeLateDay26Attach())
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20027\",\"ea\":\"wti-dom26-short\"}");
...
void OnTick()
  {
   ...
   if(!Strategy_ConsumeDay26Decision())
      return;
