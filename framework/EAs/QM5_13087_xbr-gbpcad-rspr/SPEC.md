# QM5_13087_xbr-gbpcad-rspr - Strategy Spec

**EA ID:** QM5_13087
**Slug:** `xbr-gbpcad-rspr`
**Source:** `EIA-BOC-XBR-GBPCAD-2026` (see `strategy-seeds/sources/EIA-BOC-XBR-GBPCAD-2026/`)
...
| Regime preference | Mean-revert relative-value dislocations between Brent and inverse-CAD GBPCAD |
...
**Source ID:** `EIA-BOC-XBR-GBPCAD-2026`
**Source type:** official energy research / central bank research
**Pointer:** `strategy-seeds/sources/EIA-BOC-XBR-GBPCAD-2026/`
**R1-R4 verdict (Q00):** all PASS / see `artifacts/cards_approved/QM5_13087_xbr-gbpcad-rspr.md`
...
|---|---|---|---|
| v1 | 2026-07-09 | Initial build from approved card | manual-codex-2026-07-09-xbr-gbpcad-rspr |
