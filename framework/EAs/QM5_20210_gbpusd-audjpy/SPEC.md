# QM5_20210_gbpusd-audjpy — Strategy Spec
...
`ln(GBPUSD.DWX) - (-0.038239845) * ln(AUDJPY.DWX)`. Score the newest spread
...
| `strategy_beta` | -0.038239845 | fixed | DEV-fitted structural hedge coefficient |
...
| Typical hold time | multi-day; scan half-life 104.649 D1 bars |
| Expected drawdown profile | high and regime-sensitive; conservative 30% prior |
| Regime preference | GBPUSD/AUDJPY fixed-residual mean reversion |
| Win rate target | unknown; Q02 is the first platform-economic judge |

The fixed scan recorded DEV net Sharpe `-0.166819`, OOS net Sharpe `0.304341`,
and OOS return `2.906184%`. The negative DEV score, long half-life, and small
...
|---|---|---|---|
| v1 | 2026-08-03 | Initial build from approved card | Next-ranked non-duplicate fixed-scan FX basket |
