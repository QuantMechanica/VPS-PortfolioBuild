...
`artifacts/cards_approved/QM5_10074_gh-santi-adxma.md`. See that card's body for
...
`QM5_10074_gh-santi-adxma.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_ema_period` | 8 | (see source) | (see strategy logic) |
| `strategy_adx_period` | 8 | (see source) | (see strategy logic) |
| `strategy_adx_min` | 22.0 | (see source) | (see strategy logic) |
| `strategy_stop_loss_pips` | 30 | (see source) | (see strategy logic) |
| `strategy_take_profit_pips` | 100 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10074_gh-santi-adxma.md`
