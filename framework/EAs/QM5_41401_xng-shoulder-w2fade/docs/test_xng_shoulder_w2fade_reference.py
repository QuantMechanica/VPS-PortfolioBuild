"""Deterministic reference checks for QM5_41401 XNG shoulder exhaustion."""
...
def agreement_signal(
    ...
    """Mirror strict two-week agreement and its contrarian package side."""
...
class XngShoulderTwoWeekFadeReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
