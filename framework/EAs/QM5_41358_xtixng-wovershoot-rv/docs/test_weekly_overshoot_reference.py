"""Deterministic reference checks for QM5_41358 XTI/XNG weekly reversal overshoot."""
...
class WeeklyOvershootReferenceTest(unittest.TestCase):
    def test_positive_reversal_overshoot_sells_xti(self) -> None:
    ...
    def test_negative_reversal_overshoot_buys_xti(self) -> None:
