...
type: strategy
strategy_id: AI-CODEX-XTIXNG-WOVERSHOOT-RV-20260906_S01
variant_id: AI-CODEX-XTIXNG-WOVERSHOOT-RV-20260906_S01
source_id: AI-CODEX-XTIXNG-WOVERSHOOT-RV-20260906
ea_id: QM5_41358
slug: xtixng-wovershoot-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41358_xtixng-wovershoot-rv_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41358_xtixng_weekly_reversal_overshoot_g0.md
source_approval: decisions/2026-09-06_xtixng_weekly_reversal_overshoot_source_approval.md
...
source_citations:
  - type: government_research
    citation: "Villar, Jose A. and Joutz, Frederick L. (2006), The Relationship Between Crude Oil and Natural Gas Prices, U.S. Energy Information Administration."
    location: "Governed complete-read packet strategy-seeds/sources/VILLAR-RAMBERG-OILGAS-2026/source.md"
    quality_tier: A
    role: oil_gas_structural_relationship_and_adverse_instability
  - type: academic_paper
    citation: "Ramberg, David J. and Parsons, John E. (2012), The Weak Tie Between Natural Gas and Oil Prices, The Energy Journal 33(2), 13-35."
    location: "DOI 10.5547/01956574.33.2.2; governed complete-read packet strategy-seeds/sources/VILLAR-RAMBERG-OILGAS-2026/source.md"
    quality_tier: A
    role: weak_time_varying_oil_gas_tie_and_adverse_evidence
strategy_mechanic: synchronized-completed-two-adjacent-week-xti-minus-xng-relative-returns-opposite-sign-newest-strictly-larger-fade-newest-direction-one-week-equal-notional-basket
sources:
  - "[[sources/AI-CODEX-XTIXNG-WOVERSHOOT-RV-20260906]]"
concepts:
  - "[[concepts/oil-gas-relative-value]]"
  - "[[concepts/weekly-reversal-overshoot-reversion]]"
  - "[[concepts/market-neutral-basket]]"
indicators:
  - "[[indicators/adjacent-completed-week-relative-log-returns]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, oil-gas-ratio, market-neutral-basket, weekly-reversal-overshoot, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41358_XTI_XNG_WOVERSHOOT_RV_D1
symbol: QM5_41358_XTI_XNG_WOVERSHOOT_RV_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413580000, 413580001]
period: D1
timeframe: D1
expected_trade_frequency: "Approximately ten to twenty completed paired packages per full post-warm-up year after exact synchronized week, strict sign opposition, strict newest dominance, and execution gates; Q02 must prove at least five/year or retire."
...
hard_rules_at_risk: [exact_xti_xng_carrier, synchronized_week_endpoints, consecutive_monday_anchors, nonoverlapping_relative_returns, strict_sign_opposition, strict_newest_absolute_dominance, inverse_newest_return_basket_direction, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 uses complete U.S. government and peer-reviewed oil/gas sources, retains their adverse instability evidence, and discloses the weekly reversal-overshoot fade as an untested QM translation; R2 locks exact synchronized weeks, chronological relative returns, strict sign opposition, strict newest dominance, inverse-newest-return side, durable attempt, aggregate fixed risk, equal notional, hard stops, spreads, and next-week lifecycle; R3 uses registered native XTI/XNG D1 histories with synchronization and CFD-basis risks explicit and requires active slots 0/1 before build; R4 is deterministic timestamp, price, logarithm, ATR, quote, position, deal, and terminal-state arithmetic without a banned signal, trained output, external feed, grid, or martingale; canonical dedup and manual family review found no exact identity."
---

# QM5_41358 XTI/XNG Completed-Week Reversal-Overshoot Reversion

## Hypothesis

When the oil/gas log ratio reverses its prior completed-week direction and
the newest opposite move is strictly larger, the relative reversal may have
overshot. Fading only that newest move for the next broker week may capture
convergence without taking an outright single-leg signal.

The candidate is one logical two-leg package intended to add a distinct
relative-value return driver outside the certified XTI/SP500/NDX/XNG book.
...
at commit `5f191d7cd4`.

Villar/Joutz and Ramberg/Parsons supply U.S. government and peer-reviewed
evidence for a weak, time-varying oil/gas relationship, including material
adverse instability. Neither source tests adjacent opposite-sign weekly
returns, strict newest-magnitude dominance, this contrarian direction, a
...
The canonical pre-allocation checker scanned 4,838 registry rows and 1,451
repository cards, found no exact identity, and surfaced four fuzzy family
matches. The optional Wiki root was unavailable and is explicit in the receipt.
Manual semantic review fixes the boundaries:

- `QM5_41075_xauxag-wovershoot-rv` shares the exact event arithmetic but owns
  a precious-metals carrier. This card owns the weak, time-varying oil/gas
  carrier, energy contract metadata, and energy spread costs.
- `QM5_41357_xtixng-mwinsor2-rv` shares the carrier but uses thirteen completed
  month ends, twelve relative returns, fixed two-per-tail Winsorization, and a
  next-month hold. This card uses three week ends, two returns, a strict
  dominant sign reversal, and a next-week hold.
- `QM5_41340_wti-xng-divtrend` owns only WTI, follows its annual sign, and uses
  read-only XNG as a divergence veto. This card owns two opposed legs and fades
  the newest weekly relative move.
- XTI/XNG ECM, slope, rank, change-point, weekday, and calendar baskets consume
...
- `QM5_12567_cum-rsi2-commodity` is a single-symbol long-only two-day
  oscillator pullback and has no relative-energy, weekly, or paired logic.

The exact XTI/XNG carrier, three synchronized week ends, two adjacent relative
returns, strict sign opposition, strict newest absolute dominance, inverse-
newest-return side, weekly attempt, equal-notional aggregate-risk package,
...
- Exact host: `XTIUSD.DWX`, D1, slot 0, magic `413580000`.
- Exact companion: `XNGUSD.DWX`, D1, slot 1, magic `413580001`.
...
- Signal: two strict opposite-sign weekly relative returns with strictly
  larger newest absolute magnitude; fade the newest direction.
- Ordinary exit: first tick whose broker Monday anchor is later than the
  package-open anchor.
- Expected cadence: ten to twenty completed packages/year; retire below five.
...
```text
s1 = ln(XTI_1) - ln(XNG_1)
s2 = ln(XTI_2) - ln(XNG_2)
s3 = ln(XTI_3) - ln(XNG_3)
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41358 and
...
6. Compute `s1`, `s2`, `s3`, `r_new`, and `r_old` exactly as specified. Require
   ...
   `abs(r_new)>abs(r_old)`. Same sign, either zero, equality, or a smaller
   newest move remains flat.
7. SELL XTI/BUY XNG only when `r_old<0`, `r_new>0`, and the newest move
   dominates. BUY XTI/SELL XNG only when `r_old>0`, `r_new<0`, and the newest
   move dominates. Signal magnitude never changes risk.
8. Require no owned exposure, no same-magic entry deal already recorded in the
   ...
   positive spread wider than 1,500 XTI points or 3,000 XNG points. Modeled zero
   `.DWX` spread is valid.
...
- Exact host, D1, EA 41358, slot zero, and both registered magics.
...
- First-week-bar clock, synchronized timestamps, three consecutive week
  anchors, positive finite prices, strict sign opposition, strict newest
  dominance, durable attempt, side-specific trade mode, spread, quote, ATR,
  sizing, stop geometry, and notional match all fail closed.
...
- Own exactly one `XTIUSD.DWX` position under magic `413580000` and one
  opposite-side `XNGUSD.DWX` position under magic `413580001`.
...
Villar/Joutz and Ramberg/Parsons supply a weak, time-varying oil/gas
relationship lineage and adverse evidence against a fixed tie. Neither source
supplies the weekly horizon or reversal-overshoot fade.

## QM Interpretations

`AI-CODEX-XTIXNG-WOVERSHOOT-RV-20260906_S01` fixes the exact weekly endpoint
construction, two-return count, strict state, inverse-newest-return sides,
continuous-CFD clock, durable attempt, equal-notional aggregate risk, spread
caps, stops, and lifecycle.
...
- Major risks are non-convergence, one-leg fills, stop-risk asymmetry, lot-step
  notional mismatch, oil/gas beta drift, week-end gaps, continuous-CFD
  basis, financing, spread, density below the floor, source translation, and
  realized overlap with the certified XNG and broader commodity book.
...
intervals, current-week leakage, same-sign, zero, equality, or non-dominant
entry, wrong inverse-newest-return side, duplicate attempt, one-leg survivor,
aggregate-risk breach, notional mismatch above 20 percent, missing hard stop,
wrong next-week exit, nondeterminism, or invalid fixed-risk mode.

Changing the carrier, endpoint count, weekly horizon, sign or dominance
...
non-overlapping relative returns; both strict opposite-sign newest-dominance
directions; same sign, zero, equality, and non-dominance flat states; no
