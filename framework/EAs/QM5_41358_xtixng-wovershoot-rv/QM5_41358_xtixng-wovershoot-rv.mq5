...
#property description "QM5_41358 XTI/XNG Weekly Reversal-Overshoot Reversion"
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41358 && qm_magic_slot_offset == 0 &&
            qm_rng_seed == 42 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_WOVERSHOOT_ATTEMPT_WEEK", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41358_XTIXNG_WOVERSHOOT_RV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41358_XTIXNG_WOVERSHOOT_RV_HOST";
   ...
   if(Strategy_OpenOwnedPositionCount() > 0 ||
   ...
   else
     {
      ...
      if(!signal_valid)
         ...
         g_signal_state = "positive_reversal_overshoot_short_xti";
      else if(direction > 0)
         g_signal_state = "negative_reversal_overshoot_long_xti";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XTI/XNG weekly reversal-overshoot package exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41358\",\"ea\":\"xtixng-wovershoot-rv\"}");
