"""Deterministic reference checks for QM5_41407 WTI summer two-week fade."""
...
class WtiSummerTwoWeekFadeReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_ineligible_week_refuses_before_signal(self) -> None:
        with self.assertRaisesRegex(ValueError, "ineligible month"):
            fade_signal(date(2026, 11, 2), self.bars(3, 4, 2, 3))
