...
#property description "QM5_12617 TSMOM 12M FX USDJPY"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12617 - USDJPY 12-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.tp = 0.0;
   req.symbol_slot = qm_magic_slot_offset;
   req.reason = (direction > 0) ? "USDJPY_TSMOM12M_LONG" : "USDJPY_TSMOM12M_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12617\",\"ea\":\"tsmom-12m-fx-usdjpy\"}");
