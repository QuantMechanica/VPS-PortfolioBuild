# QM5_31006_night-forex-bot-asian-stochastic-scalper — Strategy Spec

**EA ID:** QM5_31006
**Slug:** `night-forex-bot-asian-stochastic-scalper`
**Source:** `night-forex-bot-asian-stochastic-scalper-official-source` (see `strategy-seeds/sources/night-forex-bot-asian-stochastic-scalper-official-source/`)
...
`artifacts/cards_approved/QM5_31006_night-forex-bot-asian-stochastic-scalper.md`. See that card's body for
...
`QM5_31006_night-forex-bot-asian-stochastic-scalper.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `InpStochK` | 14 | (see source) | (see strategy logic) |
| `InpStochD` | 3 | (see source) | (see strategy logic) |
| `InpBBDeviation` | 1.50 | (see source) | (see strategy logic) |
...
**Source ID:** `night-forex-bot-asian-stochastic-scalper-official-source`
**Pointer:** `strategy-seeds/sources/night-forex-bot-asian-stochastic-scalper-official-source/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_31006_night-forex-bot-asian-stochastic-scalper.md`
