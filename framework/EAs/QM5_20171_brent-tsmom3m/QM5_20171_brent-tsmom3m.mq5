...
#property description "QM5_20171 Brent 3M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20171 - Brent 3-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20171_Brent_TSMOM3M";
   ...
   // back-calculates in the tester -- root-caused 2026-07-05 on the Brent
   ...
   req.reason = (direction > 0) ? "Brent_TSMOM3M_LONG" : "Brent_TSMOM3M_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20171\",\"ea\":\"brent-tsmom3m\"}");
