...
# Brent Three-Month Time-Series Momentum
...
tests the sign of Brent's completed three-month return as a monthly directional
...
- `XBRUSD.DWX`, D1, magic slot 0 only.
...
- [x] R3: registered `XBRUSD.DWX` D1 carrier.
...
|---|---|---|---|---|
| v1 | 2026-07-26 | initial source-backed three-month Brent trend build | Q02 | pending |
