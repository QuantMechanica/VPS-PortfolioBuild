...
#property description "QM5_10796 TradingView Double SMA ATR Stop"
...
input int    strategy_slow_sma_period       = 45;
input int    strategy_atr_period            = 14;
input double strategy_atr_stop_multiplier   = 2.0;
input bool   strategy_opposite_cross_exit   = true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double slow_prev = QM_SMA(_Symbol, PERIOD_CURRENT, strategy_slow_sma_period, 2);
   ...
   req.sl = stop;
   req.tp = 0.0;
   req.reason = (side == QM_BUY) ? "TV_SMA_ATR_LONG" : "TV_SMA_ATR_SHORT";
   req.symbol_slot = qm_magic_slot_offset;
   return true;
  }
...
void Strategy_ManageOpenPosition()
  {
   // Source stop is static after entry; no trailing, break-even, or partial close.
  }
...
bool Strategy_ExitSignal()
  {
   if(!strategy_opposite_cross_exit)
      return false;
