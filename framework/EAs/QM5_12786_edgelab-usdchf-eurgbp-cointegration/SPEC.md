# QM5_12786_edgelab-usdchf-eurgbp-cointegration - Strategy Spec
...
The EA trades the USDCHF.DWX and EURGBP.DWX D1 cointegration spread. It computes
`S = ln(USDCHF) - beta * ln(EURGBP)` with beta defaulting to 0.138258947, then
...
same script ranked USDCHF/EURGBP as the next unbuilt rank-28 tail candidate
after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749/12751/12756/12758/12760/12762/12764/12765/12766/12768/12770/12772/12776/12778/12781/12783
baskets, with DEV Sharpe 0.0840, OOS net Sharpe -0.3881, OOS return -3.8501%,
15 OOS state changes, beta 0.138258947, and 92.63-day half-life.
...
| strategy_beta | 0.138258947 | >0 | Hedge coefficient in `ln(USDCHF) - beta * ln(EURGBP)` |
...
**Designed for:**
- USDCHF.DWX - leg 1 of the fixed USDCHF/EURGBP spread and the spread numerator.
- EURGBP.DWX - leg 2 of the fixed USDCHF/EURGBP spread and the beta-weighted spread denominator.

**Explicitly not for:**
- Other `.DWX` symbols. This card is a fixed two-leg FX-cross basket, not a portable multi-pair strategy.

EURUSD.DWX and GBPUSD.DWX are selected as conversion history for the EURGBP leg
under USD-denominated tester accounting, but neither is traded.
...
| Regime preference | low-conviction European funding and safe-haven relative-value residual |
...
|---|---:|---:|---:|---:|---:|---:|
| USDCHF~EURGBP | 0.0840 | -0.3881 | -3.8501% | 15 | 0.138258947 | 92.63d |
...
|---|---|---|---|
| v1 | 2026-06-29 | Initial rank-28 next-unbuilt FX cointegration basket build | Built from the adjacent rank-27 basket pattern with explicit EURUSD/GBPUSD conversion history |
