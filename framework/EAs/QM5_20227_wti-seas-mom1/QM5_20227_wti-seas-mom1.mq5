...
#property description "QM5_20227 WTI Season / One-Month Momentum Concordance"
...
//   - enter only when seasonal and return-sign directions agree
...
bool Strategy_LoadCompletedMonthSignal(const int current_month_key,
                                       ...
                                       int &direction)
  {
   ...
   momentum = MathLog(month_closes[0] / month_closes[1]);
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // Consume before history, signal, agreement, spread, quote, news, stop,
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20227_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20227\",\"ea\":\"wti-seas-mom1\"}");
