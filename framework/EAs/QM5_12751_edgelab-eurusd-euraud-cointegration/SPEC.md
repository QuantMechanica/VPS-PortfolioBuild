# QM5_12751_edgelab-eurusd-euraud-cointegration - Strategy Spec
...
The EA trades the EURUSD.DWX and EURAUD.DWX D1 cointegration spread. It computes
`S = ln(EURUSD) - beta * ln(EURAUD)` with beta defaulting to 0.34, then
...
same script ranked EURUSD/EURAUD as the strongest remaining unbuilt
OOS-positive candidate after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749 baskets,
with DEV Sharpe -0.02, OOS net Sharpe 0.16, OOS return +1.28%, 15 OOS state
changes, beta 0.34, and 172-day half-life.
...
| strategy_beta | 0.34 | >0 | Hedge coefficient in `ln(EURUSD) - beta * ln(EURAUD)` |
...
| Regime preference | mean-reverting common-EUR spread between USD and AUD risk/commodity expressions |
...
|---|---:|---:|---:|---:|---:|---:|
| EURUSD~EURAUD | -0.02 | 0.16 | +1.28% | 15 | 0.34 | 172d |
...
Q02 queue note: pending; insert one logical-basket work item only after compile
and build-check pass. Do not create per-leg Q02 fanout.
