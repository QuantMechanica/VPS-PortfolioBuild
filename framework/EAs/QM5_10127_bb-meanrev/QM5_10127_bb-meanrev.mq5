...
#property description "QM5_10127 Bollinger Band mean reversion"
...
bool Strategy_NoTradeFilter()
  {
   ...
   return (Bars(_Symbol, strategy_timeframe) < strategy_bb_period + 5);
  }
...
bool Strategy_ExitSignal()
  {
   ...
   const double middle_1 = QM_BB_Middle(_Symbol, strategy_timeframe, strategy_bb_period,
                                        strategy_bb_deviation, 1, PRICE_TYPICAL);
   const double middle_2 = QM_BB_Middle(_Symbol, strategy_timeframe, strategy_bb_period,
                                        strategy_bb_deviation, 2, PRICE_TYPICAL);
