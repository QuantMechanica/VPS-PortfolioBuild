# QM5_10127_bb-meanrev — Strategy Spec
...
`artifacts/cards_approved/QM5_10127_bb-meanrev.md`. See that card's body for
...
`QM5_10127_bb-meanrev.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_enable_longs` | true | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10127_bb-meanrev.md`
