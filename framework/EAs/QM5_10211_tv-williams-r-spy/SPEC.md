...
`artifacts/cards_approved/QM5_10211_tv-williams-r-spy.md`. See that card's body for
...
`QM5_10211_tv-williams-r-spy.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_wpr_length` | 2 | (see source) | (see strategy logic) |
| `strategy_entry_wpr` | -90.0 | (see source) | (see strategy logic) |
| `strategy_exit_wpr` | -30.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.5 | (see source) | (see strategy logic) |
| `strategy_price_stop_pct` | 5.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10211_tv-williams-r-spy.md`
