# QM5_41367_xtixng-commonshock-cont - Strategy Spec
...
**Source:** `AI-CODEX-XTIXNG-COMMONSHOCK-CONT-20260906`
...
When WTI and natural gas returns share a strict sign, buy the relative
winner and sell the relative loser for one broker week.
...
- Logical symbol: `QM5_41367_XTI_XNG_COMMONSHOCK_CONT_D1`.
...
- Trigger: both leg returns have a strict shared sign and differ by more than
  `1e-10`; follow the relative winner.
...
- Symmetric opposed-leg oil/gas continuation after same-direction weekly moves.
...
`10.1016/j.jbankfin.2010.04.009`) support broad-universe commodity cross-
sectional momentum. Villar/Joutz (U.S. EIA, 2006) and Ramberg/Parsons (*The
Energy Journal*, 2012, DOI `10.5547/01956574.33.2.2`) support a weak,
time-varying oil/gas relationship and preserve adverse instability. The weekly common-shock
weekly two-asset continuation is an untested QM translation; no source result transfers.
