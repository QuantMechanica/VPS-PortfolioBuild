# QM5_41426_wti-reframp-wclv-cont - Strategy Spec

**EA ID:** QM5_41426

**Slug:** `wti-reframp-wclv-cont`

**Strategy ID:** `EIA-MOP-WTI-REFRAMP-WCLV-CONT-20260910_S01`

**Source:** `EIA-MOP-WTI-REFRAMP-WCLV-CONT-20260910`
...
only when the return is strictly positive and close location is strictly above
two-thirds. Equality, a nonpositive return, invalid packages, ineligible
...
`414260000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
and buy only after strict positive/upper-tercile agreement. Require no owned
...
completely read peer-reviewed WTI momentum lineage and governed close-location
translation. The exact April-July long-only weekly conjunction, continuous-
...
| entry | ramp calendar, two completed-week packages, strict endpoint return and upper-tercile close, long-only side, durable attempt, spread and frozen ATR stop |
...
| v1.1 | 2026-09-10 | Q01 compile PASS (`aa47bbdd-7e86-4cb1-bcef-40487423dec0`) and fixed-risk Q02 enqueue (`2ad0e7b6-fe21-4ce6-8bf9-4a501cc6b6ce`) | OWNER pacer mission |
