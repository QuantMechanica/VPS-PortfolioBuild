...
type: strategy
strategy_id: KELOHARJU-MOP-XNG-SEASRESMOM-2026_S01
variant_id: KELOHARJU-MOP-XNG-SEASRESMOM-2026_S01
source_id: KELOHARJU-MOP-XNG-SEASRESMOM-2026
ea_id: QM5_41393
slug: xng-seas-resid-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41393_xng-seas-resid-mom_card.md
execution_contract_status: APPROVED
created: 2026-09-09
created_by: Research+Development
last_updated: 2026-09-09
g0_status: APPROVED
g0_decision: decisions/2026-09-09_qm5_41393_xng_seasonal_residual_momentum_g0.md
source_approval: decisions/2026-09-09_xng_seasonal_residual_momentum_source_approval.md
...
source_citations:
  ...
  - type: peer_reviewed_trading_paper
    ...
    quality_tier: A
    role: own_return_continuation_explicit_xng_membership_and_one_month_formation_hold_evidence
  - type: governed_composite_source
    citation: "QuantMechanica bounded XNG standardized seasonal-residual momentum extraction."
    location: "strategy-seeds/sources/KELOHARJU-MOP-XNG-SEASRESMOM-2026/source.md"
    quality_tier: internal_governed
    role: exact_conjunction_calendar_sample_score_risk_and_lifecycle
strategy_mechanic: monthly-xng-just-completed-log-return-minus-up-to-ten-prior-year-same-calendar-mean-divided-by-sample-standard-deviation-strict-half-sigma-continuation-next-month
sources:
  - "[[sources/KELOHARJU-MOP-XNG-SEASRESMOM-2026]]"
concepts:
...
strategy_type_flags: [commodity, energy, natural-gas, calendar-seasonality, standardized-residual, momentum, monthly-renewal, atr-hard-stop, low-frequency, symmetric-long-short]
...
r1_reasoning: "Complete peer-reviewed Journal of Finance same-calendar commodity evidence with explicit natural-gas membership plus complete peer-reviewed Journal of Financial Economics own-return continuation evidence with explicit XNG membership and a pooled one-month formation/hold test; the exact standardized conjunction remains untested."
r2_mechanical: PASS
...
force_build: true
review_focus: "Falsify a monthly XNG stream that follows only the just-completed return unexplained by recurring same-calendar history. Verify the information clock, uniform label convention, endpoint chronology, realized-sample exclusion, exact n-1 scale, strict continuation band, durable attempt, fixed risk, frozen stop, and next-month close. Q09 alone may establish realized decorrelation from the current book."
...
g0_approval_reasoning: "OWNER mission 2026-09-09 and decisions/2026-09-09_qm5_41393_xng_seasonal_residual_momentum_g0.md: R1 passes with two complete peer-reviewed lineages and explicit untested-conjunction risk; R2 locks calendar, endpoints, exclusion, sample, mean, n-1 scale, score, continuation side, attempt, risk, stop, spread, and lifecycle; R3 uses registered native XNG D1 with session/CFD risk; R4 is deterministic native arithmetic only. Canonical dedup found no exact collision across 4,873 registry rows and 1,486 cards, reported the Strategy Wiki root unavailable, and surfaced only the expected WTI carrier and opposite-direction XNG fuzzy siblings; manual review fixes their load-bearing distinctions."
---

# QM5_41393 XNG Monthly Seasonal-Residual Momentum

## Hypothesis

Natural-gas production, storage, transport, consumption, hedging, and capital-
allocation pressures can recur by calendar month, while XNG own returns also
show continuation in the source family. When the just-completed XNG monthly
...
This is a second XNG exposure whose monthly, seasonally adjusted residual
state is mechanically distinct from the incumbent short-horizon RSI pullback.
That distinction does not prove low realized correlation. Q02 owns density and
...
SHA-256
`9AD990B697771C8DEE06DB3F4CF5D3182DBECB171F20E83BCDD5918BB1F554F8`,
committed as `6d50ec35c6` after source approval `23c1df6ce4` and before card
approval.
...
XNG membership, and a pooled commodity one-month formation / one-month hold
test. They do not report a standalone XNG one-month result.
...
- Natural gas and XNG are explicitly inside the respective source universes,
...
`78C4816EFFF5FCDCDAFE21477A2E11D7B419F9C568FE3A303AA3AFBCAF3C68C0`,
found no exact registry or card identity across 4,873 registry rows and 1,486
cards. The configured Strategy Wiki root was unavailable; that limitation is
explicit rather than converted into a clean claim. It surfaced the two
expected fuzzy siblings. Manual review fixes the boundary:
...
- `QM5_20100_xng-samecal` follows the historical mean for the upcoming
  calendar month. This card never predicts the upcoming seasonal sign.
- `QM5_41205_xng-samecal-huber10` and `QM5_41225_xng-medcal` forecast the
  upcoming calendar month from robust historical locations. This card forms
  one just-completed standardized realized-minus-expected residual instead.
- `QM5_41208_xng-seas-surprise-rv` uses the same standardized arithmetic on
  XNG and fades the residual. This card follows it under peer-reviewed
  own-return-continuation lineage; the opposite side is load-bearing.
- `QM5_41209_wti-seas-resid-mom` uses the same estimator and direction on WTI.
  This card fixes XNG before results and inherits no WTI economics.
- `QM5_12567_cum-rsi2-commodity` is a long-only two-day cumulative-RSI(2)
  pullback aligned to a slow moving average and held at most five bars. This
  card is symmetric, monthly, oscillator-free, and seasonally adjusted.
...
4. fixtures distinguish unconditional one-month XNG momentum, upcoming-month
...
|---|---|---|---|
| G0 Research Intake | 2026-09-09 | APPROVED; R1-R4 PASS | `decisions/2026-09-09_qm5_41393_xng_seasonal_residual_momentum_g0.md`; approved source packet |
...
|---|---|---|---|---|
| v1 | 2026-09-09 | initial XNG standardized seasonal-residual momentum card | G0 | APPROVED; build pending |
