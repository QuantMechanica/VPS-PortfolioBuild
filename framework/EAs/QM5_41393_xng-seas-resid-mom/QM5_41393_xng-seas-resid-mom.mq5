...
#property description "QM5_41393 XNG Monthly Standardized Seasonal-Residual Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41393 - XNG Monthly Standardized Seasonal-Residual Momentum
// -----------------------------------------------------------------------------
// Structural low-frequency XNG natural-gas sleeve:
//   - decide only at a genuine normalized broker-month boundary
//   - reconstruct the just-completed XNG calendar-month log return
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(!QM_InputRequireLong("qm_ea_id", qm_ea_id, 41393) ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(g_signal_direction > 0)
     {
      req.type = QM_BUY;
      req.reason = "XNG_SEAS_RESID_MOM_BUY";
     }
   else
     {
      req.type = QM_SELL;
      req.reason = "XNG_SEAS_RESID_MOM_SELL";
     }
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XNG monthly standardized seasonal-residual momentum card holds to the next broker month"))
      return INIT_FAILED;
   ...
   g_attempt_state_key =
      StringFormat("QM5_41393_SEAS_RESID_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41393\",\"ea\":\"xng-seas-resid-mom\"}");
