# QM5_9717_bandy-pir-position-in-range-mr-index — Strategy Spec

**EA ID:** QM5_9717
**Slug:** `bandy-pir-position-in-range-mr-index`
...
`artifacts/cards_approved/QM5_9717_bandy-pir-position-in-range-mr-index.md`. See that card's body for
...
`QM5_9717_bandy-pir-position-in-range-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
...
`artifacts/cards_approved/QM5_9717_bandy-pir-position-in-range-mr-index.md`
