...
#property description "QM5_1258_v2 Hopwood Bermaui-RSI H1 Trend-Follower"
...
double BermauiRSI(const int shift, const int buffer_size = 28)
{
   ...
   {
      const double newer = QM_RSI(_Symbol, PERIOD_H1, strategy_rsi_period, shift + i - 1);
      const double older = QM_RSI(_Symbol, PERIOD_H1, strategy_rsi_period, shift + i);
...
{
   return QM_EMA(_Symbol, PERIOD_H1, strategy_ema_period, shift + 1);
}
