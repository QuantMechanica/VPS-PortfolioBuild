# QM5_9961_bandy-hma-supertrend-confluence-trend — Strategy Spec

**EA ID:** QM5_9961
**Slug:** `bandy-hma-supertrend-confluence-trend`
...
`artifacts/cards_approved/QM5_9961_bandy-hma-supertrend-confluence-trend.md`. See that card's body for
...
`QM5_9961_bandy-hma-supertrend-confluence-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_hma_fast` | 14 | (see source) | (see strategy logic) |
| `strategy_hma_slow` | 50 | (see source) | (see strategy logic) |
...
| `strategy_stop_atr_mult` | 3.0 | (see source) | (see strategy logic) |
| `strategy_max_hold_bars` | 60 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9961_bandy-hma-supertrend-confluence-trend.md`
