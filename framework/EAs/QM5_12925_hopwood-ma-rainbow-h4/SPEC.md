# QM5_12925_hopwood-ma-rainbow-h4 — Strategy Spec

**EA ID:** QM5_12925
**Slug:** `hopwood-ma-rainbow-h4`
...
`artifacts/cards_approved/QM5_12925_hopwood-ma-rainbow-h4.md`. See that card's body for
...
`QM5_12925_hopwood-ma-rainbow-h4.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_ma_period_1` | 8 | (see source) | (see strategy logic) |
| `strategy_ma_period_2` | 13 | (see source) | (see strategy logic) |
| `strategy_ma_period_3` | 21 | (see source) | (see strategy logic) |
| `strategy_ma_period_4` | 34 | (see source) | (see strategy logic) |
| `strategy_ma_period_5` | 55 | (see source) | (see strategy logic) |
| `strategy_ma_period_6` | 89 | (see source) | (see strategy logic) |
| `strategy_min_distance_pct` | 0.004 | (see source) | (see strategy logic) |
...
| `strategy_max_spread_points` | 30 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_12925_hopwood-ma-rainbow-h4.md`
