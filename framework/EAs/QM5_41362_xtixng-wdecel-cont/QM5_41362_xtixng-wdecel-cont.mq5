...
#property description "QM5_41362 XTI/XNG Weekly Deceleration Continuation"
...
// have strict same signs and the newest absolute move is strictly smaller,
// follow that decelerating trend with an equal-notional opposite-leg package.
// Consume one attempt per week and flatten at the next week boundary.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41362;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41362 && qm_magic_slot_offset == 0 &&
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41362_XTIXNG_WDECEL_CONT";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41362_XTIXNG_WDECEL_CONT_HOST";
   ...
   if(Strategy_OpenOwnedPositionCount() > 0 ||
   ...
   else
     {
      ...
      if(!signal_valid)
         ...
         g_signal_state = "negative_same_sign_deceleration_short_xti";
      else if(direction > 0)
         g_signal_state = "positive_same_sign_deceleration_long_xti";
      else if(g_new_relative_return == 0.0 ||
              g_old_relative_return == 0.0)
         g_signal_state = "exact_zero_flat";
      else if((g_new_relative_return > 0.0) !=
              (g_old_relative_return > 0.0))
         g_signal_state = "opposite_sign_flat";
      else
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XTI/XNG weekly deceleration continuation exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41362\",\"ea\":\"xtixng-wdecel-cont\"}");
