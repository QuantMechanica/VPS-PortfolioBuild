...
`artifacts/cards_approved/QM5_10115_tv-ma-scalper-relief.md`. See that card's body for
...
`QM5_10115_tv-ma-scalper-relief.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_max_hold_bars` | 96 | (see source) | (see strategy logic) |
...
| Cadence note | "M15 MA relief-rally scalper can trigger repeatedly in downtrend regimes; conservative estimate 45-90 trades/year/symbol." |
...
`artifacts/cards_approved/QM5_10115_tv-ma-scalper-relief.md`
