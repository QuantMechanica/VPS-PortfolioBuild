...
#property description "QM5_10115 TradingView MA Scalper Relief Rally"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(reg_prior <= 0.0)
      return false;
   // Card filter: relief rallies only while the SMA200 slope is not positive.
   if(reg_1 > reg_prior)
      return false;
   ...
   req.sl = sl;
   req.tp = 0.0;
   req.reason = "TV_MA_SCALPER_RELIEF_LONG";
   return true;
  }
...
bool Strategy_ExitSignal()
  {
   ...
   const bool ma_exit = (fast_1 > 0.0 && fast_2 > 0.0 && reg_1 > 0.0 && reg_2 > 0.0 &&
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      const bool time_exit = (hold_seconds > 0 && opened_at > 0 &&
