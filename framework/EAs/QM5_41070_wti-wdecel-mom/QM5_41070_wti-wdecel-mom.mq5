...
#property description "QM5_41070 WTI Completed-Week Deceleration Momentum"
...
//   - trade only strict same-sign magnitude deceleration and follow that sign
...
bool Strategy_LoadDecelerationSignal(const int current_week_key,
                                     const int label_offset,
                                     int &direction,
                                     double &new_return,
                                     double &old_return,
...
void Strategy_PrepareDecisionSignal()
  {
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
     ...
     {
      g_signal_valid =
         Strategy_LoadDecelerationSignal(g_decision_week_key,
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "positive_deceleration_long";
      else if(g_signal_direction < 0)
         g_signal_state = "negative_deceleration_short";
         ...
         g_signal_state = "nondecelerating_flat";
     }
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41070 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41070_WTI_WDECEL_MOM";
...
int OnInit()
  {
   if(!SymbolSelect(g_strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41070 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41070_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41070\",\"ea\":\"wti-wdecel-mom\"}");
