"""Independent reference checks for the QM5_20305 locked ALIQ contract."""
...
def aliq_block(
    ...
    if block_offset not in (0, PRECEDING_OFFSET):
...
class AliqReferenceTest(unittest.TestCase):
    ...
    def test_high_recent_aliq_maps_long_and_low_recent_maps_short(self) -> None:
        ...
        preceding = aliq_block(high_recent, volumes, PRECEDING_OFFSET)
        ...
        preceding = aliq_block(low_recent, volumes, PRECEDING_OFFSET)
    ...
    def test_equal_blocks_and_tolerance_are_flat(self) -> None:
        ...
        preceding = aliq_block(closes, volumes, PRECEDING_OFFSET)
    ...
    def test_blocks_have_disjoint_return_and_volume_support(self) -> None:
        ...
        preceding_indices = set(range(PRECEDING_OFFSET, PRECEDING_OFFSET + RETURNS_PER_BLOCK))
        recent_closes = set(range(0, RETURNS_PER_BLOCK + 1))
        preceding_closes = set(range(PRECEDING_OFFSET, PRECEDING_OFFSET + RETURNS_PER_BLOCK + 1))
        ...
        preceding_0 = aliq_block(closes, volumes, PRECEDING_OFFSET)
        ...
        self.assertAlmostEqual(preceding_0, aliq_block(closes, recent_volumes, PRECEDING_OFFSET), places=12)
        ...
        self.assertNotAlmostEqual(preceding_0, aliq_block(closes, prior_volumes, PRECEDING_OFFSET), places=10)
    ...
    def test_price_scale_invariant_and_volume_scale_inverse(self) -> None:
        ...
        for offset in (0, PRECEDING_OFFSET):
