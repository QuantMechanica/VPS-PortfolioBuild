...
void OnTick()
  {
   // Capture open-position MAE before any guard can return.
   ...
   // Management and exits remain active during news blackouts.
   ...
   // News gates entries only; it must not suppress position management.
