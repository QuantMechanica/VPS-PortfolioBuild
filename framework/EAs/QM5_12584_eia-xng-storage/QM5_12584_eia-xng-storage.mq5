...
#property description "QM5_12584 EIA XNG Weekly Storage Aftershock"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12584 - EIA XNG Weekly Storage Aftershock
// -----------------------------------------------------------------------------
// D1 structural natural-gas sleeve:
//   - waits until the first D1 bar after a storage-report reaction bar
//   - requires event-day range expansion and directional close
//   - follows that direction for a short fixed D1 aftershock window
// Runtime uses MT5 OHLC only; no external EIA data or storage surprise feed.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12584;
...
input int    strategy_trend_period        = 40;
...
bool Strategy_LoadEventState(double &event_open,
                             ...
                             int &signal_day_key)
  {
   ...
   event_close = iClose(_Symbol, PERIOD_D1, 1); // perf-allowed: prior closed D1 storage reaction.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12584_EIA_XNG_STORAGE";
   ...
   req.reason = (direction > 0) ? "EIA_XNG_STORAGE_LONG" : "EIA_XNG_STORAGE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12584\",\"ea\":\"eia-xng-storage\"}");
