...
#property description "QM5_13032 CFTC COT Friday XNG positioning fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13032 - XNG COT Friday Positioning Fade
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13032_XNG_COT_FRI_FADE";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13032\",\"ea\":\"xng-cot-fade\"}");
