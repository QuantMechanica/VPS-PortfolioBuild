...
#property description "QM5_13004 CFTC COT Friday WTI positioning fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13004 - XTI COT Friday Positioning Fade
// -----------------------------------------------------------------------------
...
input double strategy_min_signal_return_pct     = 1.25;
input double strategy_min_atr_return_mult       = 0.60;
input double strategy_max_signal_return_pct     = 9.0;
input double strategy_close_location_min        = 0.65;
input int    strategy_signal_dow                = 5;
input int    strategy_atr_period                = 20;
input int    strategy_mean_period               = 50;
input double strategy_min_stretch_atr           = 0.50;
input double strategy_atr_sl_mult               = 2.75;
input int    strategy_max_hold_days             = 5;
input double strategy_reversion_close_atr_mult  = 0.80;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13004_XTI_COT_FRI_FADE";
   ...
   req.reason = (entry_type == QM_BUY) ? "XTI_COT_FRI_FADE_LONG" : "XTI_COT_FRI_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13004\",\"ea\":\"xti-cot-fade\"}");
