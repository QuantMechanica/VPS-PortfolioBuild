# QM5_41379_wti-tsmom3-h2 — Strategy Spec

**EA ID:** QM5_41379
**Slug:** `wti-tsmom3-h2`
**Source:** `MOP-WTI-TSMOM3-H2-2026`
**Author of this spec:** Codex
**Last revised:** 2026-09-07

## 1. Strategy Logic

On the first D1 bar of each odd broker month, reconstruct four consecutive
completed WTI month-end closes and follow the sign of the exact three-month log
...
| `strategy_return_months` | `3` | `[3]` | Exact formation intervals |
...
**Source ID:** `MOP-WTI-TSMOM3-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM3-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41379_wti-tsmom3-h2_card.md`.
...
`QM5_20055` renews the same three-month direction monthly. `QM5_20281` uses
the same bimonthly clock but a twelve-month formation. This identity combines
the exact three-month endpoints with the fixed odd-month two-month lifecycle.
