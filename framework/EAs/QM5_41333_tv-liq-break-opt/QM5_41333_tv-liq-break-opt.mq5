...
#property description "QM5_41333 TradingView Liquidity Contraction Breakout - DL-089 opt sibling"
// Strategy Card: QM5_41333 (tv-liq-break-opt), G0 APPROVED 2026-09-03.
// DL-089 measurement sibling of QM5_10700. Parent entry, exit, sizing, news,
// and Friday-close mechanics are unchanged; the only addition is the six
// closed-D1 pattern veto inputs (opt_pp_buy1..3 / opt_pp_sell1..3). Zero
// disables a slot, so the shipped baseline is neutral. No live or pipeline
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"ea\":\"QM5_41333_tv-liq-break-opt\"}");
