# QM5_20258_wti-mom-vote — Strategy Spec
...
majority buys WTI; a negative majority sells it. Invalid history or arithmetic
...
- Slot: 0.
- Registered magic: `202580000`.
- This is a direct WTI energy carrier; no basket leg or external data feed is
  read at runtime.
...
The non-duplicate boundary is the exact one/three/twelve nested-return
majority. Existing WTI EAs use a single horizon, require agreement between two
horizons, compare twelve-month direction with monthly-sign breadth, estimate
variance-ratio memory, or use calendar/event/carry/breakout states. None admits
the two faster states overriding the slow state through this fixed majority.
...
`strategy-seeds/sources/MOP-WTI-MOMVOTE-2026/source.md`.

The paper supplies WTI membership and the monthly own-return-sign family. The
...
Risk is high: continuous-CFD roll and financing, crude-oil gaps, false trends,
hard-stop slippage, and single-energy concentration may dominate the signal.
Q02 owns density and baseline economics; Q09 alone may establish realized
portfolio correlation. No live, demo, shadow, stress, or optimization setfile,
