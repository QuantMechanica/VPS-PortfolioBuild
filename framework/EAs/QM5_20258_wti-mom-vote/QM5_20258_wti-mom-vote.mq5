...
#property description "QM5_20258 WTI Multi-Horizon Momentum Vote"
...
//   2. calculate WTI's completed one-, three-, and twelve-month log-return signs;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20258_WTI_MOM_VOTE";
   ...
   req.reason = (g_cache_signal > 0) ? "MOM_VOTE_XTI_LONG" : "MOM_VOTE_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20258_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20258\",\"ea\":\"wti-mom-vote\"}");
