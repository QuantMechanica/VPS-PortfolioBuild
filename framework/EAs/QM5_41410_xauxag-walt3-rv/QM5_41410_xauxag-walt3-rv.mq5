...
#property description "QM5_41410 XAU/XAG Weekly Alternation Reversion"
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41410 && qm_magic_slot_offset == 0 &&
            g_leg_xau != "" && g_leg_xag != "" &&
            g_leg_xau != g_leg_xag &&
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41410_XAUXAG_WALT3_RV";
...
bool Strategy_LoadAlternation(const int current_week,
                              int &direction)
  {
   ...
   if(g_relative_return[0] > 0.0 &&
      ...
      direction = -1; // Newest WTI winner: sell XAU, buy XAG.
   else if(g_relative_return[0] < 0.0 &&
           g_relative_return[1] > 0.0 &&
           g_relative_return[2] < 0.0)
      direction = 1; // Newest XAG winner: buy XAU, sell XAG.
   return true;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41410_XAUXAG_WALT3_RV_HOST";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG weekly strict alternation reversion package exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41410\",\"ea\":\"xauxag-walt3-rv\"}");
