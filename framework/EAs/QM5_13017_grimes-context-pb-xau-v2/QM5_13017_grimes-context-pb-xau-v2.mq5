...
#property description "QM5_13017 Grimes Contextual Pullback v2 (XAUUSD exit surgery)"
...
input double strategy_breakeven_r_mult       = 1.5;
input int    strategy_time_exit_h4_bars      = 36;   // v2 surgical delta: 18 -> 36 (72h -> 144h)
input double strategy_spread_stop_max_pct    = 8.0;

double   g_qm13017_retrace_exit = 0.0;
int      g_qm13017_direction = 0;
         ...
         if(long_context && pullback_long_quality)
           {
            ...
            req.reason = "GRIMES_CONTEXT_PB_XAU_V2_LONG";
            g_qm13017_retrace_exit = NormalizeDouble(leg_high - 0.618 * leg_size, _Digits);
            g_qm13017_direction = 1;
            return true;
           }
         ...
         if(short_context && pullback_short_quality)
           {
            ...
            req.sl = NormalizeDouble(stop, _Digits);
            req.tp = NormalizeDouble(entry - strategy_target_r_mult * risk, _Digits);
            req.reason = "GRIMES_CONTEXT_PB_XAU_V2_SHORT";
            g_qm13017_retrace_exit = NormalizeDouble(leg_low + 0.618 * leg_size, _Digits);
            g_qm13017_direction = -1;
            return true;
           }
        }
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      if(improves)
         QM_TM_MoveSL(ticket, be_sl, "GRIMES_CONTEXT_PB_XAU_V2_BE_1_5R");
     }
  }
...
bool Strategy_ExitSignal()
  {
   ...
   const int active_direction = (g_qm13017_direction != 0) ? g_qm13017_direction : direction;
   if(active_direction > 0 && last_bar[0].close < g_qm13017_retrace_exit)
      return true;
   if(active_direction < 0 && last_bar[0].close > g_qm13017_retrace_exit)
      return true;
