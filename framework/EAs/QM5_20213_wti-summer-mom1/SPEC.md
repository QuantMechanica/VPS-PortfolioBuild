# QM5_20213_wti-summer-mom1 — Strategy Spec

**EA ID:** QM5_20213

**Slug:** `wti-summer-mom1`

**Source:** `BURAKOV-MOP-WTI-SUMMER-MOM1-2026`
...
consumed month. November through May is a forced-flat regime.
...
Expected cadence is at most five completed packages per full
post-warm-up year; Q02 retires below five/year. Exposure normally spans one
broker month and is always flat November through May. Primary risks are
...
`strategy-seeds/sources/BURAKOV-MOP-WTI-SUMMER-MOM1-2026/source.md`; the
approved card is
`strategy-seeds/cards/approved/QM5_20213_wti-summer-mom1_card.md`.
The sources supply the summer regime and the one-month commodity sign family,
