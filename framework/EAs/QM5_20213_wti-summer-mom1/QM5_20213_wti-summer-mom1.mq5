...
#property description "QM5_20213 WTI Summer-Regime / One-Month Momentum"
...
//   - BUY positive / SELL negative, held until the next month boundary
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = (direction > 0)
      ? "WTI_SUMMER_MOM1_LONG"
      : "WTI_SUMMER_MOM1_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20213_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20213\",\"ea\":\"wti-summer-mom1\"}");
