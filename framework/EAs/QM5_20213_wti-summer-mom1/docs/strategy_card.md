...
type: strategy
strategy_id: BURAKOV-MOP-WTI-SUMMER-MOM1-2026_S01
variant_id: BURAKOV-MOP-WTI-SUMMER-MOM1-2026_S01
source_id: BURAKOV-MOP-WTI-SUMMER-MOM1-2026
status: APPROVED
g0_status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_20213_wti-summer-mom1_card.md
...
strategy_mechanic: june-october-wti-exact-prior-completed-calendar-month-return-sign
...
sources:
  - "[[sources/BURAKOV-MOP-WTI-SUMMER-MOM1-2026]]"
concepts:
...
g0_approval_reasoning: "APPROVED under the OWNER 2026-08-04 commodity/energy sleeve mission: R1 fully reviewed peer-reviewed summer-regime and one-month momentum sources; R2 locked months, exact consecutive completed-month endpoints, sign map, renewal, stop, spread, and attempt state; R3 registered native XTIUSD.DWX D1 carrier; R4 deterministic native arithmetic only. Exact dedup CLEAN and nearest regime, horizon, unconditional, calendar-direction, and oscillator builds manually resolved."
---

# QM5_20213 WTI Summer-Regime / One-Month Momentum

## Hypothesis

WTI's June-October regime can reflect recurring physical demand, storage,
...
one-month direction only inside the fixed summer regime may isolate a crude-oil
...
The governed packet
`strategy-seeds/sources/BURAKOV-MOP-WTI-SUMMER-MOM1-2026/source.md` joins two
complete peer-reviewed source reads. Burakov, Freidin, and Solovyev supply the
fixed WTI June-October interval. Moskowitz, Ooi, and Pedersen supply the
...
The deterministic pre-allocation checker scanned 4,269 EA registry rows and
387 cards and returned `CLEAN`. Manual mechanic review fixes the boundaries:
...
- Carrier: `XTIUSD.DWX`, D1, slot 0, magic `202130000`.
...
- Expected cadence: at most five completed packages/year; retire below
...
1. Require exact EA ID `20213`, `XTIUSD.DWX` D1, magic slot 0, and every
...
- One position maximum for magic `202130000` and one consumed attempt per
  eligible broker month.
- Close before renewal, at the November season boundary, after forty days, on the
...
Primary risks are one-name breadth, five-decision cadence, seasonal and
