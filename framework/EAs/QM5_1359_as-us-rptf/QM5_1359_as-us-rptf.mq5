...
#property description "QM5_1359 Allocate Smartly US Risk Parity Trend-Following"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "MONTHLY_RP_TF_CLOSE_ABOVE_SMA10";
   return true;
  }
...
void Strategy_ManageOpenPosition()
  {
   // Source specifies no intramonth stop management beyond V5 default controls.
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_1359_as_us_rptf\"}");
