...
#property description "QM5_20304 WTI Self-Relative Common-Jump-Beta Regime"
...
//   4. buys WTI when recent jump beta is lower, sells when it is higher, and
//      consumes a tie or invalid state flat. XNG is read-only.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 20304;
...
bool Strategy_LoadSignalState(const datetime decision_bar_time,
                              int &signal)
  {
   ...
   // translated own-history state: lower recent jump beta is long WTI.
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20304 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20304_WTI_JUMPBETA_REGIME";
   ...
   req.reason = (g_cache_signal > 0) ? "JUMPBETA_REGIME_XTI_LONG" : "JUMPBETA_REGIME_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20304_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20304\",\"ea\":\"wti-jumpbeta-reg\",\"stat\":\"two_disjoint_252_return_block_local_common_jump_beta\",\"xng\":\"read_only\"}");
