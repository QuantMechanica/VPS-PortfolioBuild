...
#property description "QM5_41448 XAU/XAG Weekly WR2 CLV Reversion"
...
// the prior range and its final close is in a strict outer quartile. Fade that
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41448 && qm_magic_slot_offset == 0 &&
            g_leg_xau != "" && g_leg_xag != "" &&
            g_leg_xau != g_leg_xag &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_WR2_CLV_RV_ATTEMPT_WEEK", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41448_XAUXAG_WR2_CLV_RV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41448_XAUXAG_WR2_CLV_RV_HOST";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG weekly ratio range-expansion CLV reversion package exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41448\",\"ea\":\"xauxag-wr2-clv-rv\"}");
