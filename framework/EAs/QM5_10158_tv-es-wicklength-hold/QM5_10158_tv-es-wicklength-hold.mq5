...
input int    strategy_wick_ma_period    = 20;
input double strategy_wick_offset       = 0.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "TV_ES_WICK_LENGTH_HOLD_LONG";
   req.symbol_slot = qm_magic_slot_offset;
   req.expiration_seconds = 0;

   if(strategy_wick_ma_period <= 0 || strategy_hold_bars <= 0 ||
