...
#property description "QM5_20295 WTI Historical-Kurtosis Premium"
...
// commodity premium, use monthly sorts, and include WTI. The outright WTI
// benchmark-three time-series rule below is a locked QM hypothesis, not a
// source-tested WTI rule.
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20295 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20295_WTI_KURT_PREM";
   ...
   req.reason = (g_cache_signal > 0) ? "KURT_PREM_XTI_LONG" : "KURT_PREM_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20295_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20295\",\"ea\":\"wti-kurt-prem\",\"stat\":\"prior_252_return_absolute_pearson_kurtosis\"}");
