...
#property description "QM5_41489 Collins 9-Day 66 Percent Momentum - WTI"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41489 - Collins 9-Day 66 Percent Momentum - WTI
// -----------------------------------------------------------------------------
...
// Hard Rule (OWNER 2026-09-06): symbols are inputs. The broker-neutral base
// and FTMO's USOIL.cash alias compare through the canonical resolver.
input string strategy_host_symbol          = "XTIUSD";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsXtiD1())
      return true;
   if(qm_ea_id != 41489 || qm_magic_slot_offset != 0)
      return true;
   if(strategy_lookback_d1 < 2 || strategy_lookback_d1 > 64)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41489_COLLINS_66MOM";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41489\",\"ea\":\"collins-66mom-symbolinput\"}");
