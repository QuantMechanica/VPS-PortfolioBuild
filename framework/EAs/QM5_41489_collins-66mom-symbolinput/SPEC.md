# QM5_41489_collins-66mom-symbolinput - Strategy Spec

**EA ID:** QM5_41489
**Slug:** `collins-66mom-symbolinput`
**Lineage parent:** `QM5_20266_collins-66mom`
**Source:** `SRC08`
...
|---|---:|---|---|
| `strategy_host_symbol` | `XTIUSD.DWX` | fixed per set | Canonically compared host symbol; `USOIL.cash` resolves to the same XTIUSD base |
...
- `XTIUSD.DWX` only, magic slot 0, magic `414890000`.
...
|---|---|---|---|
| v1 | 2026-08-08 | Initial build | Parent identity QM5_20266 |
| v2 identity | 2026-09-22 | OWNER-authorized symbol-input rebuild | New identity from Q02; only the host-symbol gate and identity bindings differ from QM5_20266 |
