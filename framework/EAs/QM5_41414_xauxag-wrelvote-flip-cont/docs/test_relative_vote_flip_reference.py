"""Deterministic reference checks for QM5_41414 relative-vote flip."""
...
MQ5 = EA_DIR / "QM5_41414_xauxag-wrelvote-flip-cont.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41414_xauxag-wrelvote-flip-cont_QM5_41414_XAU_XAG_WRELVOTE_FLIP_CONT_D1_D1_backtest.set"
)
...
class RelativeVoteFlipReferenceTest(unittest.TestCase):
    ...
    def test_positive_to_negative_majority_follows_xag(self) -> None:
        self.assertEqual(vote_flip_signal([0.03, -0.02, 0.01, -0.04]), -1)
    ...
    def test_static_artifacts_lock_identity_signal_and_fixed_risk(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41414", source)
        ...
        self.assertRegex(resolver, re.compile(r"414140000.*414140001", re.DOTALL))
