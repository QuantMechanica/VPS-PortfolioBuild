...
#property description "QM5_12592 EIA WTI Pre-WPSR Positioning"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12592 - EIA WTI Pre-WPSR Positioning
// -----------------------------------------------------------------------------
// D1 structural WTI sleeve:
//   - entries only at the start of expected WPSR D1 bars (Wednesday/Thursday)
...
input int    strategy_compression_lookback   = 3;
...
bool Strategy_PreWpsrDay(const datetime bar_time)
  {
   MqlDateTime dt;
...
bool Strategy_CurrentBarIsPreWpsrDay()
  {
   const datetime current_bar = iTime(_Symbol, PERIOD_D1, 0); // perf-allowed: D1 WPSR calendar gate.
   if(current_bar <= 0)
      return false;
   return Strategy_PreWpsrDay(current_bar);
  }
...
void Strategy_CloseOpenPositionsIfNeeded()
  {
   ...
   const bool have_state = Strategy_LoadSetupState(close_last, close_momentum_ref, atr_last,
                                                   sma_last, avg_range, signal_day_key);
   const int magic = QM_FrameworkMagic();
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12592_EIA_WTI_PREWPSR";
   req.symbol_slot = qm_magic_slot_offset;
   req.expiration_seconds = 0;

   Strategy_CloseOpenPositionsIfNeeded();

   if(!Strategy_CurrentBarIsPreWpsrDay())
      return false;
   ...
   req.reason = (direction > 0) ? "EIA_WTI_PREWPSR_LONG" : "EIA_WTI_PREWPSR_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12592\",\"ea\":\"eia-wti-prewpsr\"}");
