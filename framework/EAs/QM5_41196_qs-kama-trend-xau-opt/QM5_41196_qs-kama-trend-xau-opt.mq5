...
#property description "QM5_41196 XAUUSD Kaufman Adaptive Moving Average (KAMA) Trend Strategy"
...
// =============================================================================
// QuantMechanica V5 EA: QM5_41196 - XAUUSD KAMA Trend Strategy
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(_Symbol != "XAUUSD.DWX" || _Period != PERIOD_D1)
      return true;
   if(qm_ea_id != 41196 || qm_magic_slot_offset != 0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41196_KAMA_TREND";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_41196\",\"ea\":\"qs-kama-trend-xau\"}");
