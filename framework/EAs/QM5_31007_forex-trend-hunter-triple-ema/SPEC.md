# QM5_31007_forex-trend-hunter-triple-ema — Strategy Spec

**EA ID:** QM5_31007
**Slug:** `forex-trend-hunter-triple-ema`
**Source:** `forex-trend-hunter-triple-ema-official-source` (see `strategy-seeds/sources/forex-trend-hunter-triple-ema-official-source/`)
...
`artifacts/cards_approved/QM5_31007_forex-trend-hunter-triple-ema.md`. See that card's body for
...
`QM5_31007_forex-trend-hunter-triple-ema.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `InpFastEMA` | 21 | (see source) | (see strategy logic) |
| `InpMidEMA` | 55 | (see source) | (see strategy logic) |
| `InpSlowEMA` | 200 | (see source) | (see strategy logic) |
...
**Source ID:** `forex-trend-hunter-triple-ema-official-source`
**Pointer:** `strategy-seeds/sources/forex-trend-hunter-triple-ema-official-source/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_31007_forex-trend-hunter-triple-ema.md`
