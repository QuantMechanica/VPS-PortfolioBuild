...
#property description "QM5_21504 XNG weekly high-volume flow-reversal"
...
//   - only in the high-volume tail, fade the latest five-bar close return
...
input double strategy_vol_percentile      = 75.0;
...
bool Strategy_LoadWeeklyState(int &direction,
                              ...
                              double &atr_last)
  {
   ...
   if(volume_rank < strategy_vol_percentile)
     {
      g_cached_state_reason = "below_volume_percentile";
      return false;
     }
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsExpectedHost())
      return true;
   if(qm_ea_id != 21504 || qm_magic_slot_offset != 0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_21504_XNG_FLOWREV";
   ...
   req.reason = (g_cached_direction > 0)
                ? "XNG_HIGH_TICKVOL_WEEK_FADE_LONG"
                : "XNG_HIGH_TICKVOL_WEEK_FADE_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_21504_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_21504\",\"ea\":\"xng-flowrev\",\"signal\":\"weekly_tick_volume_ranked_return_fade\"}");
