...
type: strategy
strategy_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-RV-20260906_S01
variant_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-RV-20260906_S01
source_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-RV-20260906
ea_id: QM5_41368
slug: xtixng-cs-leadswitch-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41368_xtixng-cs-leadswitch-rv_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41368_xtixng_common_shock_leader_switch_reversion_g0.md
source_approval: decisions/2026-09-06_xtixng_common_shock_leader_switch_reversion_source_approval.md
...
strategy_mechanic: normalized-week-boundary-xti-xng-three-synchronized-completed-week-endpoints-two-consecutive-individual-weekly-return-pairs-strict-same-sign-each-week-strict-relative-leader-switch-newest-winner-fade-equal-notional-one-week-hold
sources:
  - "[[sources/AI-CODEX-XTIXNG-CS-LEADSWITCH-RV-20260906]]"
concepts:
...
strategy_type_flags: [commodity, energy, oil-gas-relative-value, market-neutral-basket, common-direction-leader-switch, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41368_XTI_XNG_CS_LEADSWITCH_RV_D1
symbol: QM5_41368_XTI_XNG_CS_LEADSWITCH_RV_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413680000, 413680001]
period: D1
timeframe: D1
...
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_TWO_WEEK_LEADER_SWITCH_TRANSLATION_RISK
r2_mechanical: PASS
...
rotates, treat the newest displacement as a temporary rotation inside a weak,
time-varying relationship. Sell the newest relative winner and buy the loser
...
reversion direction, efficacy, neutrality, or decorrelation.
...
The canonical checker scanned 4,848 registry rows and 1,461 cards, found no
exact identity, and surfaced three expected fuzzy siblings. The external
Strategy Wiki root was unavailable and remains an explicit coverage limit.

- `QM5_41361` fades the newest relative winner after one common-sign week and
  has no prior-week common-sign or leader-switch requirement.
- `QM5_41367` also consumes one common-sign week and follows its winner.
...
- Logical basket: `QM5_41368_XTI_XNG_CS_LEADSWITCH_RV_D1`.
- Timeframe: exact D1; slots zero and one; magics `413680000` and
  `413680001`.
...
1. Evaluate only once on a new exact host D1 bar under EA 41368 and slots zero
   and one.
...
- Exact two-week common-sign leader rotation and fade direction.
...
- No rescue may alter carrier, two-week formation, same-sign states,
  leader-switch condition, fade direction, attempt semantics, risk, stop, or
  lifecycle.
