# QM5_10255_tv-postopen-atr — Strategy Spec
...
`artifacts/cards_approved/QM5_10255_tv-postopen-atr.md`. See that card's body for
...
`QM5_10255_tv-postopen-atr.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_bb_period` | 14 | (see source) | (see strategy logic) |
| `strategy_bb_deviation` | 1.5 | (see source) | (see strategy logic) |
| `strategy_ema_fast_period` | 10 | (see source) | (see strategy logic) |
| `strategy_ema_slow_period` | 200 | (see source) | (see strategy logic) |
| `strategy_rsi_period` | 7 | (see source) | (see strategy logic) |
| `strategy_rsi_min` | 30.0 | (see source) | (see strategy logic) |
| `strategy_adx_period` | 7 | (see source) | (see strategy logic) |
| `strategy_adx_min` | 10.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_atr_tp_mult` | 4.0 | (see source) | (see strategy logic) |
| `strategy_resistance_lookback` | 20 | (see source) | (see strategy logic) |
| `strategy_resistance_min_touches` | 2 | (see source) | (see strategy logic) |
| `strategy_res_touch_tolerance_atr` | 0.05 | (see source) | (see strategy logic) |
| `strategy_lateral_band_fraction` | 0.25 | (see source) | (see strategy logic) |
| `strategy_spread_stop_fraction` | 0.10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10255_tv-postopen-atr.md`
