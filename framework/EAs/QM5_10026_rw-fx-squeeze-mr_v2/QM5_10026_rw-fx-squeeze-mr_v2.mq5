...
#property description "QM5_10026_v2 Robot Wealth FX Squeeze Mean Reversion"
...
input double strategy_squeeze_pct            = 20.0; // legacy synth/grid setfile alias
...
double Strategy_SqueezeThreshold()
  {
   if(strategy_squeeze_pct > 0.0 && strategy_squeeze_pct <= 100.0)
      return strategy_squeeze_pct;
   return strategy_squeeze_percentile;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const bool squeeze = (g_cached_width_percentile <= Strategy_SqueezeThreshold());
