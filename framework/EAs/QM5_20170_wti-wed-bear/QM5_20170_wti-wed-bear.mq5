...
#property description "QM5_20170 WTI Wednesday Bear-Regime Bounce"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20170 - WTI Wednesday Premium / Bear-Regime Bounce
// -----------------------------------------------------------------------------
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20170_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20170\",\"ea\":\"wti-wed-bear\"}");
