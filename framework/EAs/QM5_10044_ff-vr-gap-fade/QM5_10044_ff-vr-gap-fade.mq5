...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const datetime prior_close_time = iTime(_Symbol, _Period, 2);
   if(!Strategy_IsSessionGapBar(current_open_time, prior_close_time))
      return false;
   ...
   const double raw_sl_dist = gap_price;
   ...
   req.tp = upward_gap ? entry_price - gap_price
