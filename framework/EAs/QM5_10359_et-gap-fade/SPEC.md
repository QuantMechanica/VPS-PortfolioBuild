...
session bar (broker `strategy_session_open_hhmm`, default 16:30 = US cash open),
compute `gap = abs(prev_day_close - session_open)`. If the gap is at least
...
| `strategy_session_open_hhmm` | 1630 | broker HHMM | Broker-time of the index session open (16:30 = US cash open on DXZ NY-close). |
...
| v2 | 2026-06-05 | Rebuild-in-place: added `// perf-allowed` tags to bespoke gap OHLC reads (build_check EA_FRAMEWORK_RAW_SERIES_CALL), filled §1 logic + §2 param meanings | 8f2cd142-8faa-4228-89ab-b384696b6640 |
