...
#property description "QM5_41406 WTI Summer Two-Week Agreement Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41406 - WTI Summer Two-Week Agreement Momentum
// -----------------------------------------------------------------------------
// D1 structural crude-oil sleeve:
//   - decide only in June through October
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41406_WTI_SUMMER_W2AGREE";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41406 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41406_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41406\",\"ea\":\"wti-summer-w2agree\"}");
