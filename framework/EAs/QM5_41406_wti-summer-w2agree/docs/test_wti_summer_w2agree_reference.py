"""Deterministic reference checks for QM5_41406 WTI summer two-week agreement."""
...
class WtiSummerTwoWeekAgreementReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_nonsummer_months_are_ineligible(self) -> None:
        for value in (date(2026, 1, 5), date(2026, 5, 4), date(2026, 11, 2)):
    ...
    def test_week_crossing_into_november_uses_monday_anchor(self) -> None:
        self.assertTrue(summer_week(date(2026, 10, 26)))
