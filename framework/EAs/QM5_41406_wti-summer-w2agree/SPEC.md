# QM5_41406_wti-summer-w2agree - Strategy Spec

**EA ID:** QM5_41406  
**Slug:** `wti-summer-w2agree`  
**Strategy ID:** `BURAKOV-MOP-WTI-SUMMER-W2AGREE-20260910_S01`  
**Source:** `BURAKOV-MOP-WTI-SUMMER-W2AGREE-20260910`  
**Last revised:** 2026-09-10

## 1. Strategy Logic

At the first tradable `XTIUSD.DWX` D1 bar of a normalized broker week whose
Monday anchor lies from June through October, read only the two immediately
completed adjacent three-to-five-session weeks. Compute each
`ln(final_close / first_open)` and trade their common sign only when both
weeks strictly agree. Mixed signs, exact zero, invalid history, ineligible
months, late restarts, and failed gates consume the week flat.
...
`414060000`. The symbol is an input; no executable symbol literal is embedded
in the EA. There are no companion markets or basket legs.

## 4. Timeframe

The chart, signal, ATR, and execution timeframe is D1. The configured custom-
symbol label offset maps D1 labels to broker session dates and groups them
...
week. Only June-through-October anchors may continue. Validate the two
immediately prior adjacent weeks and follow their common sign only on strict
...
It joins a completely reviewed peer-reviewed WTI seasonal paper with a
completely reviewed peer-reviewed time-series-momentum paper. The exact
...
| entry | summer calendar, two completed-week packages, strict agreement, continuation side, durable attempt, spread and frozen ATR stop |
...
basis/roll and financing, label sensitivity, seasonal instability, momentum
