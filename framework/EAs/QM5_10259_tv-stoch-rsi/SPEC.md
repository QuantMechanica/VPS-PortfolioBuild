# QM5_10259_tv-stoch-rsi — Strategy Spec
...
`artifacts/cards_approved/QM5_10259_tv-stoch-rsi.md`. See that card's body for
...
`QM5_10259_tv-stoch-rsi.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_swing_left_bars` | 3 | (see source) | (see strategy logic) |
| `strategy_swing_right_bars` | 3 | (see source) | (see strategy logic) |
| `strategy_swing_search_bars` | 80 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_min_stop_atr` | 0.5 | (see source) | (see strategy logic) |
| `strategy_max_stop_atr` | 3.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10259_tv-stoch-rsi.md`
