...
#property description "QM5_12961 WTI September Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12961 - WTI September Calendar Premium
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12961_WTI_SEP_PREM";
   ...
   req.reason = "WTI_SEPTEMBER_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12961\",\"ea\":\"wti-sep-prem\"}");
