# QM5_41463_wti-winter-hclv-cont - Strategy Spec

**EA ID:** QM5_41463  
**Strategy ID:** `BURAKOV-CRABEL-MOP-WTI-WINTER-HCLV-CONT-20260913_S01`
...
week. Buy only when its final close lies strictly above two thirds of its full
high-low range. Equality or any lower close is flat. Candle-body direction and
...
`414630000`. Runtime uses native D1 OHLC/timestamps, quotes, spread, ATR,
...
It combines peer-reviewed WTI November-May seasonality, peer-reviewed
...
`QM5_41440`/`QM5_41447` (two-week range-state rules), and
...
| entry | November-May calendar, one completed week, upper-tercile CLV, attempt, spread, ATR stop |
