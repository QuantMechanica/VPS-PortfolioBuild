# QM5_12704_xngusd-summer-power-long - Strategy Spec
...
new broker-calendar month, it enters long if the month is June through August
and the prior completed close is above SMA(`strategy_trend_period`).
...
`QM5_12575` dual-peak/shoulder-season map and not the `QM5_12588` summer
compression-breakout sleeve.
...
- Regime preference: summer electric-sector demand with positive D1 trend confirmation.
