...
#property description "QM5_12704 XNG Summer Power Long"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12704 - XNG Summer Power Long
// -----------------------------------------------------------------------------
// D1 structural natural-gas sleeve:
//   - long-only in the June-August summer electric-sector demand window
...
bool Strategy_IsSummerPowerMonth(const int month)
  {
...
void Strategy_CloseOpenPositionsIfNeeded()
  {
   ...
   const bool in_summer = Strategy_IsSummerPowerMonth(month);
   const int magic = QM_FrameworkMagic();
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12704_XNG_SUMMER_POWER";
   ...
   const int month = Strategy_MonthFromTime(current_bar);
   if(!Strategy_IsSummerPowerMonth(month))
      return false;
   ...
   req.reason = "XNG_SUMMER_POWER_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12704\",\"ea\":\"xngusd-summer-power-long\"}");
