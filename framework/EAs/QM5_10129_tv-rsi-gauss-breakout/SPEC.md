...
`artifacts/cards_approved/QM5_10129_tv-rsi-gauss-breakout.md`. See that card's body for
...
`QM5_10129_tv-rsi-gauss-breakout.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_gauss_length` | 144 | (see source) | (see strategy logic) |
| `strategy_channel_mult` | 1.414 | (see source) | (see strategy logic) |
...
| Cadence note | "Filtered channel breakout with RSI confirmation; estimate 35-70 trades/year/symbol on H1." |
...
`artifacts/cards_approved/QM5_10129_tv-rsi-gauss-breakout.md`
