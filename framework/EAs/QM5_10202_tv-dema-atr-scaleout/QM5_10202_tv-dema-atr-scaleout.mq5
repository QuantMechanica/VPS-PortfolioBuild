...
#property description "QM5_10202 TradingView DEMA ATR Scaleout"
...
input int    strategy_dema_period       = 34;
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(ask <= 0.0 || bid <= 0.0 || stop_distance <= 0.0)
      return true;
   if((ask - bid) > stop_distance * strategy_spread_stop_max)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(g_pending_reverse_direction != 0)
     {
      ...
      direction = Strategy_DemaShiftSignal();
   ...
   req.reason = (direction > 0) ? "TV_DEMA_ATR_LONG_SHIFT" : "TV_DEMA_ATR_SHORT_SHIFT";
