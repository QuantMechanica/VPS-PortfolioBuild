# QM5_12932_wyckoff-phase-e-markdown-continuation-h4 — Strategy Spec

**EA ID:** QM5_12932
**Slug:** `wyckoff-phase-e-markdown-continuation-h4`
...
`artifacts/cards_approved/QM5_12932_wyckoff-phase-e-markdown-continuation-h4.md`. See that card's body for
...
`QM5_12932_wyckoff-phase-e-markdown-continuation-h4.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_d1_sma_period` | 50 | (see source) | (see strategy logic) |
| `strategy_range_min_duration` | 50 | (see source) | (see strategy logic) |
| `strategy_range_max_lookback` | 300 | (see source) | (see strategy logic) |
| `strategy_range_min_amp_atr` | 3.0 | (see source) | (see strategy logic) |
| `strategy_range_max_amp_atr` | 14.0 | (see source) | (see strategy logic) |
| `strategy_containment_min_ratio` | 0.80 | (see source) | (see strategy logic) |
| `strategy_break_threshold_atr` | 0.50 | (see source) | (see strategy logic) |
| `strategy_pre_trend_min_slope` | 0.08 | (see source) | (see strategy logic) |
| `strategy_min_markdown_atr` | 1.50 | (see source) | (see strategy logic) |
| `strategy_min_pullback_atr` | 0.80 | (see source) | (see strategy logic) |
| `strategy_max_retrace_ratio` | 0.75 | (see source) | (see strategy logic) |
| `strategy_resistance_tol_atr` | 0.50 | (see source) | (see strategy logic) |
| `strategy_trend_max_slope` | -0.05 | (see source) | (see strategy logic) |
| `strategy_min_trend_dist_atr` | 2.00 | (see source) | (see strategy logic) |
| `strategy_max_spread_atr` | 0.20 | (see source) | (see strategy logic) |
| `strategy_pattern_reuse_bars` | 20 | (see source) | (see strategy logic) |
| `strategy_sl_max_atr` | 3.50 | (see source) | (see strategy logic) |
| `strategy_sl_buffer_atr` | 0.50 | (see source) | (see strategy logic) |
| `strategy_time_stop_bars` | 50 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_12932_wyckoff-phase-e-markdown-continuation-h4.md`
