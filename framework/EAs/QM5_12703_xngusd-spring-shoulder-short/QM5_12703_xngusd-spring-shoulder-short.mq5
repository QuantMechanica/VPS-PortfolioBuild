...
#property description "QM5_12703 XNG Spring Shoulder Short"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12703 - XNG Spring Shoulder Short
// -----------------------------------------------------------------------------
// D1 structural natural-gas sleeve:
//   - short-only in the March-May spring shoulder demand-lull window
...
bool Strategy_IsSpringShoulderMonth(const int month)
  {
...
void Strategy_CloseOpenPositionsIfNeeded()
  {
   ...
   const bool in_spring_shoulder = Strategy_IsSpringShoulderMonth(month);
   const int magic = QM_FrameworkMagic();
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12703_XNG_SPRING_SHOULDER";
   ...
   const int month = Strategy_MonthFromTime(current_bar);
   if(!Strategy_IsSpringShoulderMonth(month))
      return false;
   ...
   req.reason = "XNG_SPRING_SHOULDER_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12703\",\"ea\":\"xngusd-spring-shoulder-short\"}");
