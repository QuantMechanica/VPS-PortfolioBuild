...
#property description "QM5_41469 XNG Shoulder Lower-CLV Downside Continuation"
...
//   - decide only in April, May, September, and October shoulder months
...
void Strategy_PrepareDecisionSignal()
  {
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
      ...
      g_signal_state = "late_shoulder_consumed_flat";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41469_XNG_SHOULDER_LCLV_CONT";
   ...
   req.type = QM_SELL;
   req.reason = "XNG_SHOULDER_LCLV_CONT_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41469 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41469_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41469\",\"ea\":\"xng-shoulder-lclv-cont\"}");
