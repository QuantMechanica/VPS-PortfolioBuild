# QM5_41469_xng-shoulder-lclv-cont - Strategy Spec
...
three-to-five-session week. Sell only when its final close lies strictly below
one third of its full high-low range. Equality or any higher close is flat.
...
`414690000`. Runtime uses native D1 OHLC/timestamps, quotes, spread, ATR,
...
It combines official EIA natural-gas shoulder-season context, peer-reviewed commodity continuation, and governed peer-reviewed XNG completed-week/close-
...
predicate, and a strict shoulder-season lower-tercile close.
...
| entry | shoulder calendar, one completed week, lower-tercile CLV, attempt, spread, ATR stop |
...
| v1-q01 | 2026-09-13 | PACER audit and 10 reference tests PASS; governed compile `2261e652` COMPILE_OK with strict build-check PASS; one fixed-risk Q02 canary enqueued below the CPU ceiling |
