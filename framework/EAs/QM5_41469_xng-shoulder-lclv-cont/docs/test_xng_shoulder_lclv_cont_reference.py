"""Deterministic reference checks for QM5_41469 XNG shoulder lower-CLV downside continuation."""
...
class XngShoulderLowerClvContinuationReferenceTest(unittest.TestCase):
    current = date(2026, 4, 13)
    ...
    def test_all_four_shoulder_months_are_eligible(self) -> None:
        self.assertEqual(ELIGIBLE_MONTHS, {4, 5, 9, 10})

    def test_peak_demand_month_is_ineligible(self) -> None:
