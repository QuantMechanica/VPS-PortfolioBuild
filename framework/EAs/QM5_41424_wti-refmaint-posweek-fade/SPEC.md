# QM5_41424_wti-refmaint-posweek-fade - Strategy Spec

**EA ID:** QM5_41424

**Slug:** `wti-refmaint-posweek-fade`

**Strategy ID:** `EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910_S01`

**Source:** `EIA-YANG-WTI-REFMAINT-POSWEEK-FADE-20260910`
...
Negative, exact zero, invalid history, ineligible months, late restarts, and
...
`414240000`. The symbol is an input; no executable symbol literal is embedded
...
academic Yang-Goncu-Pantelous commodity-reversal packet. The exact short-only
...
| entry | maintenance calendar, one completed-week package, strict positive sign, short-only side, durable attempt, spread and frozen ATR stop |
