...
#property description "QM5_12784 — Configurable Intraday Engine (Lanes x Gates)"
...
input int    qm_magic_slot_offset        = 1;     // slot 0 reserved by progo-xti; 1=GDAXI 2=NDX 3=SP500 4=XAUUSD
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               StringFormat("{\"ea\":\"QM5_12784\",\"lane\":%d,\"slot\":%d}",
