...
#property description "QM5_20261 WTI Linear-Trend Quality"
...
// -----------------------------------------------------------------------------
// Source lineage: Moskowitz, Ooi & Pedersen (2012) monthly WTI own-price trend.
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20261 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20261_WTI_LR_TREND";
   ...
   req.reason = (g_cache_signal > 0) ? "LR_TREND_XTI_LONG" : "LR_TREND_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20261_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20261\",\"ea\":\"wti-lr-trend\"}");
