...
`artifacts/cards_approved/QM5_10220_tv-3ema-stoch-atr.md`. See that card's body for
...
`QM5_10220_tv-3ema-stoch-atr.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_ema_fast` | 8 | (see source) | (see strategy logic) |
| `strategy_ema_mid` | 20 | (see source) | (see strategy logic) |
| `strategy_ema_slow` | 40 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10220_tv-3ema-stoch-atr.md`
