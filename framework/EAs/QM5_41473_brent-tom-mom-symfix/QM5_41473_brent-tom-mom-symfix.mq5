...
#property description "QM5_41473 Brent Turn-Of-Month Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41473 - Brent Turn-Of-Month Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41473_BRENT_TOM_MOM";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_41473\",\"ea\":\"brent-tom-mom\"}");
