...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const datetime entry_bar = iTime(_Symbol, PERIOD_D1, 1);
   if(entry_bar <= 0)
      return false;
...
bool Strategy_ExitSignal()
  {
   ...
   const datetime first_month_bar = iTime(_Symbol, PERIOD_D1, 1);
   const datetime prior_bar = iTime(_Symbol, PERIOD_D1, 2);
