...
#property description "QM5_13030 CFTC COT Friday XNG positioning momentum"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13030;
...
input double strategy_profit_close_atr_mult    = 1.60;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13030_XNG_COT_FRI_MOM";
   ...
   req.reason = (entry_type == QM_BUY) ? "XNG_COT_FRI_MOM_LONG" : "XNG_COT_FRI_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13030\",\"ea\":\"xng-cot-mom\"}");
