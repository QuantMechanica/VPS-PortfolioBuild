...
#property description "QM5_12597 WTI Friday Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12597 - WTI Friday Calendar Premium
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - long XTIUSD.DWX on the broker-calendar Friday D1 bar
//   - flatten via framework Friday close, then by next non-Friday D1 bar or a
//     one-day stale-position guard if Friday close is disabled/missed
// Runtime uses MT5 OHLC/broker calendar only; no external energy data.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12597;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12597_WTI_FRI_PREM";
   ...
   req.reason = "WTI_FRIDAY_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12597\",\"ea\":\"wti-fri-prem\"}");
