...
#property description "QM5_20186 XAU XAG Same-Calendar Seasonality"
...
//   - long the higher seasonal metal leg and short the lower seasonal leg
...
string Strategy_AttemptStateName()
  {
   return "QM5_20186_XAUXAG_SAMECAL_ATTEMPT";
  }
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xau_short_xag ? "QM5_20186_LONG_XAU_SHORT_XAG_SAMECAL"
                                            : "QM5_20186_SHORT_XAU_LONG_XAG_SAMECAL";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart())
      return true;
   if(qm_ea_id != 20186 || qm_magic_slot_offset != 0 || qm_rng_seed != 42)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20186_XAU_XAG_SAMECAL_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20186\",\"ea\":\"xauxag-samecal\"}");
