...
#property description "QM5_20042 Brent Calendar-Day-17 One-Session Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20042 - Brent Calendar-Day-17 One-Session Fade
// -----------------------------------------------------------------------------
// Borowski (2016) Brent day-of-month carrier:
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20042_BRENT_DOM17_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "BRENT_DOM17_ONE_SESSION_SHORT";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved DOM17 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;
