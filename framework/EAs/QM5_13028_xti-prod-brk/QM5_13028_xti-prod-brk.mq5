...
#property description "QM5_13028 XTI EIA field-production compression breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13028 - XTI EIA Field-Production Compression Breakout
// -----------------------------------------------------------------------------
...
input double strategy_max_compression_atr    = 0.95;
...
bool Strategy_LoadProductionBreakoutState(int &direction,
                                          double &atr_last)
  {
   direction = 0;
   atr_last = 0.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13028_XTI_PROD_BRK";
   ...
   int direction = 0;
   double atr_last = 0.0;
   if(!Strategy_LoadProductionBreakoutState(direction, atr_last))
      return false;
   ...
   req.reason = (direction > 0) ? "XTI_FIELDPROD_BRK_LONG" : "XTI_FIELDPROD_BRK_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13028\",\"ea\":\"xti-prod-brk\"}");
