...
#property description "QM5_12856 Brent Monday Calendar Fade"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12856_BRENT_MON_FADE";
   ...
   req.reason = "BRENT_MONDAY_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12856\",\"ea\":\"brent-mon-fade\"}");
...
void OnTick()
  {
   ...
   // management/exit path so time-stop and stale-position enforcement keep
   // running through news windows (2026-07-02 audit finding). Fail-closed
   // init in OnInit is unchanged.
