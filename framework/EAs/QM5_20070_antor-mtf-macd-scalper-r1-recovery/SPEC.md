# QM5_20070_antor-mtf-macd-scalper-r1-recovery — Strategy Spec

**EA ID:** QM5_20070
**Slug:** `antor-mtf-macd-scalper-r1-recovery`
...
`artifacts/cards_approved/QM5_20070_antor-mtf-macd-scalper-r1-recovery.md`. See that card's body for
...
`QM5_20070_antor-mtf-macd-scalper-r1-recovery.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_start_hour` | 7 | (see source) | (see strategy logic) |
| `strategy_end_hour` | 17 | (see source) | (see strategy logic) |
| `strategy_max_spread_points` | 15 | (see source) | (see strategy logic) |
| `strategy_sl_atr_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_sl_min_pips` | 8.0 | (see source) | (see strategy logic) |
| `strategy_tp_rr_mult` | 1.5 | (see source) | (see strategy logic) |
| `strategy_use_m15_flip_exit` | true | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_20070_antor-mtf-macd-scalper-r1-recovery.md`
...
|---|---|---|---|
| v1 | 2026-08-11 | Initial spec (ex-post, generated by gen_spec_md.py) | post-PT15 remediation |
