# QM5_9914_bandy-zlema-distance-trend — Strategy Spec

**EA ID:** QM5_9914
**Slug:** `bandy-zlema-distance-trend`
...
`artifacts/cards_approved/QM5_9914_bandy-zlema-distance-trend.md`. See that card's body for
...
`QM5_9914_bandy-zlema-distance-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_zlema_period` | 20 | (see source) | (see strategy logic) |
| `strategy_zlema_lag` | 10 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_distance_atr_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_regime_sma_period` | 200 | (see source) | (see strategy logic) |
| `strategy_sl_atr_mult` | 3.0 | (see source) | (see strategy logic) |
| `strategy_time_stop_days` | 30 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9914_bandy-zlema-distance-trend.md`
