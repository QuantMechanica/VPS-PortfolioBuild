...
`artifacts/cards_approved/QM5_10229_tv-donchian-base.md`. See that card's body for
...
`QM5_10229_tv-donchian-base.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_donchian_lookback` | 20 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_fixed_stop_pips` | 0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10229_tv-donchian-base.md`
