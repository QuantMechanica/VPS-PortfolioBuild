...
#property description "QM5_12804 XNG 12M TSMOM ATR Gate"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12804 - Natural Gas 12-Month Time-Series Momentum ATR Gate
// -----------------------------------------------------------------------------
...
input double strategy_max_atr_pct          = 10.00;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12804_XNG_TSMOM12M_ATR";
   ...
   req.reason = (direction > 0) ? "XNG_TSMOM12M_ATR_LONG" : "XNG_TSMOM12M_ATR_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12804\",\"ea\":\"xng-tsmom12m-atr\"}");
