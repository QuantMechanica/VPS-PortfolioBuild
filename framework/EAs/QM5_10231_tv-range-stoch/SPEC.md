# QM5_10231_tv-range-stoch — Strategy Spec
...
`artifacts/cards_approved/QM5_10231_tv-range-stoch.md`. See that card's body for
...
`QM5_10231_tv-range-stoch.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_range_wma_period` | 20 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_range_entry_threshold` | 100.0 | (see source) | (see strategy logic) |
| `strategy_range_exit_threshold` | 30.0 | (see source) | (see strategy logic) |
| `strategy_stoch_k` | 5 | (see source) | (see strategy logic) |
| `strategy_stoch_d` | 3 | (see source) | (see strategy logic) |
| `strategy_stoch_slowing` | 3 | (see source) | (see strategy logic) |
| `strategy_stoch_cross_level` | 20.0 | (see source) | (see strategy logic) |
| `strategy_ema_exit_enabled` | true | (see source) | (see strategy logic) |
| `strategy_ema_exit_period` | 50 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10231_tv-range-stoch.md`
