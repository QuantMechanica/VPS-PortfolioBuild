# QM5_41190_xtixng-mtheilsen-rv - Strategy Spec
...
**Source:** `VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026`
...
SELL XTI / BUY XNG and a strictly negative slope with BUY XTI / SELL XNG.
...
- Host/traded slot 0: exact `XTIUSD.DWX`, D1, magic `411900000`.
- Companion/traded slot 1: exact `XNGUSD.DWX`, D1, magic `411900001`.
...
13-35, DOI `10.5547/01956574.33.2.2`; Moskowitz, Ooi, and Pedersen (2012),
...
The sources support a weak, state-dependent oil/gas relationship and WTI
own-price persistence lineage. The governed method packet supplies exact
thirteen-endpoint, forward-pair, denominator, sort, and median arithmetic
only. The paired robust-slope horizon, fade direction, CFD mapping,
...
|---|---|---|---|
| v0 | 2026-08-28 | approved source build | G0-approved card; governed magics `411900000`/`411900001`; one logical Q02 preset |
