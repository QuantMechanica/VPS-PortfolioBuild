...
type: strategy
strategy_id: VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026_S01
variant_id: VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026_S01
source_id: VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026
ea_id: QM5_41190
slug: xtixng-mtheilsen-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41190_xtixng-mtheilsen-rv_card.md
execution_contract_status: APPROVED
created: 2026-08-28
created_by: Research+Development
last_updated: 2026-08-28
g0_status: APPROVED
g0_decision: decisions/2026-08-28_qm5_41190_xtixng_monthly_theilsen_reversion_g0.md
source_approval: decisions/2026-08-28_xtixng_monthly_theilsen_reversion_source_approval.md
...
source_citation: "Villar and Joutz (2006), U.S. EIA, The Relationship Between Crude Oil and Natural Gas Prices; Ramberg and Parsons (2012), The Energy Journal 33(2), 13-35, DOI 10.5547/01956574.33.2.2; Moskowitz, Ooi, and Pedersen (2012), Journal of Financial Economics 104(2), 228-250, DOI 10.1016/j.jfineco.2011.11.003; governed exact Theil-Sen arithmetic reduction."
source_citations:
  ...
  - type: peer_reviewed_commodity_trend_paper
    citation: "Moskowitz, T. J., Ooi, Y. H., and Pedersen, L. H. (2012). Time Series Momentum. Journal of Financial Economics 104(2), 228-250."
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete published-paper read and retrieval receipt preserved in strategy-seeds/sources/MOP-TSMOM-2012/source.md"
    quality_tier: A
    role: structural_commodity_own_price_persistence_and_wti_membership
  - type: governed_composite_source
    citation: "QuantMechanica bounded XTI/XNG monthly exact Theil-Sen ratio-slope reversion extraction."
    location: "strategy-seeds/sources/VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026/source.md"
    quality_tier: internal_governed
    role: exact_pairwise_slope_median_direction_risk_atomicity_and_lifecycle
strategy_mechanic: synchronized-thirteen-completed-month-end-oil-minus-gas-log-ratio-seventy-eight-forward-month-index-normalized-slopes-exact-even-theil-sen-median-sign-contrarian-equal-notional-basket
sources:
  - "[[sources/VILLAR-MOP-XTIXNG-MTHEILSEN-RV-2026]]"
concepts:
...
strategy_type_flags: [commodity, energy, relative-value, market-neutral-style, structural-reversion, robust-theil-sen-slope, monthly-rebalance, equal-notional-basket, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy, oil_gas_relative_value]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41190_XTI_XNG_MTHEILSEN_RV_D1
symbol: QM5_41190_XTI_XNG_MTHEILSEN_RV_D1
...
r1_reasoning: "Complete government and peer-reviewed oil/gas relationship evidence with adverse regime findings plus a complete governed peer-reviewed WTI trend source and exact Theil-Sen arithmetic reduction; the exact contrarian ratio basket is an untested QM hypothesis."
r2_mechanical: PASS
r2_reasoning: "Month clock, synchronized endpoints, ratio orientation, 78 forward slopes, month-index denominators, exact even median, contrarian sides, consumed attempt, aggregate fixed risk, atomicity, and lifecycle are deterministic and locked."
...
r4_reasoning: "Only timestamps, completed prices, logarithms, sorting, finite pairwise arithmetic, ATR risk controls, and execution state; no trained signal, prohibited indicator, or external runtime feed."
parameters_to_test: "Locked Q02 baseline only: 13 synchronized endpoints; all 78 forward month-index-normalized slopes; exact even median indexes 38/39; 900 D1 history bars; 180-minute month-entry grace; 10-day endpoint staleness; ATR(20)*3.5 stops; equal target notionals; 20% notional mismatch ceiling; 40-day stale exit; 1500/3000-point spread ceilings."
...
force_build: true
review_focus: "Falsify a thirteen-completed-month oil/gas ratio exact Theil-Sen reversion basket outside the directional XAU/SP500/NDX/XNG book. Verify synchronization, consecutive months, oil-minus-gas orientation, all 78 forward slopes, month-index denominators, exact central indexes 38/39, contrarian sides, one attempt, aggregate fixed risk, equal-notional tolerance, atomicity, and next-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_symbols_period, first_tradable_month_bar, thirteen_consecutive_completed_months, synchronized_month_end_pairs, latest_pair_per_month, chronological_oil_minus_gas_ratio_orientation, forward_pair_bounds, month_index_denominator, exact_candidate_count_78, ascending_sort, exact_even_median_indexes_38_39, contrarian_sides, monthly_attempt_state, equal_notional_pair, aggregate_fixed_risk, atomic_pair_lifecycle, hard_stops_present, next_month_exit, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER mission 2026-08-28 and decisions/2026-08-28_qm5_41190_xtixng_monthly_theilsen_reversion_g0.md: R1 PASS with explicit estimator/carrier translation risk using complete government and peer-reviewed oil/gas evidence plus governed peer-reviewed WTI trend evidence and exact Theil-Sen arithmetic; R2 PASS locks synchronized endpoints, all 78 forward slopes, month-index denominators, sort, exact even median, sides, attempt, aggregate risk, stops, and repair; R3 PASS registered native XTI/XNG D1 with synchronization/CFD risk; R4 PASS deterministic native arithmetic only. Canonical dedup found only the expected precious-metal fuzzy sibling; manual fixtures separate repeated-median and LAD XTI/XNG neighbors."
---

# QM5_41190 XTI/XNG Thirteen-Month Theil-Sen Ratio Reversion
...
synchronized oil-minus-gas log ratio, summarized by an exact median of all
forward month-index-normalized slopes, subsequently reverts. It imports no equilibrium coefficient,
center, scale, convergence speed, or result and never scales risk by signal
magnitude.
...
authorized by
`decisions/2026-08-28_xtixng_monthly_theilsen_reversion_source_approval.md` at
commit `1c171e0ff` and extracted at commit `69c44b20d` before card review.

Villar/Joutz and Ramberg/Parsons supply a related but state-dependent oil/gas
hypothesis plus binding adverse evidence. The governed Moskowitz/Ooi/Pedersen
child packet supplies exact thirteen-observation Theil-Sen arithmetic. None tests
this exact paired monthly ratio fade, Darwinex continuous CFDs, equal-
notional fixed-dollar ATR risk, or the QM book.
...
Before allocation, the fail-closed checker scanned 4,689 registry identities,
1,340 card files, and 45 current Strategy Wiki nodes. It found no exact
identity and only the expected precious-metal Theil-Sen sibling as a fuzzy
match. Evidence is
...
- `QM5_41157_xauxag-mtheilsen-rv` applies the same statistic to a gold/silver
  path under a precious-metal thesis. This card owns an economically distinct
  oil/gas path and only XTI/XNG energy legs.
- `QM5_20271_wti-theilsen-tr` applies the estimator to outright WTI, follows
...
- `QM5_41188_xtixng-mrepmedian-rv` takes thirteen pivot-specific slope medians
  and one outer median. This card takes one global median of all 78 slopes. On
  valid ratio levels
  `[0,.01,.06,.11,.14,.13,.11,.12,.09,.04,.02,.05,.10]`, Theil-Sen is
  positive (`0.001555...`) while repeated median is negative (`-0.0045`).
- `QM5_41189_xtixng-mlad-rv` profiles a median intercept for every candidate
  and minimizes total absolute vertical loss. On valid ratio levels
  `[0,.02,0,0,-.06,-.09,-.05,-.05,.03,.06,-.02,-.03,.05]`, LAD is
  negative (`-0.002`) while Theil-Sen is positive (`0.003030...`). The locked
  fade rules therefore request opposite packages on the same valid state.
- Pettitt, Mann–Whitney, Cox–Stuart, Spearman, and median-runs XTI/XNG cards
  ...
  state functions rather than a global median pairwise slope.
- `QM5_20237_xtixng-ecm-rv` fits a daily trend-augmented OLS residual with a
  z-score and convergence exit. This card uses thirteen month ends and no
  residual center, scale, coefficient bound, or convergence exit.
- `QM5_12578_eia-oilgas-ratio` standardizes a fixed log-price ratio. This
  card uses only the strict sign of an exact Theil-Sen ratio slope.
...
- Logical tester symbol: `QM5_41190_XTI_XNG_MTHEILSEN_RV_D1` on XTI host.
- Timeframe: D1; intended magics `411900000` and `411900001`.
...
- Expected trade frequency: approximately 10–12 packages/year per symbol
  after warm-up; Q02 must prove at least five in every scored full year.
...
Positive Theil-Sen slope means SELL XTI / BUY XNG. Negative means BUY XTI /
SELL XNG. Exact zero or invalid state consumes the month flat. Magnitude
never scales risk.

## Rules

These are the complete authorized baseline. There is no parameter sweep,
candidate pruning, slope bound, repeated-median or LAD fallback, OLS,
endpoint agreement, z-score, volatility signal, seasonal filter, external
series, or prior-result gate.

## 4. Entry Rules

1. Require exact EA ID `41190`, host `XTIUSD.DWX`, companion `XNGUSD.DWX`, D1,
...
5. Reconstruct exactly thirteen consecutive completed month-end pairs from
   bounded 900-bar D1 buffers. In each month require the latest exactly
   timestamp-matched close pair; reject missing, duplicate, unmatched,
   current-month, nonchronological, or more-than-ten-day-stale newest pairs.
6. Keep pairs oldest to newest. Require positive finite closes and exactly
   thirteen finite oil-minus-gas natural-log ratios.
7. Enumerate all 78 slopes lexicographically for `0<=i<j<=12`. Orient
   each slope from earlier to later and divide by the positive integer month-
   index distance. Reject any count other than 78 or nonfinite slope.
8. Sort all 78 slopes ascending without rounding. Require finite central
   values and compute the exact even median as `(sorted[38]+sorted[39])/2`.
   Fade its strict sign; exact zero consumes the month flat.
...
- Reject consumed attempt, owned exposure, same-month entry history, malformed
  ...
  pair, nonpositive/nonfinite close, invalid ratio/slope/central median,
  wrong count, exact-zero statistic, excessive
...
| `strategy_month_end_count` | 13 | [13] | synchronized completed-month ratio observations |
...
pair bounds, denominator, median definition, direction, clock, risk, stop,
balance, hold, spread, order sequence, or retry policy requires a new card
and full pipeline run.

## Author Claims

Villar/Joutz and Ramberg/Parsons document a weak, state-dependent oil/gas
relationship and adverse evidence against a simple constant tie. The
governed method source documents exact thirteen-endpoint Theil-Sen arithmetic.
They do not claim that this rule works, that the estimator is superior, that
continuous CFDs reproduce their data, or that the package diversifies the QM
book.
...
- Fail on wrong synchronization, month order, current-month leakage, stale
  endpoint, ratio orientation, slope omission/duplication, wrong denominator,
  sort, central indexes, final median, sides, retry, non-atomic package, risk-
  mode breach, stop defect, hold beyond forty days, or nondeterminism.
- Retire on nonpositive governed economics or later portfolio-correlation
  rejection.
- Do not rescue failure by changing lookback, estimator, direction, carrier,
...
|---|---|---|
| R1 | PASS | Complete government and peer-reviewed oil/gas evidence with adverse regime findings plus complete peer-reviewed WTI trend evidence and an exact governed Theil-Sen reduction; estimator/carrier translation risk remains explicit. |
| R2 | PASS | Fixed endpoints, synchronization, 78 forward slopes, month-index denominators, ascending sort, exact even median, direction, attempt, aggregate risk, atomicity, and exits. |
| R3 | PASS | Registered XTIUSD.DWX and XNGUSD.DWX D1 histories plus native MT5 state supply every field; synchronization and continuous-CFD basis remain test risks. |
| R4 | PASS | Deterministic logarithms, finite pairwise slopes, sorting, calendar, and ATR risk arithmetic; no trained model, banned signal indicator, external feed, grid, or martingale. |
...
- trade_entry: durable month attempt, synchronized endpoint reconstruction,
  exact Theil-Sen median, spread/quote/ATR/stop checks, equal-notional sizing,
...
duplicate month, nonlatest pair, unmatched timestamp, wrong ratio, candidate
omission/duplication, wrong denominator, sort, central indexes, median, side,
retry, package, risk, stop, or determinism is an implementation failure, not
a tunable result.

Any change to carrier, observation count, synchronization, candidate
enumeration, denominator, sort, median definition, direction, stop, spread
caps, atomic sequence, attempt lifecycle, symbol, timeframe, news/Friday
mode, or risk mode requires a new binary and full pipeline requalification.
Realized diversification may only be assessed at unchanged Q09; correlation
failure receives no waiver here.
...
manifest; portfolio-gate mutation; portfolio admission; component-leg Q02
row; or correlation waiver.

## Pipeline History

| version | date | rebuild reason | phase reached | verdict |
|---|---|---|---|---|
| v1 | 2026-08-28 | initial XTI/XNG exact Theil-Sen ratio-reversion card | G0 | APPROVED; build pending |

## Pipeline Phase Status

| phase | date | verdict | evidence |
|---|---|---|---|
| G0 Research Intake | 2026-08-28 | APPROVED; R1-R4 PASS | `decisions/2026-08-28_qm5_41190_xtixng_monthly_theilsen_reversion_g0.md`; approved source packet |
