...
#property description "QM5_13103 XTI ID/NR4 contraction breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13103 - XTI ID/NR4 Contraction Breakout
// -----------------------------------------------------------------------------
...
bool Strategy_LoadIdNr4State(double &setup_high,
                             ...
                             double &atr_last)
  {
   ...
   const int copied = CopyRates(_Symbol, PERIOD_D1, 1, lookback + 2, rates); // perf-allowed: evaluated only on a new D1 bar.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13103_XTI_IDNR4_BRK";
   ...
   req.reason = (direction > 0) ? "XTI_IDNR4_BRK_LONG" : "XTI_IDNR4_BRK_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13103\",\"ea\":\"xti-idnr4-brk\"}");
