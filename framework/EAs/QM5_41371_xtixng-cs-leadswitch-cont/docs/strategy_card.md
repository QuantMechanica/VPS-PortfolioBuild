...
type: strategy
strategy_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906_S01
variant_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906_S01
source_id: AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906
ea_id: QM5_41371
slug: xtixng-cs-leadswitch-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41371_xtixng-cs-leadswitch-cont_card.md
execution_contract_status: APPROVED
created: 2026-09-06
created_by: Research+Development
last_updated: 2026-09-06
g0_status: APPROVED
g0_decision: decisions/2026-09-06_qm5_41371_xtixng_common_shock_leader_switch_continuation_g0.md
source_approval: decisions/2026-09-06_xtixng_common_shock_leader_switch_continuation_source_approval.md
...
strategy_mechanic: normalized-week-boundary-xti-xng-three-synchronized-completed-week-endpoints-two-consecutive-individual-weekly-return-pairs-strict-same-sign-each-week-strict-relative-leader-switch-newest-winner-continuation-equal-notional-one-week-hold
sources:
  - "[[sources/AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906]]"
concepts:
  - "[[concepts/oil-gas-relative-value]]"
  - "[[concepts/completed-week-common-direction-leader-rotation]]"
  - "[[concepts/market-neutral-basket]]"
indicators:
  - "[[indicators/completed-week-individual-log-return]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, energy, oil-gas-relative-value, market-neutral-basket, common-direction-leader-switch, relative-winner-continuation, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, energy]
timeframes: [D1]
target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
primary_target_symbols: [XTIUSD.DWX, XNGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41371_XTI_XNG_CS_LEADSWITCH_CONT_D1
symbol: QM5_41371_XTI_XNG_CS_LEADSWITCH_CONT_D1
host_symbol: XTIUSD.DWX
companion_symbol: XNGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [413710000, 413710001]
period: D1
timeframe: D1
expected_trade_frequency: "Approximately five to twelve completed paired packages per full post-warm-up year after two strict common-sign weeks, relative-leader switch, synchronization, and execution gates; Q02 must prove at least five/year or retire."
expected_trades_per_year_per_symbol: 7
expected_pf: 1.01
expected_dd_pct: 35.0
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_TWO_WEEK_LEADER_SWITCH_CONTINUATION_TRANSLATION_RISK
r2_mechanical: PASS
...
the same direction for two consecutive completed weeks but relative leadership
rotates, treat the newest displacement as a source-aligned continuation state
inside a weak, time-varying relationship. Buy the newest relative winner and
sell the loser as one equal-notional package for the following week.
...
continuation state, efficacy, neutrality, or decorrelation.

## Source Traceability And Claim Boundary

The approved source of record is
`strategy-seeds/sources/AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906/source.md`,
...
The canonical checker scanned 4,851 registry rows and 1,464 cards, found no
exact identity, and surfaced eight expected fuzzy siblings. The external
Strategy Wiki root was unavailable and remains an explicit coverage limit.

- `QM5_41368` uses the same strict two-week leader-switch state but fades the
  newest winner; this card follows it.
- `QM5_41369` follows the newest winner only when the same leader persists;
  this card requires a strict switch.
- `QM5_41367` consumes one common-sign week and follows its winner without a
  prior-week leader-switch requirement.
- `QM5_41365` requires opposite signs within the completed week.
- `QM5_41358` and `QM5_41360` use two opposite-sign ratio returns plus a
  magnitude comparison; this card ignores magnitude and instead requires
  same-sign individual XTI/XNG returns inside both weeks.
...
- Logical basket: `QM5_41371_XTI_XNG_CS_LEADSWITCH_CONT_D1`.
- Timeframe: exact D1; slots zero and one; magics `413710000` and
  `413710001`.
...
week, missing/nonconsecutive weeks, or asynchronous bars consume the attempt
flat. No current-week price is a signal input.
...
1. Evaluate only once on a new exact host D1 bar under EA 41371 and slots zero
   and one.
...
- Exact two-week common-sign leader rotation and continuation direction.
...
- No rescue may alter carrier, two-week formation, same-sign states,
  leader-switch condition, continuation direction, attempt semantics, risk, stop, or
  lifecycle.
...
1. Deterministic reference fixtures for week keys, session bounds, strict
   signs, leader switch, equality, mixed-sign rejection, direction, sizing,
   attempt persistence, atomic repair, and lifecycle.
