# QM5_41371_xtixng-cs-leadswitch-cont - Strategy Spec

**EA ID:** QM5_41371  
**Slug:** `xtixng-cs-leadswitch-cont`  
**Strategy ID:** `AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906_S01`  
**Source:** `AI-CODEX-XTIXNG-CS-LEADSWITCH-CONT-20260906`  
**Author:** Codex  
...
strict relative winner must switch between weeks. Follow the newest relative
...
- Logical symbol: `QM5_41371_XTI_XNG_CS_LEADSWITCH_CONT_D1`.
...
- Direction: buy the newest relative winner and sell the loser.
...
- Symmetric opposed-leg oil/gas continuation after common-direction leadership
  rotates.
...
switch continuation is an untested QM translation; no source result transfers.
