"""Deterministic reference checks for QM5_41067 XNG weekly sign handoff."""
...
def sign_handoff_signal(
    ...
    """Mirror three completed week ends and the strict sign handoff."""
...
class WeekSignHandoffReferenceTest(unittest.TestCase):
    ...
    def test_same_sign_and_exact_zero_are_flat(self) -> None:
        ...
        offset = label_offset(current, now)
        assert offset is not None
        self.assertEqual(sign_handoff_signal(20260824, bars, offset)[1], 0)
    ...
    def test_uniform_prior_date_label_normalization_and_grace(self) -> None:
        ...
        assert offset is not None
        self.assertEqual(sign_handoff_signal(20260824, bars, offset)[1], 1)
    ...
    def test_nonconsecutive_or_current_week_endpoint_rejected(self) -> None:
        ...
        self.assertFalse(sign_handoff_signal(20260824, bars, offset)[0])
