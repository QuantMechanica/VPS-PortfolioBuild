# QM5_41415_wti-wstreak3-fade - Strategy Spec
...
**Source:** `YANG-WTI-WSTREAK3-FADE-20260910`
...
common sign and the preceding return has the strict opposite sign. Fade the
...
- Magic: `414150000`, after governed allocation.
...
- Direction: fade the fresh three-week streak.
...
- Symmetric WTI reversion only on the first appearance of a three-week
...
Yang, C., Goncu, A., and Pantelous, A. A. (2017), *Momentum and Reversal in
Commodity Futures*, SSRN 3069253; Moskowitz, T. J., Ooi, Y. H., and Pedersen,
L. H. (2012), *Time Series Momentum*, *Journal of Financial Economics* 104(2),
...
The sources supply academic commodity reversal lineage and explicit WTI
carrier membership. The weekly horizon, three-week streak, opposite-sign
predecessor, and reversal direction are disclosed QM hypotheses; no source
result transfers to this CFD implementation.
