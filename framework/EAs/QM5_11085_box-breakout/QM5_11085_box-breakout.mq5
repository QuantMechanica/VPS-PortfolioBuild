...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const int signal_now = QM_Sig_Range_Breakout(_Symbol, PERIOD_CURRENT, strategy_box_bars, 1);
   if(signal_now == 0)
      return false;

   // First breakout after neutral: prior closed bar was not already outside its box.
   if(QM_Sig_Range_Breakout(_Symbol, PERIOD_CURRENT, strategy_box_bars, 2) != 0)
      return false;
