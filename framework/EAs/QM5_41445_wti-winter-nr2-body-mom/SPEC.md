# QM5_41445_wti-winter-nr2-body-mom - Strategy Spec

**EA ID:** QM5_41445  
**Strategy ID:** `BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911_S01`
...
strictly narrower. Buy when that week's final close is strictly above its chronological first open;
sell when it is strictly below. Range equality, expansion, or body equality is flat. Range
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414450000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911/source.md`. It
combines peer-reviewed WTI November-May seasonality and own-return continuation with governed
reputable Crabel range-state lineage. The exact weekly rule is an untested QM translation.

The rule differs from `QM5_12567` (two-day XNG oscillator pullback), `QM5_41443` (opposite
range-expansion body continuation), `QM5_41441` (contracting-week later-close breakout), and
`QM5_41440` (range-expansion upper-quartile WTI long only).
...
| entry | November-May calendar, two completed weeks, strict range contraction, own-body continuation, attempt, spread, ATR stop |
...
| v1-q01 | 2026-09-11 | T10 governed compile and strict build check PASS; Q02 pending deterministic intake |
| v1-q02 | 2026-09-11 | Deterministic Q02 intake accepted; work item `6bf0bb8c-91c5-4fbc-b39e-f04b3399aa83` claimed by T2; no result awaited |
