...
type: strategy
strategy_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911_S01
variant_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911_S01
source_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911
ea_id: QM5_41445
slug: wti-winter-nr2-body-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41445_wti-winter-nr2-body-mom.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41445_wti_winter_nr2_body_momentum_g0.md
source_approval: decisions/2026-09-11_wti_winter_nr2_body_momentum_source_approval.md
...
source_citation: "Burakov, Freidin and Solovyev (2018), The Halloween Effect on Energy Markets; Moskowitz, Ooi and Pedersen (2012), Time Series Momentum; governed Crabel range-state lineage."
source_citations:
  - type: peer_reviewed_and_reputable_bounded_mechanization
    citation: "Peer-reviewed WTI seasonality and own-return continuation plus governed reputable Crabel range-state lineage."
    location: strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911/source.md
    quality_tier: B_and_A_and_governed_reputable_lineages_with_translation_risk
    role: november_may_calendar_range_contraction_and_body_continuation_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-two-completed-weeks-newest-strict-narrower-range-than-prior-own-body-sign-symmetric-continuation-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911]]"]
concepts: ["[[concepts/wti-winter-seasonality]]", "[[concepts/completed-week-volatility-contraction]]", "[[concepts/time-series-momentum]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-week-body-sign]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, weekly-range-contraction, body-sign, symmetric-long-short, weekly-continuation, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 11,12,1,2,3,4,5; two immediately completed consecutive weeks with 3-5 sessions each; newest range strictly less than prior; newest body close strictly above open buys and strictly below open sells; body equality is flat; range containment is irrelevant; 30 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
q02_status: ENQUEUED
q02_work_item: 6bf0bb8c-91c5-4fbc-b39e-f04b3399aa83
force_build: true
...
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_contraction, strict_own_body_sign, continuation_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineages with explicit translation risk; R2 exact mechanical WTI winter NR2/body symmetric continuation; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
compress directional information before renewed repricing. Follow the newest completed week's own open-to-close
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-BODY-MOM-20260911/source.md`.
...
The canonical scan found no exact match. `QM5_41443` follows the same body direction only after
strict range expansion, the opposite volatility state. `QM5_41441` also requires contraction but
waits for a later current-week completed-close breakout beyond the frozen weekly box. `QM5_41440`
requires expansion, upper-quartile close location, and a long-only side. Certified `QM5_12567`
is a two-day cumulative-RSI XNG pullback. The new identity requires WTI, the full November-May
clock, two-week range contraction, immediate newest-week body direction, symmetric continuation,
and a one-week hold.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41445, slot zero, registered magic, and
...
5. Require positive finite ranges and require the newest range to be strictly less than the
   preceding range; equality is flat. Range containment is irrelevant.
6. Buy only when the newest week's final close is strictly above its chronological first open;
   sell only when it is strictly below. Equality is flat. Close location is irrelevant.
...
spread, quote, ATR, stop, sizing, or order state. Framework
...
Changing the calendar, formation, strict range relation, body-sign orientation, carrier, stop,
hold, spread, or retry contract requires a new identity.

## Source-Defined Rules

Burakov et al. supply the November-May WTI interval. Moskowitz, Ooi, and Pedersen supply broad
own-return continuation lineage, while the governed Crabel record supplies range-state lineage.
They do not supply this exact weekly conjunction or its two-week comparison.

## QM Interpretations

Monday anchors, two completed weeks, strict range contraction, no containment rule, weekly body
mapping, immediate boundary entry without later breakout confirmation,
...
| week clock, calendar, two packages, range, body sign, attempt, spread, ATR | Trade Entry | `Strategy_EntrySignal` and helpers |
...
range contraction, range tie, positive, negative, and zero body states, both continuation sides,
current-week exclusion, durable attempt, frozen stop, next-week exit, card lint,
...
| Q02 Baseline Screening | 6bf0bb8c-91c5-4fbc-b39e-f04b3399aa83 | ENQUEUED | deterministic intake receipt; claimed by T2 at handoff |
