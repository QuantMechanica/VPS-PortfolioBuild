...
#property description "QM5_12777 WTI December Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12777 - WTI December Calendar Fade
// -----------------------------------------------------------------------------
...
input int    strategy_entry_month        = 12;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12777_WTI_DEC_FADE";
   ...
   req.reason = "WTI_DECEMBER_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12777\",\"ea\":\"wti-dec-fade\"}");
