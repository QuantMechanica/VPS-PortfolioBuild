...
#property description "QM5_10224 TradingView VIOP ATR Snipe"
...
input double strategy_min_ema_diff_pts  = 0.0;
input int    strategy_rsi_period        = 14;
input double strategy_rsi_long_min      = 50.0;
input double strategy_rsi_long_max      = 80.0;
input double strategy_rsi_short_min     = 20.0;
...
input bool   strategy_no_trade_enabled  = true;
...
bool Strategy_NoTradeFilter()
  {
   if(!strategy_no_trade_enabled)
      return false;

   MqlDateTime dt;
   TimeToStruct(TimeCurrent(), dt);
   const int hour = dt.hour;
   const int start_h = MathMax(0, MathMin(23, strategy_no_trade_start_h));
   const int end_h = MathMax(0, MathMin(23, strategy_no_trade_end_h));
...
void Strategy_ManageOpenPosition()
  {
   // Card specifies fixed ATR bracket exits only; no BE, trailing, or partials.
  }
