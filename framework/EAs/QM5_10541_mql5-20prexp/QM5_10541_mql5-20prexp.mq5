...
#property description "MQL5 20Prexp rebuild"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 10541;
...
input int    strategy_model             = 6;
input int    strategy_fast_period       = 20;
input int    strategy_mid_period        = 34;
...
string strategy_symbols[] = {"EURUSD.DWX", "GBPUSD.DWX", "XAUUSD.DWX", "GDAXI.DWX"};
string strategy_reason = "DAILY_BREAKOUT";
