...
#property description "QM5_10171 TradingView VWAP RSI Dip"
...
bool Strategy_RSIDippedRecently(const int first_shift)
  {
   ...
   for(int offset = 0; offset < lookback; ++offset)
     {
      const double rsi = QM_RSI(_Symbol, strategy_signal_tf, strategy_rsi_period, first_shift + offset);
      if(rsi > 0.0 && rsi < strategy_rsi_dip_level)
         return true;
     }
   return false;
  }
