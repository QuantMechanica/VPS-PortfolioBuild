...
`artifacts/cards_approved/QM5_10171_tv-vwap-rsi-dip.md`. See that card's body for
...
`QM5_10171_tv-vwap-rsi-dip.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_rsi_dip_lookback` | 10 | (see source) | (see strategy logic) |
| `strategy_rsi_dip_level` | 10.0 | (see source) | (see strategy logic) |
| `strategy_rsi_exit_level` | 90.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_stop_mult` | 2.5 | (see source) | (see strategy logic) |
| `strategy_percent_stop` | 5.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10171_tv-vwap-rsi-dip.md`
