# QM5_41450_xauxag-nr2-body-rv — Strategy Spec

- EA ID: QM5_41450
- Slug: `xauxag-nr2-body-rv`
- Strategy ID: `SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-BODY-RV-20260912_S01`
- Source: `SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-BODY-RV-20260912`
- Author: Codex
...
be strictly narrower than the prior range. Fade the strict newest ratio-week body through an
opposed equal-notional package, consume one attempt per week, and hold for one normalized week.
Invalid, tied, expanding, or late states consume flat. Range containment is not required.
...
lineage. The exact NR2/body ratio reversion is an untested QM translation. It differs from
...
| v1-q01 | 2026-09-12 | governed T5 compile and strict build check PASS; 6 reference tests and PACER audit PASS |
