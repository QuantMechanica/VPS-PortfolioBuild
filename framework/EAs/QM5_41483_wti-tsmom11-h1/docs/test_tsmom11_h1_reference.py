#!/usr/bin/env python3
"""Independent vectors for QM5_41483's locked statistic and clock."""
...
def main() -> None:
    months = [202604, 202605, 202606, 202607, 202608, 202609, 202610, 202611, 202612, 202701, 202702, 202703]
    assert consecutive(months)
    assert not consecutive([202604, 202605, 202606, 202607, 202608, 202609, 202610, 202612, 202701, 202702, 202703, 202704])

    rising = [100.0, 101.0, 99.0, 103.0, 102.0, 105.0, 104.0, 107.0, 106.0, 108.0, 110.0, 112.0]
    falling = [100.0, 99.0, 101.0, 96.0, 98.0, 94.0, 93.0, 92.0, 94.0, 91.0, 90.0, 88.0]
    flat = [100.0, 105.0, 95.0, 106.0, 94.0, 107.0, 93.0, 108.0, 92.0, 109.0, 111.0, 100.0]
    ...
    irregular = [100.0, 92.0, 108.0, 91.0, 96.0, 89.0, 110.0, 97.0, 111.0, 98.0, 99.0, 104.0]
    ...
    print("PASS: QM5_41483 eleven-month monthly reference vectors")
