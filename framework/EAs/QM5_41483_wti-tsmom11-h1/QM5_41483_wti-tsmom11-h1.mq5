...
#property description "QM5_41483 WTI Eleven-Month Trend / One-Month Hold"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41483 - WTI Eleven-Month Trend / One-Month Hold
// -----------------------------------------------------------------------------
// Source lineage: Moskowitz, Ooi & Pedersen (2012) monthly own-return trend.
// At the first processed D1 bar of every new broker month:
...
//   4. close and reconsider at the next broker-month transition.
// The monthly renewal clock, CFD mapping, ATR stop, and fixed-dollar
// sizing are transparent QM mechanizations. Runtime uses XTIUSD.DWX data only.
// The exact eleven-month endpoint pair remains independent of the one-month clock.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41483;
...
bool Strategy_LoadMonthlyCloses(double &closes[])
  {
   ...
   // perf-allowed: one bounded bulk read, monthly new-bar path only.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41483_WTI_TSMOM11_H1";
...
void Strategy_ManageOpenPosition()
  {
   ...
   // Every genuine broker-month edge rolls the prior one-month package.
   if(g_monthly_rebalance_bar &&
      Strategy_IsEligibleDecisionMonth(g_cache_month_key) &&
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_41483_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41483\",\"ea\":\"wti-tsmom11-h1\"}");
...
void OnTick()
  {
   ...
   // Lifecycle repair and monthly liquidation precede entry gates.
