# QM5_41483_wti-tsmom11-h1 — Strategy Spec

**EA ID:** QM5_41483  
**Slug:** `wti-tsmom11-h1`  
**Source:** `MOP-WTI-TSMOM11-H1-2026`  
**Author of this spec:** Codex  
**Last revised:** 2026-09-19

## 1. Strategy Logic

On the first D1 bar of every new broker month, reconstruct twelve consecutive
...
**Source ID:** `MOP-WTI-TSMOM11-H1-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM11-H1-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41483_wti-tsmom11-h1_card.md`.
...
`QM5_41390` uses the same exact eleven-month endpoints but a fixed odd-month,
...
and filter logic. This identity combines exact eleven-month endpoints with the
