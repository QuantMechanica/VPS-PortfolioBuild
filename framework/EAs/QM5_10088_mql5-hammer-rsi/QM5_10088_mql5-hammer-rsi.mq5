...
#property description "QM5_10088 MQL5 Hammer Hanging Man RSI"
...
input int    strategy_context_lookback     = 3;
input double strategy_max_body_range_frac  = 0.35;
input double strategy_lower_shadow_body_min = 2.0;
input double strategy_upper_shadow_body_max = 1.0;
   ...
   if(sell_signal)
     {
      ...
      req.type = QM_SELL;
      req.sl = sl;
      req.reason = "hanging_man_rsi_short";
      return true;
     }
...
void Strategy_ManageOpenPosition()
  {
   // Card specifies indicator exits and a fixed ATR protective stop only.
  }
