# QM5_41177_xauxag-mwilcoxon-shift-rv - Strategy Spec
...
**Source:** `SCHWEIKERT-MANNWHITNEY-CME-XAUXAG-MSHIFT-RV-2026`
...
`U_new>=24` maps to SELL XAU / BUY XAG; `U_new<=12` maps to BUY XAU / SELL
XAG; interior values and exact ties consume flat. The exposure is one atomic,
...
- Host/traded slot 0: exact `XAUUSD.DWX`, D1, magic `411770000`.
- Companion/traded slot 1: exact `XAGUSD.DWX`, D1, magic `411770001`.
- Logical symbol: `QM5_41177_XAU_XAG_MWILCOXON_SHIFT_RV_D1`.
...
H. B. Mann and D. R. Whitney (1947), *The Annals of Mathematical Statistics*
18(1), 50-60, DOI `10.1214/aoms/1177730491`; and pinned R Core
`stats::wilcox.test` source and manual.

Canonical bounded packet:
`strategy-seeds/sources/SCHWEIKERT-MANNWHITNEY-CME-XAUXAG-MSHIFT-RV-2026/source.md`.

The sources support the state-dependent relative carrier and exact
...
|---|---|---|---|
| v0 | 2026-08-27 | approved source build | G0-approved card; governed magics `411770000`/`411770001`; one logical Q02 preset |
