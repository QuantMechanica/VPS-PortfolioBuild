...
EA_SOURCE = EA_DIR / "QM5_41177_xauxag-mwilcoxon-shift-rv.mq5"
LOGICAL_SET = (
    EA_DIR
    / "sets"
    / "QM5_41177_xauxag-mwilcoxon-shift-rv_QM5_41177_XAU_XAG_MWILCOXON_SHIFT_RV_D1_D1_backtest.set"
)
...
CANONICAL_CARD = (
    ...
    / "cards"
    / "approved"
    / "QM5_41177_xauxag-mwilcoxon-shift-rv_card.md"
)
...
class MonthlyMannWhitneyRatioReferenceTests(unittest.TestCase):
    ...
    def test_log_ratio_orientation_and_month_sequence(self) -> None:
        ...
        xag = [10.0] * 12
        self.assertEqual(
            mann_whitney_ratio_signal(log_ratios(xau, xag)).direction,
            -1,
        )
        endpoints = [
            202508,
    ...
    def test_source_manifest_sets_and_card_copy_are_locked(self) -> None:
        ...
        self.assertEqual(
            ...
            "QM5_41177_XAU_XAG_MWILCOXON_SHIFT_RV_D1",
        )
