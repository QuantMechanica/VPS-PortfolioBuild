# QM5_12911_brent-aug-prem - Strategy Spec
...
broker-calendar month is August. The position is flattened on the first
subsequent D1 bar, when the chart leaves August, or by a one-calendar-day
...
`QM5_12729_wti-aug-prem` is the same August thesis on the WTI benchmark, while
this build isolates Brent. Brent April/May/November/December/January calendar,
Brent weekday, Brent TSMOM, Brent/WTI spread, WTI event/calendar, XTI/XNG, XNG,
XAU/XAG, and commodity RSI sleeves all use different information sets, markets,
or timing. This EA is a pure Brent August calendar-premium anomaly.

## 2. Parameters

| Parameter | Default | Range | Meaning |
|---|---:|---|---|
| `strategy_entry_month` | 8 | 8 | Broker-calendar August |
...
- Regime preference: Brent August month-of-year calendar premium.
