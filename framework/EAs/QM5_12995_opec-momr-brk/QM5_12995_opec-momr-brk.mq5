...
#property description "QM5_12995 OPEC MOMR WTI breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12995 - OPEC MOMR WTI Breakout
// -----------------------------------------------------------------------------
// D1 structural WTI sleeve:
//   - fixed mid-month OPEC Monthly Oil Market Report proxy window
//   - follows ATR-sized release-window breakouts on XTIUSD.DWX
//   - ATR stop/target, max-hold exit, no external runtime data
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12995;
...
bool Strategy_LoadMomrBreakoutState(int &direction,
                                    double &atr_last,
                                    int &signal_day_key)
  {
   direction = 0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12995_XTI_OPEC_MOMR_BRK";
   ...
   if(!Strategy_LoadMomrBreakoutState(direction, atr_last, signal_day_key))
      return false;
   ...
   req.reason = (direction > 0) ? "XTI_OPEC_MOMR_BRK_LONG" : "XTI_OPEC_MOMR_BRK_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12995\",\"ea\":\"opec-momr-brk\"}");
