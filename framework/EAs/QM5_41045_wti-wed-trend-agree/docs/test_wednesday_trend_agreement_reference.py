"""Independent mechanic fixtures for QM5_41045.
...
endpoints, strict sign agreement, continuation direction, Thursday
...
def select_direction(event_return: float, slow_trend: float) -> int:
    ...
    if event_return * slow_trend <= 0:
        return 0
    return (event_return > 0) - (event_return < 0)
...
class WednesdayTrendAgreementReferenceTests(unittest.TestCase):
