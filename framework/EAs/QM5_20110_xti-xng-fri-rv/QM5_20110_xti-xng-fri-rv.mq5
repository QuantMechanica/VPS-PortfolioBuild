...
#property description "QM5_20110 XTI XNG Friday-session relative-value basket"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_20110 - XTI/XNG Friday-session relative-value basket
// -----------------------------------------------------------------------------
// At the first eligible broker-Friday D1 boundary, buy WTI and sell Natural
// Gas. Both legs target equal absolute USD notionals and share one framework
// risk budget. The complete package closes at broker Friday hour 21.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 20110;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 20110 && qm_magic_slot_offset == 0 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_FRI_ATTEMPT_DAY", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_20110_XTIXNG_FRI_RV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_20110_XTIXNG_FRI_RV_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20110\",\"ea\":\"xti-xng-fri-rv\"}");
...
void OnTick()
  {
   ...
   // Consume this broker Friday before news or order submission. A restart,
