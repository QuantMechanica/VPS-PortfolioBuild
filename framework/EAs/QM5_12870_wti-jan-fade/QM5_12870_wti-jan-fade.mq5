...
#property description "QM5_12870 WTI January Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12870 - WTI January Calendar Fade
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - short XTIUSD.DWX only during broker-calendar January D1 bars
...
input int    strategy_entry_month        = 1;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12870_WTI_JAN_FADE";
   ...
   req.reason = "WTI_JANUARY_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12870\",\"ea\":\"wti-jan-fade\"}");
