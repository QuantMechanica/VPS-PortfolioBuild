...
#property description "QM5_20008 WTI Monthly Three-Month Close Channel"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20008 - WTI Monthly Three-Month Close Channel
// -----------------------------------------------------------------------------
// Source-exact Szakmary-Shen-Sharma monthly channel carrier:
//   - latest completed WTI month-end close versus the prior three month ends
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20008_WTI_MONTH_CH3";
   ...
   req.reason = (target_state > 0) ?
      "WTI_MONTH_CH3_LONG" : "WTI_MONTH_CH3_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20008\",\"ea\":\"wti-month-ch3\"}");
