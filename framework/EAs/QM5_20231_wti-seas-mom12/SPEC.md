# QM5_20231_wti-seas-mom12 - Strategy Spec

**EA ID:** QM5_20231

**Slug:** `wti-seas-mom12`

**Source:** `BURAKOV-MOP-WTI-SEASMOM12-2026`
...
thirteen consecutive completed month-end closes and calculate the cumulative
log return from the oldest through the newest endpoint. The momentum state is
long after a strictly positive return and short after a strictly negative
return. The fixed physical-season state is long November-May and short
June-October. Open a package only when the two directions agree; exact zero,
invalid history, or disagreement remains flat for the consumed month.
...
| `strategy_lookback_months` | 12 | Exact completed-month return horizon |
...
- Formation: thirteen consecutive completed broker-month endpoints defining
  exactly twelve completed calendar months.

## 5. Expected Behaviour

Maximum cadence is twelve decisions per full post-warm-up year. The
predeclared expectation is five to eight concordant packages/year; Q02
retires below five completed packages/year. Exposure normally spans one
broker month and disagreement months remain flat. Principal risks are
interaction decay, filter-induced under-frequency, WTI gaps and rolls,
futures-to-CFD basis, financing, stop-outs, month-end history quality, and
...
`strategy-seeds/sources/BURAKOV-MOP-WTI-SEASMOM12-2026/source.md`; the
approved card is
`strategy-seeds/cards/approved/QM5_20231_wti-seas-mom12_card.md`. The sources
supply the seasonal and twelve-month return-sign parent states, not this
interaction's WTI CFD performance.
...
| v2 | 2026-08-05 | Paced baseline handoff | Q02 priority work item `aeb35f94-4dfd-4ffc-9d68-76166e601ec7` enqueued |
