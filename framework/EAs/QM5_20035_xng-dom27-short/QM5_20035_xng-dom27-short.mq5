...
#property description "QM5_20035 XNG Calendar-Day-27 One-Session Fade"
...
//   - SELL only at the opening of a broker D1 bar dated exactly the 27th
//   - never shift an absent/non-trading 27th to a neighboring session
...
input int    strategy_entry_day           = 27;
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20035_XNG_DOM27_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_PrimeLateDay27Attach()
  {
...
bool Strategy_ConsumeDay27Decision()
  {
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsXngD1())
      return true;
   if(qm_ea_id != 20035 || qm_magic_slot_offset != 0)
      return true;
   if(!qm_friday_close_enabled ||
      qm_friday_close_hour_broker != 21)
      return true;
   if(strategy_entry_day != 27)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "XNG_DOM27_ONE_SESSION_SHORT";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved DOM27 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;

   Strategy_LoadAttemptState(TimeCurrent());
   if(!Strategy_PrimeLateDay27Attach())
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20035\",\"ea\":\"xng-dom27-short\"}");
...
void OnTick()
  {
   ...
   if(!Strategy_ConsumeDay27Decision())
      return;
