# QM5_12893_xng-12m-carry - Strategy Spec
...
time-series momentum as the direction source, `QM5_12807` uses a 52-week anchor,
and the storage/weather/event sleeves use calendar or EIA event timing.
