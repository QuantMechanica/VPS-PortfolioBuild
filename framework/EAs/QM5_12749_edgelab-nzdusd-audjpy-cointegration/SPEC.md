# QM5_12749_edgelab-nzdusd-audjpy-cointegration - Strategy Spec
...
The EA trades the NZDUSD.DWX and AUDJPY.DWX D1 cointegration spread. It computes
`S = ln(NZDUSD) - beta * ln(AUDJPY)` with beta defaulting to 0.07, then
...
same script ranked NZDUSD/AUDJPY as the strongest remaining unbuilt
OOS-positive candidate after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747 baskets,
with DEV Sharpe -0.13, OOS net Sharpe 0.48, OOS return +5.35%, 21 OOS state
changes, beta 0.07, and 123-day half-life.
...
| strategy_beta | 0.07 | >0 | Hedge coefficient in `ln(NZDUSD) - beta * ln(AUDJPY)` |
...
**Designed for:**
- NZDUSD.DWX - leg 1 of the fixed NZDUSD/AUDJPY spread and the spread numerator.
- AUDJPY.DWX - leg 2 of the fixed NZDUSD/AUDJPY spread and the beta-weighted spread denominator.

**Explicitly not for:**
- Other `.DWX` symbols. This card is a fixed two-leg FX-cross basket, not a portable multi-pair strategy.

The EA selects AUDUSD.DWX and USDJPY.DWX as conversion history for the AUDJPY leg
...
|---|---:|---:|---:|---:|---:|---:|
| NZDUSD~AUDJPY | -0.13 | 0.48 | +5.35% | 21 | 0.07 | 123d |
