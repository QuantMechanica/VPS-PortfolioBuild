# QM5_10150_sma50-200 — Strategy Spec
...
`artifacts/cards_approved/QM5_10150_sma50-200.md`. See that card's body for
...
`QM5_10150_sma50-200.mq5`. Framework wiring (risk, magic, news, Friday close)
...
`artifacts/cards_approved/QM5_10150_sma50-200.md`
