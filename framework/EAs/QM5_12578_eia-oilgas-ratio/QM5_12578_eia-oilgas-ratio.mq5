...
#property description "QM5_12578 EIA Oil Gas Ratio Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12578 - EIA Oil/Gas Ratio Reversion
// -----------------------------------------------------------------------------
// D1 two-leg energy basket:
//   spread = ln(XTIUSD.DWX) - beta * ln(XNGUSD.DWX)
//   z > entry: short ratio = sell WTI, buy natural gas
//   z < -entry: long ratio = buy WTI, sell natural gas
// The EA runs from the XTIUSD.DWX host chart and trades both registered legs
// through QM_BasketOrder. Runtime uses MT5 OHLC only; no external EIA data.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12578;
...
bool Strategy_OpenPair(const int ratio_direction)
  {
   ...
   const string reason = long_ratio ? "QM5_12578_LONG_XTI_XNG_RATIO"
                                    : "QM5_12578_SHORT_XTI_XNG_RATIO";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12578_RATIO_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12578\",\"ea\":\"eia-oilgas-ratio\"}");
