...
#property description "QM5_20204 XNG One-Month Time-Series Momentum"
...
//   - sign of the just-completed calendar-month XNG log return
//   - BUY positive / SELL negative, held until the next month boundary
//   - one consumed attempt per broker month, persisted before fallible gates
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20204_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20204\",\"ea\":\"xng-tsmom1m\"}");
