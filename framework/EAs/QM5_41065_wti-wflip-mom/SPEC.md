...
| v1-q02-capacity | 2026-08-20 | paced Q02 handoff | target-only dry run selected one fresh row; apply withheld at eight active governed terminals and 99.58% average host CPU; no Q02 row exists |
