...
type: strategy
strategy_id: MOP-WTI-WFLIP-MOM-2026_S01
variant_id: MOP-WTI-WFLIP-MOM-2026_S01
source_id: MOP-WTI-WFLIP-MOM-2026
ea_id: QM5_41065
slug: wti-wflip-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41065_wti-wflip-mom_card.md
execution_contract_status: APPROVED
created: 2026-08-20
created_by: Research+Development
last_updated: 2026-08-20
g0_status: APPROVED
g0_decision: decisions/2026-08-20_qm5_41065_wti_week_flip_momentum_g0.md
source_approval: decisions/2026-08-20_wti_week_flip_momentum_source_approval.md
...
source_citations:
  - type: academic_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; Sections 3.1-3.2; Appendix A; complete-read packet strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded translation strategy-seeds/sources/MOP-WTI-WFLIP-MOM-2026/source.md"
    quality_tier: A
    role: own_return_sign_continuation_and_wti_carrier_lineage
strategy_mechanic: normalized-week-boundary-wti-two-adjacent-nonoverlapping-week-return-sign-change-newest-sign-continuation-one-week-hold
sources:
  - "[[sources/MOP-WTI-WFLIP-MOM-2026]]"
concepts:
...
strategy_type_flags: [commodity, energy, wti-crude, time-series-momentum, weekly-sign-transition, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
period: D1
timeframe: D1
expected_trade_frequency: "Approximately 18-30 completed WTI positions per full post-warm-up year after strict adjacent-week sign changes and execution gates; Q02 must prove at least five/year or retire."
...
q01_build_report: D:/QM/reports/framework/21/build_check_20260820_093441.json
q01_p1_evidence: D:/QM/reports/pipeline/QM5_41065/P1/P1_QM5_41065_result.json
review_focus: "Falsify a direct-WTI weekly transition sleeve outside the certified XAU/SP500/NDX/XNG book. Verify uniform energy labels, exact Monday anchors, three completed week-end closes, two disjoint weekly returns, strict sign handoff, newest-sign direction, one attempt, and next-week exit. Q09 alone may establish realized decorrelation."
...
# QM5_41065 WTI Fresh Weekly Return-Sign Handoff Momentum

## Hypothesis

A fresh reversal in the sign of WTI's completed weekly return may identify a
...
`strategy-seeds/sources/MOP-WTI-WFLIP-MOM-2026/source.md`, approved before
card extraction in
`decisions/2026-08-20_wti_week_flip_momentum_source_approval.md` at commit
`e37db06b8`.
...
test weekly WTI, an adjacent-week sign transition, continuous-CFD week-end
...
- `QM5_41064_wti-mflip-mom` uses completed calendar months and owns the next
  month; this card uses exact Monday anchors and owns one broker week.
- `QM5_41020_wti-wclose-mom` follows a prior Tuesday-through-Friday closing
  segment and exits Wednesday; this card uses two full adjacent weeks and a
  strict sign transition.
- `QM5_41022_wti-wdual-mom` requires agreement between opening and closing
  segments inside one week; this card has no intraday/open decomposition and
  requires opposition between separate weekly totals.
- `QM5_41032_wti-flow-div` opposes prior-week overnight and session-flow sums;
  this card uses only total close-to-close weekly returns.
- `QM5_41051_wti-fri-weekfade` is a current-week pullback followed by a
  Friday-only long; this card is symmetric and decides at the next week.
- `QM5_12567_cum-rsi2-commodity` is a two-day multi-commodity cumulative-RSI2
  pullback, not weekly WTI return-sign continuation.
...
- Timeframe: exact D1; magic slot 0; magic `410650000`.
...
1. Evaluate only once on a new exact `XTIUSD.DWX` D1 bar under EA 41065 and
   magic slot zero.
...
- Exact host, D1, EA 41065, slot zero, and registered magic.
...
- Own at most one `XTIUSD.DWX` position under magic `410650000`.
...
membership. They do not supply the weekly horizon, adjacent-week sign-change
condition, or CFD execution choices.

## QM Interpretations

`MOP-WTI-WFLIP-MOM-2026_S01` fixes the weekly horizon, strict fresh sign-
...
- Major risks are WTI reversal after a weekly sign handoff, weekend gaps,
...
|---|---|---|---|---|
| v1 | 2026-08-20 | initial WTI adjacent-week sign-handoff card | G0 | APPROVED |
...
| v1-q02-capacity | 2026-08-20 | target-only dry run selected one fresh row; apply withheld at eight active governed terminals and 99.58% average host CPU | Q02 | NOT_ENQUEUED_CPU_CEILING |

## Pipeline Phase Status

| Phase | Date | Status | Evidence |
|---|---|---|---|
| G0 Research Intake | 2026-08-20 | APPROVED | `decisions/2026-08-20_qm5_41065_wti_week_flip_momentum_g0.md` |
| Q01 Build Validation | 2026-08-20 | PASS | `D:/QM/reports/framework/21/build_check_20260820_093441.json`; `D:/QM/reports/pipeline/QM5_41065/P1/P1_QM5_41065_result.json` |
| Q02 Baseline Screening | 2026-08-20 | NOT_ENQUEUED_CPU_CEILING | `docs/ops/evidence/2026-08-20_qm5_41065_wti_week_sign_handoff_q01_q02_cpu_ceiling_stop.md` |
