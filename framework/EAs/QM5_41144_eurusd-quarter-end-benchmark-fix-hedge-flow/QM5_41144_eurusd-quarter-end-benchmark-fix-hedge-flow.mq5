...
#property description "QM5_41144 EURUSD quarter-end benchmark-fix hedge flow"

#include <QM/QM_Common.mqh>
#include <QM/QM_LondonCalendars.mqh>

// Mechanical scope from the APPROVED card: on the last London business day of
// each calendar quarter, use the sign of completed GDAXI.DWX month-to-date
// return at 14:00 London to hold EURUSD.DWX into (but never beyond) the 16:00
// London fix.

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 41144;
...
string Strategy_ConsumedGlobalName()
  {
   return StringFormat("QM5_41144_QUARTEREND_FIX_%d", QM_FrameworkMagic());
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41144_eurusd-quarter-end-benchmark-fix-hedge-flow\"}");
