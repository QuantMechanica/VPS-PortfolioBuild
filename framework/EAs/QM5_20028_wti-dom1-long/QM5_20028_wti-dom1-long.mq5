...
#property description "QM5_20028 WTI Calendar-Day-1 One-Session Long"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20028 - WTI Calendar-Day-1 One-Session Long
// -----------------------------------------------------------------------------
// Borowski (2016) crude-oil day-of-month carrier:
//   - BUY only at the opening of a broker D1 bar dated exactly the 1st
//   - never shift an absent/non-trading 1st to a neighboring session
...
input int    strategy_entry_day           = 1;
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20028_WTI_DOM1_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_PrimeLateDay1Attach()
  {
...
bool Strategy_ConsumeDay1Decision()
  {
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsWtiD1())
      return true;
   if(qm_ea_id != 20028 || qm_magic_slot_offset != 0)
      return true;
   if(!qm_friday_close_enabled ||
      qm_friday_close_hour_broker != 21)
      return true;
   if(strategy_entry_day != 1)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "WTI_DOM1_ONE_SESSION_LONG";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved WTI DOM1 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;

   Strategy_LoadAttemptState(TimeCurrent());
   if(!Strategy_PrimeLateDay1Attach())
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20028\",\"ea\":\"wti-dom1-long\"}");
...
void OnTick()
  {
   ...
   if(!Strategy_ConsumeDay1Decision())
      return;
