...
#property description "QM5_41198 Collins 9-Day 66 Percent Momentum - WTI"
...
// =============================================================================
// QM5_41198 - Collins 9-Day 66 Percent Momentum - WTI
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsXtiD1())
      return true;
   if(qm_ea_id != 41198 || qm_magic_slot_offset != 0)
      return true;
   if(strategy_lookback_d1 < 2 || strategy_lookback_d1 > 64)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41198_COLLINS_66MOM";
