"""Deterministic reference checks for QM5_41442 WTI winter WR2/CLV reversion."""
...
class WtiWinterWR2CLVFadeReferenceTest(unittest.TestCase):
    ...
    def test_expansion_lower_quartile_is_long(self) -> None:
