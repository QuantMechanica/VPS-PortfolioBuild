# QM5_41442_wti-winter-wr2-clv-fade - Strategy Spec

**EA ID:** QM5_41442  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-CLV-FADE-20260911_S01`
...
strictly wider. Buy only after a strict lower-quartile final close (`CLV<0.25`) and sell only
after a strict upper-quartile final close (`CLV>0.75`). Equality, the middle half, and weekly body
direction are flat. Consume the decision week before fallible gates and never retry.
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414420000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-CLV-FADE-20260911/source.md`. It
combines peer-reviewed WTI November-May seasonality, governed reputable Crabel range-state
lineage, and academic commodity-reversal lineage. The exact weekly rule is an untested QM
translation.

The rule differs from `QM5_12567` (two-day XNG oscillator pullback), `QM5_41403/41408` (weekly
return-sign fades), `QM5_41440` (upper-quartile WTI winter continuation), `QM5_41435` (WTI
August-October upper-quartile short fade), and `QM5_41438` (XNG winter outer-quartile momentum).
...
| entry | November-May calendar, two completed weeks, strict range/CLV, symmetric fade, attempt, spread, ATR stop |
