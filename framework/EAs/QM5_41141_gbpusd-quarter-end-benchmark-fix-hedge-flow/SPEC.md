# QM5_41141_gbpusd-quarter-end-benchmark-fix-hedge-flow — Strategy Spec

**EA ID:** QM5_41141
**Slug:** gbpusd-quarter-end-benchmark-fix-hedge-flow
...
On the last Europe/London business day of March, June, September, or December,
the EA takes one decision
...
- GBPUSD.DWX — the only execution carrier, registered in slot 0 with magic 411410000.
...
| Metric | Expected |
|---|---|
| Eligible dates / year / symbol | approximately 4 before no-trade filters |
| Card frontmatter frequency | expected_trades_per_year_per_symbol: 100, inconsistent with the once-per-quarter mechanics; Q02 measures the literal mechanics |
| Typical hold time | zero to two hours, always flat at the 16:00 London fix |
| Regime preference | quarter-end benchmark hedge flows following positive or negative UK-equity month-to-date returns |
| Drawdown profile | sparse event-window losses, including gap/slippage risk around quarter-end macro releases |
...
**Card pointer:** D:/QM/strategy_farm/artifacts/cards_approved/QM5_41141_gbpusd-quarter-end-benchmark-fix-hedge-flow.md
...
|---|---|---|---|
| v1 | 2026-09-10 | Initial build from approved card | build task 1bdda554-eca7-4b6c-8bf7-7c64177fde09; compile work item 92314586-2b57-4b67-a7d2-e29404f9e175 |
