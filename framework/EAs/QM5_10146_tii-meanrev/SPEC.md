...
`artifacts/cards_approved/QM5_10146_tii-meanrev.md`. See that card's body for
...
`QM5_10146_tii-meanrev.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_enter_long` | 20.0 | (see source) | (see strategy logic) |
| `strategy_enter_short` | 80.0 | (see source) | (see strategy logic) |
| `strategy_exit_centerline` | 50.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10146_tii-meanrev.md`
