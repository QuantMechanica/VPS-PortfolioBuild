...
#property description "QM5_12606 Oil Silver Ratio Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12606 - Oil/Silver Ratio Reversion
// -----------------------------------------------------------------------------
...
bool Strategy_OpenPair(const int ratio_direction)
  {
   ...
   const string reason = long_ratio ? "QM5_12606_LONG_XTI_XAG_RATIO"
                                    : "QM5_12606_SHORT_XTI_XAG_RATIO";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12606_RATIO_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12606\",\"ea\":\"oil-silver-ratio\"}");
