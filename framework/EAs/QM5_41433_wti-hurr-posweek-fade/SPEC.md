# QM5_41433_wti-hurr-posweek-fade - Strategy Spec

**EA ID:** QM5_41433

**Slug:** `wti-hurr-posweek-fade`

**Strategy ID:** `EIA-YANG-WTI-HURR-POSWEEK-FADE-20260911_S01`

**Source:** `EIA-YANG-WTI-HURR-POSWEEK-FADE-20260911`
...
`ln(final_close / first_open)` and sell only when it is strictly positive.
...
`414330000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
week. Only August-October anchors may qualify. Validate
...
It joins official EIA hurricane-season petroleum-supply risk context with the
completely read Yang-Goncu-Pantelous commodity-reversal record. The exact short-only
...
| entry | hurricane calendar, one completed-week package, strict positive sign, short-only side, durable attempt, spread and frozen ATR stop |
...
| v1-q01 | 2026-09-11 | Governed compile and strict build check PASS (`65fa5ff5-a729-467d-842e-1d654fb5dc43`) | OWNER pacer mission |
| v1-q02 | 2026-09-11 | One fixed-risk Q02 canary enqueued (`06341514-697d-44c5-b675-734ef0c355dc`) after CPU maximum 95.2% | OWNER pacer mission |
