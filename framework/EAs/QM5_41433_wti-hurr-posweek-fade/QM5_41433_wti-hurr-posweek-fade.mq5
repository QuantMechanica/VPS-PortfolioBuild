...
#property description "QM5_41433 WTI Hurricane-Season Positive-Week Reversion"
...
//   - sell only after a strictly positive weekly open-to-close return
...
bool Strategy_LoadPositiveWeekSignal(const int current_week_key,
                                     ...
                                     int &direction)
  {
   ...
   // completed week may revert short; nonpositive returns consume flat.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41433_WTI_HURR_POSWEEK_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_HURR_POSWEEK_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41433 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41433_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41433\",\"ea\":\"wti-hurr-posweek-fade\"}");
