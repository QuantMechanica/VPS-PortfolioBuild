...
#property description "QM5_20050 XAU XAG 12-Month Cross-Sectional Momentum"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_20050 - XAU/XAG 12-Month Cross-Sectional Momentum
// -----------------------------------------------------------------------------
// Monthly market-neutral energy basket:
//   - reconstruct 13 completed broker month-end closes from native D1 history
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xti_short_xng ? "QM5_20050_LONG_XAU_SHORT_XAG_HIGH_12M_RETURN"
                                            : "QM5_20050_SHORT_XAU_LONG_XAG_HIGH_12M_RETURN";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20050_XAU_XAG_XMOM12_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20050\",\"ea\":\"xauxag-xmom12\"}");
