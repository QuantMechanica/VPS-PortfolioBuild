...
#property description "QM5_41360 XTI/XNG Weekly Partial-Retracement Continuation"
...
// have strict opposite signs and the newest absolute move is strictly smaller,
// follow that partial retracement with an equal-notional opposite-leg package.
// Consume one attempt per week and flatten at the next week boundary.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41360;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41360 && qm_magic_slot_offset == 0 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_WRETR_ATTEMPT_WEEK", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41360_XTIXNG_WRETR_RV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41360_XTIXNG_WRETR_RV_HOST";
   ...
   if(Strategy_OpenOwnedPositionCount() > 0 ||
   ...
   else
     {
      ...
      if(!signal_valid)
         ...
         g_signal_state = "positive_impulse_negative_retracement_short_xti";
      else if(direction > 0)
         g_signal_state = "negative_impulse_positive_retracement_long_xti";
         ...
         g_signal_state = "no_strict_newest_smaller_flat";
     }
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XTI/XNG weekly partial-retracement continuation exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41360\",\"ea\":\"xtixng-wretr-rv\"}");
