...
#property description "QM5_41422 WTI Refinery-Restart Positive-Week Continuation"
...
bool Strategy_LoadPositiveWeekSignal(const int current_week_key,
                                     ...
                                     int &direction)
  {
   ...
   // The refinery-restart sleeve is deliberately asymmetric: a strictly positive
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41422_WTI_REFRESTART_POSWEEK_CONT";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_REFRESTART_POSWEEK_CONT_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41422 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41422_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41422\",\"ea\":\"wti-refrestart-posweek-cont\"}");
