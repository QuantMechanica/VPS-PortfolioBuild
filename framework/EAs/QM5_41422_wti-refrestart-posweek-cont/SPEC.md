# QM5_41422_wti-refrestart-posweek-cont - Strategy Spec
...
**Source:** `EIA-MOP-WTI-REFRESTART-POSWEEK-CONT-20260910`
...
`414220000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
| entry | restart calendar, one completed-week package, strict positive sign, long-only side, durable attempt, spread and frozen ATR stop |
