...
**Strategy:** `AI-CODEX-XAUXAG-MWINSOR2-RV-20260905_S01`

**Carrier:** logical basket `QM5_41356_XAU_XAG_MWINSOR2_RV_D1`, hosted on
`XAUUSD.DWX` D1; slot 0 magic `413560000`, slot 1 magic `413560001`
...
- positive Winsorized mean: sell XAU, buy XAG;
- negative Winsorized mean: buy XAU, sell XAG;
...
Approved composite `AI-CODEX-XAUXAG-MWINSOR2-RV-20260905`, grounded in
...
`docs/test_xauxag_mwinsor2_rv_reference.py` independently pins sorting, capped
