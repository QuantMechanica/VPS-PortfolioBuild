...
`artifacts/cards_approved/QM5_10240_tv-vwap-orb-pull.md`. See that card's body for
...
`QM5_10240_tv-vwap-orb-pull.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_or_start_hhmm_ny` | 930 | (see source) | (see strategy logic) |
| `strategy_or_minutes` | 15 | (see source) | (see strategy logic) |
| `strategy_session_end_hhmm_ny` | 1600 | (see source) | (see strategy logic) |
| `strategy_ema_period` | 9 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_take_profit_rr` | 1.5 | (see source) | (see strategy logic) |
| `strategy_vwap_pullback_atr_tolerance` | 0.25 | (see source) | (see strategy logic) |
| `strategy_max_spread_points` | 120 | (see source) | (see strategy logic) |
| `strategy_one_trade_per_day` | false | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10240_tv-vwap-orb-pull.md`
