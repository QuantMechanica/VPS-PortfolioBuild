...
#property description "QM5_41446 WTI Winter NR2 Body Reversion"
...
//   - fade a contracting newest week's own open-to-close body direction
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "nr2_negative_body_reversion_long";
      else if(g_signal_direction < 0)
         g_signal_state = "nr2_positive_body_reversion_short";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41446_WTI_WINTER_NR2_BODY_FADE";
   ...
   req.reason = (g_signal_direction > 0
                 ? "WTI_WINTER_NR2_BODY_FADE_LONG"
                 : "WTI_WINTER_NR2_BODY_FADE_SHORT");
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41446 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41446_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41446\",\"ea\":\"wti-winter-nr2-body-fade\"}");
