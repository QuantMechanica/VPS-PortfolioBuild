...
#property description "QM5_41154 EURJPY Carry-Unwind Crisis Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41154 - EURJPY Carry-Unwind Crisis Momentum
// -----------------------------------------------------------------------------
// On each completed EURJPY D1 bar, require synchronized five-session weakness
...
// EURJPY position with a frozen completed-bar ATR stop. Auxiliary symbols are
// signal inputs only and are never execution targets.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41154;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41154 && qm_magic_slot_offset == 0 &&
...
int OnInit()
  {
   if(_Symbol != "EURJPY.DWX" || _Period != PERIOD_D1 ||
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41154\",\"ea\":\"eurjpy-carry-unwind-crisis-momentum\",\"execution_symbol\":\"EURJPY.DWX\"}");
