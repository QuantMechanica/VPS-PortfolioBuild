...
#property description "QM5_20298 WTI Self-Relative Realized-VoV Regime"
...
// commodity premium, use monthly sorts, and include WTI. Darwinex exposes no
// commodity option chain, so the nested realized-VoV and self-relative WTI
// comparison below are locked QM translations, not source-tested WTI rules.
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20298 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20298_WTI_VOV_REGIME";
   ...
   req.reason = (g_cache_signal > 0) ? "VOV_REGIME_XTI_LONG" : "VOV_REGIME_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20298_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20298\",\"ea\":\"wti-vov-regime\",\"stat\":\"two_disjoint_252x20d_realized_vov_blocks\"}");
