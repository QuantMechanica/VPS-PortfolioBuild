...
`artifacts/cards_approved/QM5_10258_tv-rsi-macd-mtf.md`. See that card's body for
...
`QM5_10258_tv-rsi-macd-mtf.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_execution_tf` | PERIOD_H4 | (see source) | (see strategy logic) |
| `strategy_rsi_tf` | PERIOD_D1 | (see source) | (see strategy logic) |
...
| `strategy_max_hold_h4_bars` | 60 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10258_tv-rsi-macd-mtf.md`
