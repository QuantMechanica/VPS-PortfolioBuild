# QM5_10141_rsi-meanrev — Strategy Spec
...
`artifacts/cards_approved/QM5_10141_rsi-meanrev.md`. See that card's body for
...
`QM5_10141_rsi-meanrev.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_long_level` | 30.0 | (see source) | (see strategy logic) |
| `strategy_short_level` | 70.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10141_rsi-meanrev.md`
