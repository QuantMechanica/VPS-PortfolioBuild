"""Reference checks for QM5_41361 XTI/XNG weekly common-shock reversion."""
...
MQ5 = EA_DIR / "QM5_41361_xtixng-commonshock-rv.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41361_xtixng-commonshock-rv_QM5_41361_XTI_XNG_COMMONSHOCK_RV_D1_D1_backtest.set"
)
...
def weekly_common_shock_signal(
    ...
    if (same_positive or same_negative) and relative_return > epsilon:
        ...
        direction = 1  # XNG outperformed: buy XTI, sell XNG.
...
class WeeklyCommonShockReferenceTest(unittest.TestCase):
    def test_positive_common_shock_wti_outperformance_is_faded(self) -> None:
    ...
    def test_positive_common_shock_xng_outperformance_is_faded(self) -> None:
    ...
    def test_static_artifacts_lock_identity_and_safety(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41361", source)
        ...
        self.assertRegex(resolver, re.compile(r"413610000.*413610001", re.DOTALL))
