# QM5_12955_mql5-aroon-cross-card — Strategy Spec

**EA ID:** QM5_12955
**Slug:** `mql5-aroon-cross-card`
...
`artifacts/cards_approved/QM5_12955_mql5-aroon-cross-card.md`. See that card's body for
...
`QM5_12955_mql5-aroon-cross-card.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_aroon_period` | 25 | (see source) | (see strategy logic) |
| `strategy_tp_points` | 600 | (see source) | (see strategy logic) |
| `strategy_sl_points` | 200 | (see source) | (see strategy logic) |
...
| Cadence note | "Medium frequency; Aroon(25) up/down cross on H1 should trigger roughly 45-110 trades per year per symbol." |
...
`artifacts/cards_approved/QM5_12955_mql5-aroon-cross-card.md`
