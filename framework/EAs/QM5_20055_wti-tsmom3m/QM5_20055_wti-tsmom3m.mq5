...
#property description "QM5_20055 WTI 3M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20055 - WTI 3-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20055_WTI_TSMOM3M";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20055\",\"ea\":\"wti-tsmom3m\"}");
