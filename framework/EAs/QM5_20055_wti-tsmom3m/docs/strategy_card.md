---
strategy_id: MOP-TSMOM-2012_XTI_S03
...
pipeline_phase: Q02
review_focus: "Adds a medium-horizon WTI trend carrier to the XAU/SP500/NDX/XNG book; falsify costs, CFD/futures basis, trend whipsaw, and later book correlation."
g0_approval_reasoning: "APPROVED under the 2026-07-23 OWNER commodity-sleeve mission: peer-reviewed JFE commodity-futures lineage; deterministic monthly three-month return sign; registered XTI D1 carrier and twelve packages/year; no ML, banned indicator, external feed, grid, or martingale."
---

# WTI Three-Month Time-Series Momentum
...
tests the sign of WTI's completed three-month return as a monthly directional
...
No existing EA uses the completed three-month WTI return as its sole signal.
...
Donchian, RSI, and XTI/XNG relative-value builds have different triggers. This
card is therefore a distinct medium-horizon WTI state, not a parameter sweep of
...
|---|---|---|---|---|
| v1 | 2026-07-23 | initial source-backed three-month WTI trend build | Q02 | pending |
...
| Q01 Build Validation | 2026-07-23 | PASS: strict compile 0 errors/0 warnings | `docs/ops/evidence/2026-07-23_qm5_20055_wti_tsmom3m_q02_enqueue.md` |
