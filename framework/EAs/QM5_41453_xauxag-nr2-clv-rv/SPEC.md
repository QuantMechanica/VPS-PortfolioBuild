# QM5_41453_xauxag-nr2-clv-rv — Strategy Spec

- EA ID: QM5_41453
- Slug: `xauxag-nr2-clv-rv`
- Strategy ID: `SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912_S01`
- Source: `SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912`
- Author: Codex
...
be strictly narrower than the prior range. Fade only a newest ratio close strictly above 0.75 or
below 0.25 of its own weekly range, then hold the opposed equal-notional package for one week.
Invalid, tied, expanding, interior, or late states consume flat. Containment is not required.
...
- Logical symbol: `QM5_41453_XAU_XAG_NR2_CLV_RV_D1`.
...
`10.1016/j.jbankfin.2017.11.010`) supplies peer-reviewed gold/silver relation evidence; CME
supplies the ratio-spread carrier; governed Crabel records supply range-state and completed-week
lineage. The exact NR2/CLV ratio reversion is an untested QM translation. It differs from
WR2/CLV fade, NR2/CLV continuation, NR2/body fade, seven-week breakout, and 120-day channel
systems.
...
| v1-q01 | 2026-09-12 | governed T3 compile and strict build check PASS; 6 reference tests and PACER audit PASS; Q02 stopped at CPU ceiling |
