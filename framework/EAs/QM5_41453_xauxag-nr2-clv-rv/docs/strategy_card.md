...
type: strategy
strategy_id: SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912_S01
variant_id: SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912_S01
source_id: SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912
ea_id: QM5_41453
slug: xauxag-nr2-clv-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41453_xauxag-nr2-clv-rv.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41453_xauxag_nr2_clv_reversion_g0.md
source_approval: decisions/2026-09-12_xauxag_nr2_clv_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_exchange_and_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912/source.md
    quality_tier: A_and_B_lineages_with_cross_source_and_weekly_translation_risk
    role: gold_silver_relative_carrier_weekly_range_contraction_and_reversion_lineage
strategy_mechanic: normalized-week-boundary-xau-xag-two-synchronized-completed-weeks-newest-strict-narrower-log-ratio-close-range-strict-outer-quartile-final-ratio-close-contrarian-equal-notional-one-week-basket
sources: ["[[sources/SCHWEIKERT-CRABEL-CME-XAUXAG-NR2-CLV-RV-20260912]]"]
...
strategy_type_flags: [commodity, precious-metals, gold-silver-relative-value, market-neutral-basket, weekly-range-contraction, close-location, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41453_XAU_XAG_NR2_CLV_RV_D1
symbol: QM5_41453_XAU_XAG_NR2_CLV_RV_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [414530000, 414530001]
period: D1
timeframe: D1
...
hard_rules_at_risk: [input_bound_xau_xag_carrier, immediately_preceding_two_monday_anchors, synchronized_completed_d1_closes, bounded_week_session_counts, positive_ratio_close_ranges, strict_newest_range_contraction, strict_outer_quartile_ratio_close, contrarian_package_direction, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed, exchange, and governed lineage with explicit translation risk; R2 exact locked NR2/CLV reversion basket; R3 registered XAU/XAG D1; R4 deterministic non-ML; canonical exact dedup clear and fuzzy family matches manually separated."
---
...
to the next and the newest week still settles in an outer quartile, the relative settlement extreme may revert
over the following week. Fade the settlement extreme through an opposed XAU/XAG package. Equal
...
Schweikert and CME supply structural gold/silver relative-value lineage; the governed Crabel
record supplies range-state and completed-week construction lineage. None validates this weekly
ratio-range contraction and outer-quartile reversion.

The canonical scan found no exact identity and raised expected coarse family matches. `QM5_41448`
fades the same ratio CLV after WR2 expansion; `QM5_41450` fades NR2 ratio body sign; `QM5_41451`
continues the same NR2/CLV event; `QM5_41452` continues WR2/CLV; `QM5_41060` uses seven weekly
ranges and a later breakout; and `QM5_12724` uses a 120-day ratio channel and channel exit. The
paired carrier, two synchronized weeks, strict NR2 state, ratio CLV threshold, contrarian side,
immediate entry, and one-week hold are jointly load-bearing.
...
1. Run only from the setfile-bound `XAUUSD.DWX` D1 host with input-bound `XAGUSD.DWX` companion,
   EA 41453, slots zero/one, registered magics, and fixed-risk backtest mode.
...
boundaries, both contrarian packages, interior flat state, durable attempt, aggregate fixed-
