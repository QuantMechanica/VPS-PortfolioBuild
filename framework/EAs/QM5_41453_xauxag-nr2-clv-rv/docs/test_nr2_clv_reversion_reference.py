"""Deterministic reference checks for QM5_41453 XAU/XAG weekly NR2 CLV reversion."""
...
MQ5 = EA_DIR / "QM5_41453_xauxag-nr2-clv-rv.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41453_xauxag-nr2-clv-rv_QM5_41453_XAU_XAG_NR2_CLV_RV_D1_D1_backtest.set"
)
...
class Nr2ClvReversionReferenceTest(unittest.TestCase):
    ...
    def test_static_artifacts_lock_signal_risk_and_unpinned_framework(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41453", source)
        ...
        self.assertRegex(resolver, re.compile(r"414530000.*414530001", re.DOTALL))
