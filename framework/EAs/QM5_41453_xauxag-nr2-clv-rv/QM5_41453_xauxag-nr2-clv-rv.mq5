...
#property description "QM5_41453 XAU/XAG Weekly NR2 CLV Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_41453 - XAU/XAG Weekly NR2 CLV Reversion
// -----------------------------------------------------------------------------
...
// than the prior range and its final close is in a strict outer quartile. Fade that
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41453 && qm_magic_slot_offset == 0 &&
            g_leg_xau != "" && g_leg_xag != "" &&
            g_leg_xau != g_leg_xag &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_NR2_CLV_RV_ATTEMPT_WEEK", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41453_XAUXAG_NR2_CLV_RV";
...
bool Strategy_LoadNr2Clv(const int current_week,
                         int &direction)
  {
   ...
   if(g_newest_week_clv > strategy_clv_upper)
      direction = -1; // High ratio settlement: sell XAU, buy XAG.
   else if(g_newest_week_clv < strategy_clv_lower)
      direction = 1;  // Low ratio settlement: buy XAU, sell XAG.
   return true;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41453_XAUXAG_NR2_CLV_RV_HOST";
   ...
   if(Strategy_OpenOwnedPositionCount() > 0 ||
   ...
   else
     {
      ...
      if(!signal_valid)
         ...
         g_signal_state = "low_ratio_settlement_faded";
      else if(direction < 0)
         g_signal_state = "high_ratio_settlement_faded";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG weekly ratio range-contraction CLV reversion package exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41453\",\"ea\":\"xauxag-nr2-clv-rv\"}");
