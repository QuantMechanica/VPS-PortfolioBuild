...
#property description "QM5_11553 carter-t-m5-cci14-macd1269 — CCI(14) +/-100 breakout + MACD histogram (M5)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11553 carter-t-m5-cci14-macd1269
// -----------------------------------------------------------------------------
// Source: Thomas Carter, "20 Forex Trading Strategies (5 Minute Time Frame)",
//   System #13, self-published 2014.
// Card: artifacts/cards_approved/QM5_11553_carter-t-m5-cci14-macd1269.md
//       (g0_status APPROVED).
//
// Mechanics (M5, closed-bar reads at shift 1/2):
//   Trigger EVENT : CCI(14) crosses +/-100 in the trend direction.
//                   LONG  -> cci@1 >= +100 AND cci@2 < +100 (fresh upward cross).
...
//   (fast=12, slow=26, signal=9). The slug token "macd1269" is a compressed
//   label; the mechanical body (12,26,9) is authoritative. Flagged in build JSON.
//
// Only the 5 Strategy_* hooks + Strategy inputs are EA-specific.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 11553;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // No new entries on Friday (broker time) per the card filter.
