...
input int    strategy_spread_cap_pips    = 20;     // card: fixed 20 pip spread cap
...
void OnTick()
  {
   ...
   // Per-closed-bar: entry-signal evaluation. FW1 two-axis check gates NEW
   // entries only — never the management/exit paths above.
