...
#property description "QM5_12982 Brent September Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12982 - Brent September Calendar Premium
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - long XBRUSD.DWX only during broker-calendar September D1 bars
...
input int    strategy_entry_month        = 9;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12982_BRENT_SEP_PREM";
   ...
   req.reason = "BRENT_SEPTEMBER_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12982\",\"ea\":\"brent-sep-prem\"}");
