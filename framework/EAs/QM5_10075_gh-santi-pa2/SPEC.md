...
`artifacts/cards_approved/QM5_10075_gh-santi-pa2.md`. See that card's body for
...
`QM5_10075_gh-santi-pa2.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_max_hold_bars` | 10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10075_gh-santi-pa2.md`
