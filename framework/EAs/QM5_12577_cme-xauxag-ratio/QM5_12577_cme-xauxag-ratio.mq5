...
#property description "QM5_12577 CME XAU XAG Ratio Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12577 - CME XAU/XAG Ratio Reversion
// -----------------------------------------------------------------------------
// D1 two-leg precious-metals basket:
//   spread = ln(XAUUSD.DWX) - beta * ln(XAGUSD.DWX)
//   z > entry: short ratio = sell XAU, buy XAG
//   z < -entry: long ratio = buy XAU, sell XAG
...
bool Strategy_OpenPair(const int ratio_direction)
  {
   ...
   const QM_OrderType xau_type = long_ratio ? QM_BUY : QM_SELL;
   const QM_OrderType xag_type = long_ratio ? QM_SELL : QM_BUY;
   const string reason = long_ratio ? "QM5_12577_LONG_XAU_XAG_RATIO"
                                    : "QM5_12577_SHORT_XAU_XAG_RATIO";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12577_RATIO_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12577\",\"ea\":\"cme-xauxag-ratio\"}");
