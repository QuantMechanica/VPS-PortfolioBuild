...
#property description "QM5_41345 XAUUSD Weekly Time-Series Momentum (Short-Horizon Price Proxy)"
...
// =============================================================================
// QM5_41345 - XAUUSD Weekly Time-Series Momentum (Short-Horizon Price Proxy)
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41345_XAU_WEEKLY_TSMOM";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_41345_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41345\",\"ea\":\"xau-weekly-tsmom-opt\",\"signal\":\"weekly_return_sign_tsmom\"}");
   g_pp_active = false;
