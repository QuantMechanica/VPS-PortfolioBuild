"""Deterministic reference checks for QM5_41403 WTI winter two-week fade."""
...
class WtiWinterTwoWeekFadeReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_ineligible_week_refuses_before_signal(self) -> None:
        with self.assertRaisesRegex(ValueError, "ineligible month"):
            fade_signal(date(2026, 7, 6), self.bars(3, 4, 2, 3))
