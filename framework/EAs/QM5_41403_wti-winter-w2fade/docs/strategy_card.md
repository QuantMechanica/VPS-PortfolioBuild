...
type: strategy
strategy_id: BURAKOV-YANG-WTI-WINTER-W2FADE-20260909_S01
variant_id: BURAKOV-YANG-WTI-WINTER-W2FADE-20260909_S01
source_id: BURAKOV-YANG-WTI-WINTER-W2FADE-20260909
ea_id: QM5_41403
slug: wti-winter-w2fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41403_wti-winter-w2fade_card.md
execution_contract_status: APPROVED
created: 2026-09-09
created_by: Research+Development
last_updated: 2026-09-09
g0_status: APPROVED
g0_decision: decisions/2026-09-09_qm5_41403_wti_winter_two_week_fade_g0.md
source_approval: decisions/2026-09-09_wti_winter_two_week_fade_source_approval.md
...
source_citations:
  - type: peer_reviewed_and_academic_bounded_mechanization
    citation: "WTI November-May seasonality plus commodity fixed-horizon reversal lineage; QuantMechanica governed weekly interaction."
    location: strategy-seeds/sources/BURAKOV-YANG-WTI-WINTER-W2FADE-20260909/source.md
    quality_tier: B_lineages_with_horizon_and_interaction_translation_risk
    role: winter_regime_and_contrarian_direction_lineage
strategy_mechanic: normalized-weekly-wti-two-adjacent-completed-week-open-to-close-log-returns-strict-same-sign-contrarian-only-november-december-january-february-march-april-may-one-week-hold
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-regime, two-week-exhaustion, weekly-reversal, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; normalized Monday week anchor; eligible months 11,12,1,2,3,4,5; two immediately completed adjacent weeks; 3-5 sessions each; ln(final close/first open); strict same-sign agreement; exact-zero epsilon; contrarian side; 24 D1 history bars; 180-minute entry grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
force_build: true
review_focus: "Falsify a WTI winter two-week exhaustion fade distinct from the incumbent RSI pullback, monthly winter reversal, split-week continuation, and XNG weekly relatives. Verify anchor-month eligibility, exact adjacent completed-week membership, strict agreement, inverse orientation, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_completed_week_membership, strict_same_sign_agreement, contrarian_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 peer-reviewed WTI seasonality plus academic commodity-reversal context with disclosed horizon/interaction translation risk; R2 exact mechanical winter two-week fade; R3 registered XTIUSD.DWX D1; R4 deterministic non-ML; expected fuzzy neighbors manually resolved."
---
...
WTI has a documented November-through-May seasonal regime. Two consecutive
same-direction completed weeks inside that regime may represent a short-lived
price extension that partially reverses during the following week. This is an
untested price-only interaction, not a source-authored rule, profitability
claim, or decorrelation claim.
...
paper and an academic commodity-reversal paper. Neither parent tests this
exact weekly conjunction.

The canonical screen found no exact identity and the expected XNG fuzzy
relatives while reporting the Strategy Wiki root unavailable. `QM5_41402`
uses XNG, follows rather than fades, and ends in March. `QM5_41401` fades XNG
only in shoulder months. `QM5_20185` is a long-only 252-D1 negative-state
counterfade, `QM5_20218` is exact one-month reversal, and `QM5_41022` follows
two subsegments of one prior week year-round. `QM5_12567` is a long-only
cumulative-RSI pullback. This card uniquely fixes WTI, November-May, two
adjacent complete weeks, strict same-sign exhaustion, inverse direction, and
a one-week lifecycle together.

## Rules

### Entry

1. Run only on the setfile-bound `XTIUSD.DWX` D1 host with EA 41403, slot zero,
...
| Q01 Build Validation | 2026-09-09 | PASS | governed compile `9e86e4c6-04ad-47d2-abe2-ef9601fda53b`; 0 errors, 0 warnings; build check PASS |
