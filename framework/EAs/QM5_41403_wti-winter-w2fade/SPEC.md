# QM5_41403_wti-winter-w2fade - Strategy Spec

**EA ID:** QM5_41403  
**Slug:** `wti-winter-w2fade`  
**Strategy ID:** `BURAKOV-YANG-WTI-WINTER-W2FADE-20260909_S01`  
**Source:** `BURAKOV-YANG-WTI-WINTER-W2FADE-20260909`  
...
`ln(final_close / first_open)` and trade the inverse sign only when both weeks
strictly agree. Mixed signs, exact zero, invalid history, ineligible months,
late restarts, and failed gates consume the week flat.
...
`414030000`. The symbol is an input; no executable symbol literal is embedded
...
immediately prior adjacent weeks and fade their sign only on strict agreement.
...
completely reviewed academic commodity-reversal source. The exact two-week
winter interaction, continuous-CFD efficacy, and portfolio decorrelation are
not source claims.
...
| entry | winter calendar, two completed-week packages, strict agreement, inverse side, durable attempt, spread and frozen ATR stop |
