...
#property description "QM5_20018 XNG Wednesday One-Session Short"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20018 - XNG Wednesday One-Session Short
// -----------------------------------------------------------------------------
// Borowski (2016) natural-gas weekday carrier:
//   - SELL only at the opening of a broker Wednesday D1 bar
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20018_XNG_WED_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_PrimeLateWednesdayAttach()
  {
   ...
   // persist the missed Wednesday decision when attaching after the only
...
bool Strategy_ConsumeWednesdayDecision()
  {
   ...
   // rejected Wednesday signal is terminal for that broker day.
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsXngD1())
      return true;
   if(qm_ea_id != 20018 || qm_magic_slot_offset != 0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "XNG_WED_ONE_SESSION_SHORT";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved Wednesday card retains Friday 21 broker-time flattening"))
      return INIT_FAILED;

   Strategy_LoadAttemptState(TimeCurrent());
   if(!Strategy_PrimeLateWednesdayAttach())
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20018\",\"ea\":\"xng-wed-short\"}");
...
void OnTick()
  {
   ...
   if(!Strategy_ConsumeWednesdayDecision())
      return;
