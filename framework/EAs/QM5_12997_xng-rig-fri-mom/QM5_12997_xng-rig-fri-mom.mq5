...
#property description "QM5_12997 Baker Hughes rig-count Friday XNG momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12997 - Baker Hughes Rig-Count Friday XNG Momentum
// -----------------------------------------------------------------------------
...
input double strategy_min_signal_return_pct  = 1.20;
input double strategy_min_atr_return_mult    = 0.50;
input double strategy_max_signal_return_pct  = 12.0;
...
input double strategy_adverse_close_atr_mult = 0.85;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12997_XNG_RIGCOUNT_FRI_MOM";
   ...
   req.reason = (signal_type == QM_BUY) ? "XNG_RIGCOUNT_FRI_MOM_LONG" : "XNG_RIGCOUNT_FRI_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12997\",\"ea\":\"xng-rig-fri-mom\"}");
