# QM5_9580_bandy-regslope-pullback-mr-index — Strategy Spec

**EA ID:** QM5_9580
**Slug:** `bandy-regslope-pullback-mr-index`
...
`artifacts/cards_approved/QM5_9580_bandy-regslope-pullback-mr-index.md`. See that card's body for
...
`QM5_9580_bandy-regslope-pullback-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
...
`artifacts/cards_approved/QM5_9580_bandy-regslope-pullback-mr-index.md`
