...
#property description "QM5_12590 EIA WTI Weekly Inventory Exhaustion Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12590 - EIA WTI Weekly Inventory Exhaustion Fade
// -----------------------------------------------------------------------------
// D1 structural WTI sleeve:
//   - waits until the first D1 bar after a Wednesday/Thursday WPSR event day
//   - requires large directional event-day range, outer-tail close, and stretch
//   - fades the event-day move toward a slow D1 mean for a short hold window
// Runtime uses MT5 OHLC only; no external EIA data or inventory surprise feed.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12590;
...
input double strategy_min_range_atr       = 1.25;
input double strategy_min_body_ratio      = 0.45;
...
bool Strategy_LoadEventState(double &event_open,
                             ...
                             int &signal_day_key)
  {
   const datetime event_bar_time = iTime(_Symbol, PERIOD_D1, 1); // perf-allowed: D1 WPSR calendar gate.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12590_EIA_WTI_WPSR_FADE";
   ...
   req.reason = (fade_direction > 0) ? "EIA_WTI_WPSR_FADE_LONG" : "EIA_WTI_WPSR_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12590\",\"ea\":\"eia-wti-wpsr-fade\"}");
