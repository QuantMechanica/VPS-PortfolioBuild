...
#property description "QM5_41081 XNG Completed-Week Close-Location Momentum"
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41081 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41081_XNG_WCLOSE_LOCATION_MOM";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_WCLOSE_LOCATION_MOM_LONG"
      : "XNG_WCLOSE_LOCATION_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41081 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41081_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41081\",\"ea\":\"xng-wclose-location-mom\"}");
