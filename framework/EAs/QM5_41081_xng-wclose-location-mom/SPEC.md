# QM5_41081_xng-wclose-location-mom - Strategy Spec
...
**Source:** `MOP-XNG-WCLOSE-LOCATION-MOM-2026`
...
On the first tradable `XNGUSD.DWX` D1 bar of a new broker week, reconstruct
the immediately completed broker week and its consecutive parent. Let `C0`,
`H0`, and `L0` be the newest week's final close, high, and low, and let `C1`
be the parent week's final close. Compute:
...
- Symmetric natural-gas continuation only after a directional completed-week
  close.
- One fixed-risk position and one consumed attempt per broker week.
- Different logic from `QM5_12567` does not prove decorrelation; Q09 alone
...
The source supplies own-return-sign continuation and natural-gas membership.
The weekly horizon and completed-week close-location confirmation are
disclosed QM hypotheses; no source result transfers to this CFD
implementation.
...
|---|---|---|---|
| v0 | 2026-08-21 | approved build-directory identity | source approval `2f2604d49`; deterministic registry reservation in the commit containing this spec |
| v1-card | 2026-08-21 | G0-approved execution contract | `strategy-seeds/cards/approved/QM5_41081_xng-wclose-location-mom_card.md` |
...
| v1-q02-capacity | 2026-08-21 | paced Q02 admission stop | zero existing rows; five 100% CPU samples; seven of seven governed research terminals occupied; no enqueue |
