"""Deterministic reference checks for QM5_41081 weekly close location."""
...
class WeekCloseLocationReferenceTest(unittest.TestCase):
    ...
    def test_static_build_contract_is_fixed_risk_and_completed_data_only(self) -> None:
        source = (EA_DIR / "QM5_41081_xng-wclose-location-mom.mq5").read_text(encoding="utf-8")
        setfile = (EA_DIR / "sets" / "QM5_41081_xng-wclose-location-mom_XNGUSD.DWX_D1_backtest.set").read_text(encoding="utf-8")
        for marker in (
