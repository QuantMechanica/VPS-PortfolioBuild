# QM5_11428_connors-double7s-sma200-d1 — Strategy Spec

**EA ID:** QM5_11428
**Slug:** `connors-double7s-sma200-d1`
**Source:** `4932e25a-fdfb-50cd-b5f5-18e55f3045c2`
...
|---|---|---|---|
| `strategy_sma_period` | 200 | 100-250 | Trend-filter SMA period on the close |
| `strategy_extreme_lookback` | 7 | 5-10 | N-day close-extreme lookback (Connors "7") |
...
- `USDCAD.DWX` — liquid commodity-major; oil-correlated D1 trend/reversion behaviour.

**Explicitly NOT for:**
- Index / commodity .DWX symbols at build time — card R3 basket is the five FX majors; P3 may sweep lookback/trend-period/symmetry per the card's Implementation Notes (handled as a later parameter-sweep, not this build).
...
**Source type:** `book`
**Pointer:** Larry Connors & Cesar Alvarez, "Short-Term Trading Strategies That Work" (2009 TradingMarkets Publishing), "Double 7's Strategy" (Dropbox Forex PDF archive)
**R1–R4 verdict (Q00):** all PASS / see `artifacts/cards_approved/QM5_11428_connors-double7s-sma200-d1.md`
