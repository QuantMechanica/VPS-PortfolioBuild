...
#property description "QM5_10069_v2 MQL5 head-and-shoulders reversal"
...
bool Strategy_NoTradeFilter()
  {
   if(strategy_trade_start_hour >= 0 && strategy_trade_end_hour >= 0 &&
      strategy_trade_start_hour != strategy_trade_end_hour)
     {
      MqlDateTime dt;
