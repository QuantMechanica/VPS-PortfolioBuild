...
strategy_type_flags: [mean-reversion, trend-filtered, swing, multi-day-hold, long-only, low-frequency, survivor-port, metal]
...
r3_reasoning: "XAGUSD.DWX D1 fully covered; metal class = best Q04 survivor class (8.6% ex-infra), cheap commission."
...
g0_approval_reasoning: "R1 survivor parent 12915 plus Connors/Zakamulin; R2 locked 200/10/10/15 D1 port; R3 XAGUSD.DWX matrix; R4 deterministic long-only, no ML/grid."
---

# XAG Weekly-Horizon Oversold Swing (survivor port of QM5_12915)
...
horizon. Silver is an identified missing book class; metal MR diversifies against the index-MR sleeves (12915 parent, 11132). Port purity:
...
- Entry: On closed D1 bars, buy XAGUSD.DWX when close > SMA(200) and the close is the lowest close of the last 10 D1 bars.
...
- Target symbols: XAGUSD.DWX.
- Period: D1.
- Expected trade frequency: about 9 trades/year/symbol.
## Risks / Kill Criteria
Silver vol regimes are harsher than index vol; the ATR-free exit relies on the time stop - Q05/Q06 stress judges.
