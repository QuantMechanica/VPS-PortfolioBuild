...
- Exact host/traded symbol: `XTIUSD.DWX`, D1, slot 0, magic `414230000`.
...
`strategy-seeds/sources/YANG-WTI-WSTREAK2-FADE-20260910/source.md`.

Yang, Goncu, and Pantelous supply academic commodity-reversal lineage;
Moskowitz, Ooi, and Pedersen supply explicit WTI membership and a complete
own-return method record. The weekly horizon and fresh two-week fade remain a
QM hypothesis; no source result transfers.
...
|---|---|---|---|
| v1 | 2026-09-10 | approved new WTI fresh two-week reversion identity | G0 APPROVED; build pending |
...
| v1-q02 | 2026-09-10 | paced first-Q02 intake | pending `f3a0a713-9280-4db5-8a78-af8f0fee1006`; CPU max 91.12% |
