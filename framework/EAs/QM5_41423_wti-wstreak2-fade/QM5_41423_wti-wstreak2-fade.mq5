...
#property description "QM5_41423 WTI Fresh Two-Week Sign-Streak Reversion"
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "fresh_positive_two_week_streak_short";
      else if(g_signal_direction < 0)
         g_signal_state = "fresh_negative_two_week_streak_long";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41423_WTI_WSTREAK2_FADE";
   ...
   req.reason = (g_signal_direction > 0)
      ? "WTI_WSTREAK2_FADE_LONG"
      : "WTI_WSTREAK2_FADE_SHORT";
...
int OnInit()
  {
   ...
   if(!SymbolSelect(g_strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41423 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41423_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41423\",\"ea\":\"wti-wstreak2-fade\"}");
