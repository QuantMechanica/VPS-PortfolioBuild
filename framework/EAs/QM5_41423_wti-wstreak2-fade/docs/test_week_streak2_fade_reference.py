"""Deterministic reference checks for QM5_41423 WTI fresh-streak reversion."""
...
class WeekStreak2FadeReferenceTest(unittest.TestCase):
    def test_fresh_positive_streak_is_short(self) -> None:
        self.assertEqual(fresh_two_week_signal((120.0, 110.0, 100.0, 105.0)), -1)

    def test_fresh_negative_streak_is_long(self) -> None:
    ...
    def test_static_build_contract_and_pacer_guard(self) -> None:
        source = (EA_DIR / "QM5_41423_wti-wstreak2-fade.mq5").read_text(encoding="utf-8")
        setfile = (EA_DIR / "sets" / "QM5_41423_wti-wstreak2-fade_XTIUSD.DWX_D1_backtest.set").read_text(encoding="utf-8")
        for marker in (
            "qm_ea_id != 41423",
