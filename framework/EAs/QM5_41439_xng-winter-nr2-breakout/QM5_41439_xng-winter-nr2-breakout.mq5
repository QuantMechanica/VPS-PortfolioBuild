...
#property description "QM5_41439 XNG Winter NR2 Close Breakout"
...
//   - decide only in November through March during the winter-demand window
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41439_XNG_WINTER_NR2_BREAKOUT";
   ...
   req.reason = (g_signal_direction > 0 ?
                 "XNG_WINTER_NR2_BREAKOUT_LONG" :
                 "XNG_WINTER_NR2_BREAKOUT_SHORT");
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41439 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41439_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41439\",\"ea\":\"xng-winter-nr2-breakout\"}");
