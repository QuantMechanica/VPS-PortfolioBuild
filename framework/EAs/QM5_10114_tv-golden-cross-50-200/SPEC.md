...
`artifacts/cards_approved/QM5_10114_tv-golden-cross-50-200.md`. See that card's body for
...
`QM5_10114_tv-golden-cross-50-200.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| Cadence note | "50/200 SMA crosses are sparse on D1; H4 port gives a conservative 8-20 entries/year/symbol." |
...
`artifacts/cards_approved/QM5_10114_tv-golden-cross-50-200.md`
