...
#property description "QM5_41101 XNG Weekly Range-Migration Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41101 - XNG Weekly Range-Migration Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41101 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41101_XNG_WRANGE_MIGRATE_MOM";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_WRANGE_MIGRATE_MOM_LONG"
      : "XNG_WRANGE_MIGRATE_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41101 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41101_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41101\",\"ea\":\"xng-wrange-migrate-mom\"}");
