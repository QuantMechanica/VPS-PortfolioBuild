...
`artifacts/cards_approved/QM5_10249_tv-supertrend-4h.md`. See that card's body for
...
`QM5_10249_tv-supertrend-4h.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_supertrend_warmup` | 120 | (see source) | (see strategy logic) |
| `strategy_partial_rr` | 0.75 | (see source) | (see strategy logic) |
| `strategy_partial_fraction` | 0.50 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10249_tv-supertrend-4h.md`
