...
#property description "QM5_41467 WTI Winter Upper-CLV Reversion"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41467 - WTI Winter Upper-Tercile Weekly-Close Reversion
// -----------------------------------------------------------------------------
...
//   - short only when that week closes in the upper third of its full range
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
       ...
       if(!g_signal_valid)
          ...
          g_signal_state = "upper_tercile_reversion_short";
       else
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41467_WTI_WINTER_HCLV_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_WINTER_HCLV_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41467 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41467_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41467\",\"ea\":\"wti-winter-hclv-fade\"}");
