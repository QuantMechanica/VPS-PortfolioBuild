# QM5_41467_wti-winter-hclv-fade - Strategy Spec

**EA ID:** QM5_41467  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-WINTER-HCLV-FADE-20260913_S01`
...
`414670000`. Runtime uses native D1 OHLC/timestamps, quotes, spread, ATR,
...
It combines peer-reviewed WTI November-May seasonality, academic commodity
reversal, and governed reputable completed-week/close-location lineage. The
exact weekly rule is an untested QM translation.

The rule differs from `QM5_12567` (XNG oscillator pullback), `QM5_41442` and
`QM5_41456` (two-week range rank plus symmetric outer-quartile signals),
`QM5_41462` (the disjoint summer upper-tercile short), and `QM5_41463`
(winter upper-tercile continuation). This candidate uses one week, no range
comparison, no body predicate, and a strict counter-seasonal short.
...
Gaps, slippage, roll/basis, financing, counter-seasonal winter drift, weekly-horizon
