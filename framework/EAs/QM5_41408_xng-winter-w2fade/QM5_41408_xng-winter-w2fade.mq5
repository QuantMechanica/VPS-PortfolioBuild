...
#property description "QM5_41408 XNG Winter Two-Week Exhaustion Fade"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41408_XNG_WINTER_W2FADE";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_WINTER_W2_FADE_LONG"
      : "XNG_WINTER_W2_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41408 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41408_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41408\",\"ea\":\"xng-winter-w2fade\"}");
