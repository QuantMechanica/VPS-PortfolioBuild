"""Deterministic reference checks for QM5_41408 XNG winter two-week fade."""
...
class XngWinterTwoWeekFadeReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_week_crossing_into_december_uses_monday_anchor(self) -> None:
        self.assertTrue(winter_week(date(2026, 11, 30)))
