...
#property description "QM5_11830 Carter M5 EMA3 BB20 MACD"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double upper_1 = QM_BB_Upper(_Symbol, _Period, strategy_bb_period, strategy_bb_deviation, 1);
   const double lower_1 = QM_BB_Lower(_Symbol, _Period, strategy_bb_period, strategy_bb_deviation, 1);
   const double close_1 = QM_EMA(_Symbol, _Period, 1, 1);
   ...
   const bool long_signal = (ema_2 <= mid_2 && ema_1 > mid_1 &&
                             macd_hist > 0.0 &&
                             close_1 < upper_1);
   const bool short_signal = (ema_2 >= mid_2 && ema_1 < mid_1 &&
                              macd_hist < 0.0 &&
                              close_1 > lower_1);
   ...
   req.sl = sl;
   req.tp = tp;
   req.reason = long_signal ? "ema3_bbmid_macd_long" : "ema3_bbmid_macd_short";
