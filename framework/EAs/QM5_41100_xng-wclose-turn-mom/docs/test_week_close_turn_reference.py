"""Deterministic reference checks for QM5_41100 weekly close-turn recovery."""
...
class WeekCloseTurnReferenceTest(unittest.TestCase):
    ...
    def test_static_build_contract_is_fixed_risk_and_close_only(self) -> None:
        source = (EA_DIR / "QM5_41100_xng-wclose-turn-mom.mq5").read_text(
            encoding="utf-8"
        )
        setfile = (
            EA_DIR
            / "sets"
            / "QM5_41100_xng-wclose-turn-mom_XNGUSD.DWX_D1_backtest.set"
