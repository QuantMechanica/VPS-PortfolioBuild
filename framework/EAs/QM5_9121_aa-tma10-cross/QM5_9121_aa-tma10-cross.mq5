...
double TMA10Close(const int shift)
  {
   if(strategy_tma_period != 10)
      return 0.0;
...
bool EnsureD1State()
  {
   ...
   if(strategy_tma_period != 10 || strategy_warmup_d1_bars < 60)
      return false;
   ...
   if(d1_bar_time != g_last_d1_bar_time)
     {
      ...
      g_tma_1 = TMA10Close(1);
      g_tma_2 = TMA10Close(2);
      RefreshSpreadMedian();
     }
