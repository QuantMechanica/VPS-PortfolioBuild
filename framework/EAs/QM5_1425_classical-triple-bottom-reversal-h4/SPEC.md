...
| v2 | 2026-08-24 | Review rework c5811f96 | Restored card-faithful significant/consecutive trough gates, exactly-one-peak intervals, expiring BUY-STOP entry, rising D1 SMA, exact +/-480-minute entry news gate, accepted-order state transitions, restart persistence, and explicit H4 execution contract. |
