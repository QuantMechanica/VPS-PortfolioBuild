# QM5_12756_edgelab-usdchf-usdcad-cointegration - Strategy Spec
...
The EA trades the USDCHF.DWX and USDCAD.DWX D1 cointegration spread. It computes
`S = ln(USDCHF) - beta * ln(USDCAD)` with beta defaulting to 0.55, then
...
same script ranked USDCHF/USDCAD as the strongest remaining unbuilt
OOS-positive candidate after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749/12751
baskets, with DEV Sharpe -0.00, OOS net Sharpe 0.13, OOS return +1.06%, 16 OOS
state changes, beta 0.55, and 83-day half-life.

The near-zero DEV Sharpe and very low OOS Sharpe mean this did not clear the
...
| strategy_beta | 0.55 | >0 | Hedge coefficient in `ln(USDCHF) - beta * ln(USDCAD)` |
...
**Designed for:**
- USDCHF.DWX - leg 1 of the fixed USDCHF/USDCAD spread and the spread numerator.
- USDCAD.DWX - leg 2 of the fixed USDCHF/USDCAD spread and the beta-weighted spread denominator.

**Explicitly not for:**
- Other `.DWX` symbols. This card is a fixed two-leg FX-cross basket, not a portable multi-pair strategy.

The EA selects USDCHF.DWX and USDCAD.DWX only; both USD-base legs are available
...
| Regime preference | mean-reverting USD-base safe-haven versus North-American commodity/rate spread |
...
|---|---:|---:|---:|---:|---:|---:|
| USDCHF~USDCAD | -0.00 | 0.13 | +1.06% | 16 | 0.55 | 83d |
