...
#property description "QM5_41457 WTI Summer NR2 Positive-Week Reversion"
...
//   - short only after a contracting newest week closes above its own open
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41457_WTI_SUMMER_NR2_UPWEEK_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_SUMMER_NR2_UPWEEK_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41457 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41457_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41457\",\"ea\":\"wti-summer-nr2-upweek-fade\"}");
