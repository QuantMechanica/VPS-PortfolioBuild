# QM5_41457_wti-summer-nr2-upweek-fade - Strategy Spec

**EA ID:** QM5_41457  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-SUMMER-NR2-UPWEEK-FADE-20260912_S01`
...
strictly narrower. Sell only when that week's final close is strictly above its chronological
first open. Range equality, expansion, or a zero/negative body is flat. Consume the decision
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414570000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-NR2-UPWEEK-FADE-20260912/source.md`. It
combines peer-reviewed WTI June-October seasonality, academic commodity-futures reversal, and
...
(unconditional summer short), `QM5_20213`/`QM5_20214` (generic summer momentum/reversal),
`QM5_41446` (symmetric winter NR2 body fade), and `QM5_41456` (winter NR2 CLV fade).
...
| entry | June-October calendar, two completed weeks, strict range contraction, positive-body short fade, attempt, spread, ATR stop |
