...
#property description "QM5_1185 Quantpedia Stress Gold Rebound"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                     = 1185;
...
const string STRATEGY_TRADE_SYMBOL = "XAUUSD.DWX";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_1185_STRESS_GOLD_REBOUND";
   ...
   QM_LogEvent(QM_INFO, "STRESS_SIGNAL_ON",
               StringFormat("{\"signal_day\":%I64d,\"equity_ret\":%.6f,\"oil_ret\":%.6f,\"oil_symbol\":\"%s\"}",
                            (long)signal_day, equity_ret, oil_ret, oil_symbol));
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_1185\",\"strategy\":\"qp-stress-gold-rebound\"}");
