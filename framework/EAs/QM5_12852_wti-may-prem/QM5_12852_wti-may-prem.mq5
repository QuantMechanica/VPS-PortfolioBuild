...
#property description "QM5_12852 WTI May Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12852 - WTI May Calendar Premium
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - long XTIUSD.DWX only during broker-calendar May D1 bars
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12852_WTI_MAY_PREM";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12852\",\"ea\":\"wti-may-prem\"}");
