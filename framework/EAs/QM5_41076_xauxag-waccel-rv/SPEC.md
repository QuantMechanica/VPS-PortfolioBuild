# QM5_41076_xauxag-waccel-rv - Strategy Spec
...
**Source:** `SCHWEIKERT-CME-XAUXAG-WACCEL-RV-2026`
...
When the relative returns have the same strict sign and the newest absolute
move is strictly larger than the older move, fade the accelerating continuation for one
broker week. A dominant positive newest return opens SELL XAU / BUY XAG; a
dominant negative newest return opens BUY XAU / SELL XAG. Equality, opposed
signs,
...
- Trigger: strict same-sign continuation with strict newest absolute
  acceleration at the new-week boundary.
...
- Symmetric, opposite-leg gold/silver relative reversion after a same-sign
  weekly acceleration overshoot.
...
carrier lineage. The weekly same-sign newest-acceleration fade is a disclosed
