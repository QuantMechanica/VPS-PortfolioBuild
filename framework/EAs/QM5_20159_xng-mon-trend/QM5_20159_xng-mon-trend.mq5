...
#property description "QM5_20159 XNG Monday Premium Positive-Trend Agreement"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20159 - XNG Monday Premium / Slow-Trend Agreement
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "XNG_MON_POS252_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20159_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20159\",\"ea\":\"xng-mon-trend\"}");
