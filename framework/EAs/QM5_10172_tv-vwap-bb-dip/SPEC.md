...
`artifacts/cards_approved/QM5_10172_tv-vwap-bb-dip.md`. See that card's body for
...
`QM5_10172_tv-vwap-bb-dip.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_ema_fast` | 13 | (see source) | (see strategy logic) |
| `strategy_ema_slow` | 55 | (see source) | (see strategy logic) |
| `strategy_bb_period` | 20 | (see source) | (see strategy logic) |
| `strategy_bb_deviation` | 2.0 | (see source) | (see strategy logic) |
| `strategy_dip_lookback` | 10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10172_tv-vwap-bb-dip.md`
