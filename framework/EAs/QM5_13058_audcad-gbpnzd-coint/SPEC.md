# QM5_13058_audcad-gbpnzd-coint - Strategy Spec
...
The EA trades the AUDCAD.DWX and GBPNZD.DWX D1 cointegration spread. It
computes `S = ln(AUDCAD) - beta * ln(GBPNZD)` with beta defaulting to
`-0.7616`, then calculates a 60-bar rolling z-score of that spread.
...
| strategy_beta | -0.7616 | non-zero | Hedge coefficient in `ln(AUDCAD) - beta * ln(GBPNZD)` |
...
**Designed for:**
- AUDCAD.DWX - leg 1 of the fixed AUDCAD/GBPNZD spread and the spread numerator.
- GBPNZD.DWX - leg 2 of the fixed AUDCAD/GBPNZD spread and the beta-weighted spread denominator.
