...
#property description "QM5_20058 Copper 3M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20058 - Copper 3-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20058_Copper_TSMOM3M";
   ...
   // back-calculates in the tester -- root-caused 2026-07-05 on the Copper
   ...
   req.reason = (direction > 0) ? "Copper_TSMOM3M_LONG" : "Copper_TSMOM3M_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20058\",\"ea\":\"xcu-tsmom3m\"}");
