# QM5_12936_demark-td-reverse-differential-h4 — Strategy Spec

**EA ID:** QM5_12936
**Slug:** `demark-td-reverse-differential-h4`
...
`artifacts/cards_approved/QM5_12936_demark-td-reverse-differential-h4.md`. See that card's body for
...
`QM5_12936_demark-td-reverse-differential-h4.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_sma_d1_period` | 200 | (see source) | (see strategy logic) |
| `strategy_min_range_atr_mult` | 0.40 | (see source) | (see strategy logic) |
| `strategy_max_pullback_atr_mult` | 1.50 | (see source) | (see strategy logic) |
| `strategy_max_spread_atr_mult` | 0.30 | (see source) | (see strategy logic) |
| `strategy_cooldown_bars` | 4 | (see source) | (see strategy logic) |
| `strategy_sl_atr_mult` | 1.50 | (see source) | (see strategy logic) |
| `strategy_tp_atr_mult` | 1.50 | (see source) | (see strategy logic) |
| `strategy_time_stop_bars` | 8 | (see source) | (see strategy logic) |
| `strategy_be_trigger_atr_mult` | 0.75 | (see source) | (see strategy logic) |
| `strategy_trail_trigger_atr_mult` | 1.50 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_12936_demark-td-reverse-differential-h4.md`
