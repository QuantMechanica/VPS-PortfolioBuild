...
#property description "QM5_41161 TradingView Monday Liquidity Sweep DL-089 instrument (tv-mon-ls-opt)"
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"ea\":\"QM5_41161_tv_mon_ls_opt\"}");
