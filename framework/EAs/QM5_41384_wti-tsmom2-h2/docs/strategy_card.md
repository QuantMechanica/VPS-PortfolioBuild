...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K2H2_S35
variant_id: MOP-TSMOM-2012_XTI_K2H2_S35
source_id: MOP-WTI-TSMOM2-H2-2026
ea_id: QM5_41384
slug: wti-tsmom2-h2
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41384_wti-tsmom2-h2_card.md
execution_contract_status: APPROVED
created: 2026-09-08
created_by: Research+Development
last_updated: 2026-09-08
g0_status: APPROVED
g0_decision: decisions/2026-09-08_qm5_41384_wti_tsmom2_h2_g0.md
source_approval: decisions/2026-09-08_wti_two_month_momentum_two_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM2-H2-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: bimonthly-wti-sign-of-exact-two-completed-broker-month-log-return-two-month-hold-odd-month-epoch
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, two-month-return, two-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
pipeline_phase: Q01_PASS_Q02_CPU_STOP
q01_status: PASS
q02_status: NOT_ENQUEUED_CPU_CEILING
parameters_to_test: "Locked Q02 baseline only: D1; three consecutive completed month-end closes; exact two-month log-return sign; odd-month decisions; two-month hold; 300 D1 bars; 3.5*ATR(20,D1) frozen stop; 70-day stale repair; 1500-point spread ceiling."
review_focus: "Falsify the source-bounded WTI k=2,h=2 stream. Verify three exact completed-month endpoints, odd-month-only attempts, no even-month rollover, fixed risk, frozen stop, and next-odd-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal]
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_two_month_orientation, odd_month_epoch, bimonthly_attempt_state, two_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
---

# QM5_41384 WTI Two-Month Momentum / Two-Month Hold

## Hypothesis

A two-completed-month WTI own-return direction may persist when held as a
fixed non-overlapping two-month package. The fixed clock prevents the monthly
renewal used by the existing two-month WTI strategy and produces a distinct,
lower-turnover return stream outside the certified XAU/SP500/NDX/XNG book.
...
publish a standalone WTI `k=2, h=2` result or continuous-CFD evidence.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/MOP-WTI-TSMOM2-H2-2026/source.md`; its complete-read
parent is `strategy-seeds/sources/MOP-TSMOM-2012/source.md`. The published
paper hash is
`7682F8E97EB4B77591DC85E36731FF51ED031970CDDE81678108734DB9478379`.

The corrected-root canonical checker found no exact identity and expected
family matches only. `QM5_20064` uses the same two-month return with monthly
renewal; `QM5_20281` uses the same two-month clock with a twelve-month return,
while `QM5_41379` through `QM5_41383` use three-, one-, nine-, six-, and
four-month returns. This card requires both exact `k=2` endpoints and the
fixed odd-month `h=2` lifecycle.
...
- History: three consecutive completed broker-month-end closes `C[0]..C[2]`,
  oldest to newest; newest is the immediately prior completed month.
- Formula: `r2 = ln(C[2] / C[0])`; positive buys, negative sells, equality or invalid state stays flat.
...
2. Require configured symbol, D1, EA 41384, slot 0, and fixed-risk backtest mode.
...
4. Reconstruct exactly three positive finite consecutive completed month-end
   closes with strictly increasing timestamps and no current-month price.
5. Compute `ln(C[2]/C[0])`; buy strict positive and sell strict negative.
...
Fail closed for wrong configured symbol/period/ID/slot/risk mode, invalid
strategy inputs, ineligible month, consumed attempt, owned position, prior
deal, malformed or nonconsecutive endpoints, current-month leakage, nonfinite
return, equality, excess spread, invalid quote/ATR/stop, or failed
persistence. News and Friday inputs remain framework-governed and are not
pinned by the strategy guard.
...
phase sensitivity, hard-stop slippage, weak carrier-specific evidence, and
...
| no independent signal close | Trade Close | `Strategy_ExitSignal` returns no exit |
| kill switch, ownership, magic, fixed risk | Framework No-Trade | standard orchestration |

## Validation Plan

Q01 must prove month adjacency and year boundaries, exact three endpoints,
...
|---|---|---|---|
| G0 Research Intake | 2026-09-08 | APPROVED | `decisions/2026-09-08_qm5_41384_wti_tsmom2_h2_g0.md` |
| Q01 Build Validation | 2026-09-08 | PASS | PACER zero hits; 13/13 reference vectors; governed compile `6a063c3e-c161-4069-90fe-2bbefc258f08` returned `COMPILE_OK` |
| Q02 Baseline Screening | 2026-09-08 | NOT_ENQUEUED_CPU_CEILING | T10 recorded 98.3% and 97.3% CPU against the binding 97% ceiling; no Q02 work item exists |
