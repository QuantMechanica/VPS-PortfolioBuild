# QM5_41384_wti-tsmom2-h2 — Strategy Spec

**EA ID:** QM5_41384  
**Slug:** `wti-tsmom2-h2`  
**Source:** `MOP-WTI-TSMOM2-H2-2026`  
**Author of this spec:** Codex  
**Last revised:** 2026-09-08

## 1. Strategy Logic

On the first D1 bar of each odd broker month, reconstruct three consecutive
completed WTI month-end closes and follow the sign of the exact two-month log
...
| `strategy_return_months` | `2` | `[2]` | Exact formation intervals |
...
**Source ID:** `MOP-WTI-TSMOM2-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM2-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41384_wti-tsmom2-h2_card.md`.
...
`QM5_20064` renews the same two-month direction monthly. `QM5_20281` uses
...
identity combines the exact two-month endpoints with the fixed odd-month two-month
lifecycle.
