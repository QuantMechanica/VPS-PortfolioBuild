...
#property description "QM5_20093 WTI June-October Summer-Short Sleeve"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20093 - WTI June-October Summer-Short Sleeve
// -----------------------------------------------------------------------------
// Burakov-Freidin-Solovyev alternative-two energy-season carrier:
//   - short WTI during broker months June through October
//   - flat during November through May
...
input int    strategy_first_short_month     = 6;
input int    strategy_last_short_month      = 10;
...
bool Strategy_IsSummerMonth(const int month_number)
  {
   if(month_number < 1 || month_number > 12)
      return false;
   return (month_number >= strategy_first_short_month &&
           month_number <= strategy_last_short_month);
  }
...
void Strategy_CloseExpiredPositions()
  {
   ...
   const bool in_summer = Strategy_IsSummerMonth(current_month_number);
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(qm_magic_slot_offset != 0)
      return true;
   if(strategy_first_short_month != 6)
      return true;
   if(strategy_last_short_month != 10)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "WTI_HALLOWEEN_WINTER_LONG";
   ...
   if(month_key <= 0 || !Strategy_IsSummerMonth(month_number))
      return false;
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20093_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20093\",\"ea\":\"wti-summer-short\"}");
