...
#property description "QM5_20185 WTI Winter Negative-Trend Counterfade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20185 - WTI Winter Negative-Trend Counterfade
// -----------------------------------------------------------------------------
// D1 structural crude-oil sleeve:
//   - first tradable D1 bar of each broker-calendar week
//   - active only November through May
...
input int    strategy_start_month          = 11;
input int    strategy_end_month            = 5;
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(qm_ea_id != 20185 ||
      ...
      return true;
   if(strategy_start_month != 11 ||
      strategy_end_month != 5)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "WTI_WINTER_NEG252_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20185_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20185\",\"ea\":\"wti-win-bearfade\"}");
