# QM5_10183_carver-multi-sig — Strategy Spec
...
`artifacts/cards_approved/QM5_10183_carver-multi-sig.md`. See that card's body for
...
`QM5_10183_carver-multi-sig.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_use_mac_family` | true | (see source) | (see strategy logic) |
| `strategy_use_mbo_family` | true | (see source) | (see strategy logic) |
| `strategy_shorts_enabled` | true | (see source) | (see strategy logic) |
| `strategy_warmup_bars` | 340 | (see source) | (see strategy logic) |
| `strategy_vol_days` | 252 | (see source) | (see strategy logic) |
| `strategy_stop_vol_fraction` | 0.5 | (see source) | (see strategy logic) |
| `strategy_mac_family_weight` | 0.5 | (see source) | (see strategy logic) |
| `strategy_mbo_family_weight` | 0.5 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10183_carver-multi-sig.md`
...
|---|---|---|---|
| v1 | 2026-06-27 | Initial spec (ex-post, generated by gen_spec_md.py) | post-PT15 remediation |
