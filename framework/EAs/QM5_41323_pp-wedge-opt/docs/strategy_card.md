...
|---|---|---|
| R1 Source-Link | PASS | Inherited from the approved QM5_11660 parent card and its named source. |
| R2 Mechanical | PASS | Parent mechanics are unchanged; the six deterministic inputs only veto entries. |
| R3 Data Available | PASS | Uses closed D1 OHLC predicates on NDX.DWX, alongside the parent's H4 inputs. |
