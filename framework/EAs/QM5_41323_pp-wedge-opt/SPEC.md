# QM5_41323_pp-wedge-opt — Strategy Spec

**EA ID:** QM5_41323
**Slug:** `pp-wedge-opt`
**Parent EA:** `QM5_11660_pp-wedge`
...
`NDX.DWX` carrier and adds only the six optional DL-089 closed-D1 pattern veto
inputs. With all six inputs at zero, the veto corset is neutral.
