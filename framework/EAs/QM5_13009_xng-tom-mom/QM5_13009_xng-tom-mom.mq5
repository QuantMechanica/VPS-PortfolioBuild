...
#property description "QM5_13009 XNG Turn-Of-Month Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13009 - XNG Turn-Of-Month Momentum
// -----------------------------------------------------------------------------
...
// EIA, weather, rig-count, volume, open-interest, or ML feed.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13009;
...
input double strategy_min_momentum_pct       = 12.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13009_XNG_TOM_MOM";
   ...
   req.reason = (direction > 0) ? "XNG_TOM_MOM_LONG" : "XNG_TOM_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13009\",\"ea\":\"xng-tom-mom\"}");
