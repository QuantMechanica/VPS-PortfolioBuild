# QM5_41432_wti-hurr-negweek-cont - Strategy Spec

**EA ID:** QM5_41432

**Slug:** `wti-hurr-negweek-cont`

**Strategy ID:** `EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911_S01`

**Source:** `EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911`
...
Positive, exact zero, invalid history, ineligible months, late starts, and
...
`414320000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
| entry | hurricane calendar, one completed-week package, strict negative sign, short-only side, durable attempt, spread and frozen ATR stop |
...
| v1-q01 | 2026-09-11 | Governed compile and strict build check PASS (`693125c7-2ccc-46e5-8041-3b440c429576`) | OWNER pacer mission |
| v1-q02 | 2026-09-11 | One fixed-risk Q02 canary enqueued below CPU ceiling (`4c7d7b31-c837-4fdc-9070-505b72b82f97`) | OWNER pacer mission |
