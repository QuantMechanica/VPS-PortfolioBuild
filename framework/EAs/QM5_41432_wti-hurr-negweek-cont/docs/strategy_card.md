...
type: strategy
strategy_id: EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911_S01
variant_id: EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911_S01
source_id: EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911
ea_id: QM5_41432
slug: wti-hurr-negweek-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41432_wti-hurr-negweek-cont_card.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41432_wti_hurricane_negative_week_continuation_g0.md
source_approval: decisions/2026-09-11_wti_hurricane_negative_week_continuation_source_approval.md
...
source_citations:
  - type: official_government_and_peer_reviewed_bounded_mechanization
    citation: "EIA hurricane-season petroleum-supply risk plus Moskowitz-Ooi-Pedersen own-return commodity momentum; QuantMechanica governed negative-week WTI translation."
    location: strategy-seeds/sources/EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911/source.md
...
strategy_mechanic: normalized-weekly-wti-august-september-october-hurricane-season-one-immediately-completed-week-open-to-close-strict-negative-log-return-short-continuation-one-week-hold
sources: ["[[sources/EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911]]"]
concepts: ["[[concepts/time-series-momentum]]", "[[concepts/hurricane-season-supply-risk]]", "[[concepts/negative-week-continuation]]"]
indicators: ["[[indicators/completed-week-open-close]]", "[[indicators/log-return-sign]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, hurricane-season, negative-week, weekly-momentum, short-only, atr-hard-stop, time-stop, low-frequency]
...
hard_rules_at_risk: [exact_wti_carrier, hurricane_season_month_gate, normalized_week_clock, immediately_completed_week_membership, strict_negative_sign, short_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 official EIA plus complete-read peer-reviewed MOP context with disclosed translation risk; R2 exact mechanical short-only negative-week hurricane-season continuation; R3 registered XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate and eight fuzzy family neighbors manually resolved."
---

# QM5_41432 WTI Hurricane-Season Negative-Week Continuation
...
August, September, and October, a completed negative WTI week may identify a
demand-destruction or risk-off state that persists for one further week. This
exact short-only price translation and its causal story are unproven and
belong to Q02 onward.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/EIA-MOP-WTI-HURR-NEGWEEK-CONT-20260911/source.md`.
...
weekly WTI CFD result or the cause of a negative weekly return.

The canonical checker found no exact identity and surfaced eight fuzzy family
neighbors. `QM5_41421` has the same sign/direction package only in the
refinery-maintenance months February, March, September, and October; this card
uses the hurricane window August, September, and October. `QM5_41430` requires
a positive week and buys continuation. `QM5_41431` requires the same negative
week but buys reversion. `QM5_41424` fades positive maintenance-season weeks.
XNG shoulder variants use another carrier. `QM5_12591` requires a daily
Donchian breakout and trend confirmation, while `QM5_12754` fades a daily
failed spike. Calendar, completed-week formation, negative-only gate, short
side, and one-week lifecycle are jointly load-bearing.
...
1. Run only on the setfile-bound `XTIUSD.DWX` D1 host with EA 41432, slot zero,
...
- One strictly negative completed week, a short-only continuation, the one-
  week hold, retry semantics, and all numeric thresholds are QM choices.
...
short entry, positive/zero flat states, three-to-five-session weeks, current-
