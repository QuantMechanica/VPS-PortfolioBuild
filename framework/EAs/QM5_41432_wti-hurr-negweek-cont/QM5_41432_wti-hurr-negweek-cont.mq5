...
#property description "QM5_41432 WTI Hurricane-Season Negative-Week Continuation"
...
bool Strategy_LoadNegativeWeekSignal(const int current_week_key,
                                     ...
                                     int &direction)
  {
   ...
   // The hurricane-season sleeve is deliberately asymmetric: a strictly negative
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41432_WTI_HURR_NEGWEEK_CONT";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_HURR_NEGWEEK_CONT_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41432 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41432_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41432\",\"ea\":\"wti-hurr-negweek-cont\"}");
