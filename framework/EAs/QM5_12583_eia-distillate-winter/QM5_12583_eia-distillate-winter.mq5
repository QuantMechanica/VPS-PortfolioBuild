...
#property description "QM5_12583 EIA Distillate Winter Breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12583 - EIA Distillate Winter Breakout
// -----------------------------------------------------------------------------
// D1 structural WTI sleeve:
//   - long only during Nov 1 through Feb 15 winter distillate-demand window
//   - channel breakout entry, channel/date/time exits
// Runtime uses MT5 OHLC only; no EIA, weather, inventory, or futures-spread feed.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12583;
...
bool Strategy_InWinterWindow(const datetime t)
  {
   MqlDateTime dt;
   TimeToStruct(t, dt);
   if(dt.mon == 11 || dt.mon == 12 || dt.mon == 1)
      return true;
   if(dt.mon == 2)
      return (dt.day <= 15);
   return false;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12583_EIA_DISTILLATE_WINTER";
   ...
   req.reason = "EIA_DISTILLATE_WINTER_LONG_BREAKOUT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12583\",\"ea\":\"eia-distillate-winter\"}");
