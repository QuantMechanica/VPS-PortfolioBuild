# QM5_41204_wti-samecal-huber10 - Strategy Spec
...
- source approval:
  `decisions/2026-08-29_wti_same_calendar_huber10_source_approval.md`
- approved card:
  `strategy-seeds/cards/approved/QM5_41204_wti-samecal-huber10_card.md`
- G0 decision:
  `decisions/2026-08-29_qm5_41204_wti_same_calendar_huber10_g0.md`
- host/traded symbol: exact `XTIUSD.DWX`, D1, slot 0
- deterministic magic: `412040000`
...
- Symbol slot: `0`; deterministic magic: `412040000`.
...
Canonical preallocation dedup scanned 4,703 registry identities, 1,349 cards,
and 45 Strategy Wiki nodes. It found no exact identity and only the expected
raw-mean fuzzy neighbor `QM5_20099`. Manual review separates the twelve
adjacent-month Huber, ten-year signed-rank, five-year trim, pairwise central,
and Winsorized estimators. The approved disagreement vector makes this Huber
rule SELL while raw mean and signed rank BUY. Receipt:
...
history floor. Moskowitz, Ooi, and Pedersen (2012), *Journal of Financial
Economics* 104(2), 228-250, supply WTI own-return and monthly-renewal lineage.
Huber (1964), *Annals of Mathematical Statistics* 35(1), 73-101, supplies the
bounded-influence location family. The exact conjunction is a transparent QM
translation; no source performance or decorrelation result transfers.
...
| Version | Date | Reason |
|---|---|---|
| v1 | 2026-08-29 | G0-approved WTI exact-ten-year same-calendar fixed-scale Huber build |
