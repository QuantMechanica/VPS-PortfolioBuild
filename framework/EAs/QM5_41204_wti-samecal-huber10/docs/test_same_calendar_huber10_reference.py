"""Independent deterministic fixtures for QM5_41204.
...
class SameCalendarHuberTenReferenceTests(unittest.TestCase):
    ...
    def test_static_build_contract_matches_approved_card(self) -> None:
        source_path = EA_DIR / "QM5_41204_wti-samecal-huber10.mq5"
        source = source_path.read_text(encoding="utf-8")
        setfile = (
            EA_DIR
            / "sets"
            / "QM5_41204_wti-samecal-huber10_XTIUSD.DWX_D1_backtest.set"
        ...
        approved = (
            ...
            / "cards"
            / "approved"
            / "QM5_41204_wti-samecal-huber10_card.md"
        )
        ...
        self.assertIn(
            "41204,wti-samecal-huber10,0,XTIUSD.DWX,412040000", magic_rows
        )
        resolver = (
            REPO_ROOT / "framework" / "include" / "QM" / "QM_MagicResolver.mqh"
        ).read_text(encoding="utf-8")
        self.assertIn("412040000", resolver)
