...
`artifacts/cards_approved/QM5_10206_tv-9ema-full-candle.md`. See that card's body for
...
`QM5_10206_tv-9ema-full-candle.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_spread_stop_frac` | 0.10 | (see source) | (see strategy logic) |
| `strategy_us_start_hhmm` | 1630 | (see source) | (see strategy logic) |
| `strategy_us_end_hhmm` | 2300 | (see source) | (see strategy logic) |
| `strategy_overlap_start_hhmm` | 1500 | (see source) | (see strategy logic) |
| `strategy_overlap_end_hhmm` | 1900 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10206_tv-9ema-full-candle.md`
