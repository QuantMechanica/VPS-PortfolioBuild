...
#property description "QM5_20290 WTI Skewness Premium"
...
// commodity premium, and include crude oil. The outright WTI zero-pivot time-
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20290 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20290_WTI_SKEW_PREM";
   ...
   req.reason = (g_cache_signal > 0) ? "SKEW_PREM_XTI_LONG" : "SKEW_PREM_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20290_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20290\",\"ea\":\"wti-skew-prem\",\"stat\":\"prior_12m_absolute_pearson_skewness\"}");
