...
#property description "QM5_41030 XAU/XAG Weekly Relative-Flow Divergence"
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41030 && qm_magic_slot_offset == 0 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_FLOWDIV_ATTEMPT_DATE", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41030_XAUXAG_FLOWDIV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41030_XAUXAG_FLOWDIV_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41030\",\"ea\":\"xauxag-flowdiv\"}");
