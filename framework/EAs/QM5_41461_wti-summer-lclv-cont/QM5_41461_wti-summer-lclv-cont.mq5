...
#property description "QM5_41461 WTI Summer Lower-CLV Continuation"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41461_WTI_SUMMER_LCLV_CONT";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_SUMMER_LCLV_CONT_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41461 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41461_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41461\",\"ea\":\"wti-summer-lclv-cont\"}");
