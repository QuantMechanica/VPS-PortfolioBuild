# QM5_20262_xng-lr-trend — Strategy Spec
...
required. A positive beta buys XNG and a negative beta sells it. A weak, flat,
...
fixed regression-fit gate. Existing XNG EAs use endpoint returns, return-sign
...
consistency statistic. The carrier is shared with the certified XNG sleeve,
but its daily long-only cumulative-RSI2 pullback does not share this symmetric
monthly state or lifecycle. Only Q09 may establish realized decorrelation.
...
`strategy-seeds/sources/MOP-XNG-LRTREND-2026/source.md`.
...
Risk is high: continuous-CFD roll and financing, natural-gas gaps, false smooth
