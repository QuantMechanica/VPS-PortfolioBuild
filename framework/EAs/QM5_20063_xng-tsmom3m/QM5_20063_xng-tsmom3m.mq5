...
#property description "QM5_20063 Natural Gas 3M Time Series Momentum"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 20063;
...
bool Strategy_IsHost()
  {
   return (_Symbol == "XNGUSD.DWX" && _Period == PERIOD_D1 &&
           qm_ea_id == 20063 && qm_magic_slot_offset == 0);
  }
...
bool Strategy_NoTradeFilter()
  {
   return (!Strategy_IsHost() || strategy_momentum_lookback_d1 != 63 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20063_XNG_TSMOM3M";
   ...
   if(req.sl <= 0.0)
      return false;
   req.reason = (direction > 0) ? "XNG_TSMOM3M_LONG" : "XNG_TSMOM3M_SHORT";
