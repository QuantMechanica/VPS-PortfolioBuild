...
#property description "QM5_41029 WTI Weekly Flow-Agreement Continuation"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(direction > 0)
     {
      req.type = QM_BUY;
      req.reason = "WTI_FLOW_AGREE_LONG";
     }
   else if(direction < 0)
     {
      req.type = QM_SELL;
      req.reason = "WTI_FLOW_AGREE_SHORT";
     }
   else
      return false;
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved WTI weekly flow-agreement card uses Friday 21 as ordinary exit"))
      return INIT_FAILED;
   ...
   g_attempt_state_key =
      StringFormat("QM5_41029_FLOW_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41029\",\"ea\":\"wti-flow-agree\"}");
