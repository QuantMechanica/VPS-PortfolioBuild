...
#property description "QM5_13202 WS30 Friday Afternoon Long"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13202;
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   if(strategy_atr_bars != 56 || strategy_stop_atr <= 0.0)
      return false;
   ...
   if(request.sl <= 0.0 || request.sl >= ask)
      return false;
   request.reason = "WS30_FRI_PM_LONG";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkInit(qm_ea_id,
                        ...
                        qm_news_compliance))
      return INIT_FAILED;
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13202_ws30-fri-pm-long\"}");
