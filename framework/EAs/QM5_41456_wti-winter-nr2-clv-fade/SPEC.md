# QM5_41456_wti-winter-nr2-clv-fade - Strategy Spec

**EA ID:** QM5_41456  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-WINTER-NR2-CLV-FADE-20260912_S01`
...
strictly narrower. Buy when its final close is strictly in the lower quartile (`CLV<0.25`) and
sell when it is strictly in the upper quartile (`CLV>0.75`). Equality, middle-half closes, and
weekly body direction are flat. Consume the decision week before fallible gates and never retry.
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414560000`. Runtime uses native
...
Expected cadence is eight to eighteen positions per full post-warm-up year. Q02 retires on zero
...
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-WINTER-NR2-CLV-FADE-20260912/source.md`. It
combines peer-reviewed WTI November-May seasonality, academic commodity reversal, and governed
reputable Crabel range-state lineage. The exact weekly rule is an untested QM translation.

The rule differs from `QM5_12567` (two-day XNG oscillator pullback), `QM5_41442` (the opposite
strict expansion state), `QM5_41447` (contraction/upper-quartile long continuation), `QM5_41446`
(contraction/body fade), `QM5_41403` (same-sign weekly-return fade), and `QM5_41453` (paired
XAU/XAG ratio contraction/CLV reversion).
...
| entry | November-May calendar, two completed weeks, strict contraction/CLV, contrarian sides, attempt, spread, ATR stop |
| management | owned-position integrity, next-week closure, stale repair |
...
| v1-q01 | 2026-09-12 | Governed T5 compile and strict build check PASS; 12 reference tests and PACER audit PASS |
| v1-q02 | 2026-09-12 | Deterministic first-Q02 intake accepted; work item `39ecd610-2e9c-4b80-b7a4-f0da802ce21d` claimed by T6 at handoff |
