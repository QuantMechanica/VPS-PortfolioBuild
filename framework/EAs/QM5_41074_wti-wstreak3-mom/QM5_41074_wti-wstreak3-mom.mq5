...
#property description "QM5_41074 WTI Fresh Three-Week Sign-Streak Momentum"
...
//   - follow the fresh streak until the next week with a fixed-risk hard stop
// Runtime uses MT5-native closes, calendar, history, and framework state only.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                      = 41074;
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "fresh_positive_three_week_streak_long";
      else if(g_signal_direction < 0)
         g_signal_state = "fresh_negative_three_week_streak_short";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41074 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41074_WTI_WSTREAK3_MOM";
   ...
   req.reason = (g_signal_direction > 0)
      ? "WTI_WSTREAK3_MOM_LONG"
      : "WTI_WSTREAK3_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41074 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41074_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41074\",\"ea\":\"wti-wstreak3-mom\"}");
