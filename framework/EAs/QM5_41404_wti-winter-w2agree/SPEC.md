# QM5_41404_wti-winter-w2agree - Strategy Spec

**EA ID:** QM5_41404  
**Slug:** `wti-winter-w2agree`  
**Strategy ID:** `BURAKOV-MOP-WTI-WINTER-W2AGREE-20260909_S01`  
**Source:** `BURAKOV-MOP-WTI-WINTER-W2AGREE-20260909`  
**Last revised:** 2026-09-09

## 1. Strategy Logic

At the first tradable `XTIUSD.DWX` D1 bar of a normalized broker week whose
Monday anchor lies from November through May, read only the two immediately
...
`414040000`. The symbol is an input; no executable symbol literal is embedded
...
week. Only November-through-May anchors may continue. Validate the two
...
two-week winter interaction, continuous-CFD efficacy, and portfolio
...
| entry | winter calendar, two completed-week packages, strict agreement, continuation side, durable attempt, spread and frozen ATR stop |
