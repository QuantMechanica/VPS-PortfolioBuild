"""Deterministic reference checks for QM5_41404 WTI winter two-week agreement."""
...
def agreement_signal(
    ...
    """Mirror two adjacent completed weeks and strict-sign continuation."""
...
class WtiWinterTwoWeekAgreementReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_nonwinter_months_are_ineligible(self) -> None:
        for value in (date(2026, 6, 1), date(2026, 7, 6), date(2026, 10, 5)):
