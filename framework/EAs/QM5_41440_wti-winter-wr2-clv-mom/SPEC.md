# QM5_41440_wti-winter-wr2-clv-mom - Strategy Spec

**EA ID:** QM5_41440  
**Strategy ID:** `BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-CLV-MOM-20260911_S01`
...
is strictly wider and its final close is strictly in its upper quartile (`CLV>0.75`). Equality,
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414400000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-CLV-MOM-20260911/source.md`. It
...
WTI return-sign rules), `QM5_41438` (symmetric XNG November-March WR2/CLV), and
`QM5_41434/41435` (WTI August-October hurricane-only WR2/CLV).
