...
#property description "QM5_41440 WTI Winter WR2 CLV Momentum"
...
//   - buy after an expanding newest week closes in its upper quartile
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41440_WTI_WINTER_WR2_CLV_MOM";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_WINTER_WR2_CLV_MOM_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41440 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41440_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41440\",\"ea\":\"wti-winter-wr2-clv-mom\"}");
