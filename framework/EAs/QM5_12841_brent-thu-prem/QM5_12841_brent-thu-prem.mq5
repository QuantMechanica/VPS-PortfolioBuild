...
#property description "QM5_12841 Brent Thursday Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12841 - Brent Thursday Calendar Premium
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - buy XBRUSD.DWX on the broker-calendar Thursday D1 bar
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12841_BRENT_THU_PREM";
   ...
   req.reason = "BRENT_THURSDAY_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12841\",\"ea\":\"brent-thu-prem\"}");
