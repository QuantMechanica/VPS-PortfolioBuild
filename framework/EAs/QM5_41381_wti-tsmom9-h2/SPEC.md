# QM5_41381_wti-tsmom9-h2 — Strategy Spec

**EA ID:** QM5_41381
**Slug:** `wti-tsmom9-h2`
**Source:** `MOP-WTI-TSMOM9-H2-2026`
**Author of this spec:** Codex
**Last revised:** 2026-09-07

## 1. Strategy Logic

On the first D1 bar of each odd broker month, reconstruct ten consecutive
completed WTI month-end closes and follow the sign of the exact nine-month log
...
| `strategy_return_months` | `9` | `[9]` | Exact formation intervals |
...
**Source ID:** `MOP-WTI-TSMOM9-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM9-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41381_wti-tsmom9-h2_card.md`.
...
`QM5_20293` renews the same nine-month direction monthly. `QM5_20281` uses
...
exact nine-month endpoints with the fixed odd-month two-month lifecycle.
...
| v2 | 2026-09-07 | Q01 and Q02 intake | Governed compile/build check PASS; CPU-admitted Q02 enqueued |
...
`4b1d5e17-c622-4436-9948-e0fb054adc61` `COMPILE_OK`, zero compiler errors or
warnings, and build check PASS.

Q02 work item `bb254af8-2ddd-4450-9f73-f0ca96c3d688` was enqueued pending on
`XTIUSD.DWX` D1 with no priority boost after CPU samples
`72.3, 65.6, 63.1, 66.7, 64.4`; maximum 72.3% remained below the binding 97%
ceiling.
