...
#property description "QM5_12819 XNG Thursday Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12819 - XNG Thursday Calendar Fade
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - sell XNGUSD.DWX on the broker-calendar Thursday D1 bar
//   - flatten on the next non-Thursday D1 bar or one-day stale-position guard
// Runtime uses MT5 OHLC/broker calendar only; no external energy data.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12819;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12819_XNG_THU_FADE";
   ...
   req.reason = "XNG_THURSDAY_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12819\",\"ea\":\"xng-thu-fade\"}");
