...
The EA tests one exact WTI crude-oil day-of-week anomaly. At a genuine new
broker D1 bar timestamped Wednesday (`day_of_week == 3`, Sunday=0), it consumes
one daily decision and attempts one long WTI position. The position closes at
...
- XTIUSD.DWX on magic slot 0, the registered Darwinex WTI crude-oil CFD route.

**Explicitly not for:**

- WTI, metals, indices, FX, other WTI routes or other magic slots.
...
| Drawdown profile | high WTI gap/basis risk, bounded by fixed risk and broker stop |
...
**Source ID:** LI-WTI-DOW-2022  
**Source type:** named-author peer-reviewed full-text paper (tier B)  
**Pointer:** strategy-seeds/sources/LI-WTI-DOW-2022/source.md  
**Approved card:** strategy-seeds/cards/approved/QM5_20022_wti-wed-long_card.md
...
The paper reports a `-0.2664%` Wednesday mean for WTI crude-oil futures and
...
|---|---|---|---|
| v1 | 2026-07-20 | Initial source-backed WTI Wednesday build | Q02 candidate |
