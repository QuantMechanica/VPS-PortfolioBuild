...
#property description "QM5_20022 WTI Wednesday One-Session Long"
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20022_WTI_WED_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsWtiD1())
      return true;
   if(qm_ea_id != 20022 || qm_magic_slot_offset != 0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "WTI_WED_ONE_SESSION_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20022\",\"ea\":\"wti-wed-long\"}");
