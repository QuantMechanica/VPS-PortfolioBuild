...
#property description "QM5_10901 Carter SMA 9/100 Cross"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const ENUM_TIMEFRAMES signal_tf = PERIOD_H1;
   const double fast_now = QM_SMA(_Symbol, signal_tf, strategy_fast_sma_period, 1, PRICE_CLOSE);
   const double slow_now = QM_SMA(_Symbol, signal_tf, strategy_slow_sma_period, 1, PRICE_CLOSE);
   const double fast_prev = QM_SMA(_Symbol, signal_tf, strategy_fast_sma_period, 2, PRICE_CLOSE);
   const double slow_prev = QM_SMA(_Symbol, signal_tf, strategy_slow_sma_period, 2, PRICE_CLOSE);
   ...
   req.sl = sl;
   req.tp = tp;
   req.reason = (direction > 0) ? "CARTER_SMA9_100_BULL_CROSS" : "CARTER_SMA9_100_BEAR_CROSS";
   return true;
  }
