...
#property description "QM5_41037 XNG Monthly Information-Flow Divergence"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41037 - XNG Monthly Information-Flow Divergence
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41037 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41037_XNG_MFLOW_DIV";
...
int OnInit()
  {
   if(!SymbolSelect(g_strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41037 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41037_MFLOW_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41037\",\"ea\":\"xng-mflow-div\"}");
