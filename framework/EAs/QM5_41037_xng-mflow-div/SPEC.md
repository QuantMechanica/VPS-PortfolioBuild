# QM5_41037_xng-mflow-div - Strategy Spec

**EA ID:** QM5_41037  
**Slug:** `xng-mflow-div`  
**Strategy ID:** `WILLIAMS-MOP-XNG-MFLOWDIV-2026_S01`  
**Source:** `WILLIAMS-MOP-XNG-MFLOWDIV-2026`  
**Author:** Codex  
**Last revised:** 2026-08-17

## 1. Strategy Logic

At the first executable `XNGUSD.DWX` D1 tick of a new normalized broker month,
...
opposite signs and their total reconciles to the completed month return: long
when session flow is positive and overnight flow is negative, and short when
session flow is negative and overnight flow is positive. Direction follows
session flow irrespective of the completed-month total sign. Agreement or
...
- Symmetric session-following long/short direction; agreement and exact zero
  remain flat.
...
is `strategy-seeds/sources/WILLIAMS-MOP-XNG-MFLOWDIV-2026/source.md`.
