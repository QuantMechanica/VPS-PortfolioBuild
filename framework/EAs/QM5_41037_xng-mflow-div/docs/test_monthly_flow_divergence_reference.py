"""Independent mechanic fixtures for QM5_41037.
...
opposition, session-flow direction independent of total sign, month-return
...
class MonthlyFlowDivergenceReferenceTests(unittest.TestCase):
    ...
    def test_positive_session_negative_overnight_buys_when_total_positive(self) -> None:
    ...
    def test_positive_session_negative_overnight_buys_when_total_negative(self) -> None:
    ...
    def test_negative_session_positive_overnight_sells_when_total_positive(self) -> None:
        direction, overnight, session, _, total = flow_direction(
    ...
    def test_negative_session_positive_overnight_sells_when_total_negative(self) -> None:
        direction, overnight, session, _, total = flow_direction(
