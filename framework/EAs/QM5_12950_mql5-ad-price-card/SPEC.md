# QM5_12950_mql5-ad-price-card — Strategy Spec

**EA ID:** QM5_12950
**Slug:** `mql5-ad-price-card`
...
`artifacts/cards_approved/QM5_12950_mql5-ad-price-card.md`. See that card's body for
...
`QM5_12950_mql5-ad-price-card.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_ema_period` | 100 | (see source) | (see strategy logic) |
...
| `strategy_max_bars_in_trade` | 36 | (see source) | (see strategy logic) |
...
| Cadence note | "AD plus price continuation on H1; roughly 50-120 trades per year per symbol" |
...
`artifacts/cards_approved/QM5_12950_mql5-ad-price-card.md`
