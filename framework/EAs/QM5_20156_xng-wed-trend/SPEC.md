# QM5_20156_xng-wed-trend — Strategy Spec

**EA ID:** QM5_20156
**Slug:** `xng-wed-trend`
**Source:** `BOROWSKI-MOP-XNG-WEDTREND-2026`
...
On the first observed tick of each genuine Wednesday D1 bar immediately following
...
two-day stale repair. The first non-Wednesday D1 bar is the ordinary exit. The
...
| `strategy_entry_grace_minutes` | 5 | locked | Maximum Wednesday-bar attachment delay |
...
- `XNGUSD.DWX` — registered Darwinex XNG CFD carrier for the cited Wednesday
...
| Calendar gate | current bar Wednesday and prior completed bar Monday |
| Attempt key | Wednesday-anchored broker week derived from D1 bar time |

Only completed D1 history enters the trend state. The current Wednesday bar's
first executable quote determines entry; the Friday-close to Wednesday-open gap
...
| Typical hold time | Wednesday session only, bounded at two calendar days |
| Expected drawdown profile | XNG gaps and short squeezes during negative slow-trend states |
| Regime preference | Wednesday weakness aligned with negative 252-D1 XNG trend |
...
- **Source ID:** `BOROWSKI-MOP-XNG-WEDTREND-2026`
- **Source type:** governed composite of two peer-reviewed journal papers
- **Pointer:**
  `strategy-seeds/sources/BOROWSKI-MOP-XNG-WEDTREND-2026/source.md`
- **R1-R4 verdict (G0):** all PASS; see
  `strategy-seeds/cards/approved/QM5_20156_xng-wed-trend_card.md`

Borowski supply the XNG Wednesday direction. Moskowitz, Ooi, and
Pedersen supply the completed 12-month own-return sign. Their conjunction and
the continuous-CFD Wednesday-open package are QM hypotheses.
