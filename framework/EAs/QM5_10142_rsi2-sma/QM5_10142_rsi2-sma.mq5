...
input double strategy_long_level        = 10.0;
input double strategy_short_level       = 90.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = sl;
   req.tp = 0.0;
   req.reason = (side == QM_BUY) ? "RSI2_SMA_PULLBACK_LONG" : "RSI2_SMA_PULLBACK_SHORT";
   req.symbol_slot = qm_magic_slot_offset;
   req.expiration_seconds = 0;
   return true;
  }
