# QM5_12924_hopwood-stochastic-cross-h1 — Strategy Spec

**EA ID:** QM5_12924
**Slug:** `hopwood-stochastic-cross-h1`
...
`artifacts/cards_approved/QM5_12924_hopwood-stochastic-cross-h1.md`. See that card's body for
...
`QM5_12924_hopwood-stochastic-cross-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_overbought_level` | 70.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_12924_hopwood-stochastic-cross-h1.md`
