...
#property description "QM5_13101 XNG one-week low-volatility momentum"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13101_XNG_1W_MOM_VOL";
   ...
   req.tp = 0.0;
   req.reason = (direction > 0) ? "XNG_1W_LOWVOL_MOM_LONG" : "XNG_1W_LOWVOL_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13101\",\"ea\":\"xng-1w-mom-vol\"}");
