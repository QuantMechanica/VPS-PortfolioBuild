...
#property description "QM5_13015 Grimes New-High Acceptance Continuation v2 (exit surgery)"
// Strategy Card: QM5_13015 (grimes-accept-high-v2), G0 APPROVED 2026-07-04.
// Source: Adam H. Grimes, Patterns, Context, and a Clean Long in the S&P, 2025-08-25.
//
// EXIT SURGERY v2 — parent QM5_10938
// Surgical delta: strategy_max_hold_bars 24 -> 48 (24h -> 48h hard ceiling).
// Evidence: EXIT_SURGERY_SCAN_2026-07-04.md §3.6; hold-gradient WR 8%->62%;
// 8-trade 1-3d bucket (WR 62%, avg +760) has 5/8 TIME_MGMT kills at 24h ceiling.
// SL widening is Tier-B (parked); no stop changes in this build.
// All other logic and parameters are IDENTICAL to parent QM5_10938.

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13015;
...
// v2 surgical change: extended from 24 -> 48 H1 bars (24h -> 48h hard ceiling).
// Evidence: EXIT_SURGERY_SCAN_2026-07-04.md §3.6 — 8 trades in 1-3d bucket have
// WR 62% and avg net +760, with 5/8 being TIME_MGMT kills at the 24h ceiling.
// Extending to 48h lets the edge fully mature in the 24-48h window.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = sl;
   req.tp = tp;
   req.reason = want_long ? "GRIMES_ACCEPT_HIGH_V2_LONG" : "GRIMES_ACCEPT_HIGH_V2_SHORT";
...
void Strategy_ManageOpenPosition()
  {
   ...
   if(improves)
      QM_TM_MoveSL(ticket, NormalizeDouble(open_price, _Digits), "grimes_accept_high_v2_be_1r");
  }
...
bool Strategy_ExitSignal()
  {
   ...
   // v2: max_hold_bars = 48 (extended from 24). Time exit fires at 48 H1 bars (48h).
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13015_grimes_accept_high_v2\",\"surgery\":\"max_hold_bars_24to48\"}");
