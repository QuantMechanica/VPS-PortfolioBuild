...
#property description "QM5_12568 ichimoku-jpy-xag-trend — port of QM5_10513_mql5-ichimoku"
...
int Strategy_OppositeSignal()
  {
   ...
   if(!Strategy_IchimokuSnapshot(0, tenkan_0, kijun_0, span_b_0, close_0))
      return 0;
   if(!Strategy_IchimokuSnapshot(1, tenkan_1, kijun_1, span_b_1, close_1))
      return 0;
...
void Strategy_ManageOpenPosition()
  {
   // P2 baseline explicitly disables trailing and adds no active management.
  }
