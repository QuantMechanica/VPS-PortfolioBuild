# QM5_10144_rsi-sma-trend — Strategy Spec
...
`artifacts/cards_approved/QM5_10144_rsi-sma-trend.md`. See that card's body for
...
`QM5_10144_rsi-sma-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_fast_sma` | 5 | (see source) | (see strategy logic) |
| `strategy_slow_sma` | 20 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10144_rsi-sma-trend.md`
