...
#property description "QM5_41063 XNG Completed-Week NR7 Expansion"
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_41063_XNG_WEEKNR7_ATTEMPT_%I64d",
                       Strategy_Magic());
  }
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(!QM_InputRequireLong("qm_ea_id", qm_ea_id, 41063) ||
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.reason = (direction > 0)
                    ? "XNG_WEEKNR7_LONG" : "XNG_WEEKNR7_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) || !Strategy_IsHostChart() ||
      qm_ea_id != 41063 || qm_magic_slot_offset != 0)
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XNG completed-week NR7 expansion is flat Friday 21"))
     {
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41063\",\"ea\":\"xng-week-nr7-brk\"}");
