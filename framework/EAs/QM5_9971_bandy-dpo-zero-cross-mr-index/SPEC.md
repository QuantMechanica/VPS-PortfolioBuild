# QM5_9971_bandy-dpo-zero-cross-mr-index — Strategy Spec

**EA ID:** QM5_9971
**Slug:** `bandy-dpo-zero-cross-mr-index`
...
`artifacts/cards_approved/QM5_9971_bandy-dpo-zero-cross-mr-index.md`. See that card's body for
...
`QM5_9971_bandy-dpo-zero-cross-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_dpo_period` | 20 | (see source) | (see strategy logic) |
| `strategy_dpo_lag` | 11 | (see source) | (see strategy logic) |
| `strategy_regime_sma_period` | 200 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_stop_mult` | 2.5 | (see source) | (see strategy logic) |
| `strategy_time_stop_days` | 15 | (see source) | (see strategy logic) |
| `strategy_anti_cluster_bars` | 5 | (see source) | (see strategy logic) |
| `strategy_min_dpo_atr_mult` | 0.1 | (see source) | (see strategy logic) |
