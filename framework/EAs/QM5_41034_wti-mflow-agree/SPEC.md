# QM5_41034_wti-mflow-agree - Strategy Spec

**EA ID:** QM5_41034  
**Slug:** `wti-mflow-agree`  
**Strategy ID:** `WILLIAMS-MOP-WTI-MFLOWAGREE-2026_S01`  
**Source:** `WILLIAMS-MOP-WTI-MFLOWAGREE-2026`  
**Author:** Codex  
...
and open-to-close log returns. It enters only when both sums share one strict
sign and their total reconciles to the completed month return: long for two
positive sums and short for two negative sums. Opposition or exact zero
...
- Approximately 5-8 positions per full post-warm-up year after strict
  information-flow agreement.
- Symmetric long/short direction; opposition and exact zero remain flat.
...
is `strategy-seeds/sources/WILLIAMS-MOP-WTI-MFLOWAGREE-2026/source.md`.
