...
#property description "QM5_41437 WTI Hurricane-Season NR2 Close Breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41437 - WTI Hurricane-Season NR2 Close Breakout
// -----------------------------------------------------------------------------
// D1 structural crude-oil sleeve:
//   - decide only in August through October during the hurricane-risk peak
...
input int    strategy_hurricane_month_1      = 8;
input int    strategy_hurricane_month_2      = 9;
input int    strategy_hurricane_month_3      = 10;
...
bool Strategy_IsHurricaneMonth(const int month)
  {
   return (month == strategy_hurricane_month_1 ||
           month == strategy_hurricane_month_2 ||
           month == strategy_hurricane_month_3);
  }
...
void Strategy_PrepareDecisionSignal()
  {
   ...
   else if(!Strategy_IsHurricaneMonth(anchor_month))
      g_signal_state = "outside_hurricane_months";
   else
     {
      g_signal_valid =
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(strategy_symbol == "" ||
      ...
      strategy_hurricane_month_1 != 8 ||
      strategy_hurricane_month_2 != 9 ||
      strategy_hurricane_month_3 != 10 ||
      strategy_required_weeks != 2 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41437_WTI_HURR_NR2_BREAKOUT";
   ...
   req.reason = (g_signal_direction > 0 ?
                 "WTI_HURR_NR2_BREAKOUT_LONG" :
                 "WTI_HURR_NR2_BREAKOUT_SHORT");
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41437 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41437_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41437\",\"ea\":\"wti-hurr-nr2-breakout\"}");
