# QM5_31004_xauusd-vwap-liquidity-sweep-scalp — Strategy Spec

**EA ID:** QM5_31004
**Slug:** `xauusd-vwap-liquidity-sweep-scalp`
**Source:** `xauusd-vwap-liquidity-sweep-scalp-official-source` (see `strategy-seeds/sources/xauusd-vwap-liquidity-sweep-scalp-official-source/`)
...
`artifacts/cards_approved/QM5_31004_xauusd-vwap-liquidity-sweep-scalp.md`. See that card's body for
...
`QM5_31004_xauusd-vwap-liquidity-sweep-scalp.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `InpVWAPBandDev` | 2.00 | (see source) | (see strategy logic) |
| `InpRSIPeriod` | 14 | (see source) | (see strategy logic) |
...
**Source ID:** `xauusd-vwap-liquidity-sweep-scalp-official-source`
**Pointer:** `strategy-seeds/sources/xauusd-vwap-liquidity-sweep-scalp-official-source/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_31004_xauusd-vwap-liquidity-sweep-scalp.md`
