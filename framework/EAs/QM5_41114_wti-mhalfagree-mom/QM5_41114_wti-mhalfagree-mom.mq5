...
#property description "QM5_41114 WTI Completed-Month Two-Half Agreement Momentum"
...
bool Strategy_LoadTwoHalfSignal(const int current_month_key,
                                const int label_offset,
                                int &direction,
                                int &new_month_bars,
...
void Strategy_PrepareDecisionSignal()
  {
   ...
   if(Strategy_MonthAlreadyEntered(g_decision_month_key))
     ...
     {
      g_signal_valid =
         Strategy_LoadTwoHalfSignal(g_decision_month_key,
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "two_half_agreement_long";
      else if(g_signal_direction < 0)
         g_signal_state = "two_half_agreement_short";
      else if(g_first_half_return == 0.0 ||
              g_second_half_return == 0.0)
         g_signal_state = "half_equality_flat";
      else
         g_signal_state = "half_sign_disagreement_flat";
     }
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41114 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41114_WTI_MHALFAGREE_MOM";
   ...
   req.reason = (g_signal_direction > 0)
      ? "WTI_MHALFAGREE_MOM_LONG"
      : "WTI_MHALFAGREE_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41114 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41114_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
                "{\"card\":\"QM5_41114\",\"ea\":\"wti-mhalfagree-mom\"}");
