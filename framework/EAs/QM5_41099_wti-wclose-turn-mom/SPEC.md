# QM5_41099_wti-wclose-turn-mom - Strategy Spec
...
**Source:** `BIANCHI-MOP-WTI-WCLOSE-TURN-MOM-2026`
...
On the first tradable `XTIUSD.DWX` D1 bar of a new broker week, load every
...
- Symmetric direct-WTI continuation after a completed-week reversal and full
  recovery.
- One fixed-risk position and one durable attempt per broker week.
- A different carrier and mechanic do not prove decorrelation; Q09 owns that
  verdict.
...
The papers supply commodity reversal/continuation lineage and explicit WTI
