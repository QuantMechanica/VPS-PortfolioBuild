...
#property description "QM5_41099 WTI Weekly Close-Turn Recovery Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41099 - WTI Weekly Close-Turn Recovery Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41099 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41099_WTI_WCLOSE_TURN_MOM";
   ...
   req.reason = (g_signal_direction > 0)
       ? "WTI_WCLOSE_TURN_LONG"
       : "WTI_WCLOSE_TURN_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
       !Strategy_IsHostChart() || qm_ea_id != 41099 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41099_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
                "{\"card\":\"QM5_41099\",\"ea\":\"wti-wclose-turn-mom\"}");
