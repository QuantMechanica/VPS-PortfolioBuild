...
| `ICT_MODE_FX_WEEKLY_SWEEP` | EURUSD.DWX + GBPUSD.DWX | M5 | previous NY-week PWH/PWL sweep in London/NY session -> later MSS -> earliest FVG virtual trigger -> fixed preceding-session boundary |
