...
void OnTick()
  {
   ...
   // exit/management path per the 2026-07-02 audit finding — position
   // management and bracket enforcement must keep running through news
   // windows even though this EA's brackets are server-side SL/TP.
