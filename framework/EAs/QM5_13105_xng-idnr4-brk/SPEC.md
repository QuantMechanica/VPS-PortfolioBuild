# QM5_13105_xng-idnr4-brk - Strategy Spec

**EA ID:** QM5_13105  
**Slug:** `xng-idnr4-brk`  
**Strategy ID:** `CRABEL-XNG-IDNR4-2026_S01`  
**Source:** `CRABEL-XNG-IDNR4-2026`  
**Author:** Codex  
**Last revised:** 2026-07-10

## 1. Strategy Logic

This EA implements a low-frequency natural-gas ID/NR4 contraction breakout on
`XNGUSD.DWX` D1. The setup bar must be strictly inside its predecessor and
...
- Regime preference: daily XNG volatility contraction followed by immediate
  range expansion.
- This is not cumulative RSI2, weekly reversal/momentum, calendar, storage-
  event, seasonality, ratio, carry, index, or metal logic.
...
- Approved card: `strategy-seeds/cards/approved/QM5_13105_xng-idnr4-brk_card.md`.
- Build result: `artifacts/qm5_13105_build_result.json`.
- Q02 enqueue: `artifacts/qm5_13105_q02_enqueue_20260710.json`.
