...
#property description "MQL5 Sidus rebuild"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 10493;
...
input int    strategy_model             = 2;
input int    strategy_fast_period       = 5;
input int    strategy_mid_period        = 8;
input int    strategy_slow_period       = 13;
