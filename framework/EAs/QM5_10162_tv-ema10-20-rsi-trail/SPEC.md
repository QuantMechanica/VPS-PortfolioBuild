...
`artifacts/cards_approved/QM5_10162_tv-ema10-20-rsi-trail.md`. See that card's body for
...
`QM5_10162_tv-ema10-20-rsi-trail.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_ema_fast` | 10 | (see source) | (see strategy logic) |
| `strategy_ema_slow` | 20 | (see source) | (see strategy logic) |
| `strategy_ema_trend` | 100 | (see source) | (see strategy logic) |
...
| `strategy_stop_percent` | 1.5 | (see source) | (see strategy logic) |
| `strategy_fx_atr_cap` | 1.0 | (see source) | (see strategy logic) |
| `strategy_trail_atr_mult` | 1.5 | (see source) | (see strategy logic) |
| `strategy_trail_offset_atr` | 1.0 | (see source) | (see strategy logic) |
| `strategy_time_exit_bars` | 24 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10162_tv-ema10-20-rsi-trail.md`
