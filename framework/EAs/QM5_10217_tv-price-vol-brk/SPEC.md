...
`artifacts/cards_approved/QM5_10217_tv-price-vol-brk.md`. See that card's body for
...
`QM5_10217_tv-price-vol-brk.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_trend_ma_period` | 50 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 1.5 | (see source) | (see strategy logic) |
| `strategy_atr_cap_mult` | 3.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10217_tv-price-vol-brk.md`
