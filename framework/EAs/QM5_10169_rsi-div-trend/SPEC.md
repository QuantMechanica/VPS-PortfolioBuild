...
`artifacts/cards_approved/QM5_10169_rsi-div-trend.md`. See that card's body for
...
`QM5_10169_rsi-div-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_pivot_order` | 5 | (see source) | (see strategy logic) |
| `strategy_pivot_count_k` | 2 | (see source) | (see strategy logic) |
...
| `strategy_atr_stop_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_trail_atr_mult` | 4.0 | (see source) | (see strategy logic) |
| `strategy_warmup_bars` | 220 | (see source) | (see strategy logic) |
| `strategy_pivot_scan_bars` | 80 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10169_rsi-div-trend.md`
