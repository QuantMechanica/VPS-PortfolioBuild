...
#property description "QM5_20145 WTI Friday Premium Slow-Trend Agreement"
...
//   - first observed tick of a genuine broker-calendar Friday D1 bar
...
//   - framework Friday close, frozen ATR stop, and three-day stale repair
// Runtime uses MT5-native OHLC/calendar/history only; no external data or ML.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                     = 20145;
...
bool Strategy_LoadMomentum(double &momentum,
                           int &direction)
  {
   ...
   const int copied =
      CopyClose(_Symbol, // perf-allowed: bounded Friday D1 momentum sample.
                PERIOD_D1,
                1,
                required,
                closes);
...
void Strategy_CloseExpiredPositions()
  {
   ...
   const bool current_bar_is_friday =
      Strategy_IsFridayBar(current_bar);
   const datetime now = TimeCurrent();
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "WTI_FRI_POS252_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20145_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20145\",\"ea\":\"wti-fri-trend\"}");
