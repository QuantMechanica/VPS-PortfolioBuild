...
#property description "QM5_41488 WTI 12M TSMOM ATR Gate"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41488 - WTI 12-Month Time-Series Momentum ATR Gate
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41488_WTI_TSMOM12M_ATR";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_41488\",\"ea\":\"commodity-tsmom-12m-atr-symbolinput\"}");
