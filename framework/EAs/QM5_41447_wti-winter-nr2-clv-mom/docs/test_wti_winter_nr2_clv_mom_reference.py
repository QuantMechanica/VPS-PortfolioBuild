"""Deterministic reference checks for QM5_41447 WTI winter NR2/CLV momentum."""
...
class WtiWinterNR2CLVReferenceTest(unittest.TestCase):
    ...
    def test_contraction_upper_quartile_is_long(self) -> None:
        self.assertEqual(signal(self.current, *self.bars(0.8))[0], 1)

    def test_contraction_lower_quartile_is_flat(self) -> None:
    ...
    def test_three_to_five_sessions_are_valid(self) -> None:
        for count in (3, 4, 5):
            newest = package(self.new, count, 98, 90, 96.4)
