...
type: strategy
strategy_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912_S01
variant_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912_S01
source_id: BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912
ea_id: QM5_41447
slug: wti-winter-nr2-clv-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41447_wti-winter-nr2-clv-mom.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41447_wti_winter_nr2_clv_momentum_g0.md
source_approval: decisions/2026-09-12_wti_winter_nr2_clv_momentum_source_approval.md
...
source_citations:
  - type: peer_reviewed_and_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912/source.md
    quality_tier: A_and_B_lineages_with_cross_source_and_horizon_translation_risk
    role: november_may_calendar_range_contraction_and_long_continuation_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-two-completed-weeks-newest-strict-narrower-range-than-prior-strict-upper-quartile-final-close-long-only-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912]]"]
concepts: ["[[concepts/wti-winter-seasonality]]", "[[concepts/completed-week-range-contraction]]", "[[concepts/time-series-momentum]]"]
indicators: ["[[indicators/completed-week-range]]", "[[indicators/completed-week-close-location]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-premium, weekly-range-contraction, close-location, long-only, weekly-continuation, atr-hard-stop, time-stop, low-frequency]
...
pipeline_phase: Q02
q01_status: PASS
q01_compile_work_item: 54a704f4-3951-4363-8528-e8d638b79fe9
q01_build_report: D:/QM/reports/work_items/54a704f4-3951-4363-8528-e8d638b79fe9/QM5_41447/COMPILE_EA/compile_evidence.json
q02_status: ENQUEUED
q02_work_item: 11e67265-23c2-490b-a675-bd04c3dbc977
q02_receipt: D:/QM/strategy_farm/artifacts/receipts/first_q02_intake/54a704f4-3951-4363-8528-e8d638b79fe9_11e67265-23c2-490b-a675-bd04c3dbc977.json
force_build: true
review_focus: "Falsify a WTI November-May range-contraction/upper-quartile continuation distinct from the certified XNG oscillator, monthly WTI winter sign rules, hurricane-only NR2/CLV rules, and XNG winter NR2/CLV rule. Verify exact weeks, strict inequalities, long-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, november_may_gate, normalized_week_clock, two_consecutive_completed_weeks, bounded_week_sessions, strict_range_contraction, strict_upper_quartile_close, long_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineage with explicit translation risk; R2 exact mechanical WTI winter NR2/CLV long continuation; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-NR2-CLV-MOM-20260912/source.md`.
...
The canonical scan found no exact match. `QM5_41440` requires strict range expansion, the
opposite volatility state. The two older WTI winter fuzzy neighbors use one completed calendar-
month return sign and no weekly range/CLV state. `QM5_41438` trades XNG symmetrically, only in
November-March, and after expansion. `QM5_41441` waits for a later completed-close breakout;
`QM5_41445/41446` read weekly body sign rather than close location. Certified `QM5_12567` is a
two-day cumulative-RSI XNG pullback. Carrier, full November-May clock, strict contraction,
upper-quartile close, long-only side, and one-week hold are jointly load-bearing.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41447, slot zero, registered magic, and
...
late restart, consumed week, ineligible month, malformed packages, noncontracting range, CLV at or
...
Monday anchors, two completed weeks, strict range contraction, upper-quartile threshold, boundary
...
range contraction, range tie, strict CLV threshold, long-only entry, body-sign irrelevance,
...
| Q01 Build Validation | 2026-09-12 | PASS | governed T2 compile; zero compiler errors/warnings; strict build check PASS; 11 reference tests; PACER audit zero hits |
| Q02 Baseline Screening | 2026-09-12 | ENQUEUED | deterministic intake receipt; claimed by T8 at handoff |
