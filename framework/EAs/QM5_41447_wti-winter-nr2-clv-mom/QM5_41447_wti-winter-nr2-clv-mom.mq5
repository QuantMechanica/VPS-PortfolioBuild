...
#property description "QM5_41447 WTI Winter NR2 CLV Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41447 - WTI Winter NR2 Upper-Quartile Continuation
// -----------------------------------------------------------------------------
...
//   - buy after a contracting newest week closes in its upper quartile
   ...
   else
     {
      ...
      if(!g_signal_valid)
         g_signal_state = "two_completed_weeks_validation_failed";
          ...
          g_signal_state = "nr2_upper_quartile_continuation_long";
         ...
         g_signal_state = "close_not_upper_quartile_flat";
     }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41447_WTI_WINTER_NR2_CLV_MOM";
   ...
   if(!g_decision_bar || g_late_decision ||
      ...
      !Strategy_IsWinterMonth(
         Strategy_WeekAnchorMonth(g_decision_week_key)) ||
      !g_signal_valid || g_signal_direction != 1)
      return false;
   ...
   req.type = QM_BUY;
   req.reason = "WTI_WINTER_NR2_CLV_MOM_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41447 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41447_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41447\",\"ea\":\"wti-winter-nr2-clv-mom\"}");
