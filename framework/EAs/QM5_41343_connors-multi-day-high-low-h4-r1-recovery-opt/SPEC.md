# QM5_41343_connors-multi-day-high-low-h4-r1-recovery-opt - Strategy Spec

**EA ID:** QM5_41343
**Slug:** `connors-multi-day-high-low-h4-r1-recovery-opt`
**Parent EA:** `QM5_20086_connors-multi-day-high-low-h4-r1-recovery`
**Target symbols:** `EURUSD.DWX`
**Source:** `6e967762-b26d-59a3-b076-35c17f2e7c36` (inherited from the approved parent card)
...
40 trades/year on the host. This package is measurement-only; no live
or pipeline verdict is authorized.

## 6. Source Citation

Source ID `6e967762-b26d-59a3-b076-35c17f2e7c36` and its citations are inherited from the approved
`QM5_20086` parent card.
