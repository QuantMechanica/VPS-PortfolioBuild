...
`artifacts/cards_approved/QM5_10090_mql5-harami-h1.md`. See that card's body for
...
`QM5_10090_mql5-harami-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_min_mother_body_points` | 0.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10090_mql5-harami-h1.md`
