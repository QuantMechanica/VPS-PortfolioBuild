...
#property description "QM5_11120 MA Price Cross"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const int signal = Strategy_PriceCrossSignal();
   if(signal == 0)
      return false;
   ...
   req.sl = sl;
   req.tp = 0.0;
   req.reason = (side == QM_BUY) ? "PRICE_CROSS_SMA_LONG" : "PRICE_CROSS_SMA_SHORT";
   return true;
  }
