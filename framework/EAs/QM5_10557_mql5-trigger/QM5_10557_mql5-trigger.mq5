...
#property description "MQL5 Trigger Line rebuild"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 10557;
...
string strategy_symbols[] = {"GBPUSD.DWX", "EURUSD.DWX", "GBPJPY.DWX", "XAUUSD.DWX"};
string strategy_reason = "TRIGGER_LINE";
