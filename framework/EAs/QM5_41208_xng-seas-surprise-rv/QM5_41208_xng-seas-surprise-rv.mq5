...
#property description "QM5_41208 XNG Monthly Standardized Seasonal-Surprise Reversion"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41208 - XNG Monthly Standardized Seasonal-Surprise Reversion
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(!QM_InputRequireLong("qm_ea_id", qm_ea_id, 41208) ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "XNG_SEAS_SURPRISE_RV";
   ...
   if(g_signal_direction > 0)
     {
      req.type = QM_BUY;
      req.reason = "XNG_SEAS_SURPRISE_BUY";
     }
   else
     {
      req.type = QM_SELL;
      req.reason = "XNG_SEAS_SURPRISE_SELL";
     }
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41208 ||
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XNG monthly standardized seasonal-surprise card holds to the next broker month"))
      return INIT_FAILED;
   ...
   g_attempt_state_key =
      StringFormat("QM5_41208_SEAS_SURPRISE_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41208\",\"ea\":\"xng-seas-surprise-rv\"}");
