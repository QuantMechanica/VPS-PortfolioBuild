...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K4H2_S34
variant_id: MOP-TSMOM-2012_XTI_K4H2_S34
source_id: MOP-WTI-TSMOM4-H2-2026
ea_id: QM5_41383
slug: wti-tsmom4-h2
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41383_wti-tsmom4-h2_card.md
execution_contract_status: APPROVED
created: 2026-09-08
created_by: Research+Development
last_updated: 2026-09-08
g0_status: APPROVED
g0_decision: decisions/2026-09-08_qm5_41383_wti_tsmom4_h2_g0.md
source_approval: decisions/2026-09-08_wti_four_month_momentum_two_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM4-H2-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: bimonthly-wti-sign-of-exact-four-completed-broker-month-log-return-two-month-hold-odd-month-epoch
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, four-month-return, two-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; five consecutive completed month-end closes; exact four-month log-return sign; odd-month decisions; two-month hold; 300 D1 bars; 3.5*ATR(20,D1) frozen stop; 70-day stale repair; 1500-point spread ceiling."
review_focus: "Falsify the source-bounded WTI k=4,h=2 stream. Verify five exact completed-month endpoints, odd-month-only attempts, no even-month rollover, fixed risk, frozen stop, and next-odd-month exit. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal]
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_four_month_orientation, odd_month_epoch, bimonthly_attempt_state, two_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
---

# QM5_41383 WTI Four-Month Momentum / Two-Month Hold

## Hypothesis

A four-completed-month WTI own-return direction may persist when held as a
...
WTI `k=4, h=2` result or continuous-CFD evidence.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/MOP-WTI-TSMOM4-H2-2026/source.md`; its complete-read
...
only. `QM5_20280` uses the same four-month return with monthly renewal;
`QM5_20281` uses the same two-month clock with a twelve-month return, while
`QM5_41379` through `QM5_41382` use three-, one-, nine-, and six-month
returns. This card requires both exact `k=4` endpoints and the fixed odd-month
`h=2` lifecycle.
...
- History: five consecutive completed broker-month-end closes `C[0]..C[4]`,
  oldest to newest; newest is the immediately prior completed month.
- Formula: `r4 = ln(C[4] / C[0])`; positive buys, negative sells, equality or invalid state stays flat.
...
2. Require configured symbol, D1, EA 41383, slot 0, and fixed-risk backtest mode.
...
4. Reconstruct exactly five positive finite consecutive completed month-end
   closes with strictly increasing timestamps and no current-month price.
5. Compute `ln(C[4]/C[0])`; buy strict positive and sell strict negative.
...
Q01 must prove month adjacency and year boundaries, exact five endpoints,
...
|---|---|---|---|
| G0 Research Intake | 2026-09-08 | APPROVED | `decisions/2026-09-08_qm5_41383_wti_tsmom4_h2_g0.md` |
| Q01 Build Validation | 2026-09-08 | PASS | PACER audit zero findings; 13/13 reference vectors; governed `COMPILE_OK` work item `2560324d-2582-45cd-8ed7-63bf439589ca` |
| Q02 Baseline Screening | 2026-09-08 | NOT_ENQUEUED_CPU_CEILING | dry run eligible; fresh maximum CPU 99.221850% exceeded the binding 97% ceiling |
