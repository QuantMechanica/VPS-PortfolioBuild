# QM5_41383_wti-tsmom4-h2 — Strategy Spec

**EA ID:** QM5_41383  
**Slug:** `wti-tsmom4-h2`  
**Source:** `MOP-WTI-TSMOM4-H2-2026`  
...
completed WTI month-end closes and follow the sign of the exact four-month log
...
**Source ID:** `MOP-WTI-TSMOM4-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM4-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41383_wti-tsmom4-h2_card.md`.
...
`QM5_20280` renews the same four-month direction monthly. `QM5_20281` uses
...
combines the exact four-month endpoints with the fixed odd-month two-month
lifecycle.
