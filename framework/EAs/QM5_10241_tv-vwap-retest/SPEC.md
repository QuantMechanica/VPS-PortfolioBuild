...
|---|---|---|---|
| `strategy_break_lookback_bars` | 5 | (see source) | (see strategy logic) |
| `strategy_retest_max_bars` | 8 | (see source) | (see strategy logic) |
...
| `strategy_use_rejection_wick` | true | (see source) | (see strategy logic) |
| `strategy_rejection_wick_frac` | 0.30 | (see source) | (see strategy logic) |
| `strategy_use_volume_spike` | true | (see source) | (see strategy logic) |
| `strategy_volume_spike_mult` | 1.2 | (see source) | (see strategy logic) |
| `strategy_volume_avg_bars` | 20 | (see source) | (see strategy logic) |
| `strategy_min_atr_dist_mult` | 0.0 | (see source) | (see strategy logic) |
