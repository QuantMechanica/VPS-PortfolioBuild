...
#property description "QM5_20051 XTI XNG 1-Month Cross-Sectional Momentum"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_20051 - XTI/XNG 1-Month Cross-Sectional Momentum
// -----------------------------------------------------------------------------
// Monthly market-neutral energy basket:
//   - reconstruct 2 completed broker month-end closes from native D1 history
//   - calculate and rank the last completed monthly return per leg
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xti_short_xng ? "QM5_20051_LONG_XTI_SHORT_XNG_HIGH_1M_RETURN"
                                            : "QM5_20051_SHORT_XTI_LONG_XNG_HIGH_1M_RETURN";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20051_XTI_XNG_XMOM1_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20051\",\"ea\":\"energy-xmom1\"}");
