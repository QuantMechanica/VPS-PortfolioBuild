...
#property description "QM5_41391 WTI Ten-Month Trend / One-Month Hold"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41391 - WTI Ten-Month Trend / One-Month Hold
// -----------------------------------------------------------------------------
...
// The exact ten-month endpoint pair remains independent of the one-month clock.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41391;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41391_WTI_TSMOM10_H1";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_41391_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41391\",\"ea\":\"wti-tsmom10-h1\"}");
