...
#property description "QM5_20222 WTI Seasonal Sign Concordance"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(!Strategy_LoadReturnSignSignal(month_key,
                                     positive_probability,
                                     positive_count,
                                     trade_direction) ||
      trade_direction == 0 ||
   ...
   req.reason = StringFormat("WTI_SEAS_SIGN_%s_P%02d_OF_%02d",
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20222_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20222\",\"ea\":\"wti-seas-sign\"}");
