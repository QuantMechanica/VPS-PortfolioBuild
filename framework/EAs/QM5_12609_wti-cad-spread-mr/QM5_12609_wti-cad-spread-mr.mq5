...
#property description "QM5_12609 WTI CAD Spread Mean Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12609 - WTI/CAD petro-currency spread mean reversion
// -----------------------------------------------------------------------------
// D1 two-leg basket:
//   spread = ln(XTIUSD.DWX) + beta * ln(USDCAD.DWX)
//   rich spread: sell XTI, sell USDCAD
//   cheap spread: buy XTI, buy USDCAD
// Runtime uses MT5 OHLC only; no macro feed, futures curve, API, or ML.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12609;
...
bool Strategy_OpenPair(const int spread_direction)
  {
   ...
   const string reason = long_spread ? "QM5_12609_LONG_XTI_USDCAD_SPREAD"
                                     : "QM5_12609_SHORT_XTI_USDCAD_SPREAD";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12609_SPREAD_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12609\",\"ea\":\"wti-cad-spread-mr\"}");
