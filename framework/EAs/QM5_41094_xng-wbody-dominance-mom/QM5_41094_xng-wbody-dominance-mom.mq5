...
#property description "QM5_41094 XNG Weekly Body-Dominance Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41094 - XNG Weekly Body-Dominance Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41094 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41094_XNG_WBODY_DOMINANCE_MOM";
   ...
   req.reason = (g_signal_direction > 0)
       ? "XNG_WBODY_DOM_MOM_LONG"
       : "XNG_WBODY_DOM_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
       !Strategy_IsHostChart() || qm_ea_id != 41094 ||
   ...
   g_attempt_state_key =
      StringFormat("QM5_41094_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
                "{\"card\":\"QM5_41094\",\"ea\":\"xng-wbody-dominance-mom\"}");
