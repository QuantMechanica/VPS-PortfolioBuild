# QM5_41094_xng-wbody-dominance-mom - Strategy Spec
...
**Source:** `MOP-XNG-WBODY-DOMINANCE-MOM-2026`
...
- Approximately ten to twenty-five completed XNG positions per full post-
  warm-up year; Q02 owns the binding activity verdict.
- Symmetric direct-XNG weekly structural continuation after a directional
  completed auction.
- One fixed-risk position and one consumed attempt per broker week.
- A different mechanic on the existing XNG carrier does not establish decorrelation; Q09 owns
...
`strategy-seeds/sources/MOP-XNG-WBODY-DOMINANCE-MOM-2026/source.md`.

The paper supplies own-price continuation lineage and includes natural-gas futures. Weekly
