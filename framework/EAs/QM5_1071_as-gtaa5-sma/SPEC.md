# QM5_1071_as-gtaa5-sma - Strategy Spec
...
| 3 | `GDAXI.DWX` | Foreign equity / Europe index proxy. |
| 4 | `XAUUSD.DWX` | Commodity proxy. |

Bond and REIT sleeves from original GTAA5 are intentionally flat/cash until OWNER/CTO assigns DWX-safe proxies.
