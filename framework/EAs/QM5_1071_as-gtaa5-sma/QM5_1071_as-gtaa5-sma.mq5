...
#property description "QM5_1071 Allocate Smartly GTAA5 10-month SMA"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA
// Strategy Card: QM5_1071_as-gtaa5-sma
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 1071;
...
bool Strategy_SymbolSlotAllowed()
  {
   if(_Symbol == "SP500.DWX"  && qm_magic_slot_offset == 0) return true;
   if(_Symbol == "NDX.DWX"    && qm_magic_slot_offset == 1) return true;
   if(_Symbol == "WS30.DWX"   && qm_magic_slot_offset == 2) return true;
   if(_Symbol == "GDAXI.DWX"  && qm_magic_slot_offset == 3) return true;
   if(_Symbol == "XAUUSD.DWX" && qm_magic_slot_offset == 4) return true;
   return false;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "GTAA5_MONTH_CLOSE_ABOVE_SMA10";
   return true;
  }

void Strategy_ManageOpenPosition()
  {
   // GTAA5 uses monthly risk-on/risk-off exits; no trailing, BE, or partials.
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_1071_as_gtaa5_sma\"}");
