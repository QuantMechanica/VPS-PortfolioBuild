# QM5_20017_xng-dom15-long - Strategy Spec
...
bar whose timestamp is calendar day 15, it consumes one monthly decision and
attempts one long XNG position. A month without a D1 bar dated the 15th is
...
broker hour 21 preserves the one-session package when the 15th is a Friday.
...
- A shifted substitute when calendar day 15 has no D1 bar.
...
**Source ID:** BOROWSKI-XNG-DOM15-2016  
**Source type:** named-author peer-reviewed full-text paper (tier B)  
**Pointer:** strategy-seeds/sources/BOROWSKI-XNG-DOM15-2016/source.md  
**Approved card:** strategy-seeds/cards/approved/QM5_20017_xng-dom15-long_card.md
...
The paper reports a +0.9881% mean for natural-gas calendar day 15 and
p=0.0008 over its 1990-2016 NYMEX sample. It searches many calendar partitions
...
|---|---|---|---|
| v1 | 2026-07-20 | Initial source-backed XNG day-15 build | Q02 candidate |
