...
#property description "QM5_20017 XNG Calendar-Day-15 One-Session Premium"
...
//   - BUY only at the opening of a broker D1 bar dated exactly the 15th
//   - never shift an absent/non-trading 15th to a neighboring session
...
input int    strategy_entry_day           = 15;
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20017_XNG_DOM15_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_PrimeLateDay15Attach()
  {
...
bool Strategy_ConsumeDay15Decision()
  {
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsXngD1())
      return true;
   if(qm_ea_id != 20017 || qm_magic_slot_offset != 0)
      return true;
   if(!qm_friday_close_enabled ||
      qm_friday_close_hour_broker != 21)
      return true;
   if(strategy_entry_day != 15)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "XNG_DOM15_ONE_SESSION_LONG";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved DOM15 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;

   Strategy_LoadAttemptState(TimeCurrent());
   if(!Strategy_PrimeLateDay15Attach())
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_20017\",\"ea\":\"xng-dom15-long\"}");
...
void OnTick()
  {
   ...
   if(!Strategy_ConsumeDay15Decision())
      return;
