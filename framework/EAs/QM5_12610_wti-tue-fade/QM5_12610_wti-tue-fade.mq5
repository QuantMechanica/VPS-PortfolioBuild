...
#property description "QM5_12610 WTI Tuesday Seasonality Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12610 - WTI Tuesday Seasonality Fade
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - short XTIUSD.DWX on the broker-calendar Tuesday D1 bar
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12610_WTI_TUE_FADE";
   ...
   req.reason = "WTI_TUESDAY_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12610\",\"ea\":\"wti-tue-fade\"}");
