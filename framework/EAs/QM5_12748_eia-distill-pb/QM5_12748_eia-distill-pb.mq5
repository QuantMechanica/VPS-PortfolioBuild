...
// =============================================================================
// QM5_12748 - EIA Winter Distillate Pullback
// -----------------------------------------------------------------------------
// D1 structural WTI sleeve:
//   - long only during the Oct-Mar winter heating-oil season window
//   - pullback entry above a slow trend filter, rebound/date/time exits
// Runtime uses MT5 OHLC only; no EIA, weather, inventory, product-spread, or
// futures feed.
// =============================================================================
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12748_EIA_DISTILL_PB";
