...
`artifacts/cards_approved/QM5_10108_gh-getynet-2bar.md`. See that card's body for
...
`QM5_10108_gh-getynet-2bar.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_open_hour_broker` | 9 | (see source) | (see strategy logic) |
| `strategy_pinbar_opposite_body` | false | (see source) | (see strategy logic) |
| `strategy_range_min_points` | 0.0 | (see source) | (see strategy logic) |
| `strategy_range_max_points` | 0.0 | (see source) | (see strategy logic) |
| `strategy_min_accum_points` | 0.0 | (see source) | (see strategy logic) |
| `strategy_max_spread_risk_pct` | 5.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_max_sl_atr_mult` | 3.0 | (see source) | (see strategy logic) |
...
| Cadence note | "London-open two-bar reversal pattern, at most one entry/day/symbol and usually selective. Estimate 20-45 trades/year/symbol." |
...
`artifacts/cards_approved/QM5_10108_gh-getynet-2bar.md`
