...
"""Independent mechanic fixtures for QM5_41053.
...
reconciliation, counter-gap-fade direction,
...
class PostWednesdayCounterGapFadeReferenceTests(unittest.TestCase):
    ...
    def test_agreement_and_exact_zero_are_flat(self) -> None:
        self.assertEqual(post_wednesday_direction(100.0, 102.0, 103.0)[0], 0)
        self.assertEqual(post_wednesday_direction(100.0, 98.0, 97.0)[0], 0)
    ...
    def test_equal_or_countergap_dominance_is_flat(self) -> None:
        self.assertEqual(post_wednesday_direction(100.0, 102.0, 100.0)[0], 0)
        self.assertEqual(post_wednesday_direction(100.0, 102.0, 99.0)[0], 0)
        self.assertEqual(post_wednesday_direction(100.0, 98.0, 101.0)[0], 0)
    ...
    def test_later_intrabar_price_is_not_a_signal_input(self) -> None:
        frozen = post_wednesday_direction(100.0, 104.0, 102.0)
        # The reference function has no post-open price argument by design.
        after_large_intraday_move = post_wednesday_direction(100.0, 104.0, 102.0)
