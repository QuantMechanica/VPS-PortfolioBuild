...
#property description "QM5_2003 NNFX Wave Sniper"
...
// -----------------------------------------------------------------------------
// Baseline: McGinley Dynamic (14 period)
// Confirmation: Wadah Attar Explosion (WAE Proxy: MACD Hist > ATR Deadzone)
...
double McGinleyValue(const int shift)
  {
   // Using EMA as a stable baseline proxy within the framework constraint
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double mcginley_1 = McGinleyValue(1);
