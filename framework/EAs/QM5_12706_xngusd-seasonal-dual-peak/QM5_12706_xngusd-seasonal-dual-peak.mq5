...
#property description "QM5_12706 XNG Seasonal Dual Peak Long"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12706 - XNG Seasonal Dual Peak Long
// -----------------------------------------------------------------------------
// D1 structural natural-gas sleeve:
//   - long-only in the November-March and June-August demand-peak windows
...
bool Strategy_IsDemandPeakMonth(const int month)
  {
   return (month == 11 || month == 12 || month == 1 || month == 2 ||
           month == 3 || month == 6 || month == 7 || month == 8);
  }
...
void Strategy_CloseOpenPositionsIfNeeded()
  {
   ...
   const bool in_peak = Strategy_IsDemandPeakMonth(month);
   const int magic = QM_FrameworkMagic();
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12706_XNG_DUAL_PEAK";
   ...
   const int month = Strategy_MonthFromTime(current_bar);
   if(!Strategy_IsDemandPeakMonth(month))
      return false;
   ...
   req.reason = "XNG_SEASONAL_DUAL_PEAK_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12706\",\"ea\":\"xngusd-seasonal-dual-peak\"}");
