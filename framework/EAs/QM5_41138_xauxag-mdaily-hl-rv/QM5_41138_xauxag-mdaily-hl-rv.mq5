...
#property description "QM5_41138 XAU/XAG Completed-Month Daily Hodges-Lehmann Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_41138 - XAU/XAG Completed-Month Daily Hodges-Lehmann Reversion
// -----------------------------------------------------------------------------
...
// Form every inclusive self/cross-pair average of the gold-minus-silver daily
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41138 && qm_magic_slot_offset == 0 &&
            qm_rng_seed == 42 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_MDAILY_HL_RV_ATTEMPT_MONTH_%I64d",
                       qm_ea_id,
                       Strategy_HostMagic());
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41138_XAUXAG_MDAILY_HL_RV";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41138_XAUXAG_MDAILY_HL_RV_HOST";
   ...
   if(valid && direction > 0)
      state = "negative_pseudomedian_fade_long_xau";
   else if(valid && direction < 0)
      state = "positive_pseudomedian_fade_short_xau";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG completed-month daily Hodges-Lehmann reversion package holds through Fridays until next broker month"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41138\",\"ea\":\"xauxag-mdaily-hl-rv\"}");
