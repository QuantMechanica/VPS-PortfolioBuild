...
#property description "QM5_12826 CME Natural Gas Silver Ratio Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12826 - CME Natural Gas/Silver Ratio Reversion
// -----------------------------------------------------------------------------
// D1 two-leg commodity basket:
//   spread = ln(XNGUSD.DWX) - beta * ln(XAGUSD.DWX)
//   z > entry: short ratio = sell XNG, buy silver
//   z < -entry: long ratio = buy XNG, sell silver
...
bool Strategy_OpenPair(const int ratio_direction)
  {
   ...
   const string reason = long_ratio ? "QM5_12826_LONG_XNG_XAG_RATIO"
                                    : "QM5_12826_SHORT_XNG_XAG_RATIO";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12826_RATIO_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12826\",\"ea\":\"cme-gassilver-ratio\"}");
