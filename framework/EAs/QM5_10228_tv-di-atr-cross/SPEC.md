# QM5_10228_tv-di-atr-cross — Strategy Spec
...
`artifacts/cards_approved/QM5_10228_tv-di-atr-cross.md`. See that card's body for
...
`QM5_10228_tv-di-atr-cross.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_di_period` | 14 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10228_tv-di-atr-cross.md`
