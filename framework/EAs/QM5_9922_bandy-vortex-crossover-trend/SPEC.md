# QM5_9922_bandy-vortex-crossover-trend — Strategy Spec

**EA ID:** QM5_9922
**Slug:** `bandy-vortex-crossover-trend`
...
`artifacts/cards_approved/QM5_9922_bandy-vortex-crossover-trend.md`. See that card's body for
...
`QM5_9922_bandy-vortex-crossover-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_vortex_min_diff` | 0.05 | (see source) | (see strategy logic) |
...
| `strategy_chandelier_lookback` | 22 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_chandelier_atr_mult` | 2.5 | (see source) | (see strategy logic) |
| `strategy_time_stop_days` | 60 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9922_bandy-vortex-crossover-trend.md`
