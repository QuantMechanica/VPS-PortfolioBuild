...
type: strategy
strategy_id: MOP-TSMOM-2012_XTI_K11H2_S40
variant_id: MOP-TSMOM-2012_XTI_K11H2_S40
source_id: MOP-WTI-TSMOM11-H2-2026
ea_id: QM5_41390
slug: wti-tsmom11-h2
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41390_wti-tsmom11-h2_card.md
execution_contract_status: APPROVED
created: 2026-09-09
created_by: Research+Development
last_updated: 2026-09-09
g0_status: APPROVED
g0_decision: decisions/2026-09-09_qm5_41390_wti_tsmom11_h2_g0.md
source_approval: decisions/2026-09-09_wti_eleven_month_momentum_two_month_hold_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jfineco.2011.11.003; complete-read parent strategy-seeds/sources/MOP-TSMOM-2012/source.md; bounded extraction strategy-seeds/sources/MOP-WTI-TSMOM11-H2-2026/source.md"
    quality_tier: A
    role: primary_own_return_formation_holding_family_and_wti_membership
strategy_mechanic: bimonthly-wti-sign-of-exact-eleven-completed-broker-month-log-return-two-month-hold-odd-month-epoch
strategy_type_flags: [commodity, energy, wti-crude, structural-trend, time-series-momentum, eleven-month-return, two-month-hold, symmetric-long-short, atr-hard-stop, low-frequency]
...
hard_rules_at_risk: [exact_symbol_period, completed_month_reconstruction, exact_eleven_month_orientation, odd_month_epoch, bimonthly_attempt_state, two_month_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
---

# QM5_41390 WTI Eleven-Month Momentum / Two-Month Hold

## Hypothesis

An eleven-completed-month WTI own-return direction may persist when held as a
...
WTI `k=11, h=2` result or continuous-CFD evidence.

## Source Traceability And Non-Duplicate Decision

The approved packet is
`strategy-seeds/sources/MOP-WTI-TSMOM11-H2-2026/source.md`; its complete-read
...
`QM5_41379` through `QM5_41388` use three-, one-, nine-, six-, four-, two-,
five-, seven-, eight-, and ten-month returns. This card requires both exact `k=11`
...
2. Require configured symbol, D1, EA 41390, slot 0, and fixed-risk backtest mode.
...
Q01 must prove month adjacency and year boundaries, exact twelve endpoints,
