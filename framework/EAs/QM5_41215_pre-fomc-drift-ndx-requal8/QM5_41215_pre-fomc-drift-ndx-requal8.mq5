...
#property description "QM5_41215 Pre-FOMC Drift NDX — faithful port of PRE_FOMC_FLAT_IDX.mq5"
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(Bars(_Symbol, PERIOD_D1) < strategy_atr_period + 2) // perf-allowed: one structural history-readiness check per framework-gated tick.
      return true;
   return false;
  }
