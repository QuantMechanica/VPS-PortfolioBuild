...
ratio returns, compute their exact 32-step Hampel robust location, and
...
- Host: `XAUUSD.DWX`, D1, slot 0, magic `413480000`.
- Second traded leg: `XAGUSD.DWX`, slot 1, magic `413480001`.
- Signal: even median/MAD, frozen `1.4826*MAD` scale, exact Hampel
  `a=2`, `b=4`, `c=8` boundary inclusions and piecewise weights, exactly 32
  updates, and strict `1e-12` final-location epsilon.
