...
type: strategy
strategy_id: AI-CODEX-XAUXAG-MHAMPEL-RV-20260905_S01
variant_id: AI-CODEX-XAUXAG-MHAMPEL-RV-20260905_S01
source_id: AI-CODEX-XAUXAG-MHAMPEL-RV-20260905
ea_id: QM5_41348
slug: xauxag-mhampel-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41348_xauxag-mhampel-rv_card.md
execution_contract_status: APPROVED
created: 2026-09-05
created_by: Research+Development
last_updated: 2026-09-05
g0_status: APPROVED
g0_decision: decisions/2026-09-05_qm5_41348_xauxag_monthly_hampel_reversion_g0.md
source_approval: decisions/2026-09-05_xauxag_monthly_hampel_reversion_source_approval.md
source_author: OpenAI Codex
source_authors: OpenAI Codex; Karsten Schweikert; Frank R. Hampel; Elvezio M. Ronchetti; Peter J. Rousseeuw; Werner A. Stahel; W. N. Venables; B. D. Ripley; CME Group
source_citation: "Schweikert (2018), Journal of Banking & Finance 88, DOI 10.1016/j.jbankfin.2017.11.010; CME Group, Gold & Silver Ratio Spread; Hampel et al. (1986), Robust Statistics; author-maintained CRAN MASS psi.hampel documentation and source."
source_citations:
  - type: governed_composite_source
    citation: "OpenAI Codex (2026). XAU/XAG monthly redescending-Hampel ratio-return reversion."
    location: strategy-seeds/sources/AI-CODEX-XAUXAG-MHAMPEL-RV-20260905/source.md
  ...
  - type: governed_method_source
    citation: "Hampel et al. (1986), Robust Statistics; Venables and Ripley, CRAN MASS rlm/psi.hampel documentation and implementation."
...
strategy_mechanic: monthly-xauxag-thirteen-synchronized-completed-month-log-ratio-endpoints-twelve-adjacent-returns-frozen-scale-hampel-2-4-8-redescending-32-step-location-sign-contrarian-equal-notional-basket
sources:
  - "[[sources/AI-CODEX-XAUXAG-MHAMPEL-RV-20260905]]"
concepts:
...
indicators:
  ...
  - "[[indicators/redescending-hampel-location]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, precious-metals, market-neutral-style, relative-value, structural-reversion, redescending-hampel, monthly-renewal, equal-notional-basket, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41348_XAU_XAG_HAMPEL_RV_D1
symbol: QM5_41348_XAU_XAG_HAMPEL_RV_D1
...
r2_mechanical: PASS
r2_reasoning: "Clock, thirteen synchronized endpoints, twelve returns, even median/MAD, frozen normalized scale, exact Hampel 2/4/8 boundaries, 32 updates, contrarian side, equal-notional package, aggregate fixed risk, stops, attempt, and lifecycle are deterministic."
...
parameters_to_test: "Locked Q02 baseline only: 13 synchronized consecutive completed month-end ratio endpoints; 12 adjacent chronological log-ratio returns; even median indexes 5/6; raw MAD indexes 5/6; 1.4826 frozen scale; Hampel boundaries a=2, b=4, c=8; exact boundary inclusions and piecewise psi(u)/u weights; exactly 32 updates; 1e-12 sign epsilon; contrarian ratio side; 1200 D1 history bars; 180-minute month-entry grace; 10-day endpoint staleness; per-leg ATR(20)*3.5 frozen stops; equal target notionals; 20% notional mismatch ceiling; 40-day stale exit; 1500/500-point spread ceilings."
...
hard_rules_at_risk: [exact_symbols_period, first_tradable_month_bar, thirteen_consecutive_completed_months, synchronized_month_end_pairs, chronological_log_ratio_returns, even_sample_median, even_sample_mad, mad_normalization, frozen_hampel_scale, hampel_a_2, hampel_b_4, hampel_c_8, exact_boundary_inclusion, exactly_32_updates, contrarian_direction, monthly_attempt_state, equal_notional_pair, aggregate_fixed_risk, atomic_pair_lifecycle, hard_stops_present, friday_close_disabled, next_month_exit, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "OWNER mission 2026-09-05 and decisions/2026-09-05_qm5_41348_xauxag_monthly_hampel_reversion_g0.md: R1-R4 pass within disclosed synthesis and continuous-CFD risks. Corrected-root dedup found no exact identity across 4,828 registry rows, 1,441 cards, and 45 Wiki nodes; six fuzzy family matches were manually resolved. A fixed twelve-return fixture makes Hampel sell while nearest bisquare QM5_41341 buys. This identity decision is not a correlation claim."
---
...
governed Hampel packet fixes exact arithmetic. No source tests this
...
`FUZZY_MATCH` with no exact identity. Manual review resolved all six candidates.
This EA neither z-scores an absolute ratio (`QM5_12577`), regresses a
...
object, Hampel `2/4/8` update path, and contrarian opposed-leg output are jointly
load-bearing. On the declared twelve-return fixture the new Hampel estimator is
positive and sells, while nearest `QM5_41341` bisquare is negative and buys.

## Markets, Timeframe, And Cadence

- Logical symbol: `QM5_41348_XAU_XAG_HAMPEL_RV_D1`.
...
returns; even median/MAD; frozen `1.4826*MAD` scale; Hampel `2/4/8` piecewise
weights with exact boundary inclusions; 32 updates; `1e-12` decision epsilon; contrarian
...
1. Match independent fixtures for positive/negative robust centers,
   Hampel boundary weights, redescending outlier rejection, reflection,
   bisquare side disagreement, degeneracy, and synchronized
   log-ratio return identity.
2. Verify exact endpoint order, median/MAD indices, frozen scale, 32 updates,
   `2/4/8` boundaries, epsilon, contrarian sides, aggregate fixed risk, equal
   target notionals, atomic recovery, and lifecycle.
...
|---|---|---|---|---|
| v1 | 2026-09-05 | initial XAU/XAG Hampel reversion card | G0 | APPROVED; build pending |

## Pipeline Phase Status

| Phase | Date | Verdict | Evidence path |
|---|---|---|---|
| G0 Source Approval | 2026-09-05 | APPROVED_SOURCE | `decisions/2026-09-05_xauxag_monthly_hampel_reversion_source_approval.md` |
| G0 Research Intake | 2026-09-05 | APPROVED | `decisions/2026-09-05_qm5_41348_xauxag_monthly_hampel_reversion_g0.md` |
