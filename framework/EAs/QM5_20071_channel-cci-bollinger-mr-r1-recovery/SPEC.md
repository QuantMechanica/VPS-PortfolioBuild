# QM5_20071_channel-cci-bollinger-mr-r1-recovery — Strategy Spec

**EA ID:** QM5_20071
**Slug:** `channel-cci-bollinger-mr-r1-recovery`
...
`artifacts/cards_approved/QM5_20071_channel-cci-bollinger-mr-r1-recovery.md`. See that card's body for
...
`QM5_20071_channel-cci-bollinger-mr-r1-recovery.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_cci_period` | 20 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_mult` | 1.5 | (see source) | (see strategy logic) |
| `strategy_atr_filter_period` | 20 | (see source) | (see strategy logic) |
| `strategy_bandwidth_mult` | 0.5 | (see source) | (see strategy logic) |
| `strategy_max_holding_bars` | 24 | (see source) | (see strategy logic) |
| `strategy_max_spread_points` | 25 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_20071_channel-cci-bollinger-mr-r1-recovery.md`
