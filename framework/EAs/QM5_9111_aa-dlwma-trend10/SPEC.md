# QM5_9111_aa-dlwma-trend10 — Strategy Spec

**EA ID:** QM5_9111
**Slug:** `aa-dlwma-trend10`
...
`artifacts/cards_approved/QM5_9111_aa-dlwma-trend10.md`. See that card's body for
...
`QM5_9111_aa-dlwma-trend10.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_period` | 10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9111_aa-dlwma-trend10.md`
