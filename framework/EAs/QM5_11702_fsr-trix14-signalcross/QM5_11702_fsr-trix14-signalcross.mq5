...
#property description "QM5_11702 fsr-trix14-signalcross — TRIX(14)/signal-line cross (H1 FX)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11702 fsr-trix14-signalcross
// -----------------------------------------------------------------------------
// Source: Anonymous, "Trix Strategy Trading System — Method #1: Signal Line
//   Cross", Strategy #309, forexstrategiesresources.com, 2013 (R1 FAIL track
//   record, R2/R3/R4 PASS). Card: artifacts/cards_approved/
//   QM5_11702_fsr-trix14-signalcross.md (g0_status APPROVED).
//
...
//   Take profit  : 2 x SL distance => 2:1 RR  (card factory default).
...
input double strategy_tp_rr             = 2.0;    // take-profit risk-reward multiple
