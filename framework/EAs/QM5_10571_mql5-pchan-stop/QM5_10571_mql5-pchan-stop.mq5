...
#property description "MQL5 Price Channel Stop rebuild"
...
input int    strategy_channel_bars      = 22;
...
string strategy_symbols[] = {"EURUSD.DWX", "GBPUSD.DWX", "EURJPY.DWX", "XAUUSD.DWX"};
string strategy_reason = "PCHAN_STOP";
