...
`artifacts/cards_approved/QM5_10254_tv-double-atr.md`. See that card's body for
...
`QM5_10254_tv-double-atr.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_atr_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_catastrophic_mult` | 5.0 | (see source) | (see strategy logic) |
| `strategy_seed_bars` | 300 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10254_tv-double-atr.md`
