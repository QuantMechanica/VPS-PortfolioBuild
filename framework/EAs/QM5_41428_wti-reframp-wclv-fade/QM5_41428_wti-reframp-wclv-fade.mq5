...
#property description "QM5_41428 WTI Refinery-Ramp Weekly Close-Location Reversion"
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "negative_return_lower_tercile_long";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41428_WTI_REFRAMP_WCLV_FADE";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_REFRAMP_WCLV_FADE_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41428 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41428_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41428\",\"ea\":\"wti-reframp-wclv-fade\"}");
