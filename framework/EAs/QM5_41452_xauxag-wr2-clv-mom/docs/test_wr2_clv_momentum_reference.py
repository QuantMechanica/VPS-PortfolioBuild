"""Deterministic reference checks for QM5_41452 XAU/XAG weekly WR2 CLV momentum."""
...
MQ5 = EA_DIR / "QM5_41452_xauxag-wr2-clv-mom.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41452_xauxag-wr2-clv-mom_QM5_41452_XAU_XAG_WR2_CLV_MOM_D1_D1_backtest.set"
)
...
class Wr2ClvMomentumReferenceTest(unittest.TestCase):
    def test_ratio_range_and_both_continuation_sides(self) -> None:
        prior_width, _ = range_and_clv([4.58, 4.61, 4.57, 4.60])
        upper_width, upper_clv = range_and_clv([4.55, 4.62, 4.54, 4.64])
        lower_width, lower_clv = range_and_clv([4.65, 4.59, 4.66, 4.54])
    ...
    def test_static_artifacts_lock_signal_risk_and_unpinned_framework(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41452", source)
        ...
        self.assertRegex(resolver, re.compile(r"414520000.*414520001", re.DOTALL))
