...
type: strategy
strategy_id: FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912_S01
variant_id: FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912_S01
source_id: FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912
ea_id: QM5_41452
slug: xauxag-wr2-clv-mom
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41452_xauxag-wr2-clv-mom.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41452_xauxag_wr2_clv_momentum_g0.md
source_approval: decisions/2026-09-12_xauxag_wr2_clv_momentum_source_approval.md
...
source_citations:
  - type: peer_reviewed_exchange_and_reputable_bounded_mechanization
    ...
    location: strategy-seeds/sources/FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912/source.md
    quality_tier: A_and_B_lineages_with_cross_source_and_weekly_translation_risk
    role: gold_silver_relative_carrier_weekly_range_expansion_and_momentum_lineage
strategy_mechanic: normalized-week-boundary-xau-xag-two-synchronized-completed-weeks-newest-strict-wider-log-ratio-close-range-strict-outer-quartile-final-ratio-close-continuation-equal-notional-one-week-basket
sources: ["[[sources/FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912]]"]
...
strategy_type_flags: [commodity, precious-metals, gold-silver-relative-value, market-neutral-basket, weekly-range-expansion, close-location, momentum, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41452_XAU_XAG_WR2_CLV_MOM_D1
symbol: QM5_41452_XAU_XAG_WR2_CLV_MOM_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [414520000, 414520001]
period: D1
timeframe: D1
...
q01_status: PASS
q01_compile_work_item: 7bfbc3bc-bfc6-4496-b896-4efcd0aba437
q01_build_report: D:/QM/reports/work_items/7bfbc3bc-bfc6-4496-b896-4efcd0aba437/QM5_41452/COMPILE_EA/compile_evidence.json
q02_status: ENQUEUED
q02_work_item: 28433272-cc99-48ba-bb04-cc8dcda8a817
force_build: true
review_focus: "Falsify a two-week XAU/XAG ratio-close range-expansion and outer-quartile continuation basket outside the certified directional XAU/SP500/NDX/XNG book. Verify synchronized ratio ranges, strict inequalities, continuation package, durable weekly attempt, aggregate fixed risk, atomic repair, and next-week lifecycle. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [input_bound_xau_xag_carrier, immediately_preceding_two_monday_anchors, synchronized_completed_d1_closes, bounded_week_session_counts, positive_ratio_close_ranges, strict_newest_range_expansion, strict_outer_quartile_ratio_close, continuation_package_direction, persistent_week_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_week_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed, exchange, and governed reputable lineage with explicit translation risk; R2 exact mechanical two-week ratio WR2/CLV continuation basket; R3 registered XAU/XAG D1; R4 deterministic non-ML; no exact duplicate after canonical and manual family review."
---

# QM5_41452 XAU/XAG Weekly WR2 CLV Momentum

## Hypothesis

When the synchronized gold/silver log-ratio close range expands from one completed broker week
...
`strategy-seeds/sources/FMR-CRABEL-CME-XAUXAG-WR2-CLV-MOM-20260912/source.md`.
...
lineage. None validates this weekly ratio-range expansion and outer-quartile continuation.

The canonical scan found no exact identity and raised expected coarse family matches. `QM5_41448`
uses the identical WR2/CLV event but fades it; `QM5_41449` uses WR2 and continues body sign without
a CLV condition; `QM5_41450` uses NR2 and fades body sign; `QM5_41451` uses NR2 and continues CLV;
`QM5_41060` uses seven weekly ranges and a later breakout; and `QM5_12724` uses a 120-day ratio
channel and channel exit. The paired carrier, two synchronized weeks, ratio-close WR2 state,
ratio CLV threshold, continuation side, immediate entry, and one-week hold are jointly load-bearing.
...
1. Run only from the setfile-bound `XAUUSD.DWX` D1 host with input-bound `XAGUSD.DWX` companion,
   EA 41452, slots zero/one, registered magics, and fixed-risk backtest mode.
...
4. For every session compute `s=ln(XAU_close)-ln(XAG_close)`. For each week compute
   ...
   `R`; equality or contraction is flat. Do not require containment.
...
positive ranges, strict expansion and tie, strict upper/lower CLV
...
| Q01 Build Validation | 2026-09-12 | PASS | compile `7bfbc3bc-bfc6-4496-b896-4efcd0aba437`; `COMPILE_OK`; zero compiler errors/warnings; strict build check PASS; 6 reference tests; PACER audit zero hits |
| Q02 Baseline Screening | 2026-09-12 | PENDING | logical-basket work item `28433272-cc99-48ba-bb04-cc8dcda8a817`; five-sample whole-host CPU max 74.9% below 97% ceiling |
