...
#property description "QM5_12854 Brent December Calendar Fade"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12854_BRENT_DEC_FADE";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12854\",\"ea\":\"brent-dec-fade\"}");
