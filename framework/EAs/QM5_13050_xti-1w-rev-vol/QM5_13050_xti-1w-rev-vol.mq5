...
#property description "QM5_13050 XTI one-week high-volatility reversal"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13050_XTI_1W_REV_VOL";
   ...
   req.tp = 0.0;
   req.reason = (direction > 0) ? "XTI_1W_HIGHVOL_REV_LONG" : "XTI_1W_HIGHVOL_REV_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13050\",\"ea\":\"xti-1w-rev-vol\"}");
