...
input int    strategy_return_window_months    = 36;
...
bool Strategy_AverageReturn(const string symbol,
                            ...
                            int &observation_count)
  {
   ...
   if(observation_count != strategy_return_window_months || observation_count < 2)
      return false;
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xti_short_xng ? "QM5_13149_LONG_XTI_SHORT_XNG_HIGH_36M_RETURN"
                                            : "QM5_13149_SHORT_XTI_LONG_XNG_HIGH_36M_RETURN";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart())
      return true;
   if(strategy_return_window_months != 36)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13149_XTI_XNG_TREND36_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13149\",\"ea\":\"energy-trend36\"}");
