# QM5_41443_wti-winter-wr2-body-mom - Strategy Spec

**EA ID:** QM5_41443  
**Strategy ID:** `BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911_S01`
...
strictly wider. Buy when that week's final close is strictly above its chronological first open;
sell when it is strictly below. Range equality, contraction, or body equality is flat. Consume the
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414430000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-WR2-BODY-MOM-20260911/source.md`. It
...
The rule differs from `QM5_12567` (two-day XNG oscillator pullback), `QM5_41440` (strict
upper-quartile WTI long only), `QM5_41441` (contracting-week later-close breakout), `QM5_41442`
(outer-quartile fade), and `QM5_41087` (all-year four-week maximum plus CLV/body agreement).
...
| entry | November-May calendar, two completed weeks, strict range expansion, own-body continuation, attempt, spread, ATR stop |
