"""Deterministic reference checks for QM5_41443 WTI winter WR2 body momentum."""
...
class WtiWinterWR2BodyMomentumReferenceTest(unittest.TestCase):
    ...
    def test_expansion_positive_body_is_long(self) -> None:
        self.assertEqual(signal(self.current, *self.bars(100.0, 106.0)), 1)

    def test_expansion_negative_body_is_short(self) -> None:
