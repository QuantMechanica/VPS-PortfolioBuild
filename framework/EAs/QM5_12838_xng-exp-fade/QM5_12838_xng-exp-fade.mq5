...
#property description "QM5_12838 XNG Henry Hub Expiry Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12838 - XNG Henry Hub Expiry Fade
// -----------------------------------------------------------------------------
...
input int    strategy_mean_period         = 34;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12838_XNG_EXP_FADE";
   ...
   req.reason = (direction > 0) ? "CME_XNG_EXPIRY_FADE_LONG" : "CME_XNG_EXPIRY_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12838\",\"ea\":\"xng-exp-fade\"}");
