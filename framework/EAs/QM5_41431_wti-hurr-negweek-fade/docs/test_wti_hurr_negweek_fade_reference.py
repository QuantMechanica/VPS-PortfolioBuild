"""Deterministic reference checks for QM5_41431 WTI hurricane-season reversion."""
...
def negative_week_signal(current_anchor: date, newest_first: list[Bar]) -> tuple[int, float]:
    """Mirror the immediately completed negative-week, long-only contract."""
...
class WtiHurricaneSeasonNegativeWeekReferenceTest(unittest.TestCase):
    ...
    def test_positive_week_is_flat_not_short(self) -> None:
