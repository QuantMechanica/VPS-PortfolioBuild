...
type: strategy
strategy_id: EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911_S01
variant_id: EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911_S01
source_id: EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911
ea_id: QM5_41431
slug: wti-hurr-negweek-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41431_wti-hurr-negweek-fade_card.md
execution_contract_status: APPROVED
created: 2026-09-11
created_by: Research+Development
last_updated: 2026-09-11
g0_status: APPROVED
g0_decision: decisions/2026-09-11_qm5_41431_wti_hurricane_negative_week_reversion_g0.md
source_approval: decisions/2026-09-11_wti_hurricane_negative_week_reversion_source_approval.md
...
source_citations:
  - type: official_government_and_academic_bounded_mechanization
    citation: "EIA hurricane-season petroleum-supply risk plus Yang-Goncu-Pantelous commodity-reversal lineage; QuantMechanica governed negative-week WTI translation."
    location: strategy-seeds/sources/EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911/source.md
...
strategy_mechanic: normalized-weekly-wti-august-september-october-hurricane-season-one-immediately-completed-week-open-to-close-strict-negative-log-return-long-reversion-one-week-hold
sources: ["[[sources/EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911]]"]
concepts: ["[[concepts/commodity-reversal]]", "[[concepts/hurricane-season-supply-risk]]", "[[concepts/negative-week-reversion]]"]
indicators: ["[[indicators/completed-week-open-close]]", "[[indicators/log-return-sign]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, hurricane-season, negative-week, weekly-reversion, long-only, atr-hard-stop, time-stop, low-frequency]
...
timeframe: D1
direction: long_only
expected_trade_frequency: "Approximately 5-8 completed positions per full post-warm-up year after the negative-week gate; Q02 must prove at least five in every full scored year or retire."
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; eligible months 8,9,10; one immediately completed week with 3-5 sessions; strictly negative open-to-close log return; long-only reversion; 16 D1 history bars; 180-minute entry grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
q01_status: PASS
q02_status: ENQUEUED
q01_build_report: D:/QM/reports/framework/21/build_check_20260911_013813.json
force_build: true
review_focus: "Falsify a long-only WTI hurricane-season negative-week reversion distinct from April-May refinery restart, maintenance-season negative continuation, daily hurricane breakout/fade, unconditional weekly momentum, and XNG shoulder rules. Verify exact week membership, negative-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_wti_carrier, hurricane_season_month_gate, normalized_week_clock, immediately_completed_week_membership, strict_negative_sign, long_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 official EIA plus complete-read academic Yang-Goncu-Pantelous context with disclosed translation risk; R2 exact mechanical long-only negative-week hurricane-season reversion; R3 registered XTIUSD.DWX D1; R4 deterministic non-ML; no exact duplicate and five fuzzy family neighbors manually resolved."
---

# QM5_41431 WTI Hurricane-Season Negative-Week Reversion
...
August, September, and October, a completed negative WTI week may represent a
temporary pullback against the seasonal supply-risk backdrop and reverse over
the following week. This exact
...
`strategy-seeds/sources/EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911/source.md`.
...
The canonical checker found no exact identity and surfaced five fuzzy family
neighbors. `QM5_41430` shares the hurricane calendar and long side but admits only a
positive completed week as continuation; this card admits only a negative
week as reversion. `QM5_41425` has the same negative/long package only in
disjoint April-May refinery-restart months. Maintenance variants differ by
regime or side, and `QM5_41392` trades XNG symmetrically. `QM5_12591` requires
a daily Donchian breakout and trend confirmation, while `QM5_12754` fades a
daily failed spike. Calendar, completed-week formation, negative-only gate,
long side, and one-week lifecycle are jointly load-bearing.
...
1. Run only on the setfile-bound `XTIUSD.DWX` D1 host with EA 41431, slot zero,
...
6. If `r < 0`, buy. Positive, exact zero, malformed, stale, or nonfinite
...
nonnegative return, spread, quote, ATR, stop, sizing, or order state.
...
- One strictly negative completed week, a long-only reversion, the one-week
...
| week clock, hurricane gate, package, negative sign, attempt, spread, ATR | Trade Entry | `Strategy_EntrySignal` and helpers |
...
Q01 must verify all three eligible months, ineligible boundaries, negative
long entry, positive/zero flat states, three-to-five-session weeks, current-
...
| Q01 Build Validation | 2026-09-11 | PASS | compile `9b5e9fb8-29ed-4ce2-8a5c-dc69f28f3d14`; 0 errors / 0 compiler warnings; build-check PASS; PACER audit 0 findings; reference tests 12/12 PASS |
| Q02 Baseline Screening | 2026-09-11 | ENQUEUED | pending canary `1873db73-4c12-466a-bcd0-2ec03fbb2043`; CPU maximum 53.4% below exclusive 97% ceiling |
