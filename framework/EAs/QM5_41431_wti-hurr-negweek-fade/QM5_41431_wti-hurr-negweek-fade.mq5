...
#property description "QM5_41431 WTI Hurricane-Season Negative-Week Reversion"
...
//   - buy only after a strictly negative weekly open-to-close return
...
bool Strategy_LoadNegativeWeekSignal(const int current_week_key,
                                     ...
                                     int &direction)
  {
   ...
   // completed week may revert long; nonnegative returns consume flat.
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "negative_week_reversion_long";
      else
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41431_WTI_HURR_NEGWEEK_FADE";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_HURR_NEGWEEK_FADE_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41431 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41431_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41431\",\"ea\":\"wti-hurr-negweek-fade\"}");
