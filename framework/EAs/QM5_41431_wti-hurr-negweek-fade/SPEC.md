# QM5_41431_wti-hurr-negweek-fade - Strategy Spec

**EA ID:** QM5_41431

**Slug:** `wti-hurr-negweek-fade`

**Strategy ID:** `EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911_S01`

**Source:** `EIA-YANG-WTI-HURR-NEGWEEK-FADE-20260911`
...
`414310000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
completely read Yang-Goncu-Pantelous commodity-reversal record. The exact long-only
...
| entry | hurricane calendar, one completed-week package, strict negative sign, long-only side, durable attempt, spread and frozen ATR stop |
