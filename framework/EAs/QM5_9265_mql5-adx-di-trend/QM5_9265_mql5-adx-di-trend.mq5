...
#property description "QM5_9265 MQL5 ADX DI Trend"
...
input double strategy_adx_entry_min     = 25.0;
input double strategy_adx_exit_floor    = 20.0;
...
void Strategy_ManageOpenPosition()
  {
   // Card specifies static ATR stop and fixed RR take-profit only.
  }
   ...
   if(strategy_max_hold_h1_bars > 0 && opened_at > 0)
     {
      ...
      if(h1_seconds > 0 && TimeCurrent() - opened_at >= strategy_max_hold_h1_bars * h1_seconds)
         return true;
     }
