...
#property description "QM5_20209 WTI Winter-Regime / One-Month Momentum"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = (direction > 0)
      ? "WTI_WINTER_MOM1_LONG"
      : "WTI_WINTER_MOM1_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20209_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20209\",\"ea\":\"wti-winter-mom1\"}");
