# QM5_41486_connors-rsi2-sma200-mean-reversion-d1-v2 — Strategy Spec
...
## 0. Lineage — Second-Chance v2 of QM5_11563

This is a clean rerun of `QM5_11563_connors-rsi2-sma200-mean-reversion-d1` under a NEW
identity, per the Strategy Second-Chance Programme
(`docs/research/STRATEGY_SECOND_CHANCE_PROGRAMME.md` §5.1, revision task
`b0ef5d66-5947-4d79-ad72-02f2caee04cb`, APPROVED). `QM5_11563`'s terminal disposition was
strictly `INFRA_FAIL` (Q08 INVALID twice on context/calendar validation defects
`79a120af` DSR_V2_MUTABLE_OR_RELATIVE_CONTEXT and `44c01339`
DSR_V2_TRADE_OUTSIDE_SEALED_CALENDAR) — the trading thesis was never rejected on economic
grounds. `QM5_11563` reached Q06 with PF 1.57 / 94 trades / $4,370.07 drawdown on
GBPUSD.DWX (work item `4ece110d-6033-48c3-89cc-96db30741d8a`). `QM5_11563`'s historical
verdicts and work items remain immutable read-only evidence and are never reopened.

**Delta vs. `QM5_11563`:** identity only (`qm_ea_id` 11563 -> 41486; magics
414860000/1/2 EURUSD/GBPUSD/USDJPY vs. the parent's 115630000/1/2). All mechanical
parameters, thresholds, and the DSR single-configuration contract are unchanged —
the mq5 source is a byte-exact clone of the parent with only the identity strings
(qm_ea_id, description/log/reason strings) updated. This is a clean rerun, not a
re-parameterization.
...
| Expected drawdown profile | `~5% expected DD (card estimate); occasional loser stopped at 2×ATR / 150-pip cap` |
...
**R1-R4 verdict (G0):** R1-R4 PASS per `artifacts/cards_approved/QM5_41486_connors-rsi2-sma200-mean-reversion-d1-v2.md` (G0 APPROVED 2026-09-21, OWNER-DEC-FTMO-FULL-THROTTLE-20260921 Track C RUN_NOW; OWNER-DEC-D3-20260915 Second-Chance).
...
| Registry commit | `ae8ea16228` (governed allocator, resolver regenerated) |
| Parent (reference only, never reopened) | `framework/EAs/QM5_11563_connors-rsi2-sma200-mean-reversion-d1` |
...
|---|---|---|---|
| v1 (parent QM5_11563) | 2026-08-10 | Initial build from card | e26b6273-3c6a-478b-8f2a-b5004e32d85f |
| v2 (this EA, QM5_41486) | 2026-09-22 | Second-Chance clean rerun of QM5_11563 (INFRA_FAIL, task 67c45a2f-2b42-4813-a5c8-13704534cace) | Identity-only delta; mechanical rules byte-exact vs. parent |
