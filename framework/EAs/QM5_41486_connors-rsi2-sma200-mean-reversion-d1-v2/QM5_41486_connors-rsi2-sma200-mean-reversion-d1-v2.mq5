...
#property description "QM5_41486 Connors RSI(2) + SMA(200) Mean Reversion (D1, FX, v2)"
// Strategy Card: QM5_41486 (connors-rsi2-sma200-mean-reversion-d1-v2), G0 APPROVED 2026-09-21.
// Second-Chance v2 of QM5_11563 (INFRA_FAIL, never reopened) under revision b0ef5d66.
...
// =============================================================================
// QuantMechanica V5 EA: QM5_41486 — Connors RSI(2)/SMA(200) mean reversion (v2)
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(go_long)
     {
      req.type   = QM_BUY;
      req.reason = "QM5_41486_RSI2_LONG";
      req.sl     = ComputeSafetyStop(QM_BUY, ask);
     }
   else if(go_short)
     {
      req.type   = QM_SELL;
      req.reason = "QM5_41486_RSI2_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"ea\":\"QM5_41486_connors_rsi2_sma200_v2\"}");
