...
#property description "QM5_41175 XTI/XNG Monthly Pettitt Ratio Change-Point Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_41175 - XTI/XNG Monthly Pettitt Ratio Change-Point Reversion
// -----------------------------------------------------------------------------
...
// completed broker months. Strict-rank the oil-minus-gas log ratios, compute
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41175 && qm_magic_slot_offset == 0 &&
            qm_rng_seed == 42 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_MPETTITT_RV_ATTEMPT_MONTH_%I64d",
                       qm_ea_id,
                       Strategy_HostMagic());
  }
...
string Strategy_PairDirectionStateKey()
  {
   return StringFormat("QM5_%d_XTIXNG_MPETTITT_RV_PAIR_DIRECTION_%I64d",
                       qm_ea_id,
                       Strategy_HostMagic());
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41175_XTIXNG_MPETTITT_RV";
...
bool Strategy_LoadMonthlyPettitt(
      ...
      int &direction)
  {
   ...
   // direction > 0 means BUY XTI / SELL XNG. Negative U[K] means the later
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41175_XTIXNG_MPETTITT_RV_HOST";
   ...
   if(valid && direction > 0)
      state = "lower_late_ratio_fade_long_xti";
   else if(valid && direction < 0)
      state = "higher_late_ratio_fade_short_xti";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XTI/XNG thirteen-month Pettitt ratio change-point reversion package holds through Fridays until next broker month"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41175\",\"ea\":\"xtixng-mpettitt-rv\"}");
