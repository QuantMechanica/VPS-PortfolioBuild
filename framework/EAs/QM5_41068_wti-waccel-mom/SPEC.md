# QM5_41068_wti-waccel-mom - Strategy Spec
...
Source: `MOP-WTI-WACCEL-MOM-2026`
...
strictly larger than the older move, follow that accelerating direction for
one broker week. Two positive accelerating returns buy WTI; two negative
accelerating returns sell WTI. Equality, sign opposition, zero,
non-acceleration, malformed history, or late attachment consumes the week
...
- Magic: `410680000`, after governed allocation.
...
- Formation: two adjacent completed broker-week returns from three completed
  week-end closes.
- Trigger: strict same-sign movement with strict absolute acceleration at the
  new-week boundary.
...
- Symmetric WTI trend continuation after a strengthening two-week move.
...
weekly horizon and same-sign acceleration condition are disclosed QM timing
