...
#property description "QM5_20169 WTI Thursday Bear-Regime Bounce"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20169 - WTI Thursday Premium / Bear-Regime Bounce
// -----------------------------------------------------------------------------
// D1 structural crude-oil sleeve:
//   - first observed tick of a genuine broker-calendar Thursday D1 bar
//   - BUY only when the completed 252-D1 WTI log return is negative
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20169_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20169\",\"ea\":\"wti-thu-bear\"}");
