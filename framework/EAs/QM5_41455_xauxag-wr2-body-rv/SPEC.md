# QM5_41455_xauxag-wr2-body-rv — Strategy Spec

- EA ID: QM5_41455
- Slug: `xauxag-wr2-body-rv`
- Strategy ID: `SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912_S01`
- Source: `SCHWEIKERT-CRABEL-CME-XAUXAG-WR2-BODY-RV-20260912`
- Author: Codex
...
be strictly wider than the prior range. Fade the strict newest ratio-week body through an
opposed equal-notional package, consume one attempt per week, and hold for one normalized week.
Invalid, tied, contracting, or late states consume flat. Range containment is not required.
...
- Logical symbol: `QM5_41455_XAU_XAG_WR2_BODY_RV_D1`.
...
`10.1016/j.jbankfin.2017.11.010`) supplies state-dependent gold/silver relation lineage; CME
supplies the ratio-spread carrier; governed Crabel records supply range-state and completed-week
lineage. The exact WR2/body ratio reversion is an untested QM translation. It differs from
`QM5_41448`'s expansion/CLV fade and `QM5_41449`'s expansion/body continuation.
...
| v1-q01 | 2026-09-12 | governed T3 compile and strict build check PASS; 6 reference tests and PACER audit PASS; Q02 enqueued below CPU ceiling |
