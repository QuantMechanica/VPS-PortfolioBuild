"""Deterministic reference checks for QM5_41092 weekly body dominance."""
...
class WeekBodyDominanceReferenceTest(unittest.TestCase):
    ...
    def test_static_build_contract_is_fixed_risk_and_completed_data_only(self) -> None:
        source = (EA_DIR / "QM5_41092_wti-wbody-dominance-mom.mq5").read_text(
            encoding="utf-8"
        )
        setfile = (
            EA_DIR
            / "sets"
            / "QM5_41092_wti-wbody-dominance-mom_XTIUSD.DWX_D1_backtest.set"
