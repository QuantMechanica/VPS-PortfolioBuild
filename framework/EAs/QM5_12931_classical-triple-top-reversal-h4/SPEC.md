# QM5_12931_classical-triple-top-reversal-h4 — Strategy Spec

**EA ID:** QM5_12931
**Slug:** `classical-triple-top-reversal-h4`
...
`artifacts/cards_approved/QM5_12931_classical-triple-top-reversal-h4.md`. See that card's body for
...
`QM5_12931_classical-triple-top-reversal-h4.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_peak_spacing_min_bars` | 25 | (see source) | (see strategy logic) |
| `strategy_peak_spacing_max_bars` | 120 | (see source) | (see strategy logic) |
| `strategy_peak_height_atr` | 0.50 | (see source) | (see strategy logic) |
| `strategy_peak_equal_atr` | 0.50 | (see source) | (see strategy logic) |
| `strategy_trough_amplitude_min_atr` | 1.50 | (see source) | (see strategy logic) |
| `strategy_trough_equal_atr` | 0.40 | (see source) | (see strategy logic) |
| `strategy_neckline_slope_max_atr` | 0.05 | (see source) | (see strategy logic) |
| `strategy_uptrend_lookback_bars` | 40 | (see source) | (see strategy logic) |
| `strategy_uptrend_slope_min_atr` | 0.10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_12931_classical-triple-top-reversal-h4.md`
