...
bool Strategy_RefreshSpreadState()
  {
   ...
   if(CopyClose(g_leg_usdjpy, PERIOD_D1, 1, history_count, usdjpy) != history_count) // perf-allowed: new-bar gated.
      return false;
   if(CopyClose(g_leg_euraud, PERIOD_D1, 1, history_count, euraud) != history_count) // perf-allowed: new-bar gated.
      return false;
   if(CopyTime(g_leg_usdjpy, PERIOD_D1, 1, history_count, usdjpy_time) != history_count) // perf-allowed: new-bar gated alignment check.
      return false;
   if(CopyTime(g_leg_euraud, PERIOD_D1, 1, history_count, euraud_time) != history_count) // perf-allowed: new-bar gated alignment check.
      return false;
