...
#property description "QM5_11640 robo-ema100hl-bb10-h4 — EMA100-HL channel + BB(10,2.3) reversal (H4)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11640 robo-ema100hl-bb10-h4
// -----------------------------------------------------------------------------
// Source: RoboForex Educational Team, "Forex Strategy Collection" (~2015),
//         strategy "Pending the reversal", pages 104-105.
// Card: artifacts/cards_approved/QM5_11640_robo-ema100hl-bb10-h4.md
//       (g0_status APPROVED). Shares the source strategy with QM5_11621
//       (canonical reversal variant); this id (11640) is the active EA. Built
//       once, mechanics per THIS card.
//
// Mechanics (closed-bar reads at shift 1; one position per magic):
//   Trend STATE (EMA100-HL channel) :
//       LONG  zone : Close[1] > EMA(100, PRICE_LOW)   (price inside/above channel)
//       SHORT zone : Close[1] < EMA(100, PRICE_HIGH)  (price inside/below channel)
...
//           proxy for the BB(10,2.3) middle-band target named in the card)
