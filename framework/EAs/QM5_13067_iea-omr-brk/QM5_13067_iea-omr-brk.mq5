...
#property description "QM5_13067 IEA OMR WTI breakout"
...
//   - fixed mid-month International Energy Agency Oil Market Report proxy window
//   - follows ATR-sized OMR-window range breakouts on XTIUSD.DWX
//   - ATR stop/target, max-hold exit, no external runtime data
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13067;
...
bool Strategy_LoadOmrBreakoutState(int &direction,
                                   double &atr_last,
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13067_XTI_IEA_OMR_BRK";
   ...
   if(!Strategy_LoadOmrBreakoutState(direction, atr_last, signal_month_key))
      return false;
   ...
   req.reason = (direction > 0) ? "XTI_IEA_OMR_BRK_LONG" : "XTI_IEA_OMR_BRK_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13067\",\"ea\":\"iea-omr-brk\"}");
