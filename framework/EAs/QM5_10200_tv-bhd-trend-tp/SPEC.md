...
`artifacts/cards_approved/QM5_10200_tv-bhd-trend-tp.md`. See that card's body for
...
`QM5_10200_tv-bhd-trend-tp.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_rsi_period` | 200 | (see source) | (see strategy logic) |
| `strategy_rsi_min` | 51.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10200_tv-bhd-trend-tp.md`
