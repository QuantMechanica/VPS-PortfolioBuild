...
#property description "QM5_10200 TradingView BHD Trend Pullback TP"
...
input int    strategy_rsi_period        = 200;
input double strategy_rsi_min           = 51.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   if(strategy_ema_period < 2 || strategy_rsi_period < 2 || strategy_atr_period < 1)
      return false;
   ...
   if(ema_1 <= 0.0 || ema_2 <= 0.0 || rsi_1 <= 0.0 || atr_1 <= 0.0)
      return false;
   ...
   const double stop_distance = atr_1 * strategy_atr_sl_mult;
...
void Strategy_ManageOpenPosition()
  {
   // Card defines fixed ATR bracket exits only; no trailing, BE, or partials.
  }
...
bool Strategy_ExitSignal()
  {
   // Card exits only through the SL/TP bracket and framework Friday close.
   return false;
  }
