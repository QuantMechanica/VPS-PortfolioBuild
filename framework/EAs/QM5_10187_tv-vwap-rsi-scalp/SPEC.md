...
`artifacts/cards_approved/QM5_10187_tv-vwap-rsi-scalp.md`. See that card's body for
...
`QM5_10187_tv-vwap-rsi-scalp.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_rsi_period` | 3 | (see source) | (see strategy logic) |
| `strategy_rsi_oversold` | 20.0 | (see source) | (see strategy logic) |
| `strategy_rsi_overbought` | 80.0 | (see source) | (see strategy logic) |
...
| `strategy_session_start_hhmm` | 1400 | (see source) | (see strategy logic) |
| `strategy_session_end_hhmm` | 2100 | (see source) | (see strategy logic) |
| `strategy_max_trades_per_day` | 3 | (see source) | (see strategy logic) |
| `strategy_max_spread_atr_frac` | 0.15 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10187_tv-vwap-rsi-scalp.md`
