"""Independent mechanic fixtures for QM5_41032.
...
opposition followed in the session-flow direction, Monday grace, one-attempt identity, and later-week repair without
...
def flow_direction(
    ...
    if session_flow > 0 and overnight_flow < 0:
        direction = 1
    elif session_flow < 0 and overnight_flow > 0:
        direction = -1
    else:
        direction = 0
...
class FlowDivergenceReferenceTests(unittest.TestCase):
    ...
    def test_session_positive_overnight_negative_buys(self) -> None:
        days = ((99.0, 100.0),) * 5
        direction, overnight, session = flow_direction(100.0, days)
        self.assertEqual(direction, 1)
        self.assertLess(overnight, 0)
        self.assertGreater(session, 0)

    def test_session_negative_overnight_positive_sells(self) -> None:
        days = ((101.0, 100.0),) * 5
        direction, overnight, session = flow_direction(100.0, days)
        self.assertEqual(direction, -1)
    ...
    def test_agreeing_flows_and_exact_zero_remain_flat(self) -> None:
        both_positive = ((71.0, 72.0), (73.0, 74.0), (75.0, 76.0), (77.0, 78.0), (79.0, 80.0))
        self.assertEqual(flow_direction(70.0, both_positive)[0], 0)
        both_negative = ((79.0, 78.0), (77.0, 76.0), (75.0, 74.0), (73.0, 72.0), (71.0, 70.0))
        self.assertEqual(flow_direction(80.0, both_negative)[0], 0)
