...
#property description "QM5_20187 WTI One-Month Time-Series Momentum"
...
//   - sign of the just-completed calendar-month WTI log return
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20187_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20187\",\"ea\":\"wti-tsmom1m\"}");
