# QM5_10135_bbwidth-ema — Strategy Spec
...
`artifacts/cards_approved/QM5_10135_bbwidth-ema.md`. See that card's body for
...
`QM5_10135_bbwidth-ema.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_width_low_lookback` | 20 | (see source) | (see strategy logic) |
| `strategy_fast_ema_period` | 10 | (see source) | (see strategy logic) |
| `strategy_slow_ema_period` | 30 | (see source) | (see strategy logic) |
| `strategy_warmup_bars` | 50 | (see source) | (see strategy logic) |
| `strategy_width_ceiling` | 0.0 | (see source) | (see strategy logic) |
| `strategy_emergency_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_emergency_atr_mult` | 3.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10135_bbwidth-ema.md`
