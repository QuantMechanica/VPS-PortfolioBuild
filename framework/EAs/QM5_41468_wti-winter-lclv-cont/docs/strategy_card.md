...
type: strategy
strategy_id: BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913_S01
variant_id: BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913_S01
source_id: BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913
ea_id: QM5_41468
slug: wti-winter-lclv-cont
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41468_wti-winter-lclv-cont.md
execution_contract_status: APPROVED
created: 2026-09-13
created_by: Research+Development
last_updated: 2026-09-13
g0_status: APPROVED
g0_decision: decisions/2026-09-13_qm5_41468_wti_winter_lower_clv_continuation_g0.md
source_approval: decisions/2026-09-13_wti_winter_lower_clv_continuation_source_approval.md
...
source_citations:
  - type: peer_reviewed_reputable_bounded_mechanization
    citation: "Peer-reviewed WTI winter-season and commodity-continuation evidence plus governed reputable completed-week and close-location lineage."
    location: strategy-seeds/sources/BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913/source.md
    quality_tier: A_and_B_and_governed_reputable_lineages_with_translation_risk
    role: november_may_calendar_lower_tercile_weekly_close_downside_continuation_lineage
strategy_mechanic: normalized-weekly-wti-november-through-may-one-completed-week-lower-tercile-close-location-short-only-continuation-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913]]"]
concepts: ["[[concepts/wti-winter-seasonality]]", "[[concepts/completed-week-close-location]]", "[[concepts/commodity-momentum]]"]
indicators: ["[[indicators/completed-week-close-location]]", "[[indicators/atr-risk-stop]]"]
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, winter-regime, lower-tercile-close-location, short-only, downside-continuation, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 11,12,1,2,3,4,5; exactly the immediately completed week with 3-5 sessions; CLV strictly below one third; short only; 20 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
pipeline_phase: Q02
q01_status: PASS
q01_compile_work_item: c149230f-10c0-40e5-ac34-c1ab6addaad6
q01_build_report: D:/QM/reports/work_items/c149230f-10c0-40e5-ac34-c1ab6addaad6/QM5_41468/COMPILE_EA/compile_evidence.json
q02_status: ENQUEUED
q02_work_item: 621253f5-6ca8-4d5e-ae4c-610d0b55c28c
q02_receipt: D:/QM/strategy_farm/artifacts/receipts/first_q02_intake/c149230f-10c0-40e5-ac34-c1ab6addaad6_621253f5-6ca8-4d5e-ae4c-610d0b55c28c.json
force_build: true
review_focus: "Falsify a WTI November-May lower-tercile weekly-close downside continuation distinct from the certified XNG oscillator, monthly WTI winter sign rules, summer lower-tercile continuation, winter upper-tercile continuation, and winter lower-tercile reversion. Verify exact completed week, strict CLV inequality, no range/body predicates, short-only side, durable attempt, fixed risk, frozen stop, and next-week exit. Q09 alone may establish decorrelation."
...
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineage with explicit counter-seasonal and translation risk; R2 exact mechanical WTI winter lower-tercile weekly-close short continuation; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact repository duplicate after canonical and manual family review."
---

# QM5_41468 WTI Winter Lower-Tercile Weekly-Close Continuation

## Hypothesis

Inside the documented November-through-May WTI regime, a completed week
settling in the lower third of its full range may identify a downside shock
that persists over the next normalized broker week. Short at the next week
boundary and hold one week. The direction is counter to the regime's average
positive return and is intended as a falsifiable shock-persistence sleeve;
this exact Darwinex-CFD rule is unproven and belongs to Q02.
...
Burakov et al. supply the WTI November-May regime; the governed Crabel packet
supplies completed-week and close-location lineage; Moskowitz et al. supply
commodity-continuation lineage. None establishes this conjunction.

The canonical scan found no exact identity and two fuzzy repository matches;
its external Wiki root was unavailable and is recorded rather than treated as
a pass. `QM5_41461` uses the disjoint June-October summer interval.
`QM5_41463` buys upper-tercile winter closes. `QM5_41464` buys lower-tercile
winter closes under reversal lineage. This card requires one completed week,
no range ranking, no body direction, and only a strict lower-tercile short.
The exact mechanic is new in the available repository corpus.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41468, slot zero,
...
6. Sell only when `CLV < strategy_clv_cutoff`, locked to one third. Equality
   or a higher close is flat. There is no long side, range-rank test,
   return-sign test, or candle-body-sign test.
...
Burakov et al. supply the November-May WTI regime. Moskowitz et al. supply
broad commodity continuation. The governed Crabel record supplies weekly
close-location lineage. They do not supply this exact weekly conjunction.

## QM Interpretations

Monday anchors, one completed week, strict lower-tercile threshold, boundary
entry, counter-seasonal short side, one-week hold, retry semantics, and every
numeric execution threshold are QM choices.
...
`PORTFOLIO_WEIGHT=1`. WTI gaps, roll/basis, financing, counter-seasonal drift,
label sensitivity, sample scarcity, stop slippage, source translation, and
overlap with other WTI candidates can dominate. Q02 owns economics; unchanged
...
return/range/body gates, short-only side, durable attempt, frozen stop,
next-week exit, card lint, resolver, PACER audit, reference tests, and strict
...
| Q01 Build Validation | 2026-09-13 | PASS | compile `c149230f-10c0-40e5-ac34-c1ab6addaad6`; `COMPILE_OK`; 0 compiler errors/warnings; strict build check PASS; 10 reference tests; PACER audit zero hits |
| Q02 Baseline Screening | 2026-09-13 | ENQUEUED | exactly one fixed-risk `XTIUSD.DWX` D1 canary `621253f5-6ca8-4d5e-ae4c-610d0b55c28c`; final CPU maximum 77.7%; result not awaited |
