# QM5_41468_wti-winter-lclv-cont - Strategy Spec

**EA ID:** QM5_41468  
**Strategy ID:** `BURAKOV-CRABEL-MOP-WTI-WINTER-LCLV-CONT-20260913_S01`
...
week. Sell only when its final close lies strictly below one third of its full
high-low range. Equality or any higher close is flat. Return sign, candle-body
...
mode are locked. Framework RNG, news, Friday-close, and stress inputs remain
...
`414680000`. Runtime uses native D1 OHLC/timestamps, quotes, spread, ATR,
...
It combines peer-reviewed WTI November-May regime evidence, peer-reviewed
commodity continuation, and governed reputable completed-week/close-location
lineage. The exact downside-continuation rule is an untested QM translation
and is counter to the regime's average positive drift.

The rule differs from `QM5_12567` (XNG oscillator pullback), `QM5_41461`
(disjoint summer lower-tercile short), `QM5_41463` (winter upper-tercile long),
and `QM5_41464` (winter lower-tercile long reversion). This candidate uses one
week, no range comparison, no body predicate, and a strict lower-tercile short.
...
Gaps, slippage, roll/basis, financing, counter-seasonal winter drift, weekly-
