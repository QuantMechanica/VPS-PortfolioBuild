...
#property description "QM5_12701 WTI October Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12701 - WTI October Calendar Fade
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - short XTIUSD.DWX only during broker-calendar October D1 bars
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12701_WTI_OCT_FADE";
   ...
   req.reason = "WTI_OCTOBER_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12701\",\"ea\":\"wti-oct-fade\"}");
