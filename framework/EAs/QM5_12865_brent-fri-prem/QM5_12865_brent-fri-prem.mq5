...
#property description "QM5_12865 Brent Friday Calendar Premium"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12865_BRENT_FRI_PREM";
   ...
   req.reason = "BRENT_FRIDAY_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12865\",\"ea\":\"brent-fri-prem\"}");
