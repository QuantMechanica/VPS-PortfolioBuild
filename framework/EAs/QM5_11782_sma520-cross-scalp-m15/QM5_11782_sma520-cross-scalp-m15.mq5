...
#property description "QM5_11782 sma520-cross-scalp-m15 — SMA(5)/SMA(20) cross scalp (M15, 5-pip TP/SL)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11782 sma520-cross-scalp-m15
// -----------------------------------------------------------------------------
// Source: 'Scalp trading using the moving average', in My Top Three Scalping
//         Trading Strategies, ~2019 (481460064-Top3ScalpingStrategies.pdf, p2-4).
// Card: artifacts/cards_approved/QM5_11782_sma520-cross-scalp-m15.md (g0 APPROVED).
//
// Mechanics (closed-bar reads; M15):
//   Trigger EVENT (the ONLY trigger):
//     LONG : SMA(5) crosses ABOVE SMA(20) -> sma5[2] <= sma20[2] AND sma5[1] > sma20[1]
//     SHORT: SMA(5) crosses BELOW SMA(20) -> sma5[2] >= sma20[2] AND sma5[1] < sma20[1]
...
//   No additional filter STATE — the card explicitly adds none (the tight 5-pip
//   SL is the only risk control). Spread guard fails OPEN on .DWX zero spread.
//
// Two-cross trap avoided: the cross is the SINGLE trigger event; there is no
...
// only happens after a fresh opposite cross fires while flat.
