# QM5_41427_wti-refmaint-wclv-cont - Strategy Spec

**EA ID:** QM5_41427

**Slug:** `wti-refmaint-wclv-cont`

**Strategy ID:** `EIA-MOP-WTI-REFMAINT-WCLV-CONT-20260910_S01`

**Source:** `EIA-MOP-WTI-REFMAINT-WCLV-CONT-20260910`
...
completed weekly range. Sell only when the return is strictly negative and
close location is strictly below one-third. Equality, a nonnegative return,
...
`414270000`. The symbol is an input; no executable symbol literal is embedded
in the EA.
...
and sell only after strict negative/lower-tercile agreement. Require no owned
...
| entry | maintenance calendar, two completed-week packages, strict endpoint return and lower-tercile close, short-only side, durable attempt, spread and frozen ATR stop |
