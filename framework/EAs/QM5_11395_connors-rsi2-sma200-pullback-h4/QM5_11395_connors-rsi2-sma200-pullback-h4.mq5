...
#property description "QM5_11395 connors-rsi2-sma200-pullback-h4 — Connors RSI(2) mean reversion (H4)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11395 connors-rsi2-sma200-pullback-h4
// -----------------------------------------------------------------------------
// Source: Larry Connors & Cesar Alvarez, "Short-Term Trading Strategies That
//         Work" (2009), "The 2 Period RSI". source_id ea4596d1-...-575a5370.
// Card: artifacts/cards_approved/QM5_11395_connors-rsi2-sma200-pullback-h4.md
//       (g0_status APPROVED). Forex adaptation on H4 (sibling D1 = QM5_11365).
//
...
input ENUM_TIMEFRAMES strategy_timeframe        = PERIOD_H4;  // card TF = H4
...
input double strategy_entry_rsi_long     = 5.0;   // RSI(2) < this -> oversold pullback (long)
input double strategy_entry_rsi_short    = 95.0;  // RSI(2) > this -> overbought rally (short)
input double strategy_exit_rsi_long      = 70.0;  // RSI(2) > this -> exit long (Connors)
input double strategy_exit_rsi_short     = 30.0;  // RSI(2) < this -> exit short (mirror)
...
bool Strategy_NoTradeFilter()
  {
   // H4-native strategy: refuse to trade if attached to a non-H4 chart.
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"ea\":\"QM5_11395_connors-rsi2-sma200-pullback-h4\"}");
