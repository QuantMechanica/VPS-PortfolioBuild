...
#property description "QM5_10300 Cinar VWAP Cross Mean Reversion"
...
input int    strategy_vwap_period       = 14;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // Trade Entry: card requires D1 VWAP(14) versus closed-bar close.
   ...
   const QM_OrderType desired_side = (vwap > close) ? QM_BUY : QM_SELL;
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      // Trade Close: stop-and-reverse on VWAP/close relation flip.
   ...
   req.sl = sl;
   req.tp = 0.0;
   req.reason = (desired_side == QM_BUY) ? "VWAP_GT_CLOSE_LONG" : "VWAP_LT_CLOSE_SHORT";
   req.symbol_slot = qm_magic_slot_offset;
   req.expiration_seconds = 0;
   return true;
  }
