...
#property description "QM5_41474 XAGUSD Weekly Low-Volume Momentum Continuation"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41474 - XAGUSD Weekly Low-Volume Momentum Continuation (Residual-Proxy)
// -----------------------------------------------------------------------------
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsExpectedHost())
      return true;
   if(qm_ea_id != 41474 || qm_magic_slot_offset != 0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41474_XAG_LOWVOL_MOM";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_41474_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41474\",\"ea\":\"xag-weekly-lowvol-momentum\",\"signal\":\"weekly_tick_volume_ranked_momentum_continuation\"}");
