"""Independent deterministic fixtures for QM5_41397.
...
class SeasonalSurpriseReferenceTests(unittest.TestCase):
    ...
    def test_static_build_contract_matches_approved_card(self) -> None:
        source = (EA_DIR / "QM5_41397_wti-seas-surprise-rv.mq5").read_text(encoding="utf-8")
        set_path = EA_DIR / "sets" / "QM5_41397_wti-seas-surprise-rv_XTIUSD.DWX_D1_backtest.set"
        ...
        approved = REPO_ROOT / "strategy-seeds" / "cards" / "approved" / "QM5_41397_wti-seas-surprise-rv_card.md"
        ...
        self.assertIn("41397,wti-seas-surprise-rv,0,XTIUSD.DWX,413970000", magic_rows)
        resolver = (REPO_ROOT / "framework" / "include" / "QM" / "QM_MagicResolver.mqh").read_text(encoding="utf-8")
        self.assertIn("413970000", resolver)
