...
#property description "QM5_20094 Brent Calendar-Day-8 One-Session Long"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20094 - Brent Calendar-Day-8 One-Session Long
// -----------------------------------------------------------------------------
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_20094_BRENT_DOM8_ATTEMPT_%d",
                       QM_FrameworkMagic());
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "BRENT_DOM8_ONE_SESSION_LONG";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved DOM8 card requires Friday 21 broker-time flattening"))
      return INIT_FAILED;
