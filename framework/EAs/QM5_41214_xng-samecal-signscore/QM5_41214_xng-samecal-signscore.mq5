...
#property description "QM5_41214 XNG Same-Calendar Bernoulli Sign-Score Seasonality"
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(!QM_InputRequireLong("qm_ea_id", qm_ea_id, 41214) ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "XNG_SAMECAL_SIGNSCORE";
   ...
   if(g_signal_direction > 0)
     {
      req.type = QM_BUY;
      req.reason = "XNG_SAMECAL_SIGNSCORE_LONG";
     }
   else
     {
      req.type = QM_SELL;
      req.reason = "XNG_SAMECAL_SIGNSCORE_SHORT";
     }
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41214 ||
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XNG same-calendar Bernoulli sign-score card holds to the next broker month"))
      return INIT_FAILED;
   ...
   g_attempt_state_key =
      StringFormat("QM5_41214_SAMECAL_SIGNSCORE_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41214\",\"ea\":\"xng-samecal-signscore\"}");
