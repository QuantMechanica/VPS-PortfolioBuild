...
#property description "QM5_12850 XTI XNG Ratio VCB"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12850 - XTI/XNG Ratio Volatility-Contraction Breakout
// -----------------------------------------------------------------------------
...
//   upper envelope break: buy ratio  = buy XTI, sell XNG
//   lower envelope break: sell ratio = sell XTI, buy XNG
// Runtime uses MT5 OHLC only; no external feed, futures curve, API, or ML.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12850;
...
bool Strategy_LoadSpreadSeries(const int count_raw, double &spreads[])
  {
   ...
   if(CopyClose(g_leg_xti, PERIOD_D1, 1, count, xti) != count) // perf-allowed: called behind the D1 new-bar gate or close-state refresh.
      return false;
...
bool Strategy_OpenPair(const int ratio_direction)
  {
   ...
   const string reason = long_ratio ? "QM5_12850_LONG_XTI_XNG_VCB"
                                    : "QM5_12850_SHORT_XTI_XNG_VCB";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12850\",\"ea\":\"xti-xng-vcb\"}");
