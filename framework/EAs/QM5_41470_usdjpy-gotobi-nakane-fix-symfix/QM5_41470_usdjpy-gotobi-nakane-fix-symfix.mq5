...
#property description "QM5_41470 USDJPY Gotobi Nakane fix drift"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 41470;
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(PERIOD_M30,
                                             QM_FRIDAY_CLOSE_FRAMEWORK_OVERRIDE,
                                             "DXZ_LEGACY_BOOK_POLICY_REQUAL_REQUIRED"))
      return INIT_FAILED;

   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_41470\",\"ea\":\"usdjpy-gotobi-nakane-fix\"}");
