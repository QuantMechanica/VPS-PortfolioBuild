...
#property description "QM5_10585 MQL5 DiNapoli Stochastic Cross"
...
int Strategy_StochCrossSignal()
  {
   if(strategy_stoch_k_period <= 0 || strategy_stoch_d_period <= 0 || strategy_stoch_slowing <= 0)
      return 0;

   const double main_now = QM_Stoch_K(_Symbol, strategy_signal_tf,
                                      strategy_stoch_k_period,
                                      strategy_stoch_d_period,
                                      strategy_stoch_slowing,
                                      1);
   const double sig_now = QM_Stoch_D(_Symbol, strategy_signal_tf,
                                     strategy_stoch_k_period,
                                     strategy_stoch_d_period,
                                     strategy_stoch_slowing,
                                     1);
   const double main_prev = QM_Stoch_K(_Symbol, strategy_signal_tf,
                                       strategy_stoch_k_period,
                                       strategy_stoch_d_period,
                                       strategy_stoch_slowing,
                                       2);
   const double sig_prev = QM_Stoch_D(_Symbol, strategy_signal_tf,
                                      strategy_stoch_k_period,
                                      strategy_stoch_d_period,
                                      strategy_stoch_slowing,
                                      2);
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const int signal = Strategy_StochCrossSignal();
   if(signal == 0)
      return false;
   ...
   req.reason = (signal > 0) ? "DINAPOLI_STOCH_BULL_CROSS" : "DINAPOLI_STOCH_BEAR_CROSS";
