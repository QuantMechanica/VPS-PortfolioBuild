# QM5_41061_wti-week-nr7-brk - Strategy Spec
...
Source: `CRABEL-WTI-WEEKNR7-2026`
...
On each new `XTIUSD.DWX` D1 bar, normalize the energy session label with one
...
- Symmetric direct-WTI volatility-compression/expansion continuation.
...
`strategy-seeds/sources/CRABEL-WTI-WEEKNR7-2026/source.md`.
