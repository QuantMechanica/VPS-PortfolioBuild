...
#property description "QM5_41464 WTI Winter Lower-CLV Reversion"
...
//   - buy only when that week closes in the lower third of its full range
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
       ...
       if(!g_signal_valid)
          ...
          g_signal_state = "lower_tercile_reversion_long";
       else
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41464_WTI_WINTER_LCLV_FADE";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_WINTER_LCLV_FADE_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41464 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41464_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41464\",\"ea\":\"wti-winter-lclv-fade\"}");
