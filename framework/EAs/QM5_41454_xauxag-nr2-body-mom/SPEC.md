# QM5_41454_xauxag-nr2-body-mom — Strategy Spec

- EA ID: QM5_41454
- Slug: `xauxag-nr2-body-mom`
- Strategy ID: `FMR-CRABEL-CME-XAUXAG-NR2-BODY-MOM-20260912_S01`
- Source: `FMR-CRABEL-CME-XAUXAG-NR2-BODY-MOM-20260912`
- Author: Codex
...
be strictly narrower than the prior range. Continue the strict newest ratio-week body through an
opposed equal-notional package, consume one attempt per week, and hold for one normalized week.
Invalid, tied, expanding, or late states consume flat.
...
- Logical symbol: `QM5_41454_XAU_XAG_NR2_BODY_MOM_D1`.
...
exact NR2/body ratio continuation is an untested QM translation. It differs from `QM5_41448`'s
...
| v1-q01 | 2026-09-12 | governed T1 compile and strict build check PASS; reference tests and PACER audit PASS; Q02 stopped at CPU ceiling |
