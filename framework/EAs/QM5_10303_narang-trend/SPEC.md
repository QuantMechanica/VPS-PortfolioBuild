# QM5_10303_narang-trend — Strategy Spec
...
`artifacts/cards_approved/QM5_10303_narang-trend.md`. See that card's body for
...
`QM5_10303_narang-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_friday_cutoff_hour` | 18 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10303_narang-trend.md`
