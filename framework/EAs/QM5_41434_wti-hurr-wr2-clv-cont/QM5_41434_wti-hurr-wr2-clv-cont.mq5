...
#property description "QM5_41434 WTI Hurricane-Season WR2 CLV Continuation"
...
//   - buy only when the newest range expands and its close is in the upper quartile
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41434_WTI_HURR_WR2_CLV_CONT";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_HURR_WR2_CLV_CONT_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41434 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41434_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41434\",\"ea\":\"wti-hurr-wr2-clv-cont\"}");
