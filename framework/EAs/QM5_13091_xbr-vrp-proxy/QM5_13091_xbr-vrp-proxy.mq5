...
#property description "QM5_13091 XBR realized-volatility VRP proxy"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_13091 - XBR VRP Proxy
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13091_XBR_VRP_PROXY";
   ...
   req.reason = (direction > 0) ? "XBR_VRP_PROXY_LONG" : "XBR_VRP_PROXY_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13091\",\"ea\":\"xbr-vrp-proxy\"}");
