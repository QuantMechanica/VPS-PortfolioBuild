...
// v2: source unchanged. Root cause: Q02 ONINIT_FAILED on 7 symbols
...
bool Strategy_NoTradeFilter()
  {
   if(strategy_fast_ma_period <= 0 ||
      ...
      strategy_tp_rr <= 0.0)
      return true;
   return (Bars(_Symbol, (ENUM_TIMEFRAMES)_Period) < strategy_min_bars); // perf-allowed: structural/indicator read; called from QM_IsNewBar-gated context
  }
