...
#property description "QM5_10267 Gawd SMA25 Price Trend"
...
bool Strategy_NoTradeFilter()
  {
   ...
   return (atr_value < strategy_min_atr_spread_mult * spread_price);
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double sma_1 = QM_SMA(_Symbol, strategy_timeframe, strategy_sma_period, 1, PRICE_CLOSE);
   if(close_1 <= 0.0 || sma_1 <= 0.0 || close_1 <= sma_1)
      return false;
   ...
   req.reason = "SMA25_CLOSE_ABOVE_LONG";
