# QM5_12803_edgelab-usdcad-euraud-cointegration - Strategy Spec
...
The EA trades the USDCAD.DWX and EURAUD.DWX D1 cointegration spread. It computes
`S = ln(USDCAD) - beta * ln(EURAUD)` with beta defaulting to 0.466896958, then
...
same script ranked USDCAD/EURAUD as the next unbuilt rank-29 tail candidate
after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749/12751/12756/12758/12760/12762/12764/12765/12766/12768/12770/12772/12776/12778/12781/12783/12786
baskets, with DEV Sharpe 0.5746, OOS net Sharpe -0.8728, OOS return -5.8413%,
13 OOS state changes, beta 0.466896958, and 65.82-day half-life.
...
| strategy_beta | 0.466896958 | >0 | Hedge coefficient in `ln(USDCAD) - beta * ln(EURAUD)` |
...
**Designed for:**
- USDCAD.DWX - leg 1 of the fixed USDCAD/EURAUD spread and the spread numerator.
- EURAUD.DWX - leg 2 of the fixed USDCAD/EURAUD spread and the beta-weighted spread denominator.

**Explicitly not for:**
- Other `.DWX` symbols. This card is a fixed two-leg FX-cross basket, not a portable multi-pair strategy.

EURUSD.DWX and AUDUSD.DWX are selected as conversion history for the EURAUD leg
...
| Regime preference | low-conviction CAD commodity / EURAUD regional-rate residual |
...
|---|---:|---:|---:|---:|---:|---:|
| USDCAD~EURAUD | 0.5746 | -0.8728 | -5.8413% | 13 | 0.466896958 | 65.82d |
