...
#property description "QM5_9465 Connors RSI 25 Pullback Mean Reversion D1"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA: QM5_9465
// Strategy Card: D:/QM/strategy_farm/artifacts/cards_approved/QM5_9465_connors-rsi25-d1.md
// Source: Larry Connors / Connors Research LLC (ef14a5d7-e3f1-52be-910a-3ca6b736a152)
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 9465;
...
input double strategy_rsi_entry_thresh  = 25.0;
input double strategy_rsi_exit_thresh   = 55.0;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
{
   ...
   if(close1 <= 0.0 || sma200 <= 0.0 || rsi4 <= 0.0)
      return false;

   // Entry condition: Close > SMA(200) AND RSI(4) < 25.0 on closed D1 bar
   if(close1 > sma200 && rsi4 < strategy_rsi_entry_thresh)
   {
      const double ask = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
      if(ask <= 0.0)
         return false;
...
bool Strategy_ExitSignal()
{
   ...
   // Exit when RSI(4) closes > 55.0
   return (rsi4 > strategy_rsi_exit_thresh);
}
