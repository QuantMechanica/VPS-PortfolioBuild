# QM5_10089_mql5-bcw-rsi-h1 — Strategy Spec
...
`artifacts/cards_approved/QM5_10089_mql5-bcw-rsi-h1.md`. See that card's body for
...
`QM5_10089_mql5-bcw-rsi-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_rsi_exit_high` | 70.0 | (see source) | (see strategy logic) |
| `strategy_rsi_exit_low` | 30.0 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_context_bars` | 1 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10089_mql5-bcw-rsi-h1.md`
...
|---|---|---|---|
| v1 | 2026-06-30 | Initial spec (ex-post, generated by gen_spec_md.py) | post-PT15 remediation |
