# QM5_41387_wti-tsmom8-h2 — Strategy Spec

**EA ID:** QM5_41387  
**Slug:** `wti-tsmom8-h2`  
**Source:** `MOP-WTI-TSMOM8-H2-2026`  
**Author of this spec:** Codex  
**Last revised:** 2026-09-08

## 1. Strategy Logic

On the first D1 bar of each odd broker month, reconstruct nine consecutive
completed WTI month-end closes and follow the sign of the exact eight-month log
...
| `strategy_return_months` | `8` | `[8]` | Exact formation intervals |
...
**Source ID:** `MOP-WTI-TSMOM8-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM8-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41387_wti-tsmom8-h2_card.md`.
...
`QM5_41386` use three-, one-, nine-, six-, four-, two-, five-, and seven-month
formations. This identity combines the exact eight-month endpoints with the
fixed odd-month two-month lifecycle.
...
|---|---|---|---|
| v1 | 2026-09-08 | Initial build from approved card | PACER guarded build |
