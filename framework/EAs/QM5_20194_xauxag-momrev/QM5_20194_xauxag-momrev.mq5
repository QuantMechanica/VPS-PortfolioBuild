...
#property description "QM5_20194 XAU XAG Momentum Reversal Double Sort"
...
// -----------------------------------------------------------------------------
// Monthly opposite-leg precious-metal relative-value package:
//   - rank XAU and XAG on synchronized 12-completed-month returns
...
string Strategy_AttemptStateName()
  {
   return "QM5_20194_XAUXAG_MOMREV_ATTEMPT";
  }
...
bool Strategy_LoadSignalState(const datetime decision_bar_time,
                              int &pair_direction)
  {
   ...
   if(!Strategy_HorizonReturns(g_leg_xau, decision_bar_time,
                               g_cache_xau_momentum, g_cache_xau_reversal))
      return false;
   if(!Strategy_HorizonReturns(g_leg_xag, decision_bar_time,
                               g_cache_xag_momentum, g_cache_xag_reversal))
      return false;

   g_cache_momentum_difference = g_cache_xau_momentum - g_cache_xag_momentum;
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xau_short_xag ? "QM5_20194_LONG_XAU_SHORT_XAG_MOMREV"
                                            : "QM5_20194_SHORT_XAU_LONG_XAG_MOMREV";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart())
      return true;
   if(qm_ea_id != 20194 || qm_magic_slot_offset != 0 || qm_rng_seed != 42)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20194_XAU_XAG_MOMREV_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20194\",\"ea\":\"xauxag-momrev\"}");
