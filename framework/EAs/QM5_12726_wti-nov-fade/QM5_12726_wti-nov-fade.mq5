...
#property description "QM5_12726 WTI November Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12726 - WTI November Calendar Fade
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12726_WTI_NOV_FADE";
   ...
   req.reason = "WTI_NOVEMBER_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12726\",\"ea\":\"wti-nov-fade\"}");
...
void OnTick()
  {
   ...
   // News blackout gates NEW entries only (below). The stale-position guard
   // and month-end flatten above must keep enforcing through news windows.
