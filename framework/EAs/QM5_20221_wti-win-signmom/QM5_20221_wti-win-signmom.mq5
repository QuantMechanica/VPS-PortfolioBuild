...
#property description "QM5_20221 WTI Winter Return-Sign Momentum"
...
//   - BUY at or above threshold / SELL below, held to next month boundary
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = StringFormat("WTI_WIN_RSM_%s_P%02d_OF_%02d",
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20221_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20221\",\"ea\":\"wti-win-signmom\"}");
