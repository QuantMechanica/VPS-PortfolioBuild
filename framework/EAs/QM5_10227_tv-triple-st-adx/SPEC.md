...
`artifacts/cards_approved/QM5_10227_tv-triple-st-adx.md`. See that card's body for
...
`QM5_10227_tv-triple-st-adx.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_supertrend_1_atr_period` | 10 | (see source) | (see strategy logic) |
| `strategy_supertrend_1_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_supertrend_2_atr_period` | 11 | (see source) | (see strategy logic) |
| `strategy_supertrend_2_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_supertrend_3_atr_period` | 12 | (see source) | (see strategy logic) |
| `strategy_supertrend_3_mult` | 3.0 | (see source) | (see strategy logic) |
| `strategy_use_filters` | true | (see source) | (see strategy logic) |
...
| `strategy_supertrend_warmup_bars` | 180 | (see source) | (see strategy logic) |
| `strategy_emergency_stop_atr_mult` | 2.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10227_tv-triple-st-adx.md`
