...
#property description "QM5_12996 XTI EIA DPR shale-production momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12996 - XTI EIA DPR Shale-Production Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_LoadDprMomentumState(int &direction,
                                   double &atr_last,
                                   double &sma_last,
                                   int &signal_day_key)
  {
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12996_XTI_DPR_MOM";
   ...
   if(!Strategy_LoadDprMomentumState(direction, atr_last, sma_last, signal_day_key))
      return false;
   ...
   req.reason = (direction > 0) ? "XTI_DPR_MOM_LONG" : "XTI_DPR_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12996\",\"ea\":\"xti-dpr-mom\"}");
