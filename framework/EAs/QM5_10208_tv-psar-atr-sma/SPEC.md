...
`artifacts/cards_approved/QM5_10208_tv-psar-atr-sma.md`. See that card's body for
...
`QM5_10208_tv-psar-atr-sma.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_sma_period` | 100 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_stop_mult` | 6.0 | (see source) | (see strategy logic) |
| `strategy_psar_start` | 0.02 | (see source) | (see strategy logic) |
| `strategy_psar_increment` | 0.02 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10208_tv-psar-atr-sma.md`
