...
#property description "QM5_12771 WTI Thursday Calendar Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12771 - WTI Thursday Calendar Premium
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12771_WTI_THU_PREM";
   ...
   req.reason = "WTI_THURSDAY_PREMIUM_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12771\",\"ea\":\"wti-thu-prem\"}");
