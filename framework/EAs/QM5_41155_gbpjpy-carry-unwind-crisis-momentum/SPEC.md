# QM5_41155_gbpjpy-carry-unwind-crisis-momentum - Strategy Spec

**EA ID:** QM5_41155

**Slug:** `gbpjpy-carry-unwind-crisis-momentum`
...
At each new `GBPJPY.DWX` D1 bar, the EA reads the immediately completed D1
...
`GBPJPY.DWX`; all four JPY-cross breadth symbols are signal data only.
...
- Host/execution symbol: exact `GBPJPY.DWX`, D1, slot 0, magic `411550000`.
- Signal-only symbols: `AUDJPY.DWX`, `NZDJPY.DWX`, `CADJPY.DWX`, and
  `EURJPY.DWX`.
...
The entry decision runs once behind `QM_IsNewBar(GBPJPY.DWX, PERIOD_D1)`.
...
|---|---|---|---|
| v1 | 2026-08-29 | Initial build from OWNER-approved G0 card | `e8e61fe1-2589-4f97-adb7-7de16892f9e4` |
