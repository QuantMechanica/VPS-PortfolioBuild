...
#property description "QM5_41155 GBPJPY Carry-Unwind Crisis Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41155 - GBPJPY Carry-Unwind Crisis Momentum
// -----------------------------------------------------------------------------
// On each completed GBPJPY D1 bar, require synchronized five-session weakness
...
// GBPJPY position with a frozen completed-bar ATR stop. Auxiliary symbols are
// signal inputs only and are never execution targets.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41155;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41155 && qm_magic_slot_offset == 0 &&
...
int OnInit()
  {
   if(_Symbol != "GBPJPY.DWX" || _Period != PERIOD_D1 ||
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41155\",\"ea\":\"gbpjpy-carry-unwind-crisis-momentum\",\"execution_symbol\":\"GBPJPY.DWX\"}");
