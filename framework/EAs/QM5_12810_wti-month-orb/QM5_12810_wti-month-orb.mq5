...
#property description "QM5_12810 WTI Monthly Opening Range Breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12810 - WTI Monthly Opening Range Breakout
// -----------------------------------------------------------------------------
...
input double strategy_max_open_range_atr  = 4.00;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12810_WTI_MONTH_ORB";
   ...
   req.reason = (direction > 0) ? "WTI_MONTH_OPEN_RANGE_BREAKOUT_LONG" : "WTI_MONTH_OPEN_RANGE_BREAKOUT_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12810\",\"ea\":\"wti-month-orb\"}");
