# QM5_10207_tv-bb-wick-reversal — Strategy Spec

**EA ID:** QM5_10207
**Slug:** `tv-bb-wick-reversal`
...
`artifacts/cards_approved/QM5_10207_tv-bb-wick-reversal.md`. See that card's body for
...
`QM5_10207_tv-bb-wick-reversal.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_wick_body_min` | 1.0 | (see source) | (see strategy logic) |
...
| `strategy_max_spread_stop` | 0.10 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10207_tv-bb-wick-reversal.md`
