...
#property description "QM5_12600 CME WTI Expiry Roll Breakout"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12600 - CME WTI Expiry/Roll Breakout
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12600_CME_WTI_EXP_BRK";
   ...
   req.reason = (direction > 0) ? "CME_WTI_EXPIRY_BREAKOUT_LONG" : "CME_WTI_EXPIRY_BREAKOUT_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12600\",\"ea\":\"cme-wti-exp-brk\"}");
