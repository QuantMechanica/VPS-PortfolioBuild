...
#property description "QM5_41466 WTI Summer Lower-CLV Reversion"
...
//   - long only when that week closes in the lower third of its full range
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41466_WTI_SUMMER_LCLV_FADE";
   ...
   req.type = QM_BUY;
   req.reason = "WTI_SUMMER_LCLV_FADE_LONG";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41466 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41466_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41466\",\"ea\":\"wti-summer-lclv-fade\"}");
