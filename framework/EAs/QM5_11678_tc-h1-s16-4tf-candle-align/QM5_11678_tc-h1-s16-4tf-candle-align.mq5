...
#property description "QM5_11678 tc-h1-s16-4tf-candle-align — MTF 4-Candle Direction Alignment (H1)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11678 tc-h1-s16-4tf-candle-align
// -----------------------------------------------------------------------------
// Source: Thomas Carter, "20 Forex Trading Strategies Collection (1 Hour Time
//   Frame)", Strategy #16 (self-published, 2014). R1 FAIL (self-published, no
//   track record); R2/R3/R4 PASS.
// Card: artifacts/cards_approved/QM5_11678_tc-h1-s16-4tf-candle-align.md
//   (g0_status APPROVED).
//
...
//                      order. This is exactly the idiom proven in sibling QM5_11542.
...
input double strategy_sl_pips             = 20.0;   // fixed stop loss (pips) — card SL 20
...
input bool   strategy_no_friday_entry     = false;  // card has no Friday filter; framework Friday-close handles weekend risk
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // Optional no-Friday-entry filter (off by default; card states no such filter).
