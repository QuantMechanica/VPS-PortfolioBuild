...
`artifacts/cards_approved/QM5_10248_tv-macd-sma200.md`. See that card's body for
...
`QM5_10248_tv-macd-sma200.mq5`. Framework wiring (risk, magic, news, Friday close)
...
`artifacts/cards_approved/QM5_10248_tv-macd-sma200.md`
