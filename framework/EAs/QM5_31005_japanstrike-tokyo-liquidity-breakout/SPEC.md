# QM5_31005_japanstrike-tokyo-liquidity-breakout — Strategy Spec

**EA ID:** QM5_31005
**Slug:** `japanstrike-tokyo-liquidity-breakout`
**Source:** `japanstrike-tokyo-liquidity-breakout-official-source` (see `strategy-seeds/sources/japanstrike-tokyo-liquidity-breakout-official-source/`)
...
`artifacts/cards_approved/QM5_31005_japanstrike-tokyo-liquidity-breakout.md`. See that card's body for
...
`QM5_31005_japanstrike-tokyo-liquidity-breakout.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `InpBoxStart` | "22:00" | (see source) | (see strategy logic) |
| `InpBoxEnd` | "00:00" | (see source) | (see strategy logic) |
...
**Source ID:** `japanstrike-tokyo-liquidity-breakout-official-source`
**Pointer:** `strategy-seeds/sources/japanstrike-tokyo-liquidity-breakout-official-source/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_31005_japanstrike-tokyo-liquidity-breakout.md`
