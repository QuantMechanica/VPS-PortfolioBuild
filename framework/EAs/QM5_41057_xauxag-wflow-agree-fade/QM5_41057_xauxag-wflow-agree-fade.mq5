...
#property description "QM5_41057 XAU/XAG Weekly Relative-Flow Agreement Fade"
...
// relative components have the same strict sign. Fade the completed relative
// week with opposite equal-notional legs and
// flatten the package Friday at broker 21.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 41057;
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41057 && qm_magic_slot_offset == 0 &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_WFLOWAGREEFADE_ATTEMPT_DATE", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41057_XAUXAG_WFLOWAGREEFADE";
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41057_XAUXAG_WFLOWAGREEFADE_HOST";
   ...
   QM_LogEvent(QM_INFO,
               "STRATEGY_STATE",
               StringFormat("{\"date\":%d,\"overnight_relative\":%.12e,\"session_relative\":%.12e,\"week_relative\":%.12e,\"flow_agreement\":true,\"direction\":%d}",
                            g_signal_date_key,
                            overnight_relative,
                            session_relative,
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG weekly flow-agreement fade uses paired Friday 21 exit"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41057\",\"ea\":\"xauxag-wflow-agree-fade\"}");
