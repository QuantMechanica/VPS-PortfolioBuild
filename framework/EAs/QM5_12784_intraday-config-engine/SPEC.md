# QM5_12784_intraday-config-engine — Strategy Spec

**EA ID:** QM5_12784
**Slug:** `intraday-config-engine`
**Source:** `intraday-momentum-orb-canonical-2026-06-29` (see `artifacts/cards_approved/QM5_12784_intraday-config-engine.md`)
...
**Pointer:** `artifacts/cards_approved/QM5_12784_intraday-config-engine.md`
...
**R1–R4 verdict (Q00):** all PASS per `artifacts/cards_approved/QM5_12784_intraday-config-engine.md`
