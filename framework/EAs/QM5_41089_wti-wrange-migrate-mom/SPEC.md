# QM5_41089_wti-wrange-migrate-mom - Strategy Spec
...
**Source:** `MOP-WTI-WRANGE-MIGRATE-MOM-2026`
...
- Symbol slot: 0.
- Magic: `410890000` (governed slot-0 allocation for `XTIUSD.DWX`).
...
- Approximately twelve to twenty-four completed WTI positions per full post-
...
- Carrier and mechanic do not prove decorrelation; Q09 owns realized
...
`strategy-seeds/sources/MOP-WTI-WRANGE-MIGRATE-MOM-2026/source.md`.

The paper supplies own-price continuation lineage and includes WTI. The weekly
range-state proxy is a disclosed QM hypothesis; no paper result transfers to
this standalone continuous-CFD implementation.
...
|---|---|---|---|
| v0 | 2026-08-21 | approved build-directory identity | source approval `801e20b8e`; EA-ID reservation `c3ce76c12`; G0 card `bb1252ccb`; governed magic `410890000` |
