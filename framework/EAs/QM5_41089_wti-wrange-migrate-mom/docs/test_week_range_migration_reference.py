"""Deterministic reference checks for QM5_41089 weekly range migration."""
...
class WeekRangeMigrationReferenceTest(unittest.TestCase):
    ...
    def test_static_build_contract_is_fixed_risk_and_completed_data_only(self) -> None:
        source = (EA_DIR / "QM5_41089_wti-wrange-migrate-mom.mq5").read_text(encoding="utf-8")
        setfile = (EA_DIR / "sets" / "QM5_41089_wti-wrange-migrate-mom_XTIUSD.DWX_D1_backtest.set").read_text(encoding="utf-8")
        for marker in (
