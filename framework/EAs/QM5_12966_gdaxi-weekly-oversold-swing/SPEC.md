# QM5_12966_gdaxi-weekly-oversold-swing - Strategy Spec
...
This EA implements the approved GDAXI survivor-port card. It opens a long
...
**Designed for:**
- `GDAXI.DWX` - German DAX exposure gives a European index port with EUR rates,
  export, industrial, and regional session drivers distinct from the SP500
  parent and the existing metal/energy-heavy survivor set.
...
| Expected drawdown profile | Moderate swing drawdown, card estimate 15% |
...
**Pointer:** `D:/QM/strategy_farm/artifacts/cards_approved/QM5_12966_gdaxi-weekly-oversold-swing.md`
**R1-R4 verdict (Q00):** all PASS / see `artifacts/cards_approved/QM5_12966_gdaxi-weekly-oversold-swing.md`
...
|---|---|---|---|
| v1 | 2026-07-04 | Initial build from card | `5935f254-eb3a-4069-a05b-0d5bc26325b1` |
