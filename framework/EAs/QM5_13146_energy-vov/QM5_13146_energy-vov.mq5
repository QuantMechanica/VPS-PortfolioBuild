...
#property description "QM5_13146 XTI XNG Realized Volatility-of-Volatility Rank"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_13146 - XTI/XNG Monthly Realized Volatility-of-Volatility Rank
// -----------------------------------------------------------------------------
...
double   g_cache_xti_vov = 0.0;
double   g_cache_xng_vov = 0.0;
double   g_cache_vov_difference = 0.0;
double   g_cache_xti_mean_rv = 0.0;
double   g_cache_xng_mean_rv = 0.0;
...
bool Strategy_LoadSignalState(const datetime decision_bar_time,
                              int &pair_direction)
  {
   ...
   g_cache_xti_mean_rv = 0.0;
   g_cache_xng_mean_rv = 0.0;

   if(!Strategy_RealizedVoV(g_leg_xti,
                            decision_bar_time,
                            g_cache_xti_vov,
                            g_cache_xti_mean_rv))
      return false;
   if(!Strategy_RealizedVoV(g_leg_xng,
                            decision_bar_time,
                            g_cache_xng_vov,
                            g_cache_xng_mean_rv))
      return false;

   g_cache_vov_difference = g_cache_xti_vov - g_cache_xng_vov;
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xti_short_xng ? "QM5_13146_LONG_XTI_SHORT_XNG_LOW_VOV"
                                            : "QM5_13146_SHORT_XTI_LONG_XNG_LOW_VOV";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13146_XTI_XNG_VOV_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13146\",\"ea\":\"energy-vov\"}");
