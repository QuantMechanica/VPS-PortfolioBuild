# QM5_9400_brooks-failed-outside-outside-h4 — Strategy Spec

**EA ID:** QM5_9400
**Slug:** `brooks-failed-outside-outside-h4`
...
`artifacts/cards_approved/QM5_9400_brooks-failed-outside-outside-h4.md`. See that card's body for
...
`QM5_9400_brooks-failed-outside-outside-h4.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_oo_range_atr_min` | 1.20 | (see source) | (see strategy logic) |
| `strategy_breakout_atr_mult` | 0.20 | (see source) | (see strategy logic) |
| `strategy_failure_atr_mult` | 0.40 | (see source) | (see strategy logic) |
| `strategy_tp_atr_mult` | 0.80 | (see source) | (see strategy logic) |
| `strategy_sl_atr_mult` | 0.30 | (see source) | (see strategy logic) |
| `strategy_spread_atr_mult` | 0.20 | (see source) | (see strategy logic) |
| `strategy_breakout_window` | 12 | (see source) | (see strategy logic) |
| `strategy_failure_window` | 8 | (see source) | (see strategy logic) |
| `strategy_time_stop_h4_bars` | 24 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9400_brooks-failed-outside-outside-h4.md`
...
|---|---|---|---|
| v1 | 2026-07-01 | Initial spec (ex-post, generated by gen_spec_md.py) | post-PT15 remediation |
