# QM5_41412_wti-walt3-fade - Strategy Spec

**EA ID:** QM5_41412  
**Slug:** `wti-walt3-fade`  
**Strategy ID:** `YANG-WTI-WALT3-FADE-20260910_S01`  
**Source:** `YANG-WTI-WALT3-FADE-20260910`  
...
Compute each `ln(final_close / first_open)`. Sell after the strict chronological
path `+,-,+`; buy after `-,+,-`. Every other path, invalid history, late
...
`414120000`. The symbol is an input; no executable symbol literal is embedded
...
alternation, and fade the newest return sign. Require no owned position or
...
`strategy-seeds/sources/YANG-WTI-WALT3-FADE-20260910/source.md`. Kwon, Kang,
and Yun (2020), DOI `10.1016/j.frl.2019.101306`, supplies weekly commodity-
commodity-reversal plus weekly-horizon and WTI lineage. It does not establish this standalone time-series
alternation fade, continuous-CFD efficacy, or portfolio decorrelation.
...
basis/roll and financing, label sensitivity, reversal-crash and alternation whipsaw, horizon
