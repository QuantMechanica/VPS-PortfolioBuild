...
#property description "QM5_41412 WTI Three-Week Alternation Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41412 - WTI Three-Week Alternation Fade
// -----------------------------------------------------------------------------
...
//   - fade the newest completed-week sign for one week
...
bool Strategy_LoadThreeWeekAlternationSignal(const int current_week_key,
                                             ...
                                             int &direction)
  {
   ...
   // reversal; fade the newest completed-week sign.
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "negative_positive_negative_fade_long";
      else if(g_signal_direction < 0)
         g_signal_state = "positive_negative_positive_fade_short";
      else
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41412_WTI_WALT3_FADE";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41412 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41412_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41412\",\"ea\":\"wti-walt3-fade\"}");
