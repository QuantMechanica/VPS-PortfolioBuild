...
input string strategy_notable_suffix     = "66";
input int    strategy_lookback_d1_bars   = 2;
input double strategy_sl_price_pct       = 0.50;
input double strategy_tp_price_pct       = 0.80;
input int    strategy_window_start_hhmm  = 1100;
input int    strategy_window_end_hhmm    = 1600;

const bool   g_strnn_fade = true;
const string g_strnn_strategy_id = "STR-008";
const string g_strnn_reason_prefix = "S008";
