# QM5_41216_grimes-nested-pb-v2-requal8 - Strategy Spec

**EA ID:** QM5_41216
**Slug:** `grimes-nested-pb-v2-requal8`
**Source:** `D2C_13SLEEVE_EXIT_SURGERY_AUDIT_2026-07-03` challenger of QM5_10940
...
| `strategy_breakeven_trigger_r` | 1.5 | 0.25-3.00 | Profit in R required before moving stop to breakeven. |
| `strategy_time_exit_bars` | 40 | 1-100 | Maximum holding period in H4 bars. |
| `strategy_use_atr_trail_after_be` | false | true/false | Optional challenger ATR trail after the trigger; default OFF. |
| `strategy_atr_trail_trigger_r` | 1.5 | 0.25-5.00 | Profit in R required before optional ATR trail can arm. |
| `strategy_atr_trail_mult` | 2.0 | 0.25-10.00 | ATR multiple for optional trail. |
...
| v1.1 | 2026-08-05 | Current-V5 instrumentation refresh | Added the explicit pre-guard Q08 MAE sampler and verified the current two-axis news interface; strategy mechanics unchanged. Router task `b84011f2-7a2e-463e-a296-df4b20546013`. |
