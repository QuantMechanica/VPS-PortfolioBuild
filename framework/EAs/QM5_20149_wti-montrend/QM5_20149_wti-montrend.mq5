...
#property description "QM5_20149 WTI Monday Weakness Negative-Trend Agreement"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20149 - WTI Monday Weakness / Slow-Trend Agreement
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "WTI_MON_NEG252_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20149_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20149\",\"ea\":\"wti-montrend\"}");
