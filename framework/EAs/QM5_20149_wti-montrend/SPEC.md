# QM5_20149_wti-montrend — Strategy Spec

**EA ID:** QM5_20149
**Slug:** `wti-montrend`
**Source:** `QUAY-MOP-WTI-MONTREND-2026`
...
- `XNGUSD.DWX` — the certified book already contains natural gas, and this
  source-defined interaction is WTI-specific.
...
| Regime preference | Monday weakness aligned with negative 252-D1 WTI trend |
...
- **Source ID:** `QUAY-MOP-WTI-MONTREND-2026`
...
- **R1-R4 verdict (G0):** all PASS; see
  `strategy-seeds/cards/approved/QM5_20149_wti-montrend_card.md`
...
|---|---|---|---|
| v1 | 2026-07-25 | Initial build from approved G0 card | Q01 pending |
