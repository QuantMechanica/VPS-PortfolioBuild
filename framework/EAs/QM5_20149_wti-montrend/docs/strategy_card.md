...
canonical_card: strategy-seeds/cards/approved/QM5_20149_wti-montrend_card.md
created: 2026-07-25
---
...
`strategy-seeds/cards/approved/QM5_20149_wti-montrend_card.md`; if metadata
...
- Governed composite packet:
  `strategy-seeds/sources/QUAY-MOP-WTI-MONTREND-2026/source.md`.
...
1. Run only on exact `XTIUSD.DWX`, D1, magic slot 0 and magic `201490000`.
...
There is no parameter sweep. The Monday boundary and negative 252-D1 sign are
...
- trade_entry: one negative-trend Monday SELL with frozen ATR stop.
