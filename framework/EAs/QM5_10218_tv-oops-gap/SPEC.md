...
`artifacts/cards_approved/QM5_10218_tv-oops-gap.md`. See that card's body for
...
`QM5_10218_tv-oops-gap.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_session_start_hhmm` | 1630 | (see source) | (see strategy logic) |
| `strategy_session_end_hhmm` | 2300 | (see source) | (see strategy logic) |
| `strategy_tick_filter_points` | 2 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_emergency_mult` | 3.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10218_tv-oops-gap.md`
