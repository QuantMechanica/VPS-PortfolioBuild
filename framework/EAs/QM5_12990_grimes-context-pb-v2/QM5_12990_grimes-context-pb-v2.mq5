...
#property description "QM5_12990 Grimes Contextual Pullback v2"
...
input int    strategy_time_exit_h4_bars      = 36;
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      if(improves)
         QM_TM_MoveSL(ticket, be_sl, "GRIMES_CONTEXT_PB_BE_1_5R");
     }
  }
