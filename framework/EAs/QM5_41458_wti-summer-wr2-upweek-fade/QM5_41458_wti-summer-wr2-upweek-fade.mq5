...
#property description "QM5_41458 WTI Summer WR2 Positive-Week Reversion"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41458 - WTI Summer WR2 Positive-Week Reversion
// -----------------------------------------------------------------------------
...
//   - short only after a expanding newest week closes above its own open
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "newest_week_nonpositive_body_flat";
     }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41458_WTI_SUMMER_WR2_UPWEEK_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_SUMMER_WR2_UPWEEK_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41458 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41458_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41458\",\"ea\":\"wti-summer-wr2-upweek-fade\"}");
