# QM5_41458_wti-summer-wr2-upweek-fade - Strategy Spec

**EA ID:** QM5_41458  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912_S01`
...
strictly wider. Sell only when that week's final close is strictly above its chronological
first open. Range equality, contraction, or a zero/negative body is flat. Consume the decision
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414580000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-WR2-UPWEEK-FADE-20260912/source.md`. It
...
range state), and the November-May WR2 family. Closest sibling `QM5_41457` requires strict
range contraction, the opposite volatility state.
...
| entry | June-October calendar, two completed weeks, strict range expansion, positive-body short fade, attempt, spread, ATR stop |
