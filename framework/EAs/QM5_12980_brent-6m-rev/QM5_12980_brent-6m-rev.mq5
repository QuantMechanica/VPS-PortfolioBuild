...
#property description "QM5_12980 Brent 6M Overextension Fade"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12980_BRENT_6M_REVERSAL";
   ...
   req.reason = (reversal_direction > 0) ? "BRENT_6M_REVERSAL_LONG" : "BRENT_6M_REVERSAL_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12980\",\"ea\":\"brent-6m-rev\"}");
