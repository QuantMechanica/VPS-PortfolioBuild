# QM5_41386_wti-tsmom7-h2 — Strategy Spec

**EA ID:** QM5_41386  
**Slug:** `wti-tsmom7-h2`  
**Source:** `MOP-WTI-TSMOM7-H2-2026`  
**Author of this spec:** Codex  
**Last revised:** 2026-09-08

## 1. Strategy Logic

On the first D1 bar of each odd broker month, reconstruct eight consecutive
completed WTI month-end closes and follow the sign of the exact seven-month log
...
| `strategy_return_months` | `7` | `[7]` | Exact formation intervals |
...
**Source ID:** `MOP-WTI-TSMOM7-H2-2026`. See
`strategy-seeds/sources/MOP-WTI-TSMOM7-H2-2026/source.md` and the R1-R4 record
in `strategy-seeds/cards/approved/QM5_41386_wti-tsmom7-h2_card.md`.
...
`QM5_41385` use three-, one-, nine-, six-, four-, two-, and five-month formations. This identity
combines the exact seven-month endpoints with the fixed odd-month two-month
lifecycle.
