# QM5_41365_xtixng-decouple-rv - Strategy Spec
...
**Source:** `AI-CODEX-XTIXNG-DECOUPLE-RV-20260906`
...
`1e-10` deadband, sell the positive-return winner and buy the negative-return
...
- Logical symbol: `QM5_41365_XTI_XNG_DECOUPLE_RV_D1`.
...
- Trigger: the individual leg returns have strict opposite signs outside
  `1e-10`; buy the loser and sell the winner.
...
- Symmetric opposed-leg oil/gas reversion after opposite-direction weekly moves.
...
relationship and preserve adverse instability. The weekly decoupling-shock
fade is an untested QM translation; no source result transfers.
