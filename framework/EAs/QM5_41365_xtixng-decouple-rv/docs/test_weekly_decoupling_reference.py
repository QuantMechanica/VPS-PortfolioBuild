"""Reference checks for QM5_41365 XTI/XNG weekly decoupling reversion."""
...
MQ5 = EA_DIR / "QM5_41365_xtixng-decouple-rv.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41365_xtixng-decouple-rv_QM5_41365_XTI_XNG_DECOUPLE_RV_D1_D1_backtest.set"
)
...
class WeeklyDecouplingReferenceTest(unittest.TestCase):
    def test_wti_up_xng_down_sells_winner_and_buys_loser(self) -> None:
    ...
    def test_wti_down_xng_up_buys_loser_and_sells_winner(self) -> None:
    ...
    def test_static_artifacts_lock_identity_and_safety(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41365", source)
        ...
        self.assertRegex(resolver, re.compile(r"413650000.*413650001", re.DOTALL))
