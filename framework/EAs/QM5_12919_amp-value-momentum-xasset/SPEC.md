...
| v4 | 2026-09-11 | Q02 history-dependency routing repair | Added the eight-symbol dependency manifest so a physical-host Q02 row is classified as multisymbol, skips the single-symbol six-month prescreen, and privatizes history for every D1 input. EA logic and strategy economics are unchanged. |
