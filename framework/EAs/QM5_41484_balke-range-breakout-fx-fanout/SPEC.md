# QM5_41484 balke-range-breakout-fx-fanout — Strategy Spec

**Lineage:** Velocity fan-out of the qualified incumbent QM5_13213 (identical mechanics, new build identity, ten FX symbol slots). Symbol universe: USDJPY.DWX, EURJPY.DWX, GBPJPY.DWX, AUDJPY.DWX, CHFJPY.DWX, EURUSD.DWX, GBPUSD.DWX, USDCHF.DWX, USDCAD.DWX, AUDUSD.DWX. Each symbol is one magic slot (`qm_magic_slot_offset` 0..9); the chart symbol drives the strategy. Authority FABLE-DEC-VELOCITY-INTAKE-20260920.

---


**EA ID:** QM5_41484
**Slug:** `balke-range-breakout-fx-fanout`
