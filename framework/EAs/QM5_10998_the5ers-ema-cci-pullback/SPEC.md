...
The EA trades H4 forex trend pullbacks. A long setup requires EMA20 above EMA50, CCI(20) at or below -100, the just-closed candle touching the EMA20/50 zone, and that candle closing back above EMA20. A short setup mirrors this with EMA20 below EMA50, CCI(20) at or above +100, an EMA-zone touch, and a close back below EMA20. The stop is placed beyond the recent 5-bar swing with a 0.25 ATR buffer, profit target is the closer of 1.5R or the recent 20-bar structure target, and any remaining position is closed after 12 H4 bars.
...
| strategy_cci_threshold | 100.0 | 0+ | Oversold/overbought CCI threshold |
...
| strategy_time_stop_bars | 12 | 1+ | Maximum H4 bars to hold a trade |
