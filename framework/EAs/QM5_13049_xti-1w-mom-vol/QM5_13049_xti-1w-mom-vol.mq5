...
#property description "QM5_13049 XTI one-week low-volatility momentum"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_13049_XTI_1W_MOM_VOL";
   ...
   req.tp = 0.0;
   req.reason = (direction > 0) ? "XTI_1W_LOWVOL_MOM_LONG" : "XTI_1W_LOWVOL_MOM_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13049\",\"ea\":\"xti-1w-mom-vol\"}");
