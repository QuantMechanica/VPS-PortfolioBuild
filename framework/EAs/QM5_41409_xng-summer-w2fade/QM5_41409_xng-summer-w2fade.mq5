...
#property description "QM5_41409 XNG Summer Two-Week Exhaustion Fade"
...
//   - decide only in June through August
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41409_XNG_SUMMER_W2FADE";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_SUMMER_W2_FADE_LONG"
      : "XNG_SUMMER_W2_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41409 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41409_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41409\",\"ea\":\"xng-summer-w2fade\"}");
