# QM5_11899_psar-ao-ac-confluence-h1 — Strategy Spec

**EA ID:** QM5_11899
**Slug:** `psar-ao-ac-confluence-h1`
**Source:** `7d4e2a91-5c83-5f47-b619-a2d8c5f4e7b3` (see `strategy-seeds/sources/7d4e2a91-5c83-5f47-b619-a2d8c5f4e7b3/`)
...
`artifacts/cards_approved/QM5_11899_psar-ao-ac-confluence-h1.md`. See that card's body for
...
`QM5_11899_psar-ao-ac-confluence-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_psar_max` | 0.2 | (see source) | (see strategy logic) |
| `strategy_ao_fast_period` | 5 | (see source) | (see strategy logic) |
| `strategy_ao_slow_period` | 34 | (see source) | (see strategy logic) |
| `strategy_ac_period` | 5 | (see source) | (see strategy logic) |
| `strategy_target_rr` | 1.0 | (see source) | (see strategy logic) |
| `strategy_sl_buffer_pips` | 2.0 | (see source) | (see strategy logic) |
| `strategy_alt_exit` | true | (see source) | (see strategy logic) |
...
**Source ID:** `7d4e2a91-5c83-5f47-b619-a2d8c5f4e7b3`
**Pointer:** `strategy-seeds/sources/7d4e2a91-5c83-5f47-b619-a2d8c5f4e7b3/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_11899_psar-ao-ac-confluence-h1.md`
