...
#property description "QM5_11671 tc-h1-s6-ema5-15-60-pullback — Triple EMA(5/15/60) Trend Pullback (H1)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11671 tc-h1-s6-ema5-15-60-pullback
// -----------------------------------------------------------------------------
// Source: Thomas Carter, "Forex Trading Strategy #6", 20 Forex Trading
//   Strategies Collection (H1), 2014, pp.14-15. source_id 6b5ab225.
// Card: artifacts/cards_approved/QM5_11671_tc-h1-s6-ema5-15-60-pullback.md
//   (g0_status APPROVED).
//
...
//                        — i.e. the pullback was bought and the trend resumed.
//                        Mirror for short (High >= EMA60, close back below).
//
...
//   Exit       : via the fixed SL / TP only (card "Exit: via 30-pip SL or
//                50-pip TP"). No discretionary exit.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   // --- Trigger bar OHLC (shift 1) for the resume-close test ---
         ...
         if(touched)
           {
            ...
            req.sl     = sl;
            req.tp     = tp;
            req.reason = "triple_ema_pullback_long";
            return true;
           }
        }
      return false;
         ...
         if(touched)
           {
            ...
            req.sl     = sl;
            req.tp     = tp;
            req.reason = "triple_ema_pullback_short";
            return true;
           }
        }
     }
