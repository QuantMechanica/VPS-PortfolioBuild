...
#property description "QM5_41417 XAU/XAG Fresh Two-Week Streak Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_41417 - XAU/XAG Fresh Two-Week Streak Reversion
// -----------------------------------------------------------------------------
...
bool Strategy_InputsValid()
  {
   return (qm_ea_id == 41417 && qm_magic_slot_offset == 0 &&
            g_leg_xau != "" && g_leg_xag != "" &&
            g_leg_xau != g_leg_xag &&
...
string Strategy_AttemptStateKey()
  {
   return StringFormat("QM5_%d_XAUXAG_WRELVOTE_FLIP_ATTEMPT_WEEK", qm_ea_id);
  }
...
bool Strategy_OpenLeg(const string symbol,
                      ...
                      const double stop)
  {
   ...
   request.tp = 0.0;
   request.lots = lots;
   request.reason = "QM5_41417_XAUXAG_WSTREAK2_RV";
...
bool Strategy_LoadFreshTwoWeekStreak(const int current_week,
                                    int &direction)
  {
   ...
   if(g_relative_return[0] < 0.0 &&
      ...
      direction = -1; // Fresh positive ratio streak: sell XAU, buy XAG.
   else if(g_relative_return[0] > 0.0 &&
           g_relative_return[1] < 0.0 &&
           g_relative_return[2] < 0.0)
      direction = 1; // Fresh negative ratio streak: buy XAU, sell XAG.
   return true;
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &request)
  {
   ...
   request.sl = 0.0;
   request.tp = 0.0;
   request.reason = "QM5_41417_XAUXAG_WSTREAK2_RV_HOST";
   ...
   if(Strategy_OpenOwnedPositionCount() > 0 ||
   ...
   else
     {
      ...
      if(!signal_valid)
         ...
         g_signal_state = "newest_xag_winner_faded";
      else if(direction < 0)
         g_signal_state = "newest_xau_winner_faded";
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XAU/XAG fresh two-week streak reversion package exits at the next broker week"))
     {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK",
               "{\"card\":\"QM5_41417\",\"ea\":\"xauxag-wstreak2-rv\"}");
