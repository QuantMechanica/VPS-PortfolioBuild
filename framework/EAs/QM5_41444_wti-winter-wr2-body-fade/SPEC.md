# QM5_41444_wti-winter-wr2-body-fade - Strategy Spec

**EA ID:** QM5_41444  
**Strategy ID:** `BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911_S01`
...
strictly wider. Sell when that week's final close is strictly above its chronological first open;
buy when it is strictly below. Range equality, contraction, or body equality is flat. Consume the
...
Exact setfile-configured `XTIUSD.DWX` D1 carrier, slot zero, magic `414440000`. Runtime uses native
...
`strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-WINTER-WR2-BODY-FADE-20260911/source.md`. It
combines peer-reviewed WTI November-May seasonality and academic commodity reversal with governed
reputable Crabel range-state lineage. The exact weekly rule is an untested QM translation.

The rule differs from `QM5_12567` (two-day XNG oscillator pullback), `QM5_41442` (strict
outer-quartile CLV fade), `QM5_41443` (opposite body continuation), `QM5_41403` and `QM5_41408`
(two-same-sign-week fades without winter/range predicates), and `QM5_41096` (intraweek excursion
rejection).
...
| entry | November-May calendar, two completed weeks, strict range expansion, own-body reversion, attempt, spread, ATR stop |
