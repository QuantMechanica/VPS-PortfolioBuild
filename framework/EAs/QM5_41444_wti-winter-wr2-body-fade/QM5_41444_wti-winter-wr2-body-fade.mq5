...
#property description "QM5_41444 WTI Winter WR2 Body Reversion"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41444 - WTI Winter WR2 Body Reversion
// -----------------------------------------------------------------------------
...
//   - fade an expanding newest week's own open-to-close body direction
   ...
   if(Strategy_WeekAlreadyEntered(g_decision_week_key))
   ...
   else
     {
      ...
      if(!g_signal_valid)
         ...
         g_signal_state = "wr2_negative_body_reversion_long";
      else if(g_signal_direction < 0)
         g_signal_state = "wr2_positive_body_reversion_short";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41444_WTI_WINTER_WR2_BODY_FADE";
   ...
   req.reason = (g_signal_direction > 0
                 ? "WTI_WINTER_WR2_BODY_FADE_LONG"
                 : "WTI_WINTER_WR2_BODY_FADE_SHORT");
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41444 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41444_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41444\",\"ea\":\"wti-winter-wr2-body-fade\"}");
