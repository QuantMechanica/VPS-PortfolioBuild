...
`artifacts/cards_approved/QM5_10215_tv-cci-ema-fx.md`. See that card's body for
...
`QM5_10215_tv-cci-ema-fx.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_cci_sma_period` | 14 | (see source) | (see strategy logic) |
| `strategy_ema_fast_period` | 50 | (see source) | (see strategy logic) |
| `strategy_ema_slow_period` | 200 | (see source) | (see strategy logic) |
| `strategy_trend_filter` | true | (see source) | (see strategy logic) |
| `strategy_stop_loss_pct` | 0.50 | (see source) | (see strategy logic) |
| `strategy_take_profit_pct` | 0.50 | (see source) | (see strategy logic) |
...
| `strategy_start_hour_broker` | 0 | (see source) | (see strategy logic) |
| `strategy_end_hour_broker` | 24 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10215_tv-cci-ema-fx.md`
