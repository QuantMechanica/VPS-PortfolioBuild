...
#property description "QM5_41136 XNG Completed-Month Daily-Return Interquartile-Mean Momentum"
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 41136 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41136_XNG_MDAILY_IQRMEAN_MOM";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_MDAILY_IQRMEAN_MOM_LONG"
      : "XNG_MDAILY_IQRMEAN_MOM_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(g_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41136 ||
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved XNG completed-month daily-return-interquartile-mean position holds through Fridays until the next broker month"))
     {
   ...
   g_attempt_state_key =
      StringFormat("QM5_41136_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41136\",\"ea\":\"xng-mdaily-iqrmean-mom\"}");
