...
#property description "QM5_13012 Grimes Complex Pullback Second-Leg Continuation v2"
// Strategy Card: QM5_13012 (grimes-complex-pb-v2), G0 APPROVED 2026-07-04.
// Source: Adam H. Grimes, How to trade Complex Consolidations, 2014-11-06.
//
// EXIT SURGERY v2 — parent QM5_10911
// Surgical delta: strategy_max_hold_bars 30 -> 60 (30h -> 60h).
// Evidence: EXIT_SURGERY_SCAN_2026-07-04.md §3.4; hold-gradient WR 27%->72%;
// 43 TIME_MGMT kills at 30h ceiling (67% of the 1-3d bucket, WR 72%, avg +487).
// All other logic and parameters are IDENTICAL to parent QM5_10911.

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13012;
...
// v2 surgical change: extended from 30 -> 60 H1 bars (30h -> 60h).
// Evidence: EXIT_SURGERY_SCAN_2026-07-04.md §3.4 — 43 TIME_MGMT kills at
// 30h ceiling with 72% WR (the 1-3d bucket). Extending lets winners run
// through the 24-72h window where the edge fully matures.
      ...
      if(StrategyFindLongPattern(rates, copied, swing_low, trigger_high))
        {
         ...
         req.sl = sl;
         req.tp = tp;
         req.reason = "GRIMES_COMPLEX_PB_V2_LONG";
         return true;
        }
     }
      ...
      if(StrategyFindShortPattern(rates, copied, swing_high, trigger_low))
        {
         ...
         req.sl = sl;
         req.tp = tp;
         req.reason = "GRIMES_COMPLEX_PB_V2_SHORT";
         return true;
        }
     }
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      // v2: max_hold_bars = 60 (extended from 30). Time exit fires at 60 H1 bars (60h).
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13012_grimes_complex_pb_v2\",\"surgery\":\"max_hold_bars_30to60\"}");
