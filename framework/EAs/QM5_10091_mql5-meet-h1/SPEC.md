# QM5_10091_mql5-meet-h1 — Strategy Spec
...
`artifacts/cards_approved/QM5_10091_mql5-meet-h1.md`. See that card's body for
...
`QM5_10091_mql5-meet-h1.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_rsi_period` | 1 | (see source) | (see strategy logic) |
| `strategy_buy_rsi_max` | 40.0 | (see source) | (see strategy logic) |
| `strategy_sell_rsi_min` | 60.0 | (see source) | (see strategy logic) |
| `strategy_exit_level_low` | 30.0 | (see source) | (see strategy logic) |
| `strategy_exit_level_high` | 70.0 | (see source) | (see strategy logic) |
| `strategy_body_avg_lookback` | 20 | (see source) | (see strategy logic) |
| `strategy_context_lookback` | 5 | (see source) | (see strategy logic) |
| `strategy_close_tolerance_points` | 10 | (see source) | (see strategy logic) |
| `strategy_close_tolerance_atr` | 0.02 | (see source) | (see strategy logic) |
...
**Pointer:** `strategy-seeds/sources/a120af9a-fb72-526c-bb80-d1d098a617b5/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_10091_mql5-meet-h1.md`
