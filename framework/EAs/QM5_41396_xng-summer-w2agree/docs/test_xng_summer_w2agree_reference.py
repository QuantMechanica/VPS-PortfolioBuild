"""Deterministic reference checks for QM5_41396 XNG summer agreement."""
...
class XngSummerTwoWeekAgreementReferenceTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_nonsummer_months_are_ineligible(self) -> None:
        for value in (date(2026, 5, 25), date(2026, 9, 7), date(2026, 12, 7)):
