# QM5_41396_xng-summer-w2agree - Strategy Spec

**EA ID:** QM5_41396  
**Slug:** `xng-summer-w2agree`  
**Strategy ID:** `EIA-MOP-XNG-SUMMER-W2AGREE-2026_S01`  
**Source:** `EIA-MOP-XNG-SUMMER-W2AGREE-2026`  
**Last revised:** 2026-09-09

## 1. Strategy Logic

At the first tradable `XNGUSD.DWX` D1 bar of a normalized broker week whose
Monday anchor lies in June through August, read only the two immediately
...
`413960000`. The symbol is an input; no executable symbol literal is embedded
...
6-12 completed packages per full year. The expected regime is summer
electric-generation demand; expected hold is one normalized week.

## 6. Source Citation

The source-of-record packet is
`strategy-seeds/sources/EIA-MOP-XNG-SUMMER-W2AGREE-2026/source.md`. It joins
...
two-week summer conjunction, continuous-CFD efficacy, and portfolio decorrelation are
not source claims. R1 lineage and R2-R4 status are recorded in
`strategy-seeds/cards/approved/QM5_41396_xng-summer-w2agree_card.md`.
...
| entry | summer calendar, two completed-week packages, strict agreement, durable attempt, spread and frozen ATR stop |
