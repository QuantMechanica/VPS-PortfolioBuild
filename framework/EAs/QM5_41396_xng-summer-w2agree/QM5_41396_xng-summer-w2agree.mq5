...
#property description "QM5_41396 XNG Summer Two-Week Agreement Momentum"
...
//   - decide only in June, July, and August
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41396_XNG_SUMMER_W2AGREE";
   ...
   req.reason = (g_signal_direction > 0)
      ? "XNG_SUMMER_W2_AGREE_LONG"
      : "XNG_SUMMER_W2_AGREE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41396 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41396_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41396\",\"ea\":\"xng-summer-w2agree\"}");
