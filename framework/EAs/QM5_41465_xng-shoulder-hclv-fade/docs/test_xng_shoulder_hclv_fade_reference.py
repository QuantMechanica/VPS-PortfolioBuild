"""Deterministic reference checks for QM5_41465 XNG shoulder upper-CLV fade."""
...
class XngShoulderUpperClvFadeReferenceTest(unittest.TestCase):
    ...
    def test_upper_tercile_is_short(self) -> None:
