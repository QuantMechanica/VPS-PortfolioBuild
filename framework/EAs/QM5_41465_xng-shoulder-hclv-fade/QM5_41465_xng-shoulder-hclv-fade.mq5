...
#property description "QM5_41465 XNG Shoulder Upper-CLV Reversion"
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41465_XNG_SHOULDER_HCLV_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "XNG_SHOULDER_HCLV_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41465 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41465_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41465\",\"ea\":\"xng-shoulder-hclv-fade\"}");
