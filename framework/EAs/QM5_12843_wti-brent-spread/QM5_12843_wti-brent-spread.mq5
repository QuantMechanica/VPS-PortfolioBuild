...
#property description "QM5_12843 WTI Brent Spread Reversion"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_12843 - WTI/Brent Spread Reversion
// -----------------------------------------------------------------------------
// D1 two-leg crude benchmark basket:
//   spread = log(Brent) - beta * log(WTI)
//   z > entry: short Brent-WTI spread = sell Brent, buy WTI
//   z < -entry: long Brent-WTI spread = buy Brent, sell WTI
...
bool Strategy_RefreshSpreadState()
  {
   ...
   const int history_needed = z_lookback + 1;
...
bool Strategy_OpenPair(const int spread_direction)
  {
   ...
   const string reason = long_spread ? "QM5_12843_LONG_BRENT_WTI_SPREAD"
                                     : "QM5_12843_SHORT_BRENT_WTI_SPREAD";
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart())
      return true;
   if(strategy_z_lookback_d1 < 40 || strategy_beta <= 0.0)
      return true;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12843_SPREAD_HOST";
...
int OnInit()
  {
   ...
   QM_BasketWarmupHistory(basket_symbols,
                          PERIOD_D1,
                          MathMax(220, strategy_z_lookback_d1 + strategy_atr_period_d1 + 10));

   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12843\",\"ea\":\"wti-brent-spread\"}");
