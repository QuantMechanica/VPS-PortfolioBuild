...
#property description "QM5_11521 Carter-T EMA(6/13) + MACD + PSAR H4 GBP"
...
input double strategy_sar_max            = 0.2;
input int    strategy_ema_cross_lookback = 3;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double low1 = iLow(_Symbol, _Period, 1);   // perf-allowed: O(1) closed-bar PSAR comparison
   const double high1 = iHigh(_Symbol, _Period, 1); // perf-allowed: O(1) closed-bar PSAR comparison
