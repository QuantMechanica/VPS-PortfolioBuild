...
#property description "QM5_13080 XCU Donchian-55 trend"
...
//   - host/traded symbol: XCUUSD.DWX
//   - close-channel Donchian breakout in a confirmed trend regime
//   - ATR hard stop, shorter contra-channel exit, max-hold exit
// Runtime uses MT5 OHLC/broker state only; no external feed.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 13080;
...
bool Strategy_IsTarget()
  {
   return (_Symbol == "XCUUSD.DWX" && _Period == PERIOD_D1 && qm_magic_slot_offset == 0);
  }
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = (direction > 0) ? "XCU_DONCHIAN55_LONG" : "XCU_DONCHIAN55_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_13080\",\"ea\":\"xcu-donchian55\"}");
