...
`artifacts/cards_approved/QM5_10201_tv-ema20-50-multitp.md`. See that card's body for
...
`QM5_10201_tv-ema20-50-multitp.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_fast_ema_period` | 20 | (see source) | (see strategy logic) |
| `strategy_slow_ema_period` | 50 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_sl_mult` | 2.0 | (see source) | (see strategy logic) |
| `strategy_atr_floor_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_percent_sl` | 3.0 | (see source) | (see strategy logic) |
| `strategy_tp_range_mult` | 1.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10201_tv-ema20-50-multitp.md`
