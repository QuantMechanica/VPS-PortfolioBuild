...
`artifacts/cards_approved/QM5_10230_tv-ema-stoch-atr.md`. See that card's body for
...
`QM5_10230_tv-ema-stoch-atr.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_ema_fast` | 50 | (see source) | (see strategy logic) |
| `strategy_ema_slow` | 200 | (see source) | (see strategy logic) |
| `strategy_rsi_period` | 14 | (see source) | (see strategy logic) |
| `strategy_stoch_rsi_lookback` | 14 | (see source) | (see strategy logic) |
| `strategy_stoch_k_smooth` | 3 | (see source) | (see strategy logic) |
| `strategy_stoch_d_smooth` | 3 | (see source) | (see strategy logic) |
| `strategy_recent_extreme_bars` | 5 | (see source) | (see strategy logic) |
...
| `strategy_break_even_enabled` | false | (see source) | (see strategy logic) |
| `strategy_break_even_trigger_r` | 1.0 | (see source) | (see strategy logic) |
| `strategy_break_even_buffer_pts` | 0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10230_tv-ema-stoch-atr.md`
