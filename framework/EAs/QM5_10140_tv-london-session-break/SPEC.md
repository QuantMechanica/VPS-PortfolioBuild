...
`artifacts/cards_approved/QM5_10140_tv-london-session-break.md`. See that card's body for
...
`QM5_10140_tv-london-session-break.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_london_start_hhmm` | 300 | (see source) | (see strategy logic) |
| `strategy_london_end_hhmm` | 900 | (see source) | (see strategy logic) |
| `strategy_entry_start_hhmm` | 930 | (see source) | (see strategy logic) |
| `strategy_entry_end_hhmm` | 1100 | (see source) | (see strategy logic) |
| `strategy_exit_grace_minutes` | 15 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_stop_mult` | 0.25 | (see source) | (see strategy logic) |
| `strategy_reward_r_multiple` | 2.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10140_tv-london-session-break.md`
