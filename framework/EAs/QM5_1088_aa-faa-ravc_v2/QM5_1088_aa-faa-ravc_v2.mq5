...
#property description "QM5_1088 Alpha Architect FAA RAVC Rotation v2"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                    = 1088;
input int    qm_magic_slot_offset        = 100;
...
int       g_universe_slots[7] = {100, 101, 102, 103, 104, 105, 106};
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_1088\",\"ea\":\"aa-faa-ravc_v2\"}");
