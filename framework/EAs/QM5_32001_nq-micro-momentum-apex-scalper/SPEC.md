# QM5_32001_nq-micro-momentum-apex-scalper — Strategy Spec

**EA ID:** QM5_32001
**Slug:** `nq-micro-momentum-apex-scalper`
**Source:** `nq-micro-momentum-apex-scalper-official-source` (see `strategy-seeds/sources/nq-micro-momentum-apex-scalper-official-source/`)
...
`artifacts/cards_approved/QM5_32001_nq-micro-momentum-apex-scalper.md`. See that card's body for
...
`QM5_32001_nq-micro-momentum-apex-scalper.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `InpFastEMA` | 9 | (see source) | (see strategy logic) |
| `InpSlowEMA` | 21 | (see source) | (see strategy logic) |
| `InpTPPoints` | 20.0 | (see source) | (see strategy logic) |
| `InpSLPoints` | 15.0 | (see source) | (see strategy logic) |
| `InpBEPoints` | 10.0 | (see source) | (see strategy logic) |
...
**Source ID:** `nq-micro-momentum-apex-scalper-official-source`
**Pointer:** `strategy-seeds/sources/nq-micro-momentum-apex-scalper-official-source/`
**R1–R4 verdict (Q00):** all PASS — see
`artifacts/cards_approved/QM5_32001_nq-micro-momentum-apex-scalper.md`
