# QM5_41346_cum-rsi2-commodity-requal8-opt - Strategy Spec

**EA ID:** QM5_41346
**Slug:** `cum-rsi2-commodity-requal8-opt`
**Parent EA:** `QM5_41219_cum-rsi2-commodity-requal8`
**Target symbols:** `XAUUSD.DWX`
**Source:** `OWNER-DEC-Q09HOLD-REQUAL-8-20260829:QM5_12567` (inherited from the approved parent card)
...
15 trades/year on the host. This package is measurement-only; no live
or pipeline verdict is authorized.

## 6. Source Citation

Source ID `OWNER-DEC-Q09HOLD-REQUAL-8-20260829:QM5_12567` and its citations are inherited from the approved
`QM5_41219` parent card.
