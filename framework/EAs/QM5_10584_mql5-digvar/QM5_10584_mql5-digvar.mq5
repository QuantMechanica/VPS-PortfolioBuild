...
#property description "MQL5 DigVariation rebuild"
...
input int    strategy_momentum_period   = 12;
...
string strategy_symbols[] = {"GBPJPY.DWX", "EURUSD.DWX", "USDJPY.DWX", "XAUUSD.DWX"};
string strategy_reason = "DIGVAR";
