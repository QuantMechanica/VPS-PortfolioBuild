...
type: strategy
strategy_id: SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026_S01
variant_id: SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026_S01
source_id: SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026
ea_id: QM5_41104
slug: xauxag-mmedian-shift-rv
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41104_xauxag-mmedian-shift-rv_card.md
execution_contract_status: APPROVED
created: 2026-08-22
created_by: Research+Development
last_updated: 2026-08-22
g0_status: APPROVED
g0_decision: decisions/2026-08-22_qm5_41104_xauxag_monthly_median_shift_reversion_g0.md
source_approval: decisions/2026-08-22_xauxag_monthly_median_shift_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_paper
    ...
    location: "DOI 10.1016/j.jbankfin.2017.11.010; complete-read governed packet strategy-seeds/sources/SCHWEIKERT-XAUXAG-RATIO-2026/source.md; bounded extraction strategy-seeds/sources/SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026/source.md"
    quality_tier: A
...
strategy_mechanic: synchronized-two-consecutive-completed-calendar-month-daily-close-log-ratio-medians-strict-location-shift-fade-next-month-equal-notional-basket
sources:
  - "[[sources/SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026]]"
concepts:
  - "[[concepts/gold-silver-relative-value]]"
  - "[[concepts/completed-month-ratio-median-shift]]"
  - "[[concepts/market-neutral-basket]]"
indicators:
  - "[[indicators/completed-month-daily-close-ratio-median]]"
  - "[[indicators/atr-risk-stop]]"
strategy_type_flags: [commodity, precious-metals, gold-silver-ratio, relative-value-basket, completed-month-ratio-median-shift, mean-reversion, symmetric-long-short, atr-hard-stop, time-stop, low-frequency]
markets: [commodities, precious_metals]
timeframes: [D1]
target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
primary_target_symbols: [XAUUSD.DWX, XAGUSD.DWX]
single_symbol_only: false
logical_symbol: QM5_41104_XAU_XAG_MMEDIAN_SHIFT_RV_D1
symbol: QM5_41104_XAU_XAG_MMEDIAN_SHIFT_RV_D1
host_symbol: XAUUSD.DWX
companion_symbol: XAGUSD.DWX
symbol_slots: [0, 1]
magic_numbers: [411040000, 411040001]
period: D1
timeframe: D1
expected_trade_frequency: "Approximately ten to twelve completed paired packages per full post-warm-up year after two exact synchronized completed-month samples, a strict median displacement, and execution gates; Q02 must prove at least five/year or retire."
expected_trades_per_year_per_symbol: 10
expected_pf: 1.01
expected_dd_pct: 35.0
risk_class: high
ml_required: false
r1_track_record: PASS_WITH_MONTHLY_MEDIAN_STATE_TRANSLATION_RISK
r2_mechanical: PASS
...
review_focus: "Falsify a completed-month gold/silver daily-close ratio-median displacement fade outside the certified XAU/SP500/NDX/XNG book. Verify exact adjacent month membership, 17-23 synchronized sessions per month, ordinary odd/even sample medians, contrarian paired sides, durable monthly attempt, aggregate fixed risk, atomic basket repair, and next-month lifecycle. Q09 alone may establish realized decorrelation."
modules_used: [no_trade, trade_entry, trade_management, trade_close]
target_modules: [Strategy_NoTradeFilter, Strategy_EntrySignal, Strategy_ManageOpenPosition, Strategy_ExitSignal, Strategy_NewsFilterHook]
hard_rules_at_risk: [exact_xau_xag_carrier, first_tradable_month_bar, consecutive_calendar_months, synchronized_completed_d1_closes, bounded_month_session_counts, ordinary_sample_median, strict_median_displacement, equality_flat, contrarian_ratio_direction, persistent_month_attempt, equal_notional_basket, aggregate_fixed_risk, hard_stops_present, atomic_package_repair, next_month_exit, risk_mode_dual, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 peer-reviewed DOI plus official CME lineage with monthly median displacement disclosed as a QM translation; R2 locks synchronized months, exact odd/even median, attempt, risk, and lifecycle; R3 uses registered native XAU/XAG D1; R4 is deterministic native arithmetic with no trained or external ru"
---

# QM5_41104 XAU/XAG Completed-Month Ratio-Median Shift Reversion

## Hypothesis

The median of synchronized daily gold/silver log ratios describes the robust
location occupied through a completed calendar month without letting one
extreme session define that location. Fading a strict upward shift by selling
gold and buying silver, or fading a strict downward shift with the opposite
package, for the next broker month may capture re-convergence in the metals'
state-dependent long-run relation without taking one outright directional
signal.
...
at commit `65f571311`. The bounded extraction was committed at `ceebb96ea`.
...
tests completed-month ratio medians, comparison of non-overlapping monthly
samples, the contrarian side, a continuous-CFD package, equal-notional sizing,
fixed cash risk, ATR stops, or a one-month hold.

No source return, profit factor, risk-adjusted return, drawdown, trade count,
transaction cost, hedge ratio, median-shift rule, CFD equivalence, neutrality,
...
The canonical pre-allocation checker scanned 4,593 registry rows, 1,272
repository cards, and 45 Strategy-Wiki nodes. It found no exact identity and
one expected family-level fuzzy match. Manual semantic review fixes the
boundaries:

- `QM5_41103_xauxag-mrange-migrate-rv` requires both the minimum and maximum
  of the newest ratio sample to migrate in the same direction from both parent
  endpoints. This card discards all range endpoints and compares exactly one
  robust order statistic per completed month. It can therefore signal when
  the two ranges overlap or their endpoints migrate in mixed directions.
- `QM5_20263_xauxag-mad-rv` uses a rolling 63-D1 median and MAD score, a fresh
  ...
  estimates no scale, threshold, or crossing and compares two bounded,
  non-overlapping calendar samples once per month.
- `QM5_20057_xauxag-xmom1` follows the relative winner from two month-end
  closes. This card uses all synchronized daily closes in each month, compares
  robust ratio locations, and fades rather than follows.
- `QM5_20157_xau-xag-ratio` fades a rolling 60-day mean/standard-deviation
  ...
  window, mean, scale, nor intramonth center exit.
...
- `QM5_41039_xauxag-mflow-div` compares overnight and intraday return
  components inside one month rather than monthly ratio locations.
...
The exact XAU/XAG carrier, two consecutive synchronized completed calendar
months, ordinary sample medians, strict comparison, contrarian package,
durable monthly attempt, equal-notional aggregate-risk sizing, and next-month
exit are jointly load-bearing. Verdict:
`CLEAN_AFTER_EXPECTED_MONTHLY_RATIO_FAMILY_FUZZY_REVIEW`.

## Markets, Timeframe, And Cadence

- Exact host: `XAUUSD.DWX`, D1, slot 0, planned magic `411040000`.
- Exact companion: `XAGUSD.DWX`, D1, slot 1, planned magic `411040001`.
- Logical symbol: `QM5_41104_XAU_XAG_MMEDIAN_SHIFT_RV_D1`.
...
- Signal: strict displacement of the newest completed-month ordinary ratio
  median from its parent-month median; fade that direction.
...
sort r independently inside each completed calendar month

median(odd n)  = r_sorted[n / 2]
median(even n) = (r_sorted[n / 2 - 1] + r_sorted[n / 2]) / 2

M0 > M1 => SELL XAU, BUY XAG
M0 < M1 => BUY XAU, SELL XAG
M0 = M1 => FLAT
```
...
arithmetic, non-adjacent months, or unsynchronized history is flat. Median
displacement magnitude never changes eligibility or risk.
...
1. Evaluate only once on a new exact `XAUUSD.DWX` D1 bar under EA 41104 and
...
5. Within a fixed 70-bar buffer, collect every positive finite synchronized
   ...
   Require 17 through 23 unique, strictly increasing timestamp-identical
   sessions in each package and no current-month observation.
6. Compute `log(XAU close)-log(XAG close)` for each pair. Sort each month's
   sample independently. Use the center value for odd counts and the arithmetic
   mean of the two center values for even counts. Require finite medians.
7. Require the newest median to be strictly above or below the parent median.
   Equality, invalid arithmetic, missing session, non-adjacent month, or more
   than 23 sessions remains flat.
8. On a strict upward shift SELL XAU and BUY XAG. On a strict downward shift
   BUY XAU and SELL XAG. Distance never changes eligibility, direction, or
   risk.
...
5. No Friday close, target, fitted-median exit, signal reversal, trailing stop,
   break-even move, partial exit, discretionary close, or intentional hold
   beyond the next broker month is authorized.

## 6. Filters (No-Trade Module)

- Exact host, D1, EA 41104, slot zero, and both governed magics.
...
- First-month-bar clock, exact adjacent prior months, synchronized timestamps,
  17-to-23 session count per month, positive finite closes, finite ordinary
  medians, strict displacement, durable attempt, side-specific trade mode,
...
- Own exactly one `XAUUSD.DWX` position under active magic `411040000` and one
  opposite-side `XAGUSD.DWX` position under active magic `411040001`.
...
source supplies completed-month ordinary medians, a strict median-comparison
rule, or a next-month fade.

## QM Interpretations

`SCHWEIKERT-CME-XAUXAG-MMEDIAN-SHIFT-RV-2026_S01` fixes the exact prior two
calendar months, synchronized daily-close log-ratio samples, ordinary odd/even
medians, strict comparison, contrarian sides, continuous-CFD clock, durable
attempt, equal-notional aggregate risk, spread caps, stops, and lifecycle.
...
| Gate | Status | Finding |
|---|---|---|
| R1 | PASS_WITH_MONTHLY_MEDIAN_STATE_TRANSLATION_RISK | Named peer-reviewed DOI plus official CME carrier lineage; the median-shift fade is disclosed as an untested QM translation. |
| R2 | PASS | Clock, synchronized months, odd/even median, strict side, attempt, risk, and lifecycle are deterministic. |
| R3 | PASS | Registered native XAU/XAG D1 histories supply all runtime inputs; Q02 owns synchronization and CFD-basis sufficiency. |
...
leakage, incorrect odd/even median, accepting equality, wrong contrarian side,
duplicate monthly attempt, unbounded combined risk, missing stops, broken
...
a center or hedge ratio, adding a displacement threshold, or adding a range,
return, volatility, volume, season, external-data, or prior-result gate. No
post-result parameter salvage is authorized.
...
| synchronized two-month closes, medians, strict comparison, sides, attempt, spread, ATR | Trade Entry | `Strategy_EntrySignal` plus deterministic helpers |
...
180-minute clock; exact two consecutive completed months with 17-to-23
synchronized sessions each; correct odd/even log-ratio medians; both valid
shift directions; equality, invalid arithmetic, asynchrony, incomplete-month,
and non-adjacent flat states; no current-bar leakage; persistent monthly
attempts; fixed-risk frozen-stop sizing; atomic repair; next-month and stale
exits; card lint; strict compile; setfile schema; resolver identity; basket
manifest; and static artifact validation.
...
|---|---|---|---|---|
| v1 | 2026-08-22 | initial XAU/XAG completed-month ratio-median shift reversion card | G0 | APPROVED |

## Pipeline Phase Status

| Phase | Date | Status | Evidence |
|---|---|---|---|
| G0 Research Intake | 2026-08-22 | APPROVED | `decisions/2026-08-22_qm5_41104_xauxag_monthly_median_shift_reversion_g0.md` |
