...
#property description "QM5_12596 WTI Monday Seasonality Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12596 - WTI Monday Seasonality Fade
// -----------------------------------------------------------------------------
// D1 structural weekday sleeve:
//   - short XTIUSD.DWX on the broker-calendar Monday D1 bar
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12596_WTI_MON_FADE";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12596\",\"ea\":\"wti-mon-fade\"}");
