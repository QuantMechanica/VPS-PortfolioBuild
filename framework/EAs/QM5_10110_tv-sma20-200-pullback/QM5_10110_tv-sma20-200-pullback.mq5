...
input int    strategy_slope_bars             = 10;
input bool   strategy_use_slow_slope_filter  = true;
input int    strategy_atr_period             = 14;
input double strategy_max_sma20_atr_distance = 1.50;
input double strategy_max_spread_stop_frac   = 0.10;
input int    strategy_opposing_candle_bars   = 50;
input int    strategy_swing_fallback_bars    = 10;
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = is_long ? "TV_SMA20_200_PULLBACK_LONG" : "TV_SMA20_200_PULLBACK_SHORT";
   return true;
  }
