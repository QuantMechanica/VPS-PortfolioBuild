...
`artifacts/cards_approved/QM5_10194_tv-st-rsi-pos.md`. See that card's body for
...
`QM5_10194_tv-st-rsi-pos.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_supertrend_atr_period` | 10 | (see source) | (see strategy logic) |
| `strategy_supertrend_mult` | 3.0 | (see source) | (see strategy logic) |
| `strategy_supertrend_lookback` | 120 | (see source) | (see strategy logic) |
| `strategy_rsi_period` | 14 | (see source) | (see strategy logic) |
| `strategy_rsi_bull_threshold` | 50.0 | (see source) | (see strategy logic) |
| `strategy_use_adx_filter` | true | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10194_tv-st-rsi-pos.md`
