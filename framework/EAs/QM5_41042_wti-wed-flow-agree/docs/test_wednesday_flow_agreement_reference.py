"""Independent mechanic fixtures for QM5_41042.
...
Thursday grace/attempt identity, and next-D1 exit.
...
def select_direction(
    ...
    if overnight_flow * session_flow <= 0:
        return 0
    # Follow the completed Wednesday total.
...
class WednesdayFlowAgreementReferenceTests(unittest.TestCase):
    ...
    def test_positive_agreement_is_bought(self) -> None:
        direction, overnight, session, day_return, total = (
            wednesday_direction(100.0, 101.0, 102.0)
        )
