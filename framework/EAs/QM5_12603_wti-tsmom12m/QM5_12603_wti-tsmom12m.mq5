...
#property description "QM5_12603 WTI 12M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12603 - WTI 12-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12603_WTI_TSMOM12M";
   ...
   req.reason = (direction > 0) ? "WTI_TSMOM12M_LONG" : "WTI_TSMOM12M_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12603\",\"ea\":\"wti-tsmom12m\"}");
