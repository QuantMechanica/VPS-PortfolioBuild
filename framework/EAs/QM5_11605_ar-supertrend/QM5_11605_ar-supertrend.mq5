...
#property description "QM5_11605 ar-supertrend — SuperTrend flip trend-following (H4)"

#include <QM/QM_Common.mqh>

// =============================================================================
// QuantMechanica V5 EA — QM5_11605 ar-supertrend
// -----------------------------------------------------------------------------
// Source: TheFourGreatErrors/alpha-rptr, src/strategies/SupertrendStrat.py
//   https://github.com/TheFourGreatErrors/alpha-rptr/blob/master/src/strategies/SupertrendStrat.py
// Card: artifacts/cards_approved/QM5_11605_ar-supertrend.md (g0_status APPROVED).
//
// Mechanics (long+short, closed-bar reads, H4):
//   SuperTrend (period 10, mult 5.0) reconstructed in-EA from QM_ATR:
//     hl2          = (high + low) / 2
...
//     direction flips: dir=+1 (up) when close crosses ABOVE final_upper;
//                      dir=-1 (down) when close crosses BELOW final_lower;
...
input int    strategy_st_atr_period      = 10;     // SuperTrend ATR period
input double strategy_st_multiplier      = 5.0;    // SuperTrend ATR band multiplier
