...
`artifacts/cards_approved/QM5_10080_gh-victor-gap.md`. See that card's body for
...
`QM5_10080_gh-victor-gap.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_gap_threshold_pct` | 1.0 | (see source) | (see strategy logic) |
| `strategy_sma_period` | 250 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 250 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10080_gh-victor-gap.md`
