# QM5_12776_edgelab-audusd-gbpjpy-cointegration - Strategy Spec
...
The EA trades the AUDUSD.DWX and GBPJPY.DWX D1 cointegration spread. It
computes `S = ln(AUDUSD) - beta * ln(GBPJPY)` with beta defaulting to
0.189701, then calculates a 60-bar rolling z-score of that spread.
...
same script ranked AUDUSD/GBPJPY as the next unbuilt rank-24 tail candidate
after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749/12751/12756/12758/12760/12762/12764/12765/12766/12768/12770/12772
baskets, with DEV Sharpe 0.1257, OOS net Sharpe -0.2072, OOS return -2.3438%,
19 OOS state changes, beta 0.189701, and 117.50-day half-life.
...
| strategy_beta | 0.189701 | >0 | Hedge coefficient in `ln(AUDUSD) - beta * ln(GBPJPY)` |
...
**Designed for:**
- AUDUSD.DWX - leg 1 of the fixed AUDUSD/GBPJPY spread and the spread numerator.
- GBPJPY.DWX - leg 2 of the fixed AUDUSD/GBPJPY spread and the beta-weighted spread denominator.
...
| Regime preference | low-conviction AUD/USD risk expression versus sterling-yen carry/risk expression |
...
|---|---:|---:|---:|---:|---:|---:|
| AUDUSD~GBPJPY | 0.1257 | -0.2072 | -2.3438% | 19 | 0.189701 | 117.50d |
