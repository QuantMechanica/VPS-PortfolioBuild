...
`artifacts/cards_approved/QM5_10204_tv-ema-wma-2tpbe.md`. See that card's body for
...
`QM5_10204_tv-ema-wma-2tpbe.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_fx_stop_pips` | 20 | (see source) | (see strategy logic) |
| `strategy_fx_tp2_pips` | 40 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_nonfx_stop_atr_mult` | 1.0 | (see source) | (see strategy logic) |
| `strategy_nonfx_tp2_atr_mult` | 2.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10204_tv-ema-wma-2tpbe.md`
