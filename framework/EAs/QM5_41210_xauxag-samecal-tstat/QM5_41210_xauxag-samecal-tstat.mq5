...
#property description "QM5_41210 XAU XAG Same-Calendar T-Statistic"

#include <QM/QM_Common.mqh>
#include <QM/QM_BasketOrder.mqh>

// =============================================================================
// QM5_41210 - XAU/XAG Same-Calendar T-Statistic Relative Seasonality
// -----------------------------------------------------------------------------
// Monthly precious-metals relative-value basket:
//   - reconstruct up to ten synchronized prior-year returns for this month
//   - estimate paired XAU-minus-XAG confidence with a one-sample t-statistic
//   - trade opposite metal legs only outside the locked confidence band
...
double   g_cache_sample_variance = 0.0;
double   g_cache_standard_error = 0.0;
double   g_cache_t_statistic = 0.0;
...
string Strategy_AttemptStateName()
  {
   return "QM5_41210_XAUXAG_SAMECAL_TSTAT_ATTEMPT";
  }
...
bool Strategy_LoadSignalState(const int decision_month_key,
                               int &pair_direction)
  {
   ...
   g_cache_mean = 0.0;
   g_cache_sample_variance = 0.0;
   g_cache_standard_error = 0.0;
   g_cache_t_statistic = 0.0;
   ...
   return Strategy_TStatisticSignal(relative_returns,
                                    g_cache_sample_count,
                                    g_cache_mean,
                                    g_cache_sample_variance,
                                    g_cache_standard_error,
                                    g_cache_t_statistic,
                                    pair_direction);
  }
...
bool Strategy_OpenPair(const int pair_direction)
  {
   ...
   const string reason = long_xau_short_xag ? "QM5_41210_LONG_XAU_SHORT_XAG_SAMECAL_TSTAT"
                                            : "QM5_41210_SHORT_XAU_LONG_XAG_SAMECAL_TSTAT";
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41210_XAU_XAG_SAMECAL_TSTAT_HOST";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_41210\",\"ea\":\"xauxag-samecal-tstat\"}");
