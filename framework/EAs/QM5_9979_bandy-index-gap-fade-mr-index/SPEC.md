# QM5_9979_bandy-index-gap-fade-mr-index — Strategy Spec
...
`artifacts/cards_approved/QM5_9979_bandy-index-gap-fade-mr-index.md`. See that card's body for
...
`QM5_9979_bandy-index-gap-fade-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
