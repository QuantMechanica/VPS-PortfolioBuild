# QM5_9924_bandy-dema-crossover-trend — Strategy Spec
...
On each daily bar close, DEMA(8) and DEMA(21) are computed along with a 200-period SMA regime filter.
A long position is opened on the next bar open when DEMA(8) crosses above DEMA(21) and the closing price is above the 200-period SMA.
A short position is opened on the next bar open when DEMA(8) crosses below DEMA(21) and the closing price is below the 200-period SMA.
Positions are managed with a Chandelier trailing stop (22-bar highest high / lowest low +/- 2.5 * ATR(14)), an opposite DEMA crossover exit, and a 60-day time stop.
...
|---|---|---|---|
| `strategy_dema_fast` | 8 | 5 .. 13 | Fast DEMA period |
| `strategy_dema_slow` | 21 | 18 .. 26 | Slow DEMA period |
...
`artifacts/cards_approved/QM5_9924_bandy-dema-crossover-trend.md`
...
|---|---|---|---|
| v1 | 2026-08-23 | Initial build from card | 6bfd24a6-b1ac-47a0-a767-1053d07e81b8 |
