...
#property description "QM5_12734 WTI Feb-Sep Seasonal Premium"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12734 - WTI February-September Seasonal Premium
// -----------------------------------------------------------------------------
// D1 structural crude-oil seasonality sleeve:
//   - long XTIUSD.DWX during broker-calendar February through September
//   - flatten outside the season or by a bounded stale-position guard
// Runtime uses MT5 OHLC/broker calendar only; no external energy data.
// =============================================================================

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 12734;
...
bool Strategy_InSeasonMonth(const int month)
  {
   ...
   for(int i = PositionsTotal() - 1; i >= 0; --i)
     {
      ...
      bool should_close = !Strategy_InSeasonMonth(current_month);
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12734_WTI_FEBSEP_PREM";
   ...
   if(current_d1_bar <= 0)
      return false;
   if(!Strategy_InSeasonMonth(Strategy_Month(current_d1_bar)))
      return false;
   ...
   req.reason = "WTI_FEBSEP_SEASON_LONG";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12734\",\"ea\":\"wti-febsep-prem\"}");
