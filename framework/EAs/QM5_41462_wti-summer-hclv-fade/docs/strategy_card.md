...
type: strategy
strategy_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-HCLV-FADE-20260912_S01
variant_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-HCLV-FADE-20260912_S01
source_id: BURAKOV-CRABEL-YANG-WTI-SUMMER-HCLV-FADE-20260912
ea_id: QM5_41462
slug: wti-summer-hclv-fade
status: APPROVED
execution_contract_ref: strategy-seeds/cards/approved/QM5_41462_wti-summer-hclv-fade.md
execution_contract_status: APPROVED
created: 2026-09-12
created_by: Research+Development
last_updated: 2026-09-12
g0_status: APPROVED
g0_decision: decisions/2026-09-12_qm5_41462_wti_summer_upper_clv_reversion_g0.md
source_approval: decisions/2026-09-12_wti_summer_upper_clv_reversion_source_approval.md
...
source_citations:
  - type: peer_reviewed_reputable_and_academic_bounded_mechanization
    ...
    location: strategy-seeds/sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-HCLV-FADE-20260912/source.md
    quality_tier: B_and_governed_reputable_and_academic_lineages_with_translation_risk
    role: june_october_calendar_upper_tercile_weekly_close_reversion_lineage
strategy_mechanic: normalized-weekly-wti-june-through-october-one-completed-week-upper-tercile-close-location-short-only-reversion-one-week-hold
sources: ["[[sources/BURAKOV-CRABEL-YANG-WTI-SUMMER-HCLV-FADE-20260912]]"]
...
strategy_type_flags: [commodity, energy, crude-oil, structural-seasonality, summer-negative-leg, upper-tercile-close-location, short-only, weekly-reversion, atr-hard-stop, time-stop, low-frequency]
...
parameters_to_test: "Locked Q02 baseline only: D1; Monday anchor; months 6,7,8,9,10; exactly the immediately completed week with 3-5 sessions; CLV strictly above two thirds; short only; 20 D1 history bars; 180-minute grace; 3.5*ATR(20,D1) frozen stop; 10-day stale repair; 1500-point spread ceiling."
...
hard_rules_at_risk: [exact_wti_carrier, june_october_gate, normalized_week_clock, immediately_completed_week, bounded_week_sessions, strict_upper_tercile_close_location, no_range_rank, no_body_sign_gate, short_only_orientation, weekly_attempt_state, one_week_rollover, risk_mode_dual, hard_stop_present, q02_frequency_floor, portfolio_correlation]
g0_approval_reasoning: "R1 complete peer-reviewed and governed reputable lineage with explicit translation risk; R2 exact mechanical WTI summer upper-tercile weekly-close short reversion; R3 XTIUSD.DWX D1; R4 deterministic non-ML; no exact repository duplicate after canonical and manual fuzzy-family review."
---
...
During the documented June-through-October negative WTI return leg, a
completed week settling in the upper third of its full range may be a
short-lived counter-seasonal rebound that reverts over the next normalized
broker week. Short at the next week boundary and hold one week. This exact
...
Burakov et al. supply the WTI June-October negative leg; the governed Crabel
packet supplies completed-week and close-location lineage; Yang et al. supply
commodity-reversal lineage. None establishes this conjunction.

The canonical scan found no exact identity and two fuzzy range/body matches.
`QM5_41457` and `QM5_41458` require two completed weeks, a contraction or
expansion range comparison, and a positive newest-week body. This card
requires one completed week, no range ranking, no body direction, and only a
strict upper-tercile settlement. `QM5_41461` uses the disjoint lower tercile
with continuation lineage. The exact mechanic is distinct.
...
1. Run only on setfile-bound `XTIUSD.DWX` D1 with EA 41462, slot zero,
...
Burakov et al. supply the June-October negative WTI leg. Yang et al. supply
broad commodity reversal. The governed Crabel record supplies weekly
...
WTI gaps, roll/basis, financing, label sensitivity, sample scarcity, stop
slippage, source translation, and overlap with other WTI candidates can
