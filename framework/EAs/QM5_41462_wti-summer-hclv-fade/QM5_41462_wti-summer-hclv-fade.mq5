...
#property description "QM5_41462 WTI Summer Upper-CLV Reversion"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41462 - WTI Summer Upper-Tercile Weekly-Close Reversion
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_41462_WTI_SUMMER_HCLV_FADE";
   ...
   req.type = QM_SELL;
   req.reason = "WTI_SUMMER_HCLV_FADE_SHORT";
...
int OnInit()
  {
   if(!SymbolSelect(strategy_symbol, true) ||
      !Strategy_IsHostChart() || qm_ea_id != 41462 ||
      qm_magic_slot_offset != 0)
   ...
   g_attempt_state_key =
      StringFormat("QM5_41462_WEEK_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41462\",\"ea\":\"wti-summer-hclv-fade\"}");
