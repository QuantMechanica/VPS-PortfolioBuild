...
#property description "QM5_20218 WTI Winter-Regime / One-Month Reversal"
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20218_MONTH_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState();

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20218\",\"ea\":\"wti-winter-rev1\"}");
