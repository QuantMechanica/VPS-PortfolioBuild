...
#property description "QM5_12871 Brent January Calendar Fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12871 - Brent January Calendar Fade
// -----------------------------------------------------------------------------
// D1 structural month-of-year sleeve:
//   - short XBRUSD.DWX only during broker-calendar January D1 bars
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12871_BRENT_JAN_FADE";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12871\",\"ea\":\"brent-jan-fade\"}");
