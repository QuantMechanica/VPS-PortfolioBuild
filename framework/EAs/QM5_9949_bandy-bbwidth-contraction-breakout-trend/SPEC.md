# QM5_9949_bandy-bbwidth-contraction-breakout-trend — Strategy Spec

**EA ID:** QM5_9949
**Slug:** `bandy-bbwidth-contraction-breakout-trend`
...
`artifacts/cards_approved/QM5_9949_bandy-bbwidth-contraction-breakout-trend.md`. See that card's body for
...
`QM5_9949_bandy-bbwidth-contraction-breakout-trend.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_compression_lookback` | 120 | (see source) | (see strategy logic) |
| `strategy_compression_pct` | 10.0 | (see source) | (see strategy logic) |
| `strategy_rearm_pct` | 60.0 | (see source) | (see strategy logic) |
| `strategy_regime_sma_period` | 200 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_stop_atr_mult` | 2.5 | (see source) | (see strategy logic) |
| `strategy_extreme_range_atr_mult` | 4.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9949_bandy-bbwidth-contraction-breakout-trend.md`
