# QM5_9965_bandy-index-gap-and-go-continuation — Strategy Spec

**EA ID:** QM5_9965
**Slug:** `bandy-index-gap-and-go-continuation`
...
`artifacts/cards_approved/QM5_9965_bandy-index-gap-and-go-continuation.md`. See that card's body for
...
`QM5_9965_bandy-index-gap-and-go-continuation.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_gap_atr_mult` | 0.5 | (see source) | (see strategy logic) |
| `strategy_regime_sma_period` | 200 | (see source) | (see strategy logic) |
| `strategy_atr_period` | 14 | (see source) | (see strategy logic) |
| `strategy_atr_stop_mult` | 1.5 | (see source) | (see strategy logic) |
| `strategy_time_stop_days` | 5 | (see source) | (see strategy logic) |
| `strategy_anti_cluster_bars` | 2 | (see source) | (see strategy logic) |
