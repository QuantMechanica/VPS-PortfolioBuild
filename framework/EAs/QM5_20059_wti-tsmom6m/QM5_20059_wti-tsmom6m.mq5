...
#property description "QM5_20059 WTI 6M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20059 - WTI 6-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_LoadMomentum(double &momentum, int &direction)
  {
   ...
   const int copied = CopyClose(_Symbol, PERIOD_D1, 1, lookback + 1, closes); // perf-allowed: bounded D1 6M momentum sample behind new-bar gate.
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20059_WTI_TSMOM6M";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20059\",\"ea\":\"wti-tsmom6m\"}");
