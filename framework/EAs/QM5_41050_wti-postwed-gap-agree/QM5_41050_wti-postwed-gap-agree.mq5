...
#property description "QM5_41050 WTI Post-Wednesday Gap-Agreement Continuation"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_41050 - WTI Standard-Wednesday Overnight-Dominant Flow Continuation
// -----------------------------------------------------------------------------
...
//   - enter Thursday only when both nonzero components agree in sign
...
bool Strategy_LoadPostWednesdayGapAgreement(const datetime current_bar_time,
                                             const datetime broker_now,
...
bool Strategy_NoTradeFilter()
  {
   ...
   if(!QM_InputRequireLong("qm_ea_id", qm_ea_id, 41050) ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "WTI_POSTWED_GAP_AGREE";
   ...
   int direction = 0;
   if(!Strategy_LoadPostWednesdayGapAgreement(g_strategy_d1_bar_time,
                                               broker_now,
                                               event_session_flow,
                                               post_event_gap,
                                               confirmed_path,
   ...
   if(direction > 0)
     {
      req.type = QM_BUY;
      req.reason = "WTI_POSTWED_GAP_AGREE_LONG";
     }
   else if(direction < 0)
     {
      req.type = QM_SELL;
      req.reason = "WTI_POSTWED_GAP_AGREE_SHORT";
     }
   else
      return false;
...
int OnInit()
  {
   ...
   if(!QM_FrameworkDeclareExecutionContract(
         ...
         "Approved WTI post-Wednesday gap-agreement card exits next D1; Friday 21 is fail-safe"))
      return INIT_FAILED;
   ...
   g_attempt_state_key =
      StringFormat("QM5_41050_POSTWED_GAP_AGREE_THURSDAY_ATTEMPT_%d",
                   QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_41050\",\"ea\":\"wti-postwed-gap-agree\"}");
