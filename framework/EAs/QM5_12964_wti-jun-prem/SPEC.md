# QM5_12964_wti-jun-prem - Strategy Spec

**EA ID:** QM5_12964
**Slug:** `wti-jun-prem`
**Source:** `strategy-seeds/cards/wti-jun-prem_card.md`
...
D1 bar is in June, and uses the prior completed D1 ATR for a hard stop. The
...
April-to-June driving-season swing card, not the existing July single-month
card, and not any inventory, refinery, spread, ratio, basket, roll, or RSI
commodity sleeve.
...
|---|---:|---|---|
| `strategy_entry_month` | 6 | 6 | Broker-calendar month allowed for entries |
...
- Registered magic slot: slot 0, magic `129640000`.
...
- Regime preference: June early driving-season crude-oil exposure.
...
|---|---|---|---|
| v1 | 2026-07-02 | Initial build from approved EIA June WTI seasonality card | QM5_12964 |
