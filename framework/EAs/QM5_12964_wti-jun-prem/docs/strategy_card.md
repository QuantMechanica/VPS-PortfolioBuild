...
slug: wti-jun-prem
type: strategy
strategy_id: EIA-WTI-SEASON-2024_JUN_S03
...
logical_symbol: QM5_12964_XTI_JUN_PREM_D1
period: D1
timeframes: [D1]
expected_trade_frequency: "June-only D1 WTI driving-season seasonal sleeve; estimate 18-22 entries/year after weekends, broker holidays, and framework filters."
...
g0_approval_reasoning: "Mission-directed G0 approval 2026-07-02: R1 PASS official EIA product-demand seasonality source; R2 PASS deterministic June D1 long/time-flat rule with ATR stop; R3 PASS XTIUSD.DWX available; R4 PASS no ML/grid/martingale/external runtime data."
---

# WTI June Calendar Premium
...
gasoline prices tend to rise in spring and peak in late summer when driving
frequency increases. This card isolates June as a clean early driving-season
WTI sleeve: long-only `XTIUSD.DWX` exposure during broker-calendar June D1
...
- `QM5_12576_eia-wti-season`: broad May, June, July, August, December, and
  ...
  June and uses a one-D1-bar calendar premium contract.
- `QM5_12917_xti-driving-season-swing`: April-to-June driving-season swing
  entry with a later seasonal exit; this card opens only on June D1 bars and
  flattens on the next D1 bar.
- `QM5_12962_wti-jul-prem`: July peak driving-season exposure from the same
  EIA source packet; this card tests the earlier June segment.
- Existing WTI February, March, April, May, August, September, October,
  November, December, and January month cards: this card is the unbuilt June
...
- [x] Non-duplicate: June early driving-season exposure is not the broad EIA
  WTI season map, not the April-to-June driving-season swing card, not the
  July peak-season single-month card, not WTI event/ratio/storage/roll logic,
  and not the existing XNG RSI commodity sleeve.
...
|---|---|---|---|
| v1 | 2026-07-02 | initial structural WTI June calendar-premium build | Q02 | PENDING |
...
| Q01 Build | 2026-07-02 | PASS | artifacts/qm5_12964_build_result.json |
| Q02 Baseline Backtest | 2026-07-02 | ENQUEUED | D:\QM\strategy_farm\state\farm_state.sqlite work_item bbcffd53-283a-413a-8391-af7198f16f17 |
