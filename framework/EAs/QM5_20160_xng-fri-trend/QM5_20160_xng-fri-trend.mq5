...
#property description "QM5_20160 XNG Friday Weakness Negative-Trend Agreement"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20160 - XNG Friday Weakness / Slow-Trend Agreement
// -----------------------------------------------------------------------------
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20160_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20160\",\"ea\":\"xng-fri-trend\"}");
