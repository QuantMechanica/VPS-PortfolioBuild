...
#property description "MQL5 MA Round rebuild"

#include <QM/QM_Common.mqh>

input group "QuantMechanica V5 Framework"
input int    qm_ea_id                   = 10577;
...
string strategy_symbols[] = {"USDJPY.DWX", "EURUSD.DWX", "GBPJPY.DWX", "XAUUSD.DWX"};
string strategy_reason = "MA_ROUND";
