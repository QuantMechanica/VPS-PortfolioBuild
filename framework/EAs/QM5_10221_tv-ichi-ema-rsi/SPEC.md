...
`artifacts/cards_approved/QM5_10221_tv-ichi-ema-rsi.md`. See that card's body for
...
`QM5_10221_tv-ichi-ema-rsi.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_displacement` | 26 | (see source) | (see strategy logic) |
...
| `strategy_stoch_rsi_period` | 14 | (see source) | (see strategy logic) |
...
| `strategy_take_profit_rr` | 0.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_10221_tv-ichi-ema-rsi.md`
