...
#property description "QM5_20198 XNG Tuesday Bear-Regime Bounce"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20198 - XNG Tuesday Premium / Bear-Regime Bounce
// -----------------------------------------------------------------------------
// D1 structural natural-gas sleeve:
//   - first observed tick of a genuine broker-calendar Tuesday D1 bar
//   - BUY only when the completed 252-D1 XNG log return is negative
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "XNG_TUE_NEG252_LONG";
   return true;
  }
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20198_WEEK_ATTEMPT_%d",
                   QM_FrameworkMagic());
   Strategy_LoadAttemptState(TimeCurrent());

   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20198\",\"ea\":\"xng-tue-bear\"}");
