# QM5_41168_xauxag-mcoxstuart-rv - Strategy Spec

**EA ID:** QM5_41168

**Slug:** `xauxag-mcoxstuart-rv`

**Strategy ID:** `SCHWEIKERT-COX-STUART-CME-XAUXAG-MPAIRSIGN-RV-2026_S01`

**Source:** `SCHWEIKERT-COX-STUART-CME-XAUXAG-MPAIRSIGN-RV-2026`
...
five positive differences map to SELL XAU / BUY XAG; at least five negative
differences map to BUY XAU / SELL XAG; a 4/3 split is flat. Difference
...
- Host/traded slot 0: exact `XAUUSD.DWX`, D1, magic `411680000`.
- Companion/traded slot 1: exact `XAGUSD.DWX`, D1, magic `411680001`.
- Logical symbol: `QM5_41168_XAU_XAG_MCOXSTUART_RV_D1`.
...
`10.1016/j.jbankfin.2017.11.010`; D. R. Cox and Alan Stuart (1955),
*Biometrika* 42(1-2), 80-95, DOI `10.1093/biomet/42.1-2.80`; official NIST
Dataplot Cox Stuart Test; CME Group, "Gold & Silver Ratio Spread."

Canonical bounded packet:
`strategy-seeds/sources/SCHWEIKERT-COX-STUART-CME-XAUXAG-MPAIRSIGN-RV-2026/source.md`.

The sources support the state-dependent relative carrier, exchange
intermarket-spread lineage, and half-sample paired-sign method. The exact
...
|---|---|---|---|
| v0 | 2026-08-26 | approved source build | G0-approved card; governed magics `411680000`/`411680001`; one logical Q02 preset |
