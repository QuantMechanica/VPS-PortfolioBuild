# QM5_12758_edgelab-gbpusd-euraud-cointegration - Strategy Spec
...
The EA trades the GBPUSD.DWX and EURAUD.DWX D1 cointegration spread. It computes
`S = ln(GBPUSD) - beta * ln(EURAUD)` with beta defaulting to 0.03, then
...
same script ranked GBPUSD/EURAUD as the strongest remaining unbuilt
OOS-positive candidate after the existing
12532/12533/12624/12712/12723/12728/12731/12732/12735/12739/12747/12749/12751/12756 baskets,
with DEV Sharpe -0.27, OOS net Sharpe 0.11, OOS return +1.03%, 17 OOS state
changes, beta 0.03, and 107-day half-life.
...
| strategy_beta | 0.03 | >0 | Hedge coefficient in `ln(GBPUSD) - beta * ln(EURAUD)` |
...
**Designed for:**
- GBPUSD.DWX - leg 1 of the fixed GBPUSD/EURAUD spread and the spread numerator.
- EURAUD.DWX - leg 2 of the fixed GBPUSD/EURAUD spread and the beta-weighted spread denominator.
...
| Regime preference | low-conviction macro relative-value residual between cable and EUR/AUD risk/commodity expressions |
...
|---|---:|---:|---:|---:|---:|---:|
| GBPUSD~EURAUD | -0.27 | 0.11 | +1.03% | 17 | 0.03 | 107d |
