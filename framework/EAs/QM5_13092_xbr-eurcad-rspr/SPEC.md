# QM5_13092_xbr-eurcad-rspr - Strategy Spec

**EA ID:** QM5_13092
**Slug:** `xbr-eurcad-rspr`
**Source:** `EIA-BOC-XBR-EURCAD-2026` (see `strategy-seeds/sources/EIA-BOC-XBR-EURCAD-2026/`)
...
`log(XBR[t] / XBR[t-L]) + beta_eurcad * log(EURCAD[t] / EURCAD[t-L])`,
then standardizes that spread against a rolling lookback window.

`EURCAD` rises when EUR strengthens or CAD weakens. The plus sign is
intentional: a Brent rally and CAD strength should pull the two terms in
opposite directions, so unusually large same-direction Brent/EURCAD
dislocations are faded.
When the z-score is above the entry threshold, the EA sells Brent and sells
EURCAD. When the z-score is below the negative entry threshold, it buys Brent
and buys EURCAD. The package exits when the z-score reverts inside the exit
...
- `EURCAD.DWX` - inverse-CAD FX leg contrasting EUR with CAD oil exposure.
- `QM5_13092_XBR_EURCAD_RSPREAD_D1` - logical Q02 basket symbol backed by the two traded legs above.
...
| Regime preference | Mean-revert relative-value dislocations between Brent and inverse-CAD EURCAD |
...
**Source ID:** `EIA-BOC-XBR-EURCAD-2026`
**Source type:** official energy research / central bank research
**Pointer:** `strategy-seeds/sources/EIA-BOC-XBR-EURCAD-2026/`
**R1-R4 verdict (Q00):** all PASS / see `artifacts/cards_approved/QM5_13092_xbr-eurcad-rspr.md`
...
|---|---|---|---|
| v1 | 2026-07-09 | Initial build from approved card | manual-codex-2026-07-09-xbr-eurcad-rspr |
