...
**Source:** `EIA-BOC-BOJ-XTI-CADJPY-2026` (see `strategy-seeds/sources/EIA-BOC-BOJ-XTI-CADJPY-2026/`)
...
CADJPY. When the z-score is below the negative entry threshold, it buys WTI
...
- `QM5_13010_XTI_CADJPY_RSPREAD_D1` - logical Q02 basket symbol backed by the two traded legs above.
...
- `XBRUSD.DWX` - Brent is excluded; the card is WTI against CADJPY.
...
| Regime preference | Mean-revert relative-value dislocations between WTI and CADJPY |
...
**Source ID:** `EIA-BOC-BOJ-XTI-CADJPY-2026`
**Source type:** paper / government research / central bank research
**Pointer:** `strategy-seeds/sources/EIA-BOC-BOJ-XTI-CADJPY-2026/`
**R1-R4 verdict (Q00):** all PASS / see `artifacts/cards_approved/QM5_13010_xti-cadjpy-rspr.md`
...
|---|---|---|---|
| v1 | 2026-07-04 | Initial build from approved card | manual-codex-2026-07-04-xti-cadjpy-rspr |
