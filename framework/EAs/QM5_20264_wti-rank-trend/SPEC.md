# QM5_20264_wti-rank-trend — Strategy Spec
...
78 comparisons. A score of `S >= 28` buys WTI and `S <= -28` sells it; a weak,
...
- Slot: 0; registered magic: `202640000`.
...
no-tie boundary. Existing WTI EAs use endpoint returns, adjacent-return sign
...
Risk is high: continuous-CFD roll and financing, crude-oil gaps, rank-trend
sparsity, persistent but low-magnitude paths, abrupt reversals, hard-stop
slippage, and energy/risk-asset correlation can dominate the signal. No live,
