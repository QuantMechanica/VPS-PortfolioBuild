...
#property description "QM5_20264 WTI Pairwise Rank Trend"
...
bool Strategy_NoTradeFilter()
  {
   if(!Strategy_IsHostChart() || qm_ea_id != 20264 ||
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_20264_WTI_RANK_TREND";
   ...
   req.reason = (g_cache_signal > 0) ? "RANK_TREND_XTI_LONG" : "RANK_TREND_XTI_SHORT";
...
int OnInit()
  {
   ...
   g_attempt_state_key =
      StringFormat("QM5_20264_MONTH_ATTEMPT_%d", QM_FrameworkMagic());
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_20264\",\"ea\":\"wti-rank-trend\"}");
