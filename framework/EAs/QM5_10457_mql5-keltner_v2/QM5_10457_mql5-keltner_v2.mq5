...
// v2: source unchanged. Root cause: Q02 ONINIT_FAILED on AUDCHF+CADCHF
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   const double close_1 = iClose(_Symbol, tf, 1); // perf-allowed: structural/indicator read; called from QM_IsNewBar-gated context
