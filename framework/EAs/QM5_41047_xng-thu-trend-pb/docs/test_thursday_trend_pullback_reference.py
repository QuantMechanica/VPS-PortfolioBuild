"""Independent mechanic fixtures for QM5_41047.
...
endpoints, strict sign opposition, slow-trend direction, Friday grace/attempt
...
class ThursdayTrendPullbackReferenceTests(unittest.TestCase):
