# QM5_41369_xtixng-cs-leadpersist-cont - Strategy Spec

**EA ID:** QM5_41369  
**Slug:** `xtixng-cs-leadpersist-cont`  
**Strategy ID:** `AI-CODEX-XTIXNG-CS-LEADPERSIST-CONT-20260906_S01`  
**Source:** `AI-CODEX-XTIXNG-CS-LEADPERSIST-CONT-20260906`  
**Author:** Codex  
...
same strict relative winner must persist across both weeks. Follow the newest
...
- Logical symbol: `QM5_41369_XTI_XNG_CS_LEADPERSIST_CONT_D1`.
...
- Trigger: both legs share a strict sign in both weeks and the relative-return
  difference retains the same strict sign beyond `1e-10` in both weeks.
...
persistence continuation is an untested QM translation; no source result transfers.
