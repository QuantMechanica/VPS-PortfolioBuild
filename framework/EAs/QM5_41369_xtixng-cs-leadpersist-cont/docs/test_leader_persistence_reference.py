"""Deterministic reference checks for QM5_41369 leader-persistence continuation."""
...
MQ5 = EA_DIR / "QM5_41369_xtixng-cs-leadpersist-cont.mq5"
SETFILE = (
    EA_DIR
    / "sets"
    / "QM5_41369_xtixng-cs-leadpersist-cont_QM5_41369_XTI_XNG_CS_LEADPERSIST_CONT_D1_D1_backtest.set"
)
...
class LeaderPersistenceReferenceTest(unittest.TestCase):
    def test_positive_common_shocks_keep_wti_leader_and_follow_wti(self) -> None:
    ...
    def test_positive_common_shocks_keep_xng_leader_and_follow_xng(self) -> None:
    ...
    def test_static_artifacts_lock_identity_signal_and_fixed_risk(self) -> None:
        ...
        self.assertIn("qm_ea_id                    = 41369", source)
        ...
        self.assertRegex(resolver, re.compile(r"413690000.*413690001", re.DOTALL))
