...
#property description "QM5_12780 WTI 52-Week Anchor Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12780 - WTI 52-Week High/Low Anchor Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12780_WTI_52W_ANCHOR";
   ...
   req.reason = (direction > 0) ? "WTI_52W_ANCHOR_LONG" : "WTI_52W_ANCHOR_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12780\",\"ea\":\"wti-52w-anchor\"}");
