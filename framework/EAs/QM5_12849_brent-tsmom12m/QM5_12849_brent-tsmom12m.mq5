...
#property description "QM5_12849 Brent 12M Time Series Momentum"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12849 - Brent 12-Month Time-Series Momentum
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12849_BRENT_TSMOM12M";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12849\",\"ea\":\"brent-tsmom12m\"}");
