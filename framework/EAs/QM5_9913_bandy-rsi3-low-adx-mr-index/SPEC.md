# QM5_9913_bandy-rsi3-low-adx-mr-index — Strategy Spec

**EA ID:** QM5_9913
**Slug:** `bandy-rsi3-low-adx-mr-index`
...
`artifacts/cards_approved/QM5_9913_bandy-rsi3-low-adx-mr-index.md`. See that card's body for
...
`QM5_9913_bandy-rsi3-low-adx-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
...
| `strategy_rsi_entry_thresh` | 15.0 | (see source) | (see strategy logic) |
| `strategy_rsi_exit_thresh` | 70.0 | (see source) | (see strategy logic) |
| `strategy_adx_period` | 14 | (see source) | (see strategy logic) |
| `strategy_adx_thresh` | 20.0 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9913_bandy-rsi3-low-adx-mr-index.md`
