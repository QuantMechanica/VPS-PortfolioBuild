---
ea_id: QM5_12967
slug: uk100-weekly-oversold-swing
type: strategy
...
r3_reasoning: "UK100.DWX D1 fully covered; index commission ~$4.4/rt, gross~net."
...
g0_approval_reasoning: "R1 survivor parent 12915 plus Connors/Zakamulin; R2 locked 200/10/10/15 D1 port; R3 UK100.DWX matrix; R4 deterministic long-only, no ML/grid."
---

# UK100 Weekly-Horizon Oversold Swing (survivor port of QM5_12915)
...
horizon. UK100 is the single largest identified book-gap class (126 unbuilt cards target it); FTSE has distinct sector weights (miners, energy, financials) and GBP-rate drivers. Port purity:
...
- Entry: On closed D1 bars, buy UK100.DWX when close > SMA(200) and the close is the lowest close of the last 10 D1 bars.
...
- Target symbols: UK100.DWX.
- Period: D1.
- Expected trade frequency: about 9 trades/year/symbol.
## Risks / Kill Criteria
FTSE bear transitions whipsaw the 200-SMA filter; Q04 folds include 2018/2022.
