# QM5_41212_wti-samecal-signscore - Strategy Spec
...
- strategy ID: `KELOHARJU-PAPAILIAS-RCORE-WTI-SAMECAL-SIGNSCORE-2026_S01`
- source ID: `KELOHARJU-PAPAILIAS-RCORE-WTI-SAMECAL-SIGNSCORE-2026`
...
- G0 decision:
  `decisions/2026-08-30_qm5_41212_wti_same_calendar_sign_score_g0.md`
- host and traded symbol: exact `XTIUSD.DWX`, D1, slot 0
- deterministic magic: `412120000`
...
- Symbol slot: `0`; deterministic magic: `412120000`.
...
exposure different from the XAU/SP500/NDX/XNG book. They do not establish low
...
supply the nonnegative-return binary map, equal weighting, WTI membership, and
...
No source tests this exact Darwinex WTI CFD translation, strict
...
| Version | Date | Reason |
|---|---|---|
| v1 | 2026-08-30 | G0-approved WTI same-calendar Bernoulli sign-score build |
