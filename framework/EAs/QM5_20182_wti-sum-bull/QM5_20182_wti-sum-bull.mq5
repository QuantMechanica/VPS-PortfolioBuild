...
#property description "QM5_20182 WTI Summer Positive-Trend Counterfade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_20182 - WTI Summer Positive-Trend Counterfade
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.reason = "WTI_SUMMER_POS252_SHORT";
   return true;
  }
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO,
               "INIT_OK",
               "{\"card\":\"QM5_20182\",\"ea\":\"wti-sum-bull\"}");
