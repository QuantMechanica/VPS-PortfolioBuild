...
EA_SOURCE = EA_DIR / "QM5_41174_xauxag-mspearman-rv.mq5"
LOGICAL_SET = (
    EA_DIR
    / "sets"
    / "QM5_41174_xauxag-mspearman-rv_QM5_41174_XAU_XAG_MSPEARMAN_RV_D1_D1_backtest.set"
)
...
CANONICAL_CARD = (
    ...
    / "cards"
    / "approved"
    / "QM5_41174_xauxag-mspearman-rv_card.md"
)
...
class MonthlySpearmanRatioReferenceTests(unittest.TestCase):
    ...
    def test_log_ratio_orientation_and_month_sequence(self) -> None:
        ...
        xag = [10.0] * 13
        self.assertEqual(spearman_ratio_signal(log_ratios(xau, xag)).direction, -1)
        endpoints = [
    ...
    def test_source_manifest_sets_and_card_copy_are_locked(self) -> None:
        ...
        self.assertEqual(manifest["logical_symbol"], "QM5_41174_XAU_XAG_MSPEARMAN_RV_D1")
