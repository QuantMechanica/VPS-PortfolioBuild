# QM5_41174_xauxag-mspearman-rv - Strategy Spec

**EA ID:** QM5_41174

**Slug:** `xauxag-mspearman-rv`

**Strategy ID:** `SCHWEIKERT-SPEARMAN-CME-XAUXAG-MRANK-RV-2026_S01`

**Source:** `SCHWEIKERT-SPEARMAN-CME-XAUXAG-MRANK-RV-2026`
...
maps to SELL XAU / BUY XAG; `T<=-104` maps to BUY XAU / SELL XAG; interior
...
- Host/traded slot 0: exact `XAUUSD.DWX`, D1, magic `411740000`.
- Companion/traded slot 1: exact `XAGUSD.DWX`, D1, magic `411740001`.
- Logical symbol: `QM5_41174_XAU_XAG_MSPEARMAN_RV_D1`.
...
- Approximately 4 to 7 completed packages per full post-warm-up year; Q02
  retires below four.
...
intermarket-spread lineage, and rank-association method. The exact threshold,
horizon, contrarian direction, CFD mapping, execution, and risk are disclosed
QM hypotheses; no source result transfers.
...
|---|---|---|---|
| v0 | 2026-08-27 | approved source build | G0-approved card; governed magics `411740000`/`411740001`; one logical Q02 preset |
