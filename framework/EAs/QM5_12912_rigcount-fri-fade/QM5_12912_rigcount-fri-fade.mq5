...
#property description "QM5_12912 Baker Hughes rig-count Friday WTI fade"

#include <QM/QM_Common.mqh>

// =============================================================================
// QM5_12912 - Baker Hughes Rig-Count Friday Fade
// -----------------------------------------------------------------------------
...
bool Strategy_EntrySignal(QM_EntryRequest &req)
  {
   ...
   req.sl = 0.0;
   req.tp = 0.0;
   req.reason = "QM5_12912_RIGCOUNT_FRI_FADE";
   ...
   req.reason = (entry_type == QM_BUY) ? "RIGCOUNT_FRI_FADE_LONG" : "RIGCOUNT_FRI_FADE_SHORT";
...
int OnInit()
  {
   ...
   QM_LogEvent(QM_INFO, "INIT_OK", "{\"card\":\"QM5_12912\",\"ea\":\"rigcount-fri-fade\"}");
