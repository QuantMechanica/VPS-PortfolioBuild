# QM5_9921_bandy-cmo-extreme-fade-mr-index — Strategy Spec

**EA ID:** QM5_9921
**Slug:** `bandy-cmo-extreme-fade-mr-index`
...
`artifacts/cards_approved/QM5_9921_bandy-cmo-extreme-fade-mr-index.md`. See that card's body for
...
`QM5_9921_bandy-cmo-extreme-fade-mr-index.mq5`. Framework wiring (risk, magic, news, Friday close)
...
|---|---|---|---|
| `strategy_cmo_period` | 20 | (see source) | (see strategy logic) |
| `strategy_cmo_entry_thresh` | -50.0 | (see source) | (see strategy logic) |
| `strategy_cmo_exit_thresh` | 0.0 | (see source) | (see strategy logic) |
...
| `strategy_time_stop_days` | 8 | (see source) | (see strategy logic) |
...
`artifacts/cards_approved/QM5_9921_bandy-cmo-extreme-fade-mr-index.md`
